 ...
 *
 * Copyright (c) 2009-Present, Grégory "Greg" PLANCHAT <greg@xnova-ng.org> and
 ...
 *
 *                                --> NOTICE <--
 *  This file is part of the core development code pool, changing its contents
 * will make you unable to use the automatic updates manager. Please refer to
 * the documentation for further information about customizing XNova:Legacies.
 */
 ...
 *
 */
class Nova_Image_Block_Image_Png
{
...
$textColor = array(
    Nova_Image_Block_Image_Png::COLOR_RED   => 0xEF,
    Nova_Image_Block_Image_Png::COLOR_GREEN => 0xEF,
    Nova_Image_Block_Image_Png::COLOR_BLUE  => 0xEF
    );
...
$image = new Nova_Image_Block_Image_Png();
$image
