...
$lang['res']['fleet'] = array(
    Legacies_Empire::ID_SHIP_LIGHT_TRANSPORT => "Petit transporteur",
    Legacies_Empire::ID_SHIP_LARGE_TRANSPORT => "Grand transporteur",
    Legacies_Empire::ID_SHIP_LIGHT_FIGHTER   => "Chasseur l&eacute;ger",
    Legacies_Empire::ID_SHIP_HEAVY_FIGHTER   => "Chasseur lourd",
    Legacies_Empire::ID_SHIP_CRUISER         => "Croiseur",
    Legacies_Empire::ID_SHIP_BATTLESHIP      => "Vaisseau de bataille",
    Legacies_Empire::ID_SHIP_COLONY_SHIP     => "Vaisseau de colonisation",
    Legacies_Empire::ID_SHIP_RECYCLER        => "Recycleur",
    Legacies_Empire::ID_SHIP_SPY_DRONE       => "Sonde espionnage",
    Legacies_Empire::ID_SHIP_BOMBER          => "Bombardier",
    Legacies_Empire::ID_SHIP_SOLAR_SATELLITE => "Satellite solaire",
    Legacies_Empire::ID_SHIP_DESTRUCTOR      => "Destructeur",
    Legacies_Empire::ID_SHIP_DEATH_STAR      => "&eacute;toile de la mort",
    Legacies_Empire::ID_SHIP_BATTLECRUISER   => "Traqueur",
);
