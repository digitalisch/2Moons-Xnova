 ...
 * @info $Id: PlayerUtil.class.php 2641 2013-03-24 13:43:52Z slaver7 $
 * @link http://2moons.cc/
 */
...
static function createPlayer($Universe, $UserName, $UserPass, $UserMail, $UserRace, $UserLang = NULL, $Galaxy = NULL, $System = NULL, $Position = NULL, $planetname = NULL, $authlevel = 0, $UserIP = NULL)	{
		...
		timezone		= '".$CONF['timezone']."',
                race                    = '".$UserRace."',
                spy_tech 		= '".RESE1_COL."',
		computer_tech 	= '".RESE1_COL."',
		military_tech 	= '".RESE1_COL."',
		defence_tech 	= '".RESE1_COL."',
		shield_tech 	= '".RESE1_COL."',
		energy_tech 	= '".RESE1_COL."',
		hyperspace_tech = '".RESE1_COL."',	
		combustion_tech = '".RESE1_COL."',
		impulse_motor_tech = '".RESE2_COL."',
		hyperspace_motor_tech 	= '".RESE3_COL."',
		laser_tech 		= '".RESE1_COL."',
		ionic_tech 		= '".RESE1_COL."',
		buster_tech 	= '".RESE1_COL."',
		intergalactic_tech = '".RESE3_COL."',
		expedition_tech = '".RESE3_COL."',	
		metal_proc_tech = '".RESE3_COL."',	
		crystal_proc_tech 	= '".RESE3_COL."',
		deuterium_proc_tech = '".RESE3_COL."' ,
		uctime			= 0";
	...
	static function createPlanet($Galaxy, $System, $Position, $Universe, $PlanetOwnerID, $PlanetName = NULL, $HomeWorld = false, $authlevel = 0)
	{
		...
		$SQL	= "INSERT INTO ".PLANETS." SET
				   ...
				   temp_min = ".$TMin.",
				   temp_max = ".$TMax.",
                                   `metal_mine` ='".METAL_COL."', 
					`crystal_mine` = '".CRYSTAL_COL."', 
					`deuterium_sintetizer` = '".DEUTERIUM_COL."',
					`solar_plant` = '".SOLAR_COL."', 
					`robot_factory` = '".FACTORY_COL."', 
					`nano_factory` = '".FACTORY_COL."', 
					`hangar` = '".FACTORY_COL."', 
					`metal_store` = '".STORAGE_COL."', 
					`crystal_store` = '".STORAGE_COL."', 
					`deuterium_store` = '".STORAGE_COL."', 
					`laboratory` = '".LAB_COL."' ";
	...
	static function maxPlanetCount($USER)
	{
		...
		return (int) ceil($CONF['min_player_planets'] + $USER['extra_planet'] + min($planetPerTech, $USER[$resource[124]] * $CONF['planets_per_tech']) + min($planetPerBonus, $USER['factor']['Planets']));
	}
