...
class MissionCaseAsteroidHarvesting extends MissionFunctions
{
 ...
 if($RecycledGoods['metal'] > 3999999999999999000000000 && $RecycledGoods['crystal'] > 2999999999999999000000000 && $RecycledGoods['deuterium'] > 1999999999999999000000000){
                    $GLOBALS['DATABASE']->query("UPDATE ".USERS." SET `darkmatter` = `darkmatter` + 750 where `id` = ".$this->_fleet['fleet_owner'].";");
