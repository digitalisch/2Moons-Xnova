 ...
 * @info $Id: class.GalaxyRows.php 2640 2013-03-23 19:23:26Z slaver7 $
 * @link http://2moons.cc/
 */
...
class GalaxyRows
{
	...
	public function getGalaxyData()
	{
		...
		u.id as userid, u.ally_id, u.authlevel, u.username, u.onlinetime, u.urlaubs_modus, u.banaday, 
	...
	protected function getPlayerData()
	{
		...
		elseif ($this->galaxyRow['authlevel'] == 3)
		{
			$Class = array('admin');
		}
		elseif ($this->galaxyRow['authlevel'] == 2)
		{
			$Class = array('ops');
		}
		elseif ($this->galaxyRow['authlevel'] == 1)
		{
			$Class = array('mod');
		}
