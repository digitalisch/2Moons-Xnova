...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_548eb21a9c23e2_07246631',
  'has_nocache_code' => true,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548eb21a9c23e2_07246631')) {function content_548eb21a9c23e2_07246631($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_function_html_options')) include '/home/qwatakayean/public_html/darkness/includes/libs/Smarty/plugins/function.html_options.php';
?><!DOCTYPE html>
...
">
	...
	<title><?php echo $_smarty_tpl->tpl_vars['LNG']->value['siteTitleBanList'];?>
			...
			<td class="box-out-content-center">
				<table class="box-inner">
					<tr class="box-inner-header">
						...
						<td class="box-inner-header-center"><h1><?php echo $_smarty_tpl->tpl_vars['LNG']->value['siteTitleBanList'];?>
</h1></td>
...
">&laquo;</a>&nbsp;<?php }?><?php $_smarty_tpl->tpl_vars['site'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['site']->step = 1;$_smarty_tpl->tpl_vars['site']->total = (int)ceil(($_smarty_tpl->tpl_vars['site']->step > 0 ? $_smarty_tpl->tpl_vars['maxPage']->value+1 - (1) : 1-($_smarty_tpl->tpl_vars['maxPage']->value)+1)/abs($_smarty_tpl->tpl_vars['site']->step));
...
]<?php }?></a><?php if ($_smarty_tpl->tpl_vars['site']->value!=$_smarty_tpl->tpl_vars['maxPage']->value){?>&nbsp;<?php }?><?php }} ?><?php if ($_smarty_tpl->tpl_vars['page']->value!=$_smarty_tpl->tpl_vars['maxPage']->value){?>&nbsp;<a href="index.php?page=banList&amp;side=<?php echo $_smarty_tpl->tpl_vars['page']->value+1;?>
">&raquo;</a><?php }?></td>
	</tr>
<?php }?>
	<tr>
...
<?php if ($_smarty_tpl->tpl_vars['banCount']->value){?>
	<?php  $_smarty_tpl->tpl_vars['banRow'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['banRow']->_loop = false;
...
<?php echo pretty_number($_smarty_tpl->tpl_vars['banCount']->value);?>
<?php echo $_smarty_tpl->tpl_vars['LNG']->value['bn_players_banned'];?>
</td>
	</tr>
<?php }else{ ?>
	<tr>
