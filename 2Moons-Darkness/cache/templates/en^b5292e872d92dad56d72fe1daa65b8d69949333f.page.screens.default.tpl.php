...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_548eb264620715_62148258',
  'has_nocache_code' => true,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548eb264620715_62148258')) {function content_548eb264620715_62148258($_smarty_tpl) {?><!DOCTYPE html>
...
">
	...
	<title><?php echo $_smarty_tpl->tpl_vars['LNG']->value['siteTitleScreens'];?>
...
<body id="screens" class="<?php echo $_smarty_tpl->tpl_vars['bodyclass']->value;?>
">
	<div id="page"><header>
	<nav>
		<ul id="menu">
			...
			<td class="box-out-content-center">
				<table class="box-inner">
					<tr class="box-inner-header">
						...
						<td class="box-inner-header-center"><h1><?php echo $_smarty_tpl->tpl_vars['LNG']->value['siteTitleScreens'];?>
</h1></td>
...
?>
		<?php if (($_smarty_tpl->tpl_vars['screenshot']->iteration%2)===1){?><tr><?php }?>
		<td style="padding-top:13px;">
			<a class="gallery" href="<?php echo $_smarty_tpl->tpl_vars['screenshot']->value['path'];?>
" target="_blank" rel="gallery">
				<img src="<?php echo $_smarty_tpl->tpl_vars['screenshot']->value['thumbnail'];?>
" alt="">
			</a>
		</td>
		<?php if (($_smarty_tpl->tpl_vars['screenshot']->iteration%2)===0){?></tr><?php }?>
	<?php } ?>
</table>
</td>
