...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_548eb25c4515a5_74975213',
  'has_nocache_code' => true,
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548eb25c4515a5_74975213')) {function content_548eb25c4515a5_74975213($_smarty_tpl) {?><!DOCTYPE html>
...
">
	...
	<title><?php echo $_smarty_tpl->tpl_vars['LNG']->value['siteTitleRules'];?>
...
<body id="rules" class="<?php echo $_smarty_tpl->tpl_vars['bodyclass']->value;?>
">
	<div id="page"><header>
	<nav>
		<ul id="menu">
			...
			<td class="box-out-content-center">
				<table class="box-inner">
					<tr class="box-inner-header">
						...
						<td class="box-inner-header-center"><h1><?php echo $_smarty_tpl->tpl_vars['LNG']->value['siteTitleRules'];?>
</h1></td>
