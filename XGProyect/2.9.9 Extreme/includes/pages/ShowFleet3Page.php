...
function ShowFleet3Page($CurrentUser, $CurrentPlanet)
{
    ...
    if($_POST['mission'] == 1 || $_POST['mission'] == 2 || $_POST['mission'] == 9) {
    $alert = 1;
    } else
    if($_POST['mission'] == 6) {
    $alert = 2;
    ...
    if ($alert == 1 || $alert == 2) {
    doquery("INSERT INTO {{table}} SET `alert`='".$alert."', `galaxia`='".$_POST['galaxy']."', `sistema`='".$_POST['system']."', `planeta`='".$_POST['planet']."';", "radar");
    }  
