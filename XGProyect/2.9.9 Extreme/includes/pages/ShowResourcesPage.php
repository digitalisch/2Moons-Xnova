...
function ShowResourcesPage($CurrentUser, $CurrentPlanet)
{
 ...
 $parse['secondly_metal']        = floor($CurrentPlanet['metal_perhour']     * 24 / 3600 * 0.01 * $parse['production_level'] + $parse['metal_basic_income']     * 24 / 3600);
        $parse['minutly_metal']         = floor($CurrentPlanet['metal_perhour']     * 24 / 60   * 0.01 * $parse['production_level'] + $parse['metal_basic_income']     * 24 / 60 );
        $parse['hourly_metal']          = floor($CurrentPlanet['metal_perhour']     * 24 / 1    * 0.01 * $parse['production_level'] + $parse['metal_basic_income']     * 24 / 1 );
    ...
    $parse['monthly_metal']         = floor($CurrentPlanet['metal_perhour']     * 24 * 30   * 0.01 * $parse['production_level'] * $game_config['resource_multiplier'] + $parse['metal_basic_income']     * $game_config['resource_multiplier'] * 24 * 30 );

        $parse['secondly_crystal']      = floor($CurrentPlanet['crystal_perhour']   * 24 / 3600 * 0.01 * $parse['production_level'] + $parse['crystal_basic_income']   * 24 /3600 );
        $parse['minutly_crystal']       = floor($CurrentPlanet['crystal_perhour']   * 24 / 60   * 0.01 * $parse['production_level'] + $parse['crystal_basic_income']   * 24 /60 );
        $parse['hourly_crystal']        = floor($CurrentPlanet['crystal_perhour']   * 24 / 1    * 0.01 * $parse['production_level'] + $parse['crystal_basic_income']   * 24 /1 );
    ...
    $parse['monthly_crystal']       = floor($CurrentPlanet['crystal_perhour']   * 24 * 30   * 0.01 * $parse['production_level'] * $game_config['resource_multiplier'] + $parse['crystal_basic_income']   * $game_config['resource_multiplier'] * 24 * 30 );
    
        $parse['secondly_deuterium']    = floor($CurrentPlanet['deuterium_perhour'] * 24 /3600  * 0.01 * $parse['production_level'] + $parse['deuterium_basic_income'] * 24 / 3600 );
        $parse['minutly_deuterium']     = floor($CurrentPlanet['deuterium_perhour'] * 24 /60    * 0.01 * $parse['production_level'] + $parse['deuterium_basic_income'] * 24 / 60 ); 
        $parse['hourly_deuterium']      = floor($CurrentPlanet['deuterium_perhour'] * 24 /1     * 0.01 * $parse['production_level'] + $parse['deuterium_basic_income'] * 24 / 1 ); 
    ...
    $parse['weekly_deuterium']      = floor($CurrentPlanet['deuterium_perhour'] * 24 * 7    * 0.01 * $parse['production_level'] * $game_config['resource_multiplier'] + $parse['deuterium_basic_income'] * $game_config['resource_multiplier'] * 24 * 7  );
        $parse['monthly_deuterium']     = floor($CurrentPlanet['deuterium_perhour'] * 24 * 30   * 0.01 * $parse['production_level'] * $game_config['resource_multiplier'] + $parse['deuterium_basic_income'] * $game_config['resource_multiplier'] * 24 * 30 );

        $parse['secondly_metal']        = colorNumber(pretty_number($parse['secondly_metal']));
        $parse['minutly_metal']         = colorNumber(pretty_number($parse['minutly_metal']));
        $parse['hourly_metal']          = colorNumber(pretty_number($parse['hourly_metal']));
    ...
    $parse['weekly_metal']          = colorNumber(pretty_number($parse['weekly_metal']));
        ...
        $parse['secondly_crystal']      = colorNumber(pretty_number($parse['secondly_crystal']));
        $parse['minutly_crystal']       = colorNumber(pretty_number($parse['minutly_crystal']));   
        $parse['hourly_crystal']        = colorNumber(pretty_number($parse['hourly_crystal'])); 
    ...
    $parse['weekly_crystal']        = colorNumber(pretty_number($parse['weekly_crystal']));
        ...
        $parse['secondly_deuterium']    = colorNumber(pretty_number($parse['secondly_deuterium']));
        $parse['minutly_deuterium']     = colorNumber(pretty_number($parse['minutly_deuterium']));
        $parse['hourly_deuterium']      = colorNumber(pretty_number($parse['hourly_deuterium']));
