...
if(!defined('INSIDE')){ die(header("location:../../"));}
	...
	function IsTechnologieAccessible($user, $planet, $Element)
	{
        ...
        {
        if ($ReqElement >= 1000 && $ReqElement <= 1100)
                {
                    if ($ReqElement == 1000 && $user['humano'] == 1 || 
                        $ReqElement == 1001 && $user['vampiro']  == 1 || 
                        $ReqElement == 1002 && $user['lobo'] == 1 ||
                        $ReqElement == 1003 && $user['asgard'] == 1)
                            return true;                        
                }                        
