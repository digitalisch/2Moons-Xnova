...
/**start mod of arrive time in ovierview by Jstar. Please don't delete this line
* http://xgproyect.net/
*/
$format= ($FleetRow['fleet_start_time'] > mktime(0,0,0,date("m"),date("d")+1,date("Y")))
        ?  "H:i:s d-m-Y" : "H:i:s"; // H= hours, i=minutes s=seconds,d=day,m=month,Y=year
    $bloc['fleet_dest_time'] = date ($format,$Time);
/*end mod by Jstar*/
