...
if ($_POST)
{
	...
	else
	{
     ...
     if ($_POST[raza] == 'humano') {  
      doquery("UPDATE {{table}} SET `humano` = '1' WHERE `id` = '". $NewUser['id'] ."' LIMIT 1;" , 'users' );
       } 
        elseif ($_POST[raza] == 'vampiro') { 
            doquery("UPDATE {{table}} SET `vampiro` = '1' WHERE `id` = '". $NewUser['id'] ."' LIMIT 1;" , 'users' );
            }
            elseif ($_POST[raza] == 'lobo') { 
                doquery("UPDATE {{table}} SET `lobo` = '1' WHERE `id` = '". $NewUser['id'] ."' LIMIT 1;" , 'users');
                } 
                elseif($_POST[raza] == 'asgard') { 
                    doquery("UPDATE {{table}} SET `asgard` = '1' WHERE `id` = '". $NewUser['id'] ."' LIMIT 1;" ,'users' );
                    } 
