...
<input type="hidden" name="s" value="sacar">

<table width="310">
<td class="b" colspan="6"><center><b>[<a href="game.php?page=banco&mode=depositar"><font color=lime>Ir a depositar recursos</font></a>]</b></center></td>
</table>
<table width="310">
<td class="b" colspan="6"><center><b>Retirar Recursos</b></center></td>
</table>
<br>
<table width="310">
<tbody>
...
<th>Cristal:</th><th><input name="cristal" type="text" value="0" /></tr><tr></th>
<th>Deuterio:</th><th><input name="deute" type="text" value="0" /></tr><tr></th>
</tr>
<tr>
<td class="b" colspan="6"><center><input type="Submit" value="Retirar" /></center></td>
</tbody>
</tr>
</table>
</form>
