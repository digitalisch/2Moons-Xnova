...
<tr><th class="error2"><center><span class="estado2">Estado de la loteria</span></center></th></tr>
...
<tr><td class="c" colspan="3"><center>Loteria intergalactica</center></td></tr>
<tr>
<td width="20%" align="center"></td>
<td width="40%" align="center" class="pp">Precio (P/Ticket)</td>
<td width="40%" align="center" class="pp">Premio</td>
</tr>
...
<tr><th>Materia Oscura</th><th class="precio">{materia_c}</th><th class="premio">{materia_p}</th></tr>
</table>
<table border="0" cellpadding="5" cellspacing="0" width="700">
<th><font color="#F7BE81">El premio sera entregado siempre en tu planeta principal.</font></th>
</table>

<br />
<table border="0" cellpadding="5" cellspacing="0" width="700">
<tr><td class="c" colspan="3"><center>Informacion</center></td></tr>
<tr>
<td width="20%" align="center" class="info">Boletos totales</td>
<td width="40%" align="center" class="info">Max. boletos p/persona</td>
...
<tr><td class="c"><center>Comprar Tickets</center></td></tr>
<tr>
   <th>
...
<tr><td class="c"><center>Usuarios participando en la loteria</center></td></tr>
{participantes}
</table>
