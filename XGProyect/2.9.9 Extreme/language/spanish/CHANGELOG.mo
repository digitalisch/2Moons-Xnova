...
-[Mods]
- Mod Avatar ( Adaptado por thedy) added to Left Menu ( Adaptado por NkrSystem) 
- Mod Razas (By Skinet) (Without admin panel)
- Mod Rules (By Nkrsystem) 
- Mod Fleet Event (By Lordmagnus)
- Mod Messages in Topnave (By pbr1111)
- Mod Puntos y top en Visión General (By 5amu)
- Mod Buildings 3 Columns (By Samurai.Rukasu)
- Mod Rangos (By jonamix) 
- Mod Technology 3 Columns (BY Kalax(programacion) - JonaMiX(adaptacion)
- Mod Selector de Skins (By PoliticKiller)
- Mod Informação de recursos alargada (Donald aka morgado)
- Mod Mostrar escombros en visión general (By 5amu e neko)
- Mod Campos ocupados (By djtenssy) 
- Mod Producciones en Proceso en Vista General. (By Luismx) 
- Mod New Techtree (By Dr. Kush) and (By mikey302) ---join the 2mods in one...
- Mod Hora de llegada en overview (By jstar)
- Mod Arrive and return time in fleetpage (By jstar)
- Mod NewBot - Bot de juego integrado (By Shoghicp)
- Mod Panel para controlar los bots (By Gonzalo)
- Mod Administrators Online (By Nkrsystem)
- Mod Sensor de espionaje (By djtenssy) 
- Mod Elegir forma de gobierno (By Rubidium68)
- Mod Mensaje y Noticias del los Admin (By Jonamix)
- Mod New Version of Simulador de Batallas  (By youhou35)
- Mod Cambio de idioma desde opciones de usuario. (By Luismx)  
- Mod Agregar energia al lado de los edificios (By Neko)
- Mod Nueva vista de cola de producción de edificios. para v2.9.1 (By Luismx)
- Mod Firma con caracteristicas de cuenta (By Th3R1p) 
- Mod Hall of Fame [Eumele (Old XNova Germany Forum)]  (By Dr.Kush)  
- Mod MOD Support (By Sk3y (compatible con 2.6 jtsamper y adaptado para 2.9.1 por samurai.rukasu)
- Mod Aviso de nuevos tickets de soporte (By Shoek)  
- Mod Credits (By Nkrsystem)
- Mod Login Login Xnova Revolutions [Adapte Form] (By Diseñador: Brayan Narvaez Adaptador: JonaMiX)
- Mod Oficiais completo (By Nkrsystem)
- Mod Chat Repack Autor: Shogcip para el repack Adaptación: (By Think) 
- Mod (Máx) en Hangar y Defensa (posted By Darkai)
- Mod Mensajes enviados (By Think) 
- Mod Hyperspace Portal link in menu (By Jstar)  
- Mod Records (5aMu (código retocado del original)
- Mod Banco (Version de Neko) (By Neko)
- Mod Mercader: Recursos por MO (By Think)  
- Mod Nueva caracteristica debug v.0.0.2 (By jtsamper)
- Mod Loteria (Version de Neko)  (By Neko)
- Mod Comercial (Nain Pitoyable (XNova FR) (By pbr1111) 
- Mod Porcentajes de almacenes con barra en topnav (By djtenssy)
- Mod Tutorial (By jonamix)
- Mod Inactivos (By 5amu)
- Mod Vision general rediseñada (By jonamix)
- Mod Menú de opciones dividido por categorías.(By 5amu)


 
-------- A.D.M --------
- Modified Menu and Topnav in administration. (by Nkrsystem)


- [Fixs]
- Messages will be deleted in 7days automaticaly.(By 5amu)
- Corrigido bug nos Relatorios de combate. (By Luigii)
- [+Fix] ShowInfosPage mejorado (By Think)
- [Fix] Codigos br en los mensajes  (By Alucard_666)
- [Fix] Spy and recycle bug in tooltip for galaxy (By GameProg)
- [Fix] Hyperspace Portal redirect  (By Quaua)
- [Fix] Un SAC diferentes destinos (By TomTom) solved (By Jstar)
- [Fix] Sql error in editing moon in ACP (By Jstar)
- [Fix] [2.X] Ataque a la administración (By Think)
- [Fix] Más errores... en los misiles! (By Think)
- [Fix] [<2.9.X] mantener la posición de amigos (jstar)
',
