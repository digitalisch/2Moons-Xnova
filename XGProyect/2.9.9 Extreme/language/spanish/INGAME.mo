...
// GAME.PHP
$lang['see_you_soon']						= '¡Hasta la próxima!';
$lang['page_doesnt_exist']					= 'La página solicitada no existe';
...
$lang['lm_fleet']							= 'Flota';
$lang['lm_buildings']						= 'Edificios';
$lang['lm_research']						= 'Investigación';
$lang['lm_shipshard']						= 'Hangar';
...
$lang['lm_buddylist']						= 'Lista de compañeros';
$lang['lm_notes']							= 'Notas';
$lang['lm_statistics']						= 'Estadísticas';
$lang['lm_search']							= 'Buscar';
$lang['lm_options']							= 'Opciones';
$lang['lm_banned']							= 'Baneados';
$lang['lm_contact']							= 'Contacto';
$lang['lm_forums']							= 'Foro';
$lang['lm_logout']							= 'Salir';
$lang['lm_administration']					= 'Administración';
$lang['lm_game_speed']						= 'Juego';
$lang['lm_fleet_speed']						= 'Flotas';
$lang['lm_resources_speed']					= 'Recursos';
$lang['lm_queues']							= 'Colas';

//----------------------------------------------------------------------------//
//OVERVIEW
$lang['ov_newname_error']					= 'Has introducido algún caracter ilegal. Sólo puedes introducir caracteres alfanuméricos.';
$lang['ov_planet_abandoned']				= 'Planeta abandonado con éxito.';
$lang['ov_principal_planet_cant_abanone']	= 'El planeta principal no puede ser abandonado.';
$lang['ov_wrong_pass']						= 'Contraseña incorrecta, vuelve a ingresarla.';
$lang['ov_have_new_message']				= 'Tienes 1 mensaje nuevo';
$lang['ov_have_new_messages']				= 'Tienes %m mensajes nuevos';
$lang['ov_free']							= 'Libre';
$lang['ov_news']							= 'Noticias';
$lang['ov_place']							= 'Lugar';
$lang['ov_of']								= 'de';
$lang['ov_planet']							= 'Planeta';
$lang['ov_server_time']						= 'Hora del servidor';
...
$lang['ov_security_request']				= 'Petición de seguridad';
$lang['ov_security_confirm']				= 'Confirmar borrado de planeta';
$lang['ov_with_pass']						= 'con contraseña';
$lang['ov_password']						= 'Contraseña';
$lang['ov_delete_planet']					= '¡Borrar planeta!';
$lang['ov_your_planet']						= 'Tu planeta';
$lang['ov_coords']							= 'Coordenadas';
$lang['ov_abandon_planet']					= 'Abandonar colonia';
$lang['ov_planet_name']						= 'Nombre';
...
$lang['fl_arrival_time']                    = 'Hora de llegada';
$lang['fl_return_time']                        = 'Hora de regreso'; 
$lang['fl_returning']						= 'Regresando';
$lang['fl_onway']							= 'En camino';
$lang['fl_r']								= '(R)';
$lang['fl_a']								= '(A)';
$lang['fl_send_back']						= 'Volver';
$lang['fl_acs']								= 'SAC';
$lang['fl_no_more_slots']					= 'Todos los slots de flotas estan siendo utilizados';
$lang['fl_speed_title']						= 'Velocidad: ';
$lang['fl_continue']						= 'Continuar';
$lang['fl_no_ships']						= 'No hay naves';
$lang['fl_remove_all_ships']				= 'Ninguna nave';
$lang['fl_select_all_ships']				= 'Todas las naves';
$lang['fl_fleets']							= 'Flotas';
$lang['fl_expeditions']						= 'expediciones';
$lang['fl_number']							= 'Num';
$lang['fl_mission']							= 'Misión';
$lang['fl_ammount']							= 'Cantidad';
$lang['fl_beginning']						= 'Comienzo';
$lang['fl_departure']						= 'Salida';
$lang['fl_destiny']							= 'Destino';
$lang['fl_objective']						= 'Objetivo';
$lang['fl_arrival']							= 'Llegada';
$lang['fl_order']							= 'Orden';
$lang['fl_new_mission_title']				= 'Nueva mision: escoge las naves';
$lang['fl_ship_type']						= 'Tipo de nave';
$lang['fl_ship_available']					= 'Disponibles';
$lang['fl_planet']							= 'Planeta';
$lang['fl_debris']							= 'Escombros';
$lang['fl_moon']							= 'Luna';
$lang['fl_planet_shortcut']					= '(P)';
$lang['fl_debris_shortcut']					= '(E)';
$lang['fl_moon_shortcut']					= '(L)';
$lang['fl_no_shortcuts']					= 'No hay accesos directos';
$lang['fl_anonymous']						= 'Anónimo';
$lang['fl_shortcut_add_title']				= 'Nombre [Galaxia/Sistema/Planeta]';
$lang['fl_shortcut_name']					= 'Nombre';
$lang['fl_shortcut_galaxy']					= 'Galaxia';
$lang['fl_shortcut_solar_system']			= 'Sistema solar';
$lang['fl_clean']							= 'Borrar';
$lang['fl_register_shorcut']				= 'Registrar';
$lang['fl_shortcuts']						= 'Accesos directos';
$lang['fl_reset_shortcut']					= 'Reestablecer';
$lang['fl_dlte_shortcut']					= 'Suprimir';
$lang['fl_back']							= 'Volver';
$lang['fl_shortcut_add']					= 'Agregar';
$lang['fl_shortcut_edition']				= 'Edición: ';
$lang['fl_no_colony']						= 'No hay colonias';
$lang['fl_send_fleet']						= 'Enviar flota';
$lang['fl_fleet_speed']						= 'Velocidad';
$lang['fl_distance']						= 'Distancia';
$lang['fl_flying_time']						= 'Tiempo de vuelo';
$lang['fl_fuel_consumption']				= 'Consumo de combustible';
$lang['fl_max_speed']						= 'Velocidad max.';
$lang['fl_cargo_capacity']					= 'Capacidad de carga';
$lang['fl_shortcut']						= 'Atajos';
$lang['fl_shortcut_add_edit']				= '(Agregar / Editar)';
$lang['fl_my_planets']						= 'Mis planetas';
$lang['fl_acs_title']						= 'Ataques grupales';
$lang['fl_hold_time']						= 'Tiempo de estacionamiento';
$lang['fl_resources']						= 'Recursos';
$lang['fl_max']								= 'max';
$lang['fl_resources_left']					= 'Restante';
$lang['fl_all_resources']					= 'Todos los recursos';
$lang['fl_expedition_alert_message']		= 'Atención ! Las expediciones son misiones arriesgadas, puedes perder tus naves !';
$lang['fl_vacation_mode_active']			= 'El modo vacaciones se encuentra activo';
$lang['fl_expedition_tech_required']		= '¡Investiga la Tecnologia de Expedicion!';
$lang['fl_expedition_fleets_limit']			= '¡Limite de flotas de Expedicion!';
$lang['fl_week_player']						= '¡El jugador es muy débil!';
$lang['fl_strong_player']					= '¡El jugador es muy fuerte!';
$lang['fl_in_vacation_player']				= '¡El jugador esta en modo vacaciones!';
$lang['fl_no_slots']						= 'No hay más slots disponibles';
$lang['fl_empty_transport']					= 'No puedes transportar 0 recursos';
$lang['fl_planet_populed']					= '¡Este planeta esta ocupado!';
$lang['fl_stay_not_on_enemy']				= '¡No puedes estacionar flotas en el enemigo!';
$lang['fl_not_ally_deposit']				= '¡No hay deposito de la alianza!';
$lang['fl_deploy_only_your_planets']		= '¡Sólo puedes desplegar flotas en tus planetas!';
$lang['fl_no_enought_deuterium']			= 'No tienes deuterio suficiente. Consumo de Deuterio: ';
$lang['fl_no_enought_cargo_capacity']		= 'No tienes suficiente espacio de carga! Disponible:';
$lang['fl_admins_cannot_be_attacked']		= 'Los administradores y moderadores del juego no pueden recibir ataques.';
$lang['fl_fleet_sended']					= 'Flota enviada';
$lang['fl_from']							= 'De';
$lang['fl_arrival_time']					= 'Hora de llegada';
$lang['fl_return_time']						= 'Hora de regreso';
$lang['fl_fleet']							= 'Flota';
$lang['fl_player']							= 'El jugador ';
$lang['fl_add_to_attack']					= ' fue agregado al ataque.';
$lang['fl_dont_exist']						= ' no fue agregado al ataque.';
$lang['fl_acs_invitation_message']			= ' te invita a participar en un SAC.';
$lang['fl_acs_invitation_title']			= 'Invitación a SAC';
$lang['fl_sac_of_fleet']					= 'SAC de flota';
...
$lang['bd_build']							= 'Construir';
$lang['bd_build_next_level']				= 'Ampliar al nivel ';
$lang['bd_add_to_list']						= 'Agregar a la lista';
...
//----------------------------------------------------------------------------//
//RESOURCES
$lang['rs_amount']                       = 'Quantidade';
$lang['rs_lvl']                          = 'Nível';
$lang['rs_production_on_planet']         = 'Recursos produzidos no planeta "%s"';
$lang['rs_basic_income']                 = 'Produção básica';
$lang['rs_storage_capacity']             = 'Capacidade de armazenamento';
$lang['rs_calculate']                    = 'calculo';
$lang['Secondly']                        = 'Produção P/segundo';
$lang['Minutly']                         = 'Produção P/minuto';
$lang['Hourly']                          = 'Produção P/hora';
$lang['rs_daily']                        = 'Produção diária';
$lang['rs_weekly']                       = 'Produção semanal';
$lang['rs_monthly']                      = 'Produção mensal';
$lang['rs_widespread_production']        = 'Produção ampliada';
$lang['rs_storage_state']                = 'Estado dos depósitos';
$lang['rs_production_level']             = 'Nivel de Produção'; 
//----------------------------------------------------------------------------//
//OFFICIERS
$lang['of_recruit']							= 'Reclutar';
$lang['of_max_lvl']							= 'Nivel máximo';
$lang['of_available_points']				= 'Puntos disponibles:';
$lang['of_points_per_thousand_darkmatter']	= '(1 punto por cada 1000 de materia oscura)';
$lang['of_lvl']								= 'Nivel';
...
601 => 'El geólogo es un experto en astrominerolog&iacute;a y astrocristalograf&iacute;a. Asiste a sus equipos en la metalurgia y qu&iacute;mica y tambi&eacute;n se encarga de las comunicaciones interplanetarias para optimizar el uso y refinamiento de la materia bruta a lo largo de todo el imperio.<br><br><strong><font color="lime">+5% de producción. Nivel Máx. 20</font></strong>',
602 => 'El almirante es un veterano de guerra experimentado y un habilidoso estratega. En las batallas mas duras, es capaz de hacerse una idea de la situación y contactar a sus almirantes subordinados. Un emperador sabio puede apoyarse en su ayuda durante los combates.<br><br><strong><font color="lime">+5% escudo en naves. Nivel Máx. 20</font></strong>',
603 => 'El Ingeniero es un especialista en la gestión de energía. En tiempos de paz, aumenta la energía de todas las colonias. En caso de ataque, garantiza el abastecimiento de energía a los cañones, evitando una posible sobrecarga, lo que conduce a una reducción de defensas perdidas en batalla.<br><br><strong><font color="lime">+5% de energia. Nivel Máx. 10</font></strong>',
604 => 'El gremio de los tecnócratas está compuesto de auténticos genios, y siempre los encontrarás en ese peligroso borde donde todo explotaría en mil pedazos antes de poder encontrar una explicación tecnológica y racional. Ningún ser humano normal trataría jamás descifrar el código de un tecnócrata, con su presencia, inspira a los investigadores del imperio.<br><br><strong><font color="lime">+5% velocidad de construcción de naves. Nivel Máx. 10</font></strong>',
605 => 'El Constructor tiene alterado su ADN, uno solo de estos hombres puede construir una ciudad entera en poco tiempo.<br><br><strong><font color="lime">+10% de rapidez en la construcción de edificios. Nivel Máx. 3</font></strong>',
606 => 'Los científicos forman parte de un gremio concurrente al de los tecnócratas. Ellos se especializan en la mejora de las tecnologías.<br><br><strong><font color="lime">+10% de rapidez en la investigacion. Nivel Máx. 3</font></strong>',
607 => 'El almacenista es parte de la antigua hermandad del planeta Hsac. Su lema es ganar el máximo, es por ello que necesita espacios de almacenamiento enormes. Por ese motivo ha desarrollado una nueva técnica de almacenamiento.<br><br><strong><font color="lime">+50% de almacenamiento. Nivel Máx.2</font></strong>',
608 => 'El defensor es un miembro del ejército imperial. Abocarse en su trabajo le permite construir una formidable defensa en un breve periodo de tiempo.<br><br><strong><font color="lime">+25% de rapidez en la construccion de defensas. Nivel Máx. 2</font></strong>',
609 => 'El protector forma parte del ejercito imperial y su objetivo es desarrollar tecnologías que mejoren las defensas planetarias.<br><br><strong><font color="lime">Desbloquea la protección planetaria. Nivel Máx. 1</font></strong>',
610 => 'El espía es una persona enigmática. Nadie nunca vio su verdadero rostro, la única forma sería asesinandoló.<br><br><strong><font color="lime">+5 niveles de espionaje. Nivel Máx. 2</font></strong>',
611 => 'El comandante forma parte del ejército imperial ha dominado el arte del manejo de flotas. Su cerebro puede calcular las trayectorias de una gran cantidad de flotas.<br><br><strong><font color="lime">+3 slots para flotas. Nivel Máx. 3</font></strong>',
612 => 'El destructor es un miembro del ejército imperial sin misericordia. Masacra todo lo que está a su paso sólo por placer. Actualmente está desarrollando un nuevo método de producción de las estrellas de la muerte.<br><br><strong><font color="lime">2 estrellas al hacer 1. Nivel Máx. 1</font></strong>',
613 => 'El general es una persona que ha servido desde hace muchos años al ejército imperial. Los fabricantes de naves producen más rápido en su presencia.<br><br><strong><font color="lime">+10% de rapidez en los hangares. Nivel Máx. 3</font></strong>',
614 => 'El Conquistador es un miembro más del ejercito, este tiene la habilidad de navegar un tipo de nave que nadie más podría ni hacer despegar.<br><br><strong><font color="lime">Desbloquea la SuperNova. Nivel Máx. 1</font></strong>',
615 => 'El emperador pone bajo su mando a todos los oficiales disponibles en el imperio, combinar sus habilidades para dominar el universo y lograr ser un oponente casi invensile.<br><br><strong><font color="lime">Desbloquea la destrucción planetaria. Nivel Máx. 1</font></strong>',
);
...
$lang['in_level']       					= 'Nivel';
$lang['in_prod_p_hour'] 					= 'Producion/hora';
...
$lang['info'][601]['description'] 			= "El geólogo es un experto en astrominerolog&iacute;a y astrocristalograf&iacute;a. Asiste a sus equipos en la metalurgia y qu&iacute;mica y tambi&eacute;n se encarga de las comunicaciones interplanetarias para optimizar el uso y refinamiento de la materia bruta a lo largo de todo el imperio.";
$lang['info'][602]['name']        			= "Almirante";
$lang['info'][602]['description'] 			= "El almirante es un veterano de guerra experimentado y un habilidoso estratega. En las batallas mas duras, es capaz de hacerse una idea de la situación y contactar a sus almirantes subordinados. Un emperador sabio puede apoyarse en su ayuda durante los combates.";
$lang['info'][603]['name']        			= "Ingeniero";
$lang['info'][603]['description'] 			= "El Ingeniero es un especialista en la gestión de energía. En tiempos de paz, aumenta la energía de todas las colonias. En caso de ataque, garantiza el abastecimiento de energía a los cañones, evitando una posible sobrecarga, lo que conduce a una reducción de defensas perdidas en batalla.";
$lang['info'][604]['name']        			= "Tecnócrata";
$lang['info'][604]['description'] 			= "El gremio de los tecnócratas está compuesto de auténticos genios, y siempre los encontrarás en ese peligroso borde donde todo explotaría en mil pedazos antes de poder encontrar una explicación tecnológica y racional. Ningún ser humano normal trataría jamás descifrar el código de un tecnócrata, con su presencia, inspira a los investigadores del imperio.";
$lang['info'][605]['name']        			= "Constructor";
$lang['info'][605]['description'] 			= "El Constructor tiene alterado su ADN, uno solo de estos hombres puede construir una ciudad entera en poco tiempo.";
$lang['info'][606]['name']        			= "Científico";
$lang['info'][606]['description'] 			= "Los científicos forman parte de un gremio concurrente al de los tecnócratas. Ellos se especializan en la mejora de las tecnologías.";
$lang['info'][607]['name']        			= "Almacenista";
$lang['info'][607]['description'] 			= "El almacenista es parte de la antigua hermandad del planeta Hsac. Su lema es ganar el máximo, es por ello que necesita espacios de almacenamiento enormes. Por ese motivo ha desarrollado una nueva técnica de almacenamiento.";
$lang['info'][608]['name']        			= "Defensor";
$lang['info'][608]['description'] 			= "El defensor es un miembro del ejército imperial. Abocarse en su trabajo le permite construir una formidable defensa en un breve periodo de tiempo.";
$lang['info'][609]['name']        			= "Protector";
$lang['info'][609]['description'] 			= "El protector forma parte del ejercito imperial y su objetivo es desarrollar tecnologías que mejoren las defensas planetarias.";
$lang['info'][610]['name']        			= "Espía";
$lang['info'][610]['description'] 			= "El espía es una persona enigmática. Nadie nunca vio su verdadero rostro, la única forma sería asesinandoló.";
$lang['info'][611]['name']        			= "Comandante";
$lang['info'][611]['description'] 			= "El comandante forma parte del ejército imperial ha dominado el arte del manejo de flotas. Su cerebro puede calcular las trayectorias de una gran cantidad de flotas.";
$lang['info'][612]['name']        			= "Destructor";
$lang['info'][612]['description'] 			= "El destructor es un miembro del ejército imperial sin misericordia. Masacra todo lo que está a su paso sólo por placer. Actualmente está desarrollando un nuevo método de producción de las estrellas de la muerte.";
$lang['info'][613]['name']        			= "General";
$lang['info'][613]['description'] 			= "El general es una persona que ha servido desde hace muchos años al ejército imperial. Los fabricantes de naves producen más rápido en su presencia.";
$lang['info'][614]['name']        			= "Conquistador";
$lang['info'][614]['description'] 			= "El Conquistador es un miembro más del ejercito, este tiene la habilidad de navegar un tipo de nave que nadie más podría ni hacer despegar.";
$lang['info'][615]['name']        			= "Emperador";
$lang['info'][615]['description'] 			= "El emperador pone bajo su mando a todos los oficiales disponibles en el imperio, combinar sus habilidades para dominar el universo y lograr ser un oponente casi invensile.";

//----------------------------------------------------------------------------//
//MESSAGES
$lang['mg_type'][0]    						= 'Informes de espionaje';
$lang['mg_type'][1]    						= 'Mensajes de jugadores';
$lang['mg_type'][2]    						= 'Mensajes de la alianza';
$lang['mg_type'][3]    						= 'Informes de batalla';
$lang['mg_type'][4]    						= 'Informes de recolección';
$lang['mg_type'][5]    						= 'Informes de tranporte';
...
$lang['mg_type'][101]                       = "Mensajes enviados"; 
...
$lang['al_tag_required']					= 'Falta la etiqueta de la alianza.';
$lang['al_name_required']					= 'Falta el nombre de la alianza.';
$lang['al_already_exists']					= 'La alianza %s ya existe.';
$lang['al_created']							= 'La alianza %s ha sido creada';
...
$lang['al_change_title']					= 'Cambiar';
$lang['al_the_alliance']					= 'de la alianza';
...
$lang['al_make_ally_tag_required']			= 'Etiqueta de la alianza (De 3-8 caracteres)';
$lang['al_make_ally_name_required']			= 'Nombre de la alianza (Máx. 35 caracteres)';
...
$lang['bu_cannot_request_yourself']			= '¡No puedes solicitarte como compañero a ti mismo!';
$lang['bu_request_message']					= 'Mensaje de solicitud';
$lang['bu_player']							= 'Jugador';
...
$lang['bu_connected']						= 'Conectado';
$lang['bu_fifteen_minutes']					= '15 minutos';
$lang['bu_disconnected']					= 'Desconectado';
$lang['bu_delete']							= 'Eliminar';
$lang['bu_buddy_list']						= 'Lista de compañeros';
$lang['bu_requests']						= 'Solicitudes';
...
//----------------------------------------------------------------------------//
//MENÚ DE OPCIONES by 5aMu

//GENERAL
$lang['cc_datos'] = 'Datos de usuario';
$lang['cc_general'] = 'Ajustes generales';
$lang['cc_galaxy'] = 'Opciones de galaxia';
$lang['cc_estado'] = 'Estado de la cuenta';
$lang['cc_guardar'] = 'Guardar cambios';
$lang['op_options_changed']               = 'La nueva configuración se guardó correctamennte. <i>Redirigiendo...</i>';
$lang['op_seconds']                    = 'segundos';
$lang['cc_center'] = 'Centro de Mando';
$lang['cc_good'] = 'Las opciones cambiadas se guardaron correctamente.';
$lang['cc_accept'] = 'Aceptar';
$lang['cc_return'] = 'Volver';


//MODO VACACIONES
$lang['op_cant_activate_vacation_mode']      = 'Si estás construyendo o moviendo flotas no podrás entrar al modo vaciones.<br><br>Si sigues sin poder activar el modo vacaciones a pesar de no tener nada en proceso, debes entrar planeta por planeta para que el sistema compruebe que no hay ningún tipo de construcción en proceso. <i>Redirigiendo en diez segundos...</i>';
$lang['op_vacation_mode_active_message']  = 'El modo vacaciones está activado. Tienes que estar de vacaciones como mínimo hasta el: ';
$lang['op_end_vacation_mode']          = 'Finalizar modo vacaciones';


//PÁGINA: DATOS DE USUARIO
$lang['op_username']                = 'Nombre de usuario';
$lang['op_old_pass']                = 'Contraseña anterior';
$lang['op_new_pass']                = 'Nueva contraseña (mín. 8 caracteres)';
$lang['op_repeat_new_pass']               = 'Nueva contraseña (repetir)';
$lang['op_email_adress']               = 'Nueva dirección de correo electrónico';
$lang['op_permanent_email_adress']        = 'Dirección pemanente de correo electrónico';
$lang['op_password_changed']           = 'La contraseña ha sido cambiada.<br /><a href="index.php" target="_top">Volver</a>';
$lang['op_username_changed']           = 'La nueva configuración se guardó correctamennte. <i>Redirigiendo en tres segundos...</i>';
$lang['dt_user']               = 'Este nombre es mostrado a los demás. No debe contener caracteres especiales ni debe ser menor de 3 caracteres ni mayor de 16 caracteres de largo.';
$lang['dt_pass']               = 'Para cambiar la contraseña, primero debes escribir la anterior aquí.';
$lang['dt_new_pass']               = 'Escribe una contraseña que sea segura. Mientras más letras y números tenga, mejor.';
$lang['dt_new_pass_repit']               = 'Escribe una vez más la contraseña para asegurarte de que la has escrito correctamente.';
$lang['dt_mail']               = 'Esta dirección es la que usaste en tu registro. El correo que nos proporcionas lo usaremos sólo para enviar noticias del juego.';
$lang['dt_new_mail']               = 'Cambiar tu dirección de correo electrónico si así lo deseas.';
...
$lang['op_vacation']       = 'Modo de vacaciones';
$lang['op_activate_vacation_mode']        = 'Activar modo vacaciones';
$lang['op_dlte_account']               = 'Borrar cuenta';
$lang['ag_skin']               = 'Puedes cambiar la apariencia del juego cambiando esta dirección. Para encontrar skins, puedes buscarlos mediante cualquier buscador web, aunque debes tener en cuenta que no todos se adaptarán al cien por cien.';
$lang['ag_ip_check']               = 'La comprobación de IP significa que se realizará un logout de seguridad automáticamente cuando cambie la IP o cuando 2 personas entren en la misma cuenta usando diferentes IP´s.';
$lang['ag_planets']               = 'Esta opción te permite ordenar el orden de aparición de los planetas.';
$lang['ag_ordenacion']               = 'Elige el tipo de ordenación que prefieras para tus planetas: Creciente o Decreciente';
$lang['ag_vacation']               = 'El modo vacaciones protege los planetas cuando el usuario se ausenta por un tiempo. Solamente es posible activarlo cuando no se está construyendo nada (edificios, naves, defensas y/o investigaciones), y que no haya ninguna flota realizando una misión.<br>
Al activar el modo de vacaciones, los planetas sólo serán protegidos de recibir nuevos ataques, pero los que hayan empezado antes de activar el modo de vacaciones serán realizados igualmente. La producción de recursos será nula durante el modo vacaciones y hay que cambiarla manualmente a 100% al desactivar el modo vacaciones. El modo vacaciones tiene una duración mínima de 2 días; sólo después del tiempo mínimo es posible desactivarlo.';
$lang['ag_delete']               = 'Si borras tu cuenta jamás podrás volver a usarla, mientras que si te han atacado o has perdido las ganas de jugar, siempre puedes dejarla en modo vacaciones y volver al cabo de un tiempo.<br>
Si aún así estás seguro de eliminar tu cuenta, marca la opción y guarda los cambios; tu cuenta será borrada en un plazo de siete días.';


//PÁGINA: OPCIONES DE GALAXIA
$lang['op_spy_probes_number']          = 'Cantidad de sondas de espionaje';
$lang['op_spy_retorn']          = 'Retorno de las sondas de espionaje';
...
$lang['op_send_report']                = 'Enviar reporte';

$lang['og_sondas']               = 'Cantidad de sondas de espionaje que serán enviadas en cada espionaje desde el menú de galaxia.';
$lang['og_return']               = 'Marca esta casilla a 0 si no quieres recibir ningún mensaje de retorno de las sondas de espionaje.'; 
...
$lang['sys_moonbuilt'] 						= "Las enormes cantidad de metal y cristal se fucionan y forman un satélite lunar en la orbita del planeta %s [%d:%d:%d] !";
...
$lang['fleet_attack_2']						= "sobre el defensor. Los escudos del defensor absorven";
$lang['fleet_defs_1'] 						= "La flota defensora dispara con una fuerza total de";
$lang['fleet_defs_2']						= "sobre el atacante. Los escudos del atacante absorven";
...
$lang['css_account_banned_expire']			= 'Expiración:';
...
//----------------------------------------------------------------------------//
// FleetAjax.php
$lang['fa_not_enough_probes']				= 'Error, no hay sondas suficientes';
$lang['fa_galaxy_not_exist']				= 'Error, la galaxia no existe';
$lang['fa_system_not_exist']				= 'Error, el sistema no existe';
$lang['fa_planet_not_exist']				= 'Error, el planeta no existe';
$lang['fa_not_enough_fuel']					= 'Error, no tienes combustible suficiente';
$lang['fa_no_more_slots']					= 'Error, no tienes mas slots de flotas disponibles';
$lang['fa_no_recyclers']					= 'Error, no hay recicladores disponibles';
$lang['fa_mission_not_available']			= 'Error, la misión no esta disponible';
$lang['fa_no_ships']						= 'Error, no hay naves disponibles';
$lang['fa_vacation_mode']					= 'Error, el jugador se encuentra en modo vacaciones';
$lang['fa_week_player']						= 'Error, el jugador es demasiado débil';
...
//---Formas de gobierno---//
// Mensajes
$lang['erfolgreichestaatsformwahl'] = '¡Acabas de elgir una nueva forma de gobierno!.<br /><a href="game.php?page=gouv">Volver</a>';
$lang['badstaatsformwahl'] = 'No puedes cambiar de forma de gobierno puesto que ya elegiste uno y no es modificable.';

// Página del template
$lang['staatsformwahl'] = "Selecciona tu forma de gobierno:";
$lang['barbarisch'] = "Ninguno";
$lang['demokratie'] = "Democracia";
$lang['monarchie'] = "Monarquía";
$lang['diktatur'] = "Dictadura";
$lang['imperialisme'] = "Imperialismo";
$lang['aristocratie'] = "Aristocracia";
$lang['save_settings'] = 'Seleccionar forma de gobierno';  

//----------------------------------------------------------------------------//
// Mostrar tiempo faltante de construcción en vista general (edificios y tecnologias)
$lang['pr_edificios']                         = 'EDIFICIOS';
$lang['pr_investigacion']                     = 'INVESTIGACIÓN';
$lang['pr_hangar']                            = 'HANGAR';
$lang['pr_subiendo']                          = 'Subiendo al';
$lang['pr_investigando']                      = 'Investigando al';
$lang['pr_duracion']                          = 'Duración';
$lang['pr_tiempo_prod']                       = 'Tiempo de producción';  

//----------------------------------------------------------------------------//
// Topkb.php
$lang['tkb_top']                    = "Hall of Fame";
$lang['tkb_destunits']              = "Unidades destruidas"; 
$lang['tkb_Platz']                  = "Place";
$lang['tkb_Beteiligte']             = "Involved";
$lang['tkb_Datum']                  = "Date";
$lang['tkb_Legende']                = "Legend";
$lang['tkb_Gewinner']               = "Winner";
$lang['tkb_Verlierer']              = "Loser";
$lang['tkb_unentschieden']          = "Both White, undecided";
$lang['tkb_Missing']                = "Missing in Action: Useraccount deleted";
...
//SISTEMA DE INCIDENCIA SOPORTE BY shoek
$lang['sp_answer_message_title']          = 'Respuesta en Ticket #%d';
$lang['sp_answer_message']                = 'Ha recibido una respuesta en su ticket con ID #%d.';

//Records Mod
$lang['rec_title']  = 'Mejores Jugadores';
$lang['rec_build']  = 'Edificaciones';
$lang['rec_specb']  = 'Edificaciones Lunares';
$lang['rec_playe']  = 'Jugadores';
$lang['rec_defes']  = 'Naves espaciales';
$lang['rec_fleet']  = 'Naves espaciales';
$lang['rec_techn']  = 'Investigaciones';
$lang['rec_level']  = 'Nivel';
$lang['rec_nbre']   = 'Número';
$lang['rec_rien']   = '-';

//Mo Trader
$lang['mo_buy'] = "Buy darkmatter";
$lang['mo_noenoughres'] = "The amount of darkmatter given is lower than 1!";
$lang['mo_success_exchange'] = "<b><font color=lime>Exchange successfully completed!</font></b>";
