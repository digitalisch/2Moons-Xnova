...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
 case'rules':
  include_once($xgp_root . 'includes/pages/ShowRulesPage.' . $phpEx);
  ShowRulesPage();
 break;  
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'overview':
...
// -------------------------------------------------- Menú de opciones by 5aMu ------------------------------------------------------------------//
   case'options':
      include_once($xgp_root . 'includes/options/class.ShowOptionsPage.' . $phpEx);
      new ShowOptionsPage($user);
   break;
//--//
    case'general':
        include_once($xgp_root . 'includes/options/class.ShowOptionsPageTwo.' . $phpEx);
        new ShowOptionsPage($user);
    break;
//--//
    case'galaxia':
        include_once($xgp_root . 'includes/options/class.ShowOptionsPageGalaxy.' . $phpEx);
        new ShowOptionsPage($user);
    break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'banned':
...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
    case'gouv':
        include_once($xgp_root . 'includes/pages/ShowGouv.' . $phpEx);
        ShowGouv($user);
    break; 
// ----------------------------------------------------------------------------------------------------------------------------------------------//
...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
case'simulateur':
        include_once($xgp_root . 'includes/pages/ShowSimulatorPage.' . $phpEx);
    break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
    case'topkb':
...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
  	...
  	case'support':
		include_once($xgp_root . 'includes/pages/ShowSupportPage.' . $phpEx);
		ShowSupportPage($user);
	break;  
// ----------------------------------------------------------------------------------------------------------------------------------------------//
 case'credits':
  include_once($xgp_root . 'includes/pages/ShowCreditsPage.' . $phpEx);
  ShowCreditsPage();
 break;  
// ----------------------------------------------------------------------------------------------------------------------------------------------//
    case'records':
...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
    case'banco':
        include_once($xgp_root . 'includes/pages/Banco.' . $phpEx);
        Banco($user, $planetrow);
    break;
// ----------------------------------------------------------------------------------------------------------------------------------------------// 
case'motrader':
        include_once($xgp_root . 'includes/pages/ShowMOTraderPage.' . $phpEx);
        ShowMOTraderPage($user,$planetrow);
    break;  
// ----------------------------------------------------------------------------------------------------------------------------------------------// 
   case'loteria':
        include_once($xgp_root . 'includes/pages/ShowLoteriaPage.' . $phpEx);
        Loteria($user, $planetrow);
    break;  
// ----------------------------------------------------------------------------------------------------------------------------------------------// 
    case'annonce':
        include_once($xgp_root . 'includes/pages/annonce.' . $phpEx);
        annonce($user, $planetrow);
    break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
 case'tutorial':
