...
/// Prüfen ob beide felder mit Text versehen sind
		...
		while($ticket = mysql_fetch_array($query))
		{
        // Mod aviso por mensaje by shoek
        SendSimpleMessage($ticket['player_id'], '', $time, 1, $user['username'], sprintf($lang['sp_answer_message_title'], $ticket['ID']), sprintf($lang['sp_answer_message'], $ticket['ID']));
        // Fin mod aviso por mensaje  
