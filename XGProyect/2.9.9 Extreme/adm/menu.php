...
$onMouseOverIELime	=	"onMouseOver=\"this.className='ForIEHoverLime'\" onMouseOut=\"this.className='ForIEHoverr'\"";
        ...
        $MenSoporte = doquery("SELECT COUNT(*) as total FROM `{{table}}` WHERE `status` = '1' OR `status` = '3';", 'supp', true);
        if ($MenSoporte['total'] > 0)
         $parse['NumSoporte']        = " (".$MenSoporte['total'].")";
...
$ViewTable	=
        ...
        <tr>
            <th ".$onMouseOverIE." class=\"ForIE\"><a href=\"support.php\" target=\"Hauptframe\">".$lang['supp_header']. $parse['NumSoporte']."</a></th>
        </tr>
		<tr>
