...
if ( !defined('INSIDE') ) die(header("location:../"));
	...
	define("MINIDB_PATH", $xgp_root.'minidb/');
	
	//NUMBER OF EASTER EGGS IN THE CODE/GAME
	define('EASTER_EGGS'			  , 6);
	...
	//UGAMELAPLAY PAY
	define('UGAPAY_ACTIVATED'		  ,    false);
	define('UGAPAY_PUBLIC_KEY'		  ,   "PUBLIC_KEY");
	define('UGAPAY_PRIVATE_KEY'		  ,   "PRIVATE_KEY");	
