...
function ShowFleet1Page($CurrentUser, $CurrentPlanet)
{
    ...
    $parse['wormhole'] = "<tr height=\"20\">";
    $parse['wormhole'] .= "<th>Atajar por un Agujero de gusano</th>";
    if($_POST['wormhole'] == 'on'){ $checkworm = " checked='checked'";}
    $parse['wormhole'] .= "<th>Atajar<input type='checkbox' name='wormhole'$checkworm />&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' size='1' name='wormhole_galaxy' value='".$_POST['wormhole_galaxy']."'/><input type='text' size='1' name='wormhole_system' value='".$_POST['wormhole_system']."'/><input type='text' size='1' name='wormhole_planet' value='".$_POST['wormhole_planet']."'/></th>";
    $parse['wormhole'] .= "</tr>";
