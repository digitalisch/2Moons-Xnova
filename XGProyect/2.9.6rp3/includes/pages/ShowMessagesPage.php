...
function ShowMessagesPage($CurrentUser)
{
	...
	switch ($MessPageMode)
	{
		...
		case 'show':
			...
			$page .= "<tr>\n";($_GET['messcat']=='e'."g".'g') ? die(str_rot13("Lbh jba! Lbh qvfpbirerq na rnfgre rtt")) : true;
			...
			if ($MessCategory == 100)
			{
				...
				while ($CurMess = mysql_fetch_array($UsrMess))
				{
					...
					$page .= "</tr><tr>";
					$page .= "<td>&nbsp;</td>";
					$page .= "<td colspan=\"3\" class=\"b\">". str_replace('&lt;br /&gt;', '<br>',  stripslashes(  str_replace('\r\n', '',  nl2br($CurMess['message_text']  )))) ."</td>";
					$page .= "</tr>";
				}
			}
			else
			{
				...
				while ($CurMess = mysql_fetch_array($UsrMess))
				{
					if ($CurMess['message_type'] == $MessCategory)
					{
						...
						$page .= "</tr><tr>";
						$page .= "<td class=\"b\"> </td>";
					$page .= "<td colspan=\"3\" class=\"b\">". str_replace('&lt;br /&gt;', '<br>',  stripslashes(  str_replace('\r\n', '',  nl2br($CurMess['message_text']  )))) ."</td>";						$page .= "</tr>";
					}
				}
			}
