...
if (!defined('INSIDE'))die(header("location:../../"));
    ...
    $parse = $lang;
     ...
     $a = 0;
        ...
        if ($data['fleetresult'] == a) $bloc['top_fighters']       = "<a href=\"CombatReport.php?raport=". $data['rid'] ."\" target=\"_new\"><font color=\"green\">" .$data['angreifer'] ."</font><b> VS </b><font color=\"red\">". $data['defender'] ."</font></a>";
        elseif ($data['fleetresult'] == r) $bloc['top_fighters']       = "<a href=\"CombatReport.php?raport=". $data['rid'] ."\" target=\"_new\"><font color=\"red\">" .$data['angreifer'] ."</font><b> VS </b><font color=\"green\">". $data['defender'] ."</font></a>";
