...
$lang['forum']				= 'Forum';
$lang['email_alert']		= '<div style="position:relative;color:orange;font-size:10px;"><b>Alert:</b> You need to login with your email instead your username.</div>';

/* ------------------------------------------------------------------------------------------ */

//index.php
//case lostpassword
$lang['mail_not_exist'] 		= 'The email address does not exist!';
$lang['mail_title']			= 'New password';
$lang['mail_text']			= 'This is your new password: ';
$lang['mail_sended']			= 'Your new password has been successfully sent!';

//case default
$lang['login_error']			= 'Incorrect data entered! '.$lang['email_alert'].'<br /><a href="index.php" target="_top">Back to index</a>';

/* ------------------------------------------------------------------------------------------ */

//lostpassword.tpl
$lang['lost_pass_title']		= 'Retrieve lost password';
...
$lang['user']				= 'User';
$lang['pass']				= 'Password';
$lang['remember_pass']			= 'Remember password';
