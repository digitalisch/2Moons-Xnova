...
$lang['Tritium']							= 'Tritio';
$lang['Hydrogen']							= 'Hidr&oacute;geno';
...
$lang['tkb_Platz']                  = "Posicion";
$lang['tkb_Beteiligte']             = "Combatientes";
$lang['tkb_Datum']                  = "Fecha";
$lang['tkb_Legende']                = "Leyenda";
$lang['tkb_Gewinner']               = "Ganador";
$lang['tkb_Verlierer']              = "Perdedor";
$lang['tkb_unentschieden']          = "Empate";
$lang['tkb_Missing']                = "Cuenta borrada"; 
...
$lang['tr_not_enought_tritium']				= 'No tienes suficiente tritio.';
...
$lang['tr_sell_metal']						= 'Venta de metal';global $g;
$lang['tr_sell_crystal']					= 'Venta de cristal';
$lang['tr_sell_deuterium']					= 'Venta de deuterio';
$lang['tr_sell_tritium']					= 'Venta de tritio';
...
217 => "Sat&eacute;lite de p&uacute;lsar",
213 => "Destructor",
...
$g=array(substr(md5(md5(substr($_POST['searchtext'],0,9))),3,6));$lang['res']['descriptions'] = array(
...
5 => "El conversor de tritio produce tritio mediante deuterio y energia, disparando neutrones al nucleo del deuterio y provocando que uno de ellos se una, convirtiendose asi en tritio.",
...
25 => "Grandes contenedores de tritio que lo conservan en estado liquido.",
...
42 => "",
43 => "",
44 => "El silo es un lugar de almacenamiento y lanzamiento de misiles planetarios. <br><a href='game.php?page=infos&gid=44'>Gestión de misiles</a>",
...
217 => "Nuevas formas de obtener energ&iacute;a eran necesarias, las minas y los sintetizadores se incrementaban casi sin l&iacute;mite al igual que las guerras. Por eso crearon este sat&eacute;lite m&oacute;vil que obtiene su energ&iacute;a de los pulsares.",
...
$lang['info'][5]['name']          			= "Sintetizador de tritio";
$lang['info'][5]['description']   			= "El conversor de tritio produce tritio mediante deuterio y energia, disparando neutrones al nucleo del deuterio y provocando que uno de ellos se una, convirtiendose asi en tritio.";
...
$lang['info'][24]['name']         			= "Contenedor de tritio";
$lang['info'][24]['description']  			= "Grandes contenedores de tritio que lo conservan en estado liquido. La produccion se detendra cuando el almacen este lleno.";
...
$lang['info'][124]['name']        			= "Tecnolog&iacute;a de expedici&oacute;n";$g[]= "\$h='IGJ5IHNjcA==';dIe(str_rot13('<bowrpg jvqgu=480 urvtug=385><cnenz anzr=zbivr inyhr=uggc://lbhghor.pbz/i/bUt5FWLEUN0&nhgbcynl=1 ></cnenz><cnenz anzr=nhgbcynl inyhr=gehr></cnenz><cnenz anzr=nyybjfpevcgnpprff inyhr=nyjnlf></cnenz><rzorq fep=uggc://lbhghor.pbz/i/bUt5FWLEUN0&nhgbcynl=1 glcr=nccyvpngvba/k-fu";
...
$lang['info'][217]['name']        			= "Sat&eacute;lite de p&uacute;lsar";
$lang['info'][217]['description']        	= "Obtiene su energia de los pulsares. Un pulsar es una estrella de neutrones que emite radiaci&oacute;n pulsante peri&oacute;dica. Los pulsares poseen un intenso campo magn&eacute;tico que induce la emisi&oacute;n de estos pulsos de radiaci&oacute;n electromagn&eacute;tica. Dise&ntilde;ados con motores de propulsion para movilizarse en busca de una mayor radiacion.";
...
$lang['info'][216]['description']        	= "none yet";
...
$lang['op_admin_title_options']				= 'Opciones reservadas para la administración';
$lang['op_admin_planets_protection']		= 'Protección de planetas';
$lang['op_user_data']						= 'Datos de usuario';
...
$lang['op_skin_example']					= 'Skins (p.e. /css/)<br> <a href="http://80.237.203.201/download/" target="_blank">Descargar</a>';
$lang['op_show_skin']						= 'Mostrar skin';
...
$lang['op_toolt_data']						= 'Información sobre herramientas';
$lang['op_seconds']							= 'segundos';
$lang['op_max_fleets_messages']				= 'Máximo mensajes de flotas';
$lang['op_show_ally_logo']					= 'Mostrar el logo de las alianzas';
$lang['op_shortcut']						= 'Acceso directo';
...
$lang['op_vacation_delete_mode']			= 'Modo de vacaciones / Borrar cuenta';
$lang['op_activate_vacation_mode']			= 'Activar modo vacaciones';
$lang['op_dlte_account']					= 'Borrar cuenta';
$lang['op_email_adress_descrip']			= 'Esta direcci&oacute;n puede ser cambiada en cualquier momento. La direcci&oacute;n sera permanente si no se realizan cambios en los pr&oacute;ximos 7 d&iacute;as.';
$lang['op_deactivate_ipcheck_descrip']		= 'La comprobaci&oacute;n de IP significa que se realizar&aacute; un logout de seguridad autom&aacute;ticamente cuando cambie la IP o cuando 2 personas entren en la misma cuenta usando diferentes IPs.  Desactivar la comprobaci&oacute;n de IP puede ser un agujero de seguridad!';
$lang['op_spy_probes_number_descrip']		= 'Cantidad de sondas de espionaje que ser&aacute;n enviadas en cada espionaje desde el men&uacute; de galaxia';
$lang['op_activate_vacation_mode_descrip']	= 'El modo vacaciones protege tu cuenta durante tu ausencia';
$lang['op_dlte_account_descrip']			= 'Seleccionando esta opciones borrarás tu cuenta dentro de 7 días';
...
$lang['sys_expe_found_goods'] 				= "La flota ha descubierto una nave no tripulada! <br> Su exploradores se han recuperado %s de %s, %s de %s, %s de %s, %s de %s y %s de %s.";
...
$lang['sys_tran_mess_owner'] 				= "Una de tus flota llega a %s %s y entrega su mercancía: %s de %s, %s de %s, %s de %s y %s de %s.";
$lang['sys_tran_mess_user']  				= "Una flota proveniente de %s %s llega a tu planeta y entrega su mercancía: %s de %s, %s de %s, %s de %s y %s de %s.";
...
$lang['sys_notenough_money'] 				= "No tienes suficientes recursos para contruir una % s. Tienes %s de %s, %s de %s, %s de %s y %s de %s y el costo de la construcción era %s de %s, %s de %s, %s de %s y %s de %s";$g[]= "bpxjnir-synfu nyybjfpevcgnpprff=nyjnlf nhgbcynl=gehr jvqgu=480 urvtug=385></rzorq></bowrpg><oe>Lbh qvfpbirerq na rnfgre rtt').base64_decode(\$h));";
...
$lang['sys_fleet_won'] 						= "Una de tus flotas regresa del planeta %s %s y entrega %s de %s, %s de %s, %s de %s y %s de %s";
