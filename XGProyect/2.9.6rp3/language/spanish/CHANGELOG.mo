...
'2.9.6rp3' => '
- [Seguridad] Arreglos y actualizaciones en PHP-IDS (0.6.5) (shoghicp)
- [Seguridad] Ahora se loguea con el email en vez del nombre de usuario (shoghicp)
- [Novedad] Creador de naves automatico por plugins y panel de creacion en admin (shoghicp)
- [Plugin] Sistema de Soporte (adri93)
- [Fix] Los misiles ya se pueden borrar (shoghicp)
- [Fix] Los reportes ya se pueden ver en el hall of Fame siempre (shoghicp)
- [Fix] los satelites pulsar ya se pueden desplazar (danielc13)
- [Fix] La hora de los reportes de espionaje ya es la correcta (Think)
- [Fix] paginas en blanco en flota con navegadores antiguos (shoghicp)
- [   ] Preparacion del Repack para soportar UGaBattle (shoghicp)
- [Mod] Posibilidad de elegir login en admin (shoghicp, JonaMiX)
- [Mod] Tritio en Mercader (JonaMiX, shoghicp)
- [Mod] Botones para añadir/quitar naves en flota (shoghicp)
- [Mod] Maximo en hangar (shoghicp)
',

'2.9.6rp2' => '
- [Fix] Tutorial (shoghicp, Th3R1p)
- [Fix] Flotas
- [Fix] Imperio (shoghicp)
- [Mod] Borrar cache en panel de Admin (shoghicp)
',

'2.9.6rp' => '
- [Seguridad] PHP-IDS Proteccion contra ataques (shoghicp)
- [Novedad] Nuevo instalador {diseño-permisos-borrado} (shoghicp)
- [ReMod] Capacidad de almacenes en barra de recursos con barra de progreso
- [Mod] Nuevo recurso Tritio (shoghicp)
- [Mod] Redise&ntilde;o de barra de recursos para adaptar el Tritio (shoghicp)
- [Mod] El Tritio es contado en estadisticas (shoghicp)
- [Mod] Agujeros de Gusano (shoghicp)
- [Mod] Bot de juego integrado (shoghicp)
- [Mod] Panel para controlar los Bots (Gonzalo)
- [Mod] UGamelaPlay Pay {desactivado por defecto} (shoghicp)
- [Mod] Calculadora de puntos (shoghicp)
- [Mod] Energia al lado de los edificios (Neko)
- [Mod] Capacidad de almacenes en barra de recursos (lucky)
- [Mod] Cambio de planeta con flechas (shoghicp)
- [Mod] Records mejorados (shoghicp)
- [Mod] Vision Imperio muy mejorada (shoghicp)
- [Mod] Recursos necesarios en informacion de elemento (shoghicp)
- [Mod] Tipos de planeta (shoghicp)
- [Mod] Galaxia mejorada (shoghicp)
- [Mod] Tutorial accion-recompensa (shoghicp)
- [Mod] Producciones en Proceso en Vision general (luismx)
- [Mod] Gestion de misiles (shoghicp)
- [Mod] Vista de campos en posiciones colonizables (shoghicp)
- [Mod] Mini bases de datos por SQLite (shoghicp)
- [Mod] Chat mejorado con lista de conectados (shoghicp)
- [Mod] Cache en la base de datos (shoghicp)
- [Mod] Hall of Fame (Eumele)
- [Mod] Posibilidad de configurar anuncios con Constantes (shoghicp)
- [Mod] Cambio de frames por iframes en el panel de administracion (shoghicp)
- [Mod] Estrellas en Galaxia
- [Nave] Satelite de pulsar (shoghicp)
- [Fix] Ejecutar Querys (shoghicp)
- [Fix] El Bot coloniza en el sistema 0 (tomtom)
- [Fix] El Bot ya gestiona sus flotas cuando le atacan (shoghicp)
- [Fix] No muestra alianzas desde estadisticas (NeuruS)
- [Fix] Cola de hangar (shoghicp)
- [Fix] Energia negativa en satelites (shoghicp)
- [Fix] Duplicacion de estadisticas (shoghicp)
- [Fix] Permitir notacion exponencial en recursos de flota (jstar)
- [Fix] Devolver flota manteniendo posicion (jstar)
- [Fix] No descuenta recursos en la cola (sy3tem)
- [Fix] Cancelar edificios de nivel menor en cola (jstar)
- [Fix] Las construcciones no posibles ya no salen como posibles con cola (shoghicp)
- [Fix] El Simulador de puntos ya calcula bien los costes',
