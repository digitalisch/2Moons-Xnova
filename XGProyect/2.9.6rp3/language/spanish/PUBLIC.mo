...
$lang['forum']				= 'Foros';
$lang['email_alert']		= '<div style="position:relative;color:orange;font-size:10px;"><b>Aviso:</b> la entrada se realiza ahora con el email de la cuenta. Con esto mejoramos la seguridad.</div>';
...
//case default
$lang['login_error']			= '¡Datos ingresados incorrectos! '.$lang['email_alert'].'<br /><a href="index.php" target="_top">Volver al inicio</a>';
