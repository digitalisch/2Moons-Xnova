...
$QryTableTopKB = "CREATE TABLE IF NOT EXISTS `{{table}}` (
...
";
$QryTableCache = "CREATE TABLE `{{table}}` (
  `name` TEXT NOT NULL,
  `content` TEXT NOT NULL,
  `last_time` bigint(11) NOT NULL
) ENGINE=MyISAM  DEFAULT CHARSET=latin1;
";
$QryTableChat = "CREATE TABLE IF NOT EXISTS `{{table}}` (
...
$QryTableWormholes = "CREATE TABLE `{{table}}` (
...
$QryInsertConfig    .= "('VERSION'          	 , '2.9.6rp3'), ";
$QryInsertConfig    .= "('users_amount'          , '0'), ";
$QryInsertConfig    .= "('background'            , '0'), ";
...
$QryInsertConfig    .= "('tritium_basic_income'	 , '0'), ";
...
$QryTableFleets     .= "`fleet_resource_tritium` bigint(11) NOT NULL default '0', ";
...
$QryTableFleets     .= "`fleet_wormhole` varchar (64) NOT NULL DEFAULT '0', ";
...
$QryTablePlanets    .= "`tritium` double(132,8) NOT NULL default '0.00000000', ";
$QryTablePlanets    .= "`tritium_perhour` int(11) NOT NULL default '0', ";
$QryTablePlanets    .= "`tritium_max` bigint(20) default '100000', ";
...
$QryTablePlanets    .= "`pulsar_satelit` bigint(11) NOT NULL default '0', ";
...
$QryTablePlanets    .= "`deuterium_sintetizer_porcent` int(11) NOT NULL default '10', `tritium_sintetizer` int(11) NOT NULL default '0', `tritium_store` int(11) NOT NULL default '0', `tritium_sintetizer_porcent` int(11) NOT NULL default '10', ";
...
$QryTablePlanets    .= "`pulsar_satelit_porcent` int(11) NOT NULL default '10', ";
...
$QryInsertPlugins  = "INSERT INTO {{table}} SET `plugin` = 'Sistema de incidencias', `status` = 1;";
...
$QryTableUsers      .= "`tut_1` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_2` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_3` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_4` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_5` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_5_forum` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_6` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_6_mer` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_7` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_7_esp` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_8` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_8_exp` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_9` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_10` int(11) NOT NULL default '0', ";
$QryTableUsers      .= "`tut_10_rec` int(11) NOT NULL default '0', ";
