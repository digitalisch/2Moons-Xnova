		...
		<tr>
			<th align="center">Tengo la versi&oacute;n:<font color="red">(ej: 2.9.6)</font></th>
			<th align="left">
                <select name="modo">
                    <option value="2.3">XG Proyect 2.0 / 2.1 / 2.2</option>
                    <option value="2.4">XG Proyect 2.3</option>
                    <option value="2.5">XG Proyect 2.4</option>
					...
					<option value="2.9.6rp">XG Proyect 2.9.6</option>
					<option value="2.9.6rp2">XG Proyect 2.9.6rp</option>
					<option selected="selected" value="2.9.6rpN">XG Proyect 2.9.6rp2</option>
                </select>
            </th>
		</tr>
		<tr>
			<th align="center" colspan="2"><input type="submit" name="continuar" value="Actualizar a la versi&oacute;n 2.9.6rpN"/></th>
		</tr>
