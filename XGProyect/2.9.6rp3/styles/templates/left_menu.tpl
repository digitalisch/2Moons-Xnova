...
<div id='menu'>
<br/>
<center><NOBR>{servername} (<a href="game.php?page=changelog">{version}</a>)</NOBR></center>
...
<td>
<div align="center"><font color="#FFFFFF">
<a href='game.php?page=topkb'>Hall of Fame</a>
</font></div>
</td>
</tr>
  ...
  <a href='game.php?page=records'>{lm_records}</a>
    </font></div>
  </td>
 </tr>
