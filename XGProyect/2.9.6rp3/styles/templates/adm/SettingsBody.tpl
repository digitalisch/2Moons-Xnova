...
<tr>
	...
	<th>Login Image<br /></th>
	<th><select name="loginImage"><option value="0" {selectedLogin0}>Default</option><option value="1" {selectedLogin1}>XGP Default</option><option value="2" {selectedLogin2}>NewCity</option><option value="3" {selectedLogin3}>Collision</option><option value="4" {selectedLogin4}>Travel</option><option value="5" {selectedLogin5}>Open Space</option><option value="6" {selectedLogin6}>Milk Way</option><option value="-1" {selectedLogin-1}>Random</option></select></th>
	<th><img src="../styles/images/Adm/i.gif" onMouseOver='return overlib("<div style=overflow:auto;width:100%;height:160px;><u>Default</u><br><img src=../styles/images/tlo0.jpg width=130 onclick=document.form.loginImage.selectedIndex=0; style=cursor:pointer; ><br><br><u>XGP Default</u><br><img src=../styles/images/tlo1.jpg width=130 onclick=document.form.loginImage.selectedIndex=1; style=cursor:pointer; ><br><br><u>NewCity</u><br><img src=../styles/images/tlo2.jpg width=130 onclick=document.form.loginImage.selectedIndex=2; style=cursor:pointer; ><br><br><u>Collision</u><br><img src=../styles/images/tlo3.jpg width=130 onclick=document.form.loginImage.selectedIndex=3; style=cursor:pointer; ><br><br><u>Travel</u><br><img src=../styles/images/tlo4.jpg width=130 onclick=document.form.loginImage.selectedIndex=4; style=cursor:pointer; ><br><br><u>Open Space</u><br><img src=../styles/images/tlo5.jpg width=130 onclick=document.form.loginImage.selectedIndex=5; style=cursor:pointer; ><br><br><u>Milk Way</u><br><img src=../styles/images/tlo6.jpg width=130 onclick=document.form.loginImage.selectedIndex=6; style=cursor:pointer; ><br><br></div>", STICKY, MOUSEOFF, CENTER, OFFSETX, -150, OFFSETY, -10, WIDTH, 250);' onMouseOut='return nd();'></th></th>
</tr><tr>
	...
	<th>{se_tritium_production}</th>
	<th><input name="tritium_basic_income" maxlength="10" size="10" value="{tritium_basic_income}" type="text"> {se_per_hour}</th>
</tr><tr>
