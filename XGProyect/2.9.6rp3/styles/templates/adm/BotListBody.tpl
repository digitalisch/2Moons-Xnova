...
<table width="400">
    <tr>
    	<td class="c" colspan="8">Lista de Bots [<a href="?deleteall=yes" onClick="return confirm('Vas a borrar todos los bots. Estas seguro?');">{er_dlte_all}</a>][<a href="BotListPage.php?page=deletenew_bot" onClick="return confirm('Solo borre este archivo si está lento el servidor, presenta errores, o el archivo pesa demaciado. Desea borrarlo de todas formas?');">Borrar bot_new</a>]</td>
    </tr>
    <tr>
