...
<table>
	<tr>
		...
		<tr>
		<form action="SettingsPage.php?page=support&ticket={id}&sendenantwort=1" method="POST">
		...
		<form action="SettingsPage.php?page=support&ticket={id}&schliessen=1" method="POST">
