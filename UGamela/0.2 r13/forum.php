...
function reply($topic) {
	...
	if(!$user){message("Para poder responder un tema, necesitas identificarte.","Responder tema");}
...
function showtopic($forum){
	...
	while($t = mysql_fetch_array($query)){
		...
		$lastpost .= " title=\"Ver 伃timo mensaje\"><img src=\"images/icon_latest_reply.gif\" alt=\">\"></a>";
...
<tr align="center">
<td><a href="javascript:emoticon(':D')"><img src="images/smiles/icon_biggrin.gif" alt="Very Happy" title="Very Happy" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':)')"><img src="images/smiles/icon_smile.gif" alt="Smile" title="Smile" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':(')"><img src="images/smiles/icon_sad.gif" alt="Sad" title="Sad" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':o')"><img src="images/smiles/icon_surprised.gif" alt="Surprised" title="Surprised" border="0" height="15" width="15"></a></td>
</tr>
<tr align="center">
<td><a href="javascript:emoticon(':shock:')"><img src="images/smiles/icon_eek.gif" alt="Shocked" title="Shocked" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':?')"><img src="images/smiles/icon_confused.gif" alt="Confused" title="Confused" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon('8)')"><img src="images/smiles/icon_cool.gif" alt="Cool" title="Cool" border="0" height="15" width="15"></a></td>

<td><a href="javascript:emoticon(':lol:')"><img src="images/smiles/icon_lol.gif" alt="Laughing" title="Laughing" border="0" height="15" width="15"></a></td>
</tr>
<tr align="center">
<td><a href="javascript:emoticon(':x')"><img src="images/smiles/icon_mad.gif" alt="Mad" title="Mad" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':P')"><img src="images/smiles/icon_razz.gif" alt="Razz" title="Razz" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':oops:')"><img src="images/smiles/icon_redface.gif" alt="Embarassed" title="Embarassed" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':cry:')"><img src="images/smiles/icon_cry.gif" alt="Crying or Very sad" title="Crying or Very sad" border="0" height="15" width="15"></a></td>
</tr>
<tr align="center">
<td><a href="javascript:emoticon(':evil:')"><img src="images/smiles/icon_evil.gif" alt="Evil or Very Mad" title="Evil or Very Mad" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':twisted:')"><img src="images/smiles/icon_twisted.gif" alt="Twisted Evil" title="Twisted Evil" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':roll:')"><img src="images/smiles/icon_rolleyes.gif" alt="Rolling Eyes" title="Rolling Eyes" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':wink:')"><img src="images/smiles/icon_wink.gif" alt="Wink" title="Wink" border="0" height="15" width="15"></a></td>
</tr>
<tr align="center">
<td><a href="javascript:emoticon(':!:')"><img src="images/smiles/icon_exclaim.gif" alt="Exclamation" title="Exclamation" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':?:')"><img src="images/smiles/icon_question.gif" alt="Question" title="Question" border="0" height="15" width="15"></a></td>

<td><a href="javascript:emoticon(':idea:')"><img src="images/smiles/icon_idea.gif" alt="Idea" title="Idea" border="0" height="15" width="15"></a></td>
<td><a href="javascript:emoticon(':arrow:')"><img src="images/smiles/icon_arrow.gif" alt="Arrow" title="Arrow" border="0" height="15" width="15"></a></td>
</tr>
<tr align="center">
