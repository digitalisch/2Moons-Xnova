...
<form action="" method="post">
  <center>
    <table width="519" border="0" cellpadding="0" cellspacing="1">
      <tr height="20">
        <td colspan="8" class="c">Flotas (max. '.++$user[$resource[108]].')</td>
      </tr>
      <tr height="20">
        <th>Num.</th>
        <th>Misi�</th>
	...
	*/
	...
	$page .= '
	  ...
	  <center>
		<table width="519" border="0" cellpadding="0" cellspacing="1">
		  <tr height="20">
			<td colspan="4" class="c">Nueva misi�: elegir naves</td>
		  </tr>
		  <tr height="20">
			<th>Naves</th>
			<th>Disponibles</th>';
	...
	*/
	...
	if(!$have_ships){
		...
		*/
		$page .= '<tr height="20">
		<th colspan="4">No hay ninguna nave</th>
		</tr>
		<tr height="20">
		<th colspan="4">
		<input type="button" value="Continuar" disabled/></th>
		</tr>
		</table>
		</center>
		</form>';
	  ...
	  <th><a href="javascript:maxResources()">Todos los recursos</a></th>
		  ...
		  <table width="519" border="0" cellpadding="0" cellspacing="1">
		  <tr height="20">
			<td colspan="2" class="c">Acceso r�ido <a href="fleetshortcut.php">(Editar)</a></td>
		  </tr>';
