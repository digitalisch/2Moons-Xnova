...
31 => "Bilimsel Arastirma Labarotuvari",
33 => "Terraformer",
34 => "Ittifak Deposu",
44 => "Roket Silosu",
//Tecnologias
...
//Contrucciones
1 => "Gemi ve bina insaatinda kullanilan, olmazsa olmaz hammaddelerin en önemli kaynagi.",
2 => "Elektronik insaat malzemesi ve alasim için gereken hammaddelerin en önemli kaynagi.",
3 => "Bir gezegende bulunan su kütlesinden sadece suyun icinde az miktarda bulunan Deuterium elementini cikarir.",
4 => "Solar Enerji günes isinlarindan elde ediliyor. Neredeyse tüm binalarin, üretim icin enerjiye ihtiyaclari var.",
...
14 => "Robot fabrikalari gezegenin altyapisi ve organizasyonu için gereken vasifsiz is gücünü üretiyorlar.Kademesi arttikça diger binalarin yapim süreci de daha hizli isliyor.",
...
22 => "Daha islenmemis ama islenmeye hazir metallerin içinde tutulabilecegi depo.",
23 => "Daha islenmemis ama islenmeye hazir kristallerin içinde tutulabilecegi depo.",
24 => "Yeni elde edilen deuterium'un depolanabilecegi dev tankerler.",
31 => "Yeni teknolojileri kesfedebilmek için bilimsel arastirma istasyonu gerekli.",
33 => "Terraformer...",
34 => "Ittifak Deposu, savunmaya yardim eden ve yörüngede bulunan dost ittifak filolarina yakit aktarilmasini saglar.",
44 => "Roket silolarinda roketler konuslandirilir.",
//Tecnologias
