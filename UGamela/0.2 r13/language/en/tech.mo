...
21 => "Robotic factories provide construction robots to aid in the construction of buildings. Each level increases the speed of the upgrade of buildings.",
...
204 => "The light fighter is an agile ship that is encountered on almost each planet. The costs are not particularly high, however the shield strength and cargo capacity are very low.",
