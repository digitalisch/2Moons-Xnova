...
//Contrucciones
1 => "メタル鉱石の採掘に使用されます。メタル採掘所は帝国の出現、設立に重要な施設です。",
2 => "クリスタルは電子回路、一定の合金化合物の形成に使用される主な資源です。",
3 => "デューテリウムはスペースシップの燃料として使用され、深海で採掘します。デューテリウムは貴重な物質で比較的、高価な物質です。",
4 => "ソーラー プラントは太陽の放射光からエネルギーを吸収します。全ての採掘所はエネルギーを使用して稼動します",
...
14 => "ロボティック工場は建造物の建設の手助けをする建設ロボットを提供します。それぞれのレベルは、建造物のアップグレードのスピードを向上させます。",
...
22 => "余剰に採掘されたメタルを貯蔵します。",
23 => "余剰に採掘されたクリスタルを貯蔵します。",
24 => "新しく抽出されたデューテリウムのための巨大タンクです。",
31 => "リサーチセンターは新しい技術を研究するのに必要です。",
33 => "Terraformer...",
...
43 => "El salto cuántico usa portales transmisores-receptores capaces de enviar incluso la mayor flota instantaneamente a un portal lejano."
);}
