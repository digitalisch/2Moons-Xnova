...
$lang['Name'] = 'Nome';
$lang['Information_on'] = 'Informação em %n:';
...
<tr><td class="c">Nível</td><td class="c">Produção/hora</td><td class="c">Consumo de energia</td></tr><tr><th>1</th><th>22</th><th>-11</th></tr><tr><th>2</th><th>48</th><th>-25</th></tr><tr><th>3</th><th>79</th><th>-40</th></tr><tr><th>4</th><th>117</th><th>-59</th></tr><tr><th>5</th><th>161</th><th>-81</th></tr><tr><th>6</th><th>212</th><th>-107</th></tr><tr><th>7</th><th>272</th><th>-137</th></tr><tr><th>8</th><th>342</th><th>-172</th></tr><tr><th>9</th><th>424</th><th>-213</th></tr><tr><th>10</th><th>518</th><th>-260</th></tr><tr><th>11</th><th>627</th><th>-314</th></tr><tr><th>12</th><th>753</th><th>-377</th></tr><tr><th>13</th><th>897</th><th>-449</th></tr><tr><th>14</th><th>1063</th><th>-532</th></tr><tr><th>15</th><th>1253</th><th>-627</th></tr>';


$lang['info'][106]['name'] = 'Tecnologia de Espionagem';
$lang['info'][106]['description'] = 'A tecnologia de espionagem resulta de pesquisas sobre sensores de dados, equipamento e conhecimento da inteligência de que um império necessita para se proteger de ataques, mas também para dirigir ataques contra o inimigo. A evolução desta tecnologia aumenta os detalhes, e informações obtidos.

O resultado de espionagem depende também da força e do nível de espionagem do jogador adverso. A evolução do nível da tecnologia de espionagem define também o nível dos detalhes sobre uma frota que se aproxima do teu planeta:

- Nível 2 adiciona o número de naves à informação sobre a frota;
- Nível 4 adiciona o tipo das naves que se aproximam;
- Nível 8 adiciona finalmente detalhes sobre o tipo e o número de naves que se aproximam.

Em geral, a tecnologia de espionagem é muito importante para um império, seja ele agressivo ou amigável. Conselho: começar a pesquisar esta área tecnológica logo depois de ter à sua disposição as primeiras naves de transporte.';
...
$lang['info'][109]['name'] = 'TecnologÃ­a militar';
$lang['info'][109]['description'] = 'La tecnologÃ­a militar se ocupa de avanzar en el desarrollo de sistemas de armamento existentes. Principalmente estÃ¡ centrada en aumentar la efectividad de las armas y su eficiencia.
De este modo, incrementando el nivel de esta tecnologÃ­a, el mismo arma tiene mÃ¡s poder y provoca mÃ¡s daÃ±o; cada nivel aumenta la potencia en un 10% de la fuerza base del arma.
Es importante mantener la tecnologÃ­a militar actualizada contra tus enemigos. Es una buena idea aumentar el conocimiento en esta Ã¡rea continuamente.';

$lang['info'][109]['name'] = 'Tecnologia de Armas';
$lang['info'][109]['description'] = 'A tecnologia de armas trata do desenvolvimento dos sistemas de armas existentes. É focalizada principalmente no aumento do poder e da eficiência das armas.
Com esta tecnologia, e aumentando o seu nível, a mesma arma tem mais poder e causa mais danos - cada nível aumenta o poder de fogo em 10%.
...
$lang['info'][115]['description'] = 'Os motores de combustão pertencem aos motores antigos e são baseados na repulsão. As partículas são aceleradas deixando o motor criar uma força repulsiva que move a nave no sentido oposto. A eficiência destes motores de combustão é baixa, mas são baratos e de confiança.
Pesquisar e evoluir esta tecnologia aumenta a velocidade de combustão dos motores e assim a velocidade das naves, cada evolução aumenta a velocidade em 10%. Esta tecnologia é de grande importância para um império emergente, e deve ser pesquisado o mais cedo possível.';
...
$lang['info'][120]['description'] = 'O laser (amplificação de luz pela emissão estimulada da radiação) cria um raio intenso de luz, que concentra uma grande quantidade de energia. O laser tem várias áreas de aplicação como os sistemas ópticos de computadores, e as armas com alto poder destructivo. O conhecimento desta tecnologia é fundamental para a investigação de novas armas.
Requisitos: Laboratório de Pesquisas (Nível 1) Tecnologia de Energia (Nível 2)';
...
$lang['info'][123]['description'] = 'Os cientistas dos teus planetas podem comunicar uns com os outros graças a esta rede.
No nível 0, terás apenas o benefício de ligar o satélite ao teu laboratório de pesquisas mais evoluído. Com o nível 1, ligarás os 2 laboratórios mais evoluídos. Cada nível acrescenta mais um laboratório. Desta maneira, as pesquisas serão efectuadas com a máxima velocidade.';

$lang['info'][12]['name'] = 'Planta de Fusão';
$lang['info'][12]['description'] = 'A planta de fusão é um reactor de fusão nuclear que produz um átomo de hélio para dois átomos de deutério usando extremamente altas temperaturas e pressão. Sempre que dois núcleos de deutério fundem numa partícula alfa, há uma grande diminuição de massa. Esta massa não desaparece simplesmente, mas é convertida na energia cinética do núcleo recentemente criado. Esta energia pode ser convertida em potência eléctrica. Cada grama de deutério fornece 172 MWh de energia; quanto maior o reactor de fusão, maior são as reacções de fusão realizadas aumentando a energia total de saída.
<tr><td class="c">Nível</td><td class="c">Produção/hora</td><td class="c">Consumo de deutério</td></tr><tr><th>1</th><th>55</th><th>-11</th></tr><tr><th>2</th><th>121</th><th>-25</th></tr><tr><th>3</th><th>199</th><th>-40</th></tr><tr><th>4</th><th>292</th><th>-59</th></tr><tr><th>5</th><th>402</th><th>-81</th></tr><tr><th>6</th><th>531</th><th>-107</th></tr><tr><th>7</th><th>682</th><th>-137</th></tr><tr><th>8</th><th>857</th><th>-172</th></tr><tr><th>9</th><th>1061</th><th>-213</th></tr><tr><th>10</th><th>1296</th><th>-260</th></tr><tr><th>11</th><th>1569</th><th>-314</th></tr><tr><th>12</th><th>1883</th><th>-377</th></tr><tr><th>13</th><th>2243</th><th>-449</th></tr><tr><th>14</th><th>2658</th><th>-532</th></tr><tr><th>15</th><th>3132</th><th>-627</th></tr>';
...
$lang['info'][202]['description'] = 'Estas naves são aproximadamente do tamanho de uma nave de combate, mas não são equipadas nem com motores nem com armamento de combate, para deixar mais espaço para os recursos a transportar. O cargueiro pequeno pode transportar até 5.000 unidades de recursos.
A velocidade básica dos teus cargueiros pequenos é aumentada logo que a tecnologia de impulsão nível 5 for pesquisada, já que ficam equipados com motores de impulsão.

Rapidfire contra Sonda de Espionagem: <font color="lime">5</font>
Rapidfire contra Satélite Solar: <font color="lime">5</font>
Rapidfire de Caça Pesado contra esta nave: <font color="red">3</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">250</font>
Rapidfire de Interceptor contra esta nave: <font color="red">3</font>';
...
Rapidfire contra Sonda de Espionagem: <font color="lime">5</font>
Rapidfire contra Satélite Solar: <font color="lime">5</font>
Rapidfire de Cruzador contra esta nave: <font color="red">3</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">200</font>';
...
Rapidfire contra Sonda de Espionagem: <font color="lime">5</font>
Rapidfire contra Satélite Solar: <font color="lime">5</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">100</font>';

$lang['info'][206]['name'] = 'Cruzador';
$lang['info'][206]['description'] = 'Com os lasers pesados e os canhões do iões que emergem nos campos de batalha, as naves básicas de combate encontravam cada vez mais em dificuldade. Apesar de muitas modificações nos sistemas de arma estas naves não podiam ser aumentadas ou evoluidas bastante para poder rivalizar com os novos sistemas de defesa.
Por esta razão, foi decidido desenvolver uma nova nave, poderosa e com sistemas de armas devastadores. Nasceu então o cruzador.
Os cruzadores possuem um sistema de armas três vezes mais poderoso do que aquele encontrado no caça pesado e uma velocidade de tiro aumentada. A velocidade do cruzador é a mais rápida já vista. Infelizmente, com o aparecimento mais tarde dos novos e mais fortes sistemas de defesa como os canhões de Gauss e os lançadores de plasma, o domínio dos cruzadores acabou. O cruzador tem RapidFire(10) contra os lançadores de mísseis e contra os caças ligeiros, isso quer dizer que um cruzador destrói sempre mais de um míssil ou caça ligeiro a cada round.


Rapidfire contra Sonda de Espionagem: <font color="lime">5</font>
Rapidfire contra Satélite Solar: <font color="lime">5</font>
Rapidfire contra Caça Ligeiro: <font color="lime">3</font>
Rapidfire contra Lançador de Mísseis: <font color="lime">10</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">33</font>';
...
Rapidfire contra Sonda de Espionagem: <font color="lime">5</font>
Rapidfire contra Satélite Solar: <font color="lime">5</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">30</font>';
...
$lang['info'][209]['description'] = 'Os combates no espaço parecem tornar-se cada vez mais impressionantes onde numa única batalha milhares de naves podem ser destruídas, e os restos perdidos para sempre. Os cargueiros não têm os meios para recolher esses recursos valiosos.
Com o desenvolvimento das naves espaciais, veio a ser possível recolher aqueles campos de ruínas. Um reciclador é do tamanho de um cargueiro grande e tem uma capacidade de armazenamento limitada de 20.000 unidades.
...
$lang['info'][210]['description'] = 'As sondas de espionagem são drones com uma rapidez impressionante de propulsão utilizados para espiar os inimigos. Com um sistema de comunicação altamente avançado as sondas podem emitir dados a grande distância.
Quando chegam ao planeta alvo, as sondas permanecem na orbita de maneira a recolher os dados do planeta. Durante esse período é relativamente fácil detectá-las. Uma vez detectadas, devido à fraqueza da sua estrutura, as sondas não podem resistir muito tempo aos tiros dos sistemas de defesa, e são rapidamente destruidas.
Para que o tempo de permanencia em órbita seja o mais reduzido possível, é conveniente ter uma Tecnologia de Espionagem bem desenvolvida.

Rapidfire de Cargueiro Pequeno contra esta nave: <font color="red">5</font>
Rapidfire de Cargueiro Grande contra esta nave: <font color="red">5</font>
Rapidfire de Caça Ligeiro contra esta nave: <font color="red">5</font>
Rapidfire de Caça Pesado contra esta nave: <font color="red">5</font>
Rapidfire de Cruzador contra esta nave: <font color="red">5</font>
Rapidfire de Nave de Batalha contra esta nave: <font color="red">5</font>
Rapidfire de Nave de Colonização contra esta nave: <font color="red">5</font>
Rapidfire de Reciclador contra esta nave: <font color="red">5</font>
Rapidfire de Bombardeiro contra esta nave: <font color="red">5</font>
Rapidfire de Destruidor contra esta nave: <font color="red">5</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">1250</font>';

$lang['info'][211]['name'] = 'Bombardeiro';
$lang['info'][211]['description'] = ' 	O bombardeiro é uma nave espacial desenvolvida para destruir os sistemas de defesa planetários mais recentes e poderosos. Dotado de um sistema de escolha de alvo guiado ao laser, e de bombas de plasma, o bombardeiro é uma arma destrutiva
A velocidade básica dos teus bombardeiros é aumentada assim que seja pesquisado o motor de hiperespaço nível 8, já que ficam equipadas com o motor de hiperespaço.


Rapidfire contra Sonda de Espionagem: <font color="lime">5</font>
Rapidfire contra Satélite Solar: <font color="lime">5</font>
Rapidfire contra Lançador de Mísseis: <font color="lime">20</font>
Rapidfire contra Laser Ligeiro: <font color="lime">20</font>
Rapidfire contra Laser Pesado: <font color="lime">10</font>
Rapidfire contra Canhão de Iões: <font color="lime">10</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">25</font>';

$lang['info'][212]['name'] = 'Satélite Solar';
$lang['info'][212]['description'] = 'Os satélites solares são satélites simples situados na órbita de um planeta, equipados de células fotovoltaicas, capazes de transferir energia para o planeta. A energia é transmitida ao planeta graças a um feixe de laser especial.
Estes satélites são uma ajuda ao nível da procura de energia, mas não resistem aos tiros das naves inimigas, e desta maneira a perda de os satélites pode ser fatal para a sobrevivência energética do teu planeta.
...
Rapidfire contra Sonda de Espionagem: <font color="lime">1250</font>
Rapidfire contra Satélite Solar: <font color="lime">1250</font>
Rapidfire contra Cargueiro Pequeno: <font color="lime">250</font>
Rapidfire contra Cargueiro Grande: <font color="lime">250</font>
Rapidfire contra Caça Ligeiro: <font color="lime">200</font>
Rapidfire contra Caça Pesado: <font color="lime">100</font>
Rapidfire contra Cruzador: <font color="lime">33</font>
Rapidfire contra Nave de Batalha: <font color="lime">30</font>
Rapidfire contra Nave de Colonização: <font color="lime">250</font>
Rapidfire contra Reciclador: <font color="lime">250</font>
Rapidfire contra Bombardeiro: <font color="lime">25</font>
Rapidfire contra Destruidor: <font color="lime">5</font>
Rapidfire contra Lançador de Mísseis: <font color="lime">200</font>
Rapidfire contra Laser Ligeiro: <font color="lime">200</font>
Rapidfire contra Laser Pesado: <font color="lime">100</font>
Rapidfire contra Canhão de Gauss: <font color="lime">50</font>
Rapidfire contra Canhão de Iões: <font color="lime">100</font>
Rapidfire contra Interceptor: <font color="lime">15</font>';
...
Rapidfire de Destruidor contra este tipo de nave: <font color="red">2</font>
Rapidfire de Estrela da Morte contra este tipo de nave: <font color="red">15</font>
Rapidfire contra Sonda de Espionagem: <font color="red">5</font>
Rapidfire contra Satélite Solar: <font color="lime">5</font>
Rapidfire contra Cargueiro Pequeno: <font color="lime">3</font>
Rapidfire contra Cargueiro Grande: <font color="lime">3</font>
Rapidfire contra Caça Pesado: <font color="lime">4</font>
Rapidfire contra Cruzador: <font color="lime">4</font>
Rapidfire contra Nave de Batalha: <font color="lime">7</font>';
...
<tr><td class="c">Nível</td><td class="c">Capacidade de armazenamento</td></tr><tr><th>0</th><th>100 k</th></tr><tr><th>1</th><th>150 k</th></tr><tr><th>2</th><th>200 k</th></tr><tr><th>3</th><th>300 k</th></tr><tr><th>4</th><th>400 k</th></tr><tr><th>5</th><th>600 k</th></tr><tr><th>6</th><th>900 k</th></tr><tr><th>7</th><th>1400 k</th></tr><tr><th>8</th><th>2200 k</th></tr><tr><th>9</th><th>3500 k</th></tr><tr><th>10</th><th>5550 k</th></tr><tr><th>11</th><th>8850 k</th></tr><tr><th>12</th><th>14150 k</th></tr><tr><th>13</th><th>22600 k</th></tr><tr><th>14</th><th>36100 k</th></tr>';
...
$lang['info'][3]['name'] = 'Sintetizador de Deutério';
$lang['info'][3]['description'] = 'O deutério é água pesada -- o núcleo do hidrogénio contém um neutrão adicional, sendo um excelente combustível para as naves devido ao elevado rendimento energético da reacção. O deutério pode ser frequentemente encontrado no mar profundo devido ao seu peso molecular. Evoluir o sintetizador de deutério permite colher maior quantidade deste recurso.
<tr><td class="c">Nível</td><td class="c">Produção/hora</td><td class="c">Consumo de energia</td></tr><tr><th>1</th><th>12</th><th>-22</th></tr><tr><th>2</th><th>28</th><th>-49</th></tr><tr><th>3</th><th>46</th><th>-80</th></tr><tr><th>4</th><th>67</th><th>-118</th></tr><tr><th>5</th><th>93</th><th>-162</th></tr><tr><th>6</th><th>123</th><th>-213</th></tr><tr><th>7</th><th>157</th><th>-273</th></tr><tr><th>8</th><th>198</th><th>-343</th></tr><tr><th>9</th><th>245</th><th>-425</th></tr><tr><th>10</th><th>300</th><th>-519</th></tr><tr><th>11</th><th>363</th><th>-628</th></tr><tr><th>12</th><th>436</th><th>-754</th></tr><tr><th>13</th><th>519</th><th>-898</th></tr><tr><th>14</th><th>615</th><th>-1064</th></tr><tr><th>15</th><th>725</th><th>-1254</th></tr>';
...
$lang['info'][33]['description'] = 'O Terra-Formador permite aumentar o número de áreas disponíveis para construção do planeta. Graças a este processo, um planeta pode aumentar a sua capacidade, e espaço. Com o tempo, o espaço tende a ser insuficiente e vários métodos já utilizados eram insuficientes ou inúteis a longo prazo.
Um grupo de cientistas e nano-tecnicos encontraram uma solução: Criar e formar Terra (Terra-Formador)
Com muita energia, é possivel criar continentos inteiros!
Nanitas especiais são produzidos neste edifício para assegurar a qualidade e a usabilidade das áreas formadas pelo Terra-Formador.';
...
<tr><td class="c">Nível</td><td class="c">Produção/hora</td></tr><tr><th>1</th><th>22</th></tr><tr><th>2</th><th>48</th></tr><tr><th>3</th><th>79</th></tr><tr><th>4</th><th>117</th></tr><tr><th>5</th><th>161</th></tr><tr><th>6</th><th>212</th></tr><tr><th>7</th><th>272</th></tr><tr><th>8</th><th>342</th></tr><tr><th>9</th><th>424</th></tr><tr><th>10</th><th>518</th></tr><tr><th>11</th><th>627</th></tr><tr><th>12</th><th>753</th></tr><tr><th>13</th><th>897</th></tr><tr><th>14</th><th>1063</th></tr><tr><th>15</th><th>1253</th></tr>';

$lang['info'][401]['name'] = 'Lançador de Mísseis';
$lang['info'][401]['description'] = 'O lançador de mísseis é um sistema de defesa simples e barato. Tornam-se muito eficazes em número e podem ser construídos sem pesquisa específica porque é uma arma de balística simples. Os custos de fabricação baixos fazem desta arma defensiva um adversário apropriado para frotas pequenas.
Em geral, os sistemas de defesa desactivam-se ao alcançar parâmetros operacionais críticos de maneira a fornecer uma possibilidade de reparação. 70% da defesa planetária destruída pode ser reparada depois dum combate.

Rapidfire de Cruzador contra esta nave: <font color="red">10</font>
Rapidfire de Bombardeiro contra esta nave: <font color="red">20</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">200</font>';

$lang['info'][402]['name'] = 'Laser Ligeiro';
$lang['info'][402]['description'] = 'Para acompanhar o ritmo com a velocidade sempre crescente do desenvolvimento das tecnologias de naves espaciais, os cientistas tiveram que criar um tipo novo de sistema da defesa capaz de destruír as naves mais fortes.
Rapidamente, o laser ligeiro foi inventado, este pode disparar um feixe de laser altamente concentrado no alvo e criar danos muito mais elevados do que o impacto de mísseis balísticos. Um preço baixo da unidade era um objetivo essencial do projeto, por isso a estrutura basica não foi melhorada comparada ao lançador de mísseis.

Rapidfire de Bombardeiro contra esta nave: <font color="red">20</font>
Rapidfire de Destruidor contra esta nave: <font color="red">10</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">200</font>';
...
Rapidfire de Bombardeiro contra esta nave: <font color="red">10</font>
Rapidfire de Estrela da Morte contra esta nave: <font color="red">100</font>';
...
Rapidfire de Estrela da Morte contra esta nave: <font color="red">50</font>';
...
$lang['info'][43]['description'] = 'O portal de salto quântico é um transceptor enorme capaz de transportar instantaneamente uma frota inteira para outro portal de salto. O portal necessita o desenvolvimento de numerosas tecnologias avançadas, e também uma imensa quantidade de energia para funcionar.';
...
<tr><th>Integridade estrutural</th>
     <th>15000</th>
    </tr>
    <tr>
     <th>Escudo</th>
