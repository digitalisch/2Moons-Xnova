...
*/
$lang['Name'] = 'Nombre';
$lang['Information_on'] = 'Información en %n:';
...
$lang['info'][106]['description'] = 'La tecnología de espionaje es la investigación sobre los sensores de datos, equipamiento de inteligencia y conocimiento que un imperio necesita para poder protegerse a sí mismo de espionajes y conductas similares. Cuanto más avanzada es esta tecnología, más detalles se pueden obtener de otros imperios.

Para las sondas de espionaje y su probabilidad de éxito, la diferencia entre la tecnología propia y la del rival es importante. Cuanto más elevada sea la nuestra, más información podrá obtener la sonda y menor será la posibilidad de ser detectada por las fuerzas enemigas. Cuantas más sondas se envíen, más detalles se conseguirán, pero, también aumentará la posibilidad de ser detectado.
El nivel de mejora de la tecnología de espionaje tambien define el nivel de detalles sobre una flota atacante:
- El nivel 2 añade el número total de naves a la información de la flota.
- El nivel 4 añade entonces los tipos de naves aproximándose a la información de la flota.
- El nivel 8 añade finalmente detalles sobre la cantidad de naves de cada tipo.

En general, la tecnología de espionaje es muy importante para cada imperio, sea agresivo o pacífico. Por lo que se propone iniciar la investigación en esta área justo después de que se puedan construir las naves pequeñas de carga.';
...
$lang['info'][109]['description'] = 'La tecnología militar se ocupa de avanzar en el desarrollo de sistemas de armamento existentes. Principalmente está centrada en aumentar la efectividad de las armas y su eficiencia.
...
Investigar sobre niveles más altos proporciona siempre motores más rápidos ya que cada nivel aumenta un 10% la velocidad efectiva de viaje, basándose en la velocidad base.
Dado que esta tecnología es una de las cosas más básicas para un imperio emergente, debería ser investigada tan pronto como sea posible.';

$lang['info'][117]['name'] = 'Motor de impulso';
$lang['info'][117]['description'] = 'El sistema del motor de impulso se basa en el principio de la repulsión de partículas. La materia repelida es basura generada por el reactor de fusión usado para proporcionar la energía necesaria para este tipo de motor de propulsión. Los motores de impulso son un desarrollo posterior a los simples motores de combustión, aumentan la eficienta y reducen el consumo de combustible en relación a su velocidad.';

$lang['info'][118]['name'] = 'Propulsor hiperespacial';
$lang['info'][118]['description'] = 'A través de la curvatura del espacio-tiempo en el entorno inmediato de las naves viajantes, el espacio se comprime hasta tal grado que las distancias más grandes pueden ser cubiertas en un corto período de tiempo. Cuanto mayor sea el nivel del motor de hiperespacio, mayores serán las compresiones que se puedan obtener, y por tanto la velocidad de desplazamiento de las naves se incrementa en un 30% por cada nivel de mejora de esta investigación.
...
Requisitos: Laboratorio de investigación (nivel 1) Tecnología de energía (nivel 2)';
...
$lang['info'][123]['description'] = 'Los científicos de tus planetas pueden comunicarse entre ellos a través de esta red.
Con cada nivel investigado, uno de tus laboratorios de investigación del nivel más alto, será enlazado a la red. Sus niveles se añadirán cuando la red se establezca.
Cada laboratorio de investigación enlazado necesita el nivel requerido para la investigación programada para poder unirse a la investigación en red. Los niveles de todos los laboratorios de investigación que tomen parte serán añadidos conjuntamente.';

$lang['info'][12]['name'] = 'Planta de fusión';
$lang['info'][12]['description'] = 'Un reactor de fusión nuclear que produce un átomo de helio a partir de dos átomos de deuterio usando una presión extremadamente alta y una elevadísima temperatura. Siempre que dos núcleos de deuterio se funden en una partícula alfa, hay una disminución neta de la masa. Esta masa no desaparece, sino que se convierte en la energía cinética del nuevo núcleo creado. Esta energía puede ser convertida en energía eléctrica. Cada gramo de deuterio proporciona 172 MWh de energía, por ello, cuanto mayor sea el reactor de fusión, será posible realizar al mismo tiempo más reacciones de fusión paralelamente y aumentar la energía de salida.';
...
Requisitos: Laboratorio de investigación (nivel 12)';
...
Fuego rápido contra Sonda de espionaje: <font color="lime">5</font>
Fuego rápido contra Satélite solar: <font color="lime">5</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">250</font>';
...
Fuego rápido contra Sonda de espionaje: <font color="lime">5</font>
Fuego rápido contra Satélite solar: <font color="lime">5</font>
Fuego rápido de Crucero contra este tipo de nave: <font color="red">3</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">200</font>';
...
Fuego rápido contra Sonda de espionaje: <font color="lime">5</font>
Fuego rápido contra Satélite solar: <font color="lime">5</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">100</font>';
...
Fuego rápido contra Sonda de espionaje: <font color="lime">5</font>
Fuego rápido contra Satélite solar: <font color="lime">5</font>
Fuego rápido contra Cazador ligero: <font color="lime">3</font>
Fuego rápido contra Lanzamisiles: <font color="lime">10</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">33</font>';
...
Fuego rápido contra Sonda de espionaje: <font color="lime">5</font>
Fuego rápido contra Satélite solar: <font color="lime">5</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">30</font>';
...
$lang['info'][210]['description'] = 'Las sondas de espionaje son pequeños droides no tripulados con un sistema de propulsión excepcionalmente rápido usado para espiar en planetas extranjeros. Con su avanzado sistema de comunicación, estas sondas pueden enviar de vuelta, a gran distancia, información inteligente.
...
Fuego rápido de Nave pequeña de carga contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Nave grande de carga contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Cazador ligero contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Cazador pesado contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Crucero contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Nave de batalla contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Colonizador contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Reciclador contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Bombardero contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Destructor contra este tipo de nave: <font color="red">5</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">1250</font>';
...
Fuego rápido contra Sonda de espionaje: <font color="lime">5</font>
Fuego rápido contra Satélite solar: <font color="lime">5</font>
Fuego rápido contra Lanzamisiles: <font color="lime">20</font>
Fuego rápido contra Láser pequeño: <font color="lime">20</font>
Fuego rápido contra Láser grande: <font color="lime">10</font>
Fuego rápido contra Cañón iónico: <font color="lime">10</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">25</font>';

$lang['info'][212]['name'] = 'Satélite solar';
$lang['info'][212]['description'] = 'Los satélites solares son simples satélites en órbita equipados con células fotovoltaicas y transmisores para llevar la energía al planeta. Se transmite por este medio a la tierra usando un rayo láser especial. La eficiencia de estas plataformas está relacionada con la cantidad de luz solar, haciéndolos más o menos eficientes dependiendo de la distancia de los planetas respecto al sol.
Debido a su bajo precio y fácil instalación, estos sátelites son ampliamente conocidos por ser usados como ayuda de las infraestructuras de las plantas de energía.
...
$lang['info'][213]['description'] = 'Con el destructor, la madre de todas las naves de batalla entra en escena. Su sistemas de armamento multi-phalanx consisten en cañones gauss, de plasma e iónicos armados en torretas de respuesta rápida, lo que permite eliminar a los cazadores operativos con una probabilidad del 99%. El tamaño de la nave es también su pega, ya que su maniobrabilidad es limitada, haciendo al destructor más parecido a una estación de combate que a una nave de guerra. El consumo de comubstible de estos inmensos destructores es casi tan alto como su poder de ataque...

Fuego rápido contra láser pequeño: 10

Fuego rápido contra Sonda de espionaje: <font color="lime">5</font>
Fuego rápido contra Satélite solar: <font color="lime">5</font>
Fuego rápido contra Láser pequeño: <font color="lime">10</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">5</font>';
...
Fuego rápido contra Sonda de espionaje: <font color="lime">1250</font>
Fuego rápido contra Satélite solar: <font color="lime">1250</font>
Fuego rápido contra Nave pequeña de carga: <font color="lime">250</font>
Fuego rápido contra Nave grande de carga: <font color="lime">250</font>
Fuego rápido contra Cazador ligero: <font color="lime">200</font>
Fuego rápido contra Cazador pesado: <font color="lime">100</font>
Fuego rápido contra Crucero: <font color="lime">33</font>
Fuego rápido contra Nave de batalla: <font color="lime">30</font>
Fuego rápido contra Colonizador: <font color="lime">250</font>
Fuego rápido contra Reciclador: <font color="lime">250</font>
Fuego rápido contra Bombardero: <font color="lime">25</font>
Fuego rápido contra Destructor: <font color="lime">5</font>
Fuego rápido contra Lanzamisiles: <font color="lime">200</font>
Fuego rápido contra Láser pequeño: <font color="lime">200</font>
Fuego rápido contra Láser grande: <font color="lime">100</font>
Fuego rápido contra Cañón Gauss: <font color="lime">50</font>
Fuego rápido contra Cañón iónico: <font color="lime">100</font>';
...
Fuego rápido de Crucero contra este tipo de nave: <font color="red">10</font>
Fuego rápido de Bombardero contra este tipo de nave: <font color="red">20</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">200</font>';

$lang['info'][402]['name'] = 'Láser pequeño';
$lang['info'][402]['description'] = 'Para mantener el ritmo con el aumento notable de la velocidad de desarrollo en términos de tecnología especial, los científicos tuvieron que llegar a un nuevo sistema de defensa, capaz de aguantar contra naves y flotas más fuertes y mejor equipadas.
...
Fuego rápido de Bombardero contra este tipo de nave: <font color="red">20</font>
Fuego rápido de Destructor contra este tipo de nave: <font color="red">10</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">200</font>';
...
Fuego rápido de Bombardero contra este tipo de nave: <font color="red">10</font>
Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">100</font>';
...
Incluso las nuevas aleaciones de blindaje y tecnologías de escudo tienen un duro trago al sopotar el impacto del proyectil, a menudo, el disparo simplemente atraviesa la estructura del objetivo.

Fuego rápido de Estrella de la muerte contra este tipo de nave: <font color="red">50</font>';
...
$lang['info'][43]['name'] = 'Salto cuántico';
$lang['info'][43]['description'] = 'Los portales del salto cuántico son enormes transmisores-receptores capaces de enviar incluso la flota más grande instantaneamente a un portal distante en cualquier galaxia. Necesitan la tecnología más sofisticada ya que se precisa una cantidad inmensa de energía para cumplir con esta tarea.';
...
$lang['info'][502]['name'] = 'Misil de intercepción';
$lang['info'][502]['description'] = 'Los misiles de intercepción destruyen los misiles interplanetarios. Cada misíl de intercepción destruye un misíl interplanetario.';
