...
if($_POST){
	...
	if($errors != 0){
		...
		doquery("UPDATE {{table}} SET field_max='{$game_config['initial_fields']}' WHERE id_owner='{$iduser}' LIMIT 1",'planets',true);
		//
		...
		message($lang['thanksforregistry'],$lang['reg_welldone']);
		else
