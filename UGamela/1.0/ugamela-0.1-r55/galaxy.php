...
function echo_galaxy($g,$s){
  ...
  ?>
<a style="cursor: pointer;" onmouseover="this.T_WIDTH=250;this.T_OFFSETX=-110;this.T_OFFSETY=-30;this.T_STICKY=true;this.T_TEMP=<?php $T_TEMP = $user["settings_tooltiptime"]*1000; echo $T_TEMP; ; ?>;this.T_STATIC=true;return escape('<table width=\'240\'><tr><td class=\'c\' colspan=\'2\'>Planeta <?php echo $planetrow["name"]." [$g:$s:$i]"; ?></td></tr><tr><th width=\'80\'><img src=\'<?php echo $dpath."planeten/small/s_".$planetrow["image"].".jpg"; ?>\' height=\'75\' width=\'75\'/></th><th style=\'text-align: left\'><a href=\'#\' onclick=\'doit(6, 2, 288, 5, 1, 1)\'>Espiar</a><br /><br /><a href=\'fleet.php?galaxy=2&system=288&planet=5&planettype=1&target_mission=1\'>Atacar</a><br /><a href=\'fleet.php?galaxy=2&system=288&planet=5&planettype=1&target_mission=3\'>Transportar</a></th></tr></table>');">
      <img src="<?php echo $dpath."planeten/small/s_".$planetrow["image"].".jpg"; ?>" height="30" width="30"></a><?php
  }
?>
</th>
<th style="white-space: nowrap;" width="130">
<?php if($galaxyrow && $planetrow["destruyed"] == 0){ echo $planetrow{"name"} ;}elseif($planetrow["destruyed"] != 0){echo "Planeta destruido";} ?></th>
...
?>background-image: none;" width="30">
	...
	<a href="fleet.php?galaxy=7&amp;system=325&amp;planet=6&amp;planettype=2&amp;target_mission=8" style="cursor: pointer;" onmouseover="this.T_WIDTH=250;this.T_OFFSETX=-110;this.T_OFFSETY=-110;this.T_STICKY=true;this.T_TEMP=<?php $T_TEMP = $user["settings_tooltiptime"]*1000; echo $T_TEMP; ; ?>;return escape('<table width=\'240\'><tr><td class=\'c\' colspan=\'2\'>Escombros [7:325:6]</td></tr><tr><th width=\'80\'><img src=\'<?php echo $dpath; ?>planeten/debris.jpg\' height=\'75\' width=\'75\' alt=\'T\'/></th><th><table><tr><td class=\'c\' colspan=\'2\'>Recursos:</td></tr><tr><th>Metal:</th><th><?php echo number_format($galaxyrow["metal"],0, '', '.'); ?></th></tr><tr><th>Cristal:</th><th><?php echo number_format($galaxyrow["crystal"],0, '', '.'); ?></th></tr><tr><td class=\'c\' colspan=\'2\'>Acciones:</tr><tr><th colspan=\'2\' style=\'text-align: left\'><font color=\'#808080\'>Recolectar</font></tr></table></th></tr></table>');">
<img src="<?php echo $dpath; ?>planeten/debris.jpg" alt="Escombros" height="16" width="16"></a>
...
echo "\n\n   </th>\n    <th width=\"150\"> \n\n     ";
  ...
  ?>
<a style="cursor: pointer;" onmouseover="this.T_WIDTH=200;this.T_OFFSETX=-20;this.T_OFFSETY=-30;this.T_STICKY=true;this.T_TEMP=<?php $T_TEMP = $user["settings_tooltiptime"]*1000; echo $T_TEMP; ; ?>;return escape('<table width=\'190\'><tr><td class=\'c\' colspan=\'2\'>Jugador <?php echo $playerrow["username"];?></td></tr><tr><td><a href=\'messages.php?mode=write&id=<?php echo $playerrow["id"];?>\'>Escribir mensaje</a></td></tr><tr><td><a href=\'buddy.php?a=2&u=<?php echo $playerrow["id"];?>\'>Solicitud de compañeros</a></td></tr></table>');"><span class="noob"><?php echo $playerrow["username"];?></span></a>
...
<?php
  if($playerrow && $planetrow["destruyed"] == 0){
	if($user["settings_esp"] == "1"){
		...
		?>"><img src="<?php echo $dpath; ?>img/e.gif" alt="Espiar" title="Espiar" border="0"></a>
		<?php
	}
	if($user["settings_wri"] == "1"){
		?>
<a href="messages.php?mode=write&id=<?php echo $playerrow["id"];?>"><img src="<?php echo $dpath; ?>img/m.gif" alt="Escribir mensaje" title="Escribir mensaje" border="0"></a>
		<?php
	}
	if($user["settings_bud"] == "1"){
		?>
<a href="buddy.php?a=2&amp;u=<?php echo $playerrow["id"];?>"><img src="<?php echo $dpath; ?>img/b.gif" alt="Solicitud de compañeros" title="Solicitud de compañeros" border="0"></a>
<?php	}
  }
?></th>
</tr>
...
<table border="0"> 
  <tbody><tr>
    <td>
      <table>
        ...
        <tr>
          ...
          <td class="l"><input name="galaxy" value="<?php echo $galaxy; ?>" size="5" maxlength="3" tabindex="1" type="text">
       ...
       <table>
        <tbody><tr>
         ...
         <tr>
          ...
          <td class="l"><input name="system" value="<?php echo $system; ?>" size="5" maxlength="3" tabindex="2" type="text">
   ...
   <table width="569">
<tbody><tr>
  <td class="c" colspan="8">Sistema solar <?php echo "$galaxy:$system"; ?></td>
</tr>
   <tr>
    <td class="c">Pos</td>
