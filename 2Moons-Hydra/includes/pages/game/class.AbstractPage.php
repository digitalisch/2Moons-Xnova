...
abstract class AbstractPage 
{
	...
	protected function getNavigationData() 
    {
		...
		$this->tplObj->assign_vars(array(	
			...
			'tinyMetal_current'	=> $PLANET[$resource['901']],
			'tinyMetal_max'	=> $PLANET[$resource['901'].'_max'],
			'tinyMetal_prod'	=> $PLANET[$resource['901'].'_perhour'],
			'tinyCrystal_current'	=> $PLANET[$resource['902']],
			'tinyCrystal_max'	=> $PLANET[$resource['902'].'_max'],
			'tinyCrystal_prod'	=> $PLANET[$resource['902'].'_perhour'],
			'tinyDeuterium_current'	=> $PLANET[$resource['903']],
			'tinyDeuterium_max'	=> $PLANET[$resource['903'].'_max'],
			'tinyDeuterium_prod'	=> $PLANET[$resource['903'].'_perhour'],
			'tinyEnergy_current'	=> $PLANET[$resource['911']],
			'tinyEnergy_used'	=> $PLANET[$resource['911'].'_used'],
			'tinyDarkMatter'	=> $USER[$resource['921']],
			'planetName'	=> $PLANET['name'],
			'planetCoords1'	=> $PLANET['galaxy'],
			'planetCoords2'	=> $PLANET['system'],
			'planetCoords3'	=> $PLANET['planet'],
		));
	}
