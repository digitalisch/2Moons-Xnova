...
<div class="grid_24">
	...
	<div class="box_top">
		...
		<h2 class="icon users">{$LNG.al_manage_alliance}</h2>
...
<input type="hidden" name="send" value="1">
	...
	<div class="box_top">
		...
		<h2 class="icon users">{$LNG.al_texts}</h2>
...
<tr>
	...
	<div class="box_top">
		...
		<h2 class="icon users">{$LNG.al_manage_options}</h2>
...
{if $AllianceOwner}
	...
	<div class="box_content">
		...
		<table>
			<tbody>
	<tr>
		<td>{$LNG.al_disolve_alliance} : <form action="game.php?page=alliance&amp;mode=admin&amp;action=close" method="post"><input type="submit" value="{$LNG.al_continue}" onclick="return confirm('{$LNG.al_close_ally}');"></form></td>
	</tr>
	<tr>
		<td>{$LNG.al_transfer_alliance} : <form action="game.php?page=alliance&amp;mode=admin&amp;action=transfer" method="post"><input type="submit" value="{$LNG.al_continue}"></form></td>
	</tr>
			</tbody>
		</table>
		<!-- Plain Table: End -->
