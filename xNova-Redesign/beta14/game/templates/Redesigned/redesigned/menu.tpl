	...
	<ul id="menuTable">
		...
		<li class="menubutton_table">
			<span class="menu_icon">
				<img src="{{skin}}/img/navigation/navi_ikon_overview_{let_overview}.gif" height="29" width="38" />
			</span>
...
{empire}
		...
		<li class="menubutton_table" id="resources_menu_link" style="display:{show_resources};">
			<span class="menu_icon">
		  		<img src="{{skin}}/img/navigation/navi_ikon_resources_{let_resources}.gif" height="29" width="38" />
			</span>
		...
		<li class="menubutton_table">
			<span class="menu_icon">
		  		<img src="{{skin}}/img/navigation/navi_ikon_station_{let_station}.gif" height="29" width="38" />
			</span>
		...
		<li class="menubutton_table">
			<span class="menu_icon">
		  		<img src="{{skin}}/img/navigation/navi_ikon_trader_{let_trader}.gif" height="29" width="38" />
			</span>
		...
		<li class="menubutton_table">
			<span class="menu_icon">
		  		<img src="{{skin}}/img/navigation/navi_ikon_shipyard_{let_shipyard}.gif" height="29" width="38" />
			</span>
		...
		<li class="menubutton_table">
			<span class="menu_icon">
		  		<img src="{{skin}}/img/navigation/navi_ikon_defense_{let_defense}.gif" height="29" width="38" />
			</span>
