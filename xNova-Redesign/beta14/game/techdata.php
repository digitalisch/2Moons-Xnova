...
case 'tree':
	...
	function get_req($id,$from = '-1',$req = 1){
		...
		$get_req = "\t\t\t\t".'myTree.add('.$n.','.$from.',"<a><img src=\'{{skin}}/img/small/small_'.$id.'.jpg\' style=\'border:1px solid '.$colour.';\' /><span class=\'mrtooltip\' style=\'color:'.$colour.'\'>'.$req_txt.' - '.$lang['tech'][$id].'</span></a>",46,'.$h.');'."\n";
