<!--<?php include('login.php');?>-->
	...
	<tr>
		<td class="row1">
			<p class="breadcrumbs"><a href="#" onClick="loadpage('./home.php','XNova Forum','bodyid');">Forumoverview</a> &#187;<?php
			$forum = "{$_GET['forum']}";
			?>			
	...
	<h2><a class="titles" href="./topic.php<?php $onderwerp = "{$_GET['onderwerp']}"; $forum = "{$_GET['forum']}"; echo "?onderwerp=".$onderwerp."&forum=".$forum; ?>"><?php $onderwerp = "{$_GET['onderwerp']}"; echo $onderwerp; ?></a></h2>
	...
	?>
	<form action="wijzigant.php" method="post" name="postform">
 
<table class="tablebg" width="100%" cellspacing="0">
<caption><div class="cap-left"><div class="cap-right">&nbsp;Place a new message&nbsp;</div></div></caption>
<tr>
...
<input type="hidden" value="<?php echo "{$_GET['auteur']}"?>" name="auteur" />
<tr>
	<td class="row1" valign="top" width="22%"><b class="genmed">Message:</b><br /><span class="gensmall">Place your message here, it can't contain more than <strong>60000</strong> characters.&nbsp;</span><br /><br />
...
<tr>
	<td id="helpline">Hint: format can be used quick on selected text.&nbsp;</td>
		...
		<tr>
			<td valign="top" style="width: 100%;"><textarea name="reactie" rows="15" cols="76" tabindex="3" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" style="width: 98%;"><?php echo "{$_GET['reactie']}" ?></textarea></td>
...
<tr>
	<td class="cat" colspan="2" align="center">
		<input class="btnmain" type="submit" accesskey="s" tabindex="11" name="post" value="Change" />
	...
	<tr>
		<td class="row1">
           ...
           <?php
			$forum = "{$_GET['forum']}";
			?>			
			<a href="#" onClick="loadpage('./forums.php?forum=<?php echo $forum; ?>&p=0',document.title,document.body.id);"><?php echo $forum; ?></a></p>			<p class="datetime">Alle tijden zijn GMT + 1 uur [ Zomertijd ]</p>
		</td>
	</tr>
	</table>		<br clear="all" />
		...
		<table class="tablebg" width="100%" cellspacing="0">
		<tr>
			<td class="cat"><h4>All times are GMT</h4></td>
		</tr>
		<tr>
			<td class="row1"><span class="gensmall">Doesn't work!! Users on this forum: <a href="./memberlist.php?mode=viewprofile&amp;u=64">Warsaalk</a> en 0 gasten</span></td>
		</tr>
		</table>
