       <!-- Sidebar -->
        <nav id="sidebar">
            ...
            <center><a href="game.php?page=changelog">2Moons ({$VERSION})</a></center>
		...
		<li><a href="game.php?page=logout">{$LNG.lm_logout}</a></li>
              ...
              <li><a href="#">Modifications</a>
                    <ul class="submenu">
		<li><a href="#">Mods not found<br><br>inclues/pages/game has different page file that is not default from 2Moons Googlecode Source?</a></li>
                    </ul>
                </li>
