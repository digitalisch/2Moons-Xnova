...
<div class="titlebar"><span class="icon awesome "></span> <a href="#" class="button tiny">{$LNG.fl_fleets} {$activeFleetSlots} / {$maxFleetSlots}</a> <a href="#" class="button tiny">{$activeExpedition} / {$maxExpedition} {$LNG.fl_expeditions}</a></div>
...
<tbody>
	...
	{if !$isVacation && $FlyingFleetRow.state != 1}
		...
		<input class="button tiny" value="{$LNG.fl_send_back}" type="submit">
		</form>
		{if $FlyingFleetRow.mission == 1}
		<form action="game.php?page=fleetTable&amp;action=acs" method="post">
		<input name="fleetID" value="{$FlyingFleetRow.id}" type="hidden">
		<input class="button tiny"  value="{$LNG.fl_acs}" type="submit">
		</form>
		{/if}
	{else}
	&nbsp;-&nbsp;
...
<div class="box">
<div class="inner"> 
<div class="titlebar">{$LNG.fl_new_mission_title}</div>
<div class="contents">
...
<div class="box">
<div class="inner"> 
<div class="titlebar"><span class="w-icon">{$LNG.fl_bonus}</span></div>
<div class="contents">
...
<div class="box">
<div class="inner"> 
<div class="titlebar"><span class="icon awesome white table"></span> <span class="w-icon">ACS</span></div>
<div class="contents">
