<div id='leftmenu'>
<div id='menu' style="height: 1200px; !important">
<script language="JavaScript">
function f(target_url,win_name) {
  var new_win = window.open(target_url,win_name,'resizable=yes,scrollbars=yes,menubar=no,toolbar=no,width=900,height=500,top=0,left=0');
  new_win.focus();
}
</script>
...
<table width="110" cellspacing="0" cellpadding="0">
 ...
 <tr>
  <td>
   <div align="center"><font color="#FFFFFF">
     <a href='game.php?page=records'>Rekorde</a>
    </font></div>
  </td>
 </tr> 
 ...
 <tr>
  ...
  <a href='game.php?page=topkb'>{lm_topkb}</a>
    </font></div>
  </td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td>
   <div align="center"><font color="#FFFFFF">
     <a href='game.php?page=chat'>{chat_title}</a>
    </font></div>
...
<tr>
  <td>
   <div align="center"><font color="#FFFFFF">
     <a href='game.php?page=loteria'>Lotterie</a>
    </font></div>
  </td>
 </tr>
  <tr>
  <td>
   <div align="center"><font color="#FFFFFF">
     <a href='game.php?page=support'>{supp_header}</a>
    </font></div>
  </td>
 ...
 <tr>
  <td>
   <div align="center"><font color="#FFFFFF">
     <a href='game.php?page=banned'>Pranger</a>
    </font></div>
  </td>
 </tr>
