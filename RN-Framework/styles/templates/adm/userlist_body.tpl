...
<tr>
        ...
        <th><a href="?cmd=sort&type=urlaubs_modus">U-Mod</a></th>
        <th>{adm_ul_actio}</th>
</tr>
{adm_ul_table}
<tr>
<th class="b" colspan="11">{adm_ul_count}{adm_ul_playe}</th>
</tr>
</table>