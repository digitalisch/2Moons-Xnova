...
<tbody>
<tr>
	<td class="c" colspan="2">{ad_dlte_resources}</td>
</tr><tr>
	<th width="200">{ad_planet_id}</th>
	...
	<th colspan="2">{ad_message_alert_darkmatter}</td>
</tr><tr>
	<th colspan="2"><input type="Submit" value="{ad_dlte_resources_button}" /></th>
</tbody>
</tr>
</table>
</form>