...
includeLang('INGAME');
$raportrow 	= doquery("SELECT * FROM {{table}} WHERE `rid` = '".(mysql_escape_string($_GET["mode"]))."';", 'topkb', true);
$Page .= "<div id=\"content\">";
$Page .= "<table border=0 width=\"100%\"><tr align=\"center\"><td width=\"40%\"><h1>".$raportrow['angreifer']."</h1></td><td><h1 width=\"20%\">VS</h1></td><td width=\"40%\"><h1>".$raportrow['defender']." </h1></td></tr></table>";
