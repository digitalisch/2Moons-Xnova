...
'<font color="red">0.9c AKS V2</font>' => '- FIX : Rapidfire. (Col_Burton)
- MOD : Erweiterte Planeten,Spieler- und Mondliste im ACP. (Helmchen)
- FIX : Feldanzahl des Mondes (Chaos-fighter)
- FIX : Anzahl der Flotten in der Galaxiansicht (killerelias)
- MOD : Angriffssperre.  (Metusalem)
- FIX : Beim Kolonisieren werden mitgenommene Rohstoffe abgeliefert. (Metusalem)
- MOD : Admin aus den Recorden.(Metusalem)
- MOD : The Cleaner(angelus_ira)
- FIX : Energie FIX (Antonie)
',
'0.9c AKS' => '- FIX : Ueberarbeitete Installation (Metusalem)
- FIX : Flotten Cheat (Metusalem)
- MOD : Neue Forschung Produktionsoptimierung (Metusalem)
- FIX : Anpassen der DB:Schiffe;Verteidigung;AKS (Metusalem)
- MOD : Uebersetzen der Mo Dateien ins Deutsche (Metusalem)
- ADD : Halten (Metusalem)
- ADD : AKS (Metusalem)
- FIX : Statistik und Banner (Metusalem)
- MOD : Neues Schiff Gigarecykler (Metusalem)
',

'0.9c' => '- ADD : Position des nouveaux joueurs (Banania)
- ADD : Gestion de la protection noob (Banania)
- ADD : Gestion des debris de flottes et de defences (Banania)
- ADD : Note de l\'operateur sur un joueur (Burn)
- ADD : Inscription avec validation par mail (Nain Pitoyable)
- ADD : Captcha a l\'inscription (The P\'tit Prince)
- ADD : Bouton "max" dans flotte et defense (Sword91)
- FIX : Bug des 1+9999.... (dark_angel)
- MOD : Correction des accents (The P\tit Prince) 
',

'0.9b' => '- FIX : Correction de la BDD lors de l\'installation (The P\'tit Prince)
- FIX : Correction affichage dans la galaxie (The P\'tit Prince)
- FIX : Correction administration alliance (Sylver20, The P\'tit Prince)
- FIX : Debanne auto (sylver20)
- FIX : Mode debug (Snider)
- ADD : Bouton "Actualiser points" (Oo-Whitemars)
- FIX : Difference dans les statistiques (Snider)
- FIX : Correction bug mot de passe dans options.php (Snider)
- FIX : Abandon colonie + lune (Mixxis)
- FIX : Bug DES bouclier (Redik)
- FIX : Reseau de recherche intergalactique (Snider)
- FIX : Technologie expedition (Snider)
- FIX : Capacite des hangars (Teyla)
- ADD : Optimisation du chat??? (Jiinn)
- FIX : Changer le nom du jeu (Wicked)
- ADD : Identifier Admin, Operateur, Moderateur dans galaxie (Snider)
- FIX : Missiles infinis (Jenova11)
- MOD : Debut d\'amelioration de quelques defauts du skin (The P\'tit Prince)
- FIX : Lien "Notes" et "Annonces" (The P\'tit Prince)
- MOD : Jouer sous I.E et Opera (Kiiwi)
- FIX : Correction de l\'officier destructeur (MinoX)
- FIX : Mode vacance (Kiiwi)
',

'0.9a' => '- ADD : Protecteur Plan&egrave;taire (Raito)
- FIX : Destruction (Teyla)
- ADD : Nouveau Syst&egrave;me d\'installation (Bono)
- ADD : Supernova (Raito)
- MOD : Mission coloniser dans la galaxie (XxmangaxX)
- MOD : Message de masse (juju67)
',

'0.9' => '- FIX : Scroll dans la galaxie (Teyla)
- FIX : Ing&eacute;nieur
- FIX : Commandant (Scofield06)
- FIX : Mail Inscription (Mod de Bono...)
- FIX : Message rapports d\'espionnage (nils2rs)
- FIX : "\" dans les alliances (axool) 
- FIX : Puissance de 10 (Darkmat)
- FIX : Traduction FR de la page Alliance (Loucouss)
- ADD : Ajout de ressources, flottes et autres dans le panel admin (Dr. Isaac)
- FIX : Lien dans le leftmenu (Bono)
- ADD : Lors du ban d\'un joueurs son compte est mit en mode vacance (Raito)
',
...
- ADD: Message d\'accueil &agrave; l\'inscription (Raito)
- ADD: Affichage points raids (Raito)',
...
- Ajout de fonction sur la vue principale (Raito)',

'0.6b' => 'Divers :
- Correction & Ajouts de fonctions pour les officiers (Raito)
...
- Ajout module "Officier" (by Raito)',
...
'0.2' => 'Corrections
- Ajouts de la version 0.5 des Exploration (Raito)
