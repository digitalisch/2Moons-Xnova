        ...
        if ($_POST['action'] == $lang['namer']) {
            ...
            if (md5($_POST['pw']) == $user["password"] && $user['id_planet'] != $user['current_planet']) {
                ...
                if (CheckFleets($planetrow)){
                   $strMessage = "Planet/Mond kann nicht geloescht werden solange eine Flotte unterwegs ist!!";
        ...
        if ($user['id'] != '') {
            ...
            while ($irak = mysql_fetch_array ($iraks_query)) {
                ...
                if ($irak['zeit'] > time()) {
                    ...
                    $fpage[$irak['zeit']] .= "<tr><th><div id=\"bxxfs$i\" class=\"z\"></div><font color=\"lime\">" . date("H:i:s", $irak['zeit'] ) . "</font> </th><th colspan=\"3\"><font color=\"#0099FF\">Une attaque de missiles (" . $irak['anzahl'] . ") de " . $user_planet['name'] . " ";
            ...
            if (($galaxyrow['metal'] != 0 || $galaxyrow['crystal'] != 0) && $planetrow[$resource[219]] != 0 or $planetrow[$resource[209]] != 0) {
            ...
            $parse['lvl_up_minier'] = $LvlMinier * 1000000;
