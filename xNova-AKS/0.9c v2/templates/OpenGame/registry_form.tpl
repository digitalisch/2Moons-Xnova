...
<tr>
  <th><img src="captcha.php" id="image"><br><a href="#" onclick="document.getElementById('image').src = 'captcha.php?sid=' + Math.random(); return false">(Nouvelle image)</a></th>
  <th><input name="captcha" size="20" maxlength="20" type="text" onKeypress="
     if (event.keyCode==60 || event.keyCode==62) event.returnValue = false;
     if (event.which==60 || event.which==62) return false;"></th>
</tr>
<tr>
