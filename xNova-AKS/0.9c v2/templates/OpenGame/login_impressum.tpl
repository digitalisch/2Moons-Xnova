...
<div id="title">{impressum} von {servername}</div>
<div id="content">
<div id="contentscroll">
<table width="100%" class="gibts nicht">
<tbody align="center">
<tr>
	  <th colspan="2"><b>Domainbetreiber</b></th>
</tr><tr>
	<th>Ansprechpartner:<br>Homepage:<br>
	  Forum:<br>Email : 
	<p>Adresse:<br>
&nbsp;</th>
    <th><b>Max Mustermann</b><br><a href="http://www.deineDomain.de/" target="_blank">http://www.deineDomain.de/</a><br >
      <a href="http://www.board.deineDomain.de/" target="_blank">http://www.board.deineDomain.de</a><br><b>deine@email.de</b><p>
	Deine-Stra&szlig;e-Str. 00<br>
	12345 Stadt</th>
</tr><tr>
	 <th colspan="2"><b>Bearbeitung</b></th>
</tr><tr>
    <th>Programmierung<br>Designer<br >Webmaster<br></th>
   	<th><a href="login.php?mode=credit" target="_top">siehe Hier</a><br><a href="login.php?mode=credit" target="_top">siehe Hier</a><br >MWieners<br></th>
</tr><tr>
	 <th colspan="2"><b>Dein Game - Vorlagen</b></th>
</tr><tr>
	<th>UGamela Vorlage<br>
	  XNova Vorlage</th>
    <th>0.4 / 0.4a / 04++<br>0.7f / 0.8 / 0.8a / 0.8b / 08-Basic</th>
</tr>
<tr>
	  <th colspan="2" align="Center"><b><h2>Haftungsausschluss</h2></b></th>
</tr>
<tr>
	<th width="475" colspan="2"><strong><h2>1. Inhalt des Onlineangebotes</h2></strong><br>
...
<tr>
	<th width="475" colspan="2"><strong><h2>2. Verweise und Links</h2></strong><br>
...
<tr>
	<th width="475" colspan="2"><strong><h2>3. Urheber- und Kennzeichenrecht</h2></strong><br>
