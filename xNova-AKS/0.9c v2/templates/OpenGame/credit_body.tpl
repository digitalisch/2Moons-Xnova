...
<tr><td colspan="2" class="c"><div align="center"><img src="images/xnova.png" width="213" height="93"></div></td>
	...
	<td colspan="2" class="c"><b>{cred_link}</b></td>
</tr><tr>
	<th width="278">{cred_site}:<br>{cred_forum}:</th>
	<th width="279"><a href="http://www.xnova-reloaded.de" target="_blank">http://www.xnova-reloaded.de</a><br><a href="http://www.xnova-reloaded.de" target="_blank">http://www.xnova-reloaded.de</a></th>
</tr><tr>
