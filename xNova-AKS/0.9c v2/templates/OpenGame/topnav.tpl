...
<td>
      ...
      <table>
         <tr>
           ...
           <select id="pselector" size="1" onChange="eval('location=\''+this.options[this.selectedIndex].value+'\'');">{planetlist}
           <input style="width: 20px;" value="&gt;" onclick="eval('location=\''+pselector.options[pselector.selectedIndex+1].value+'\'');" type="button">
            <table border="1">
           </td>
         </tr>
	...
	<td class="header">
		<table width="519" border="0" cellpadding="0" cellspacing="0" class="header" id="resources" style="width: 519px;" padding-right="30">
		<tbody>
		<tr class="header">
