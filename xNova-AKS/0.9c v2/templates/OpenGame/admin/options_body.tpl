...
<tr>
	...
	<th>Angriffssperre<br></th>
	<th><input name="attack_disabled"{attack_disabled} type="checkbox" /></th>

</tr><tr>
	<th>Admin aus den Rekorden<br></th>
	<th><input name="SHOW_ADMIN_IN_RECORDS"{SHOW_ADMIN_IN_RECORDS} type="checkbox" /></th>
...
<th><textarea name="adress_bot" cols="80" rows="1" size="80" >{bot_adress}</textarea></th>
	...
	<th><input name="metal_basic_income" maxlength="10" size="10" value="{metal_basic_income}" type="text"> par heure</th>
</tr><tr>
	<th>{adm_opt_plan_base_inc}{Crystal}</th>
	<th><input name="crystal_basic_income" maxlength="10" size="10" value="{crystal_basic_income}" type="text"> par heure   </th>
</tr><tr>
	<th>{adm_opt_plan_base_inc}{Deuterium}</th>
	<th><input name="deuterium_basic_income" maxlength="10" size="10" value="{deuterium_basic_income}" type="text"> par heure   </th>
</tr><tr>
	<th>{adm_opt_plan_base_inc}{Energy}</th>
	<th><input name="energy_basic_income" maxlength="10" size="10" value="{energy_basic_income}" type="text"> par heure</th>
</tr><td colspan="2" class="c Style1">{adm_deb_opt}</td>
</tr>
<tr>
  <th><span class="Style1">{adm_deb_flotte}</span></th>
  <th><input name="Fleet_Cdr" maxlength="3" size="5" value="{Fleet_Cdr}" type="text" /></th>
</tr>
<tr>
  <th><span class="Style1">{adm_deb_defence}</span></th>
  <th><input name="Defs_Cdr" maxlength="3" size="5" value="{Defs_Cdr}" type="text" /></th>
</tr>
<td colspan="2" class="c Style1">{adm_noob_opt}</td>
<tr>
  <th><span class="Style1">{adm_noob_protec}</span></th>
  <th><input name="noobprotection" maxlength="1" size="5" value="{noobprotection}" type="text" /></th>
</tr>
<tr>
  <th><span class="Style1">{adm_noob_val_def}</span></th>
  <th><input name="noobprotectiontime" maxlength="12" size="5" value="{noobprotectiontime}" type="text" /></th>
</tr>
<tr>
  <th><span class="Style1">{adm_noob_val_multi}</span></th>
  <th><input name="noobprotectionmulti" maxlength="5" size="5" value="{noobprotectionmulti}" type="text" /></th>
</tr>
<td colspan="2" class="c Style1">{adm_pnj}</td>
<tr>
  <th><span class="Style1">{adm_GalaxyPos}</span></th>
  <th><input name="LastSettedGalaxyPos" maxlength="1" size="5" value="{LastSettedGalaxyPos}" type="text" /></th>
</tr>
<tr>
  <th><span class="Style1">{adm_SystemPos}</span></th>
  <th><input name="LastSettedSystemPos" maxlength="3" size="5" value="{LastSettedSystemPos}" type="text" /></th>
</tr>
<tr>
  <th><span class="Style1">{adm_PlanetPos}</span></th>
  <th><input name="LastSettedPlanetPos" maxlength="2" size="5" value="{LastSettedPlanetPos}" type="text" /></th><tr>
