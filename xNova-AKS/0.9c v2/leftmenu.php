...
function ShowLeftMenu ( $Level , $Template = 'left_menu') {
	...
	//Lien suppl&eacute;mentaire d&eacute;termin&eacute; dans le panel admin
	...
	//Maintenant on v&eacute;rifie si les annonces sont activ&eacute;es ou non
	if ($game_config['enable_announces'] == 1) {
		$parse['announce_link']  = "
		<tr>
			<td colspan=\"2\"><div><a href=\"annonce.php\" target=\"Hauptframe\">Biete/Suche Rohstoffe</a></div></td>
		</tr>";
	} else {
		$parse['announce_link']  = "";
	}
	...
	if ($game_config['enable_marchand'] == 1) {
		$parse['marchand_link']  = "
		<tr>
			<td colspan=\"2\"><div><a href=\"marchand.php\" target=\"Hauptframe\">Rohstoffhaendler</a></div></td>
		</tr>";
	} else {
		$parse['marchand_link']  = "";
	}
	...
	if ($game_config['enable_notes'] == 1) {
		$parse['notes_link']  = "
		<tr>
			<td colspan=\"2\"><div><a href=\"#\" onClick=\"f('notes.php', '');\" accesskey=\"c\">Notitzen</a></div></td>
		</tr>";
	} else {
		$parse['notes_link']  = "";
	}
