		...
		foreach($_POST['fmenge'] as $Element => $Count) {
			...
			if ($Count != 0) {
				...
				if ($Element == 407) {
                   ...
                   } else if($Element == 408 || $Element == 409) {
				...
				if ($CanBuildOne) {
                   ...
                   if ($Element == 408){
                    ...
                    if ($maxElement > MAX_FLEET_OR_DEFS_PER_ROW) $maxElement = MAX_FLEET_OR_DEFS_PER_ROW; 
                        $PageTable .= "<br><a href='javascript:' onclick=\"document.getElementsByName('fmenge[".$Element."]')[0].value = '$maxElement';\">(Max : {$maxElement})</a>"; $PageTable .= "</th>";
					}
				} else {
					$PageTable .= "</th>";
				}
