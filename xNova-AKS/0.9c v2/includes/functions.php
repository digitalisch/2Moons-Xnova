...
function check_urlaubmodus ($user) {
	if ($user['urlaubs_modus'] == 1) {
		message("Vous &ecirc;tes en mode vacances!", $title = $user['username'], $dest = "", $time = "3");
	}
}
...
// ----------------------------------------------------------------------------------------------------------------
//
// Routine Test de validit&eacute; d'une adresse email
//
...
// ----------------------------------------------------------------------------------------------------------------
//
// Routine Affichage d'un message administrateur avec saut vers une autre page si souhait&eacute;
//
...
// ----------------------------------------------------------------------------------------------------------------
//
// Routine Affichage d'un message avec saut vers une autre page si souhait&eacute;
//
...
// ----------------------------------------------------------------------------------------------------------------
//
// Routine d'affichage d'une page dans un cadre donn&eacute;
//
// $page      -> la page
...
function CalculateMaxPlanetFields (&$planet) {
		...
		//return $planet["field_max"] + ($planet[ $resource[41] ] * FIELDS_BY_MOONBASIS_LEVEL);
        }
}
?>
