...
function formatCR (&$result_array,&$steal_array,&$moon_int,&$moon_string,&$time_float) {
        ...
        if ($result_array['won'] == "r"){
            ...
            $result1 .= $lang['resource_take']." ".pretty_number($steal_array['metal'])." ".$lang['Metal'].", ".pretty_number($steal_array['crystal'])." ".$lang['Crystal']." ".$lang['and']." ".pretty_number($steal_array['deuterium'])." ".$lang['Deuterium']."<br />";
        }else{
        ...
        $html .= $lang['debree_field_1']." ".pretty_number($debirs_meta)." ".$lang['Metal']." ".$lang['and']." ".pretty_number($debirs_crys)." ".$lang['debree_field_2']."<br /><br />";
