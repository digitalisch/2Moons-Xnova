...
//
	...
	$QryTableAks        .= "`name` varchar(50) character set utf8 collate utf8_general_ci default NULL, ";
	$QryTableAks        .= "`teilnehmer` text character set utf8 collate utf8_general_ci, ";
	$QryTableAks        .= "`flotten` text character set utf8 collate utf8_general_ci, ";
	...
	$QryTableAks        .= "`eingeladen` varchar(255) character set utf8 collate utf8_general_ci default NULL, ";
	...
	$QryInsertConfig    .= "('OverviewNewsText'      , 'Herzlich Willkommen bei XNova' ), ";
	...
	$QryTableFleets     .= "`fleet_group` varchar(15) character set utf8 collate utf8_general_ci NOT NULL default '0', ";
	...
	$QryTableUsers      .= "`avatar` varchar(255) character set utf8 NOT NULL default '', ";
	...
	$QryTableUsers      .= "`NoteOp` text character set utf8 ";
    ...
    $QryTablevacation   .= "`id` bigint(11) NOT NULL default '0', ";
    $QryTablevacation   .= "`metal_perhour` int(11) NOT NULL default '0', ";
    $QryTablevacation   .= "`crystal_perhour` int(11) NOT NULL default '0', ";
    $QryTablevacation   .= "`deuterium_perhour` int(11) NOT NULL default '0', ";
