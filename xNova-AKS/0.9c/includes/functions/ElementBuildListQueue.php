...
change `name` `name` varchar (255) NULL COLLATE utf8_general_ci,
change `b_building_id` `b_building_id` text NULL COLLATE utf8_general_ci,
change `b_tech_id` `b_tech_id` text NULL COLLATE utf8_general_ci,
change `b_hangar_id` `b_hangar_id` text NULL COLLATE utf8_general_ci,
change `image` `image` varchar (32) DEFAULT 'normaltempplanet01' NOT NULL COLLATE utf8_general_ci,
change `b_building_queue` `b_building_queue` text NULL COLLATE utf8_general_ci,
change `unbau` `unbau` varchar (100) NULL COLLATE utf8_general_ci;
