...
function PlanetSizeRandomiser ($Position, $HomeWorld = false) {
	...
	if (!$HomeWorld) {
		...
		$RandomMin        = array (  421,    430,   434,  420,  425,  435,  455,  435,  421,  423,  458,  443,  423,  423,  423);
		$RandomMax        = array (  744,  744,  745, 745, 740, 740, 720, 719, 745, 635, 599, 595, 626, 626, 668);
