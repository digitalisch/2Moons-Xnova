...
<table width="519">
	...
	{fleet_list}
	<tr><th width="90">{moon_img}<br>{moon}</th>
	<th width="700" colspan="2"><img src="{dpath}planeten/{planet_image}.jpg" height="200" width="200"><br>{building}</th>
	<th width="90" class="s"><table class="s" align="top" border="0"><tr>{anothers_planets}<br></tr></table></th></tr>
	<tr><th>{Diameter}</th>
	...
	<th colspan="3"><div  style="border: 1px solid rgb(153, 153, 255); width: 410px;"><div  id="CaseBarre" style="background-color: {case_barre_barcolor}; width: {case_barre}px;"><font color="#CCF19F">{case_pourcentage}</font></div></th>
