...
//mise en forme du mail a envoyer
	$headers = "Reply-to: Admin@spacecombat.biz \n";
	$headers .= "From: Admin@spacecombat.biz \n";
	...
	$message_txt .= "<a href=".GAMEURL."/reg.php?mode=valid&pseudo=$UserName&clef=$clef> Link Druecken um die Registrierung abzuschliessen </a><br><br>";
	$message_txt .= "Ihre Logindaten : <br>";
	$message_txt .= "Spielername : $UserName <br>";
	$message_txt .= "Passwort : $newpass <br>";
	$message_txt .= "Danke für ihre Anmeldung <h3>".GAMEURL."login.php</h3>  <br><br>";
	$message_txt .= "Mit besten Gruessen,<br>";
	$message_txt .= "Ihr SpaceCombat Team<br>";
	$message_txt .= "<img src=".GAMEURL."/images/bann.png>";
