...
* Script by Anthony
* 
* Edit by DGLDevil for XNova
* ueberarbeitet Metusalem 21062009
*/
...
//Generic
	...
	*/
	...
	$no_fleet = "<table border=1 align=\"center\"><tr><th>Type</th></tr><tr><th>Total</th></tr><tr><th>Weapons</th></tr><tr><th>Armour</th></tr><tr><th></th>Shields</tr></table>";
	$destroyed = "<table border=1 align=\"center\"><tr><th><font color=\"red\"><strong>Vernichted!</strong></font></th></tr></table>";
...
// Now its Sonyedorlys input form. Many thanks for allowing me to use it. (Slightly edited)
	...
	$parse['crystal'] = 0;
	$parse['deuterium'] = 0;
	for ($SetItem = 109; $SetItem <= 112; $SetItem++) $parse[$SetItem] = 0;
	...
	$page = "<form action='simulator.php' method='post'><center><table><tr><td>Kampfsimulator<br />";
	$page .= "<table border=1 width=100%><tr><td class=\"c\">&nbsp;</td><td class=\"c\">Angreifer</td><td class=\"c\">Verteidiger</td></tr>";
	$page .= "<tr><td class=\"c\" colspan=\"3\">Techs</td></tr>";
	$page .= "<tr><th>Waffen</th><th><input type='text' name='military_tech_us[1]' value='".$parse['military']."'></th><th><input type='text' name='military_tech_them[0]' value='".$parse[ 109 ]."'></th></tr>";
	$page .= "<tr><th>Schilde</th><th><input type='text' name='shield_tech_us[1]' value='".$parse['defence']."'></th><th><input type='text' name='shield_tech_them[0]' value='".$parse[ 110 ]."'></th></tr>";
	$page .= "<tr><th>Panzerung</th><th><input type='text' name='defence_tech_us[1]' value='".$parse['shield']."'></th><th><input type='text' name='defence_tech_them[0]' value='".$parse[ 111 ]."'></th></tr>";
	...
	$page .= "<tr><td class=\"c\" colspan=\"3\">Ressourcen</td></tr>";
	$page .= "<tr><th>Metall</th><th>&nbsp;</th><th><input type='text' name='metal' value='".$parse['metal']."'></th></tr>";
	$page .= "<tr><th>Kristall</th><th>&nbsp;</th><th><input type='text' name='crystal' value='".$parse['crystal']."'></th></tr>";
	$page .= "<tr><th>Deuterium</th><th>&nbsp;</th><th><input type='text' name='deuterium' value='".$parse['deuterium']."'></th></tr>";
	$page .= "<tr><th colspan='3'><input type='submit' name='submit' value='Berechnen'></th></tr>";
	$page .= "</table></center></form>";
	display($page, "Kampf Simulator", false);
}
