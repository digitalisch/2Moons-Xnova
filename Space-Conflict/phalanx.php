...
if ($planetrow['planet_type'] != '3') {
	message("The sensor only works on the moon", "Error", "overview." . $phpEx, 1);
}
...
if (mysql_num_rows($fq) == "0") {
	...
	<tr>
	  <td class=c colspan=7>Last maneuvers on the moon</td>
	</tr><th>No fleet movement was detected;</th></table>";
} else {
	$page .= "<center><table>";
	$parse = $lang;
