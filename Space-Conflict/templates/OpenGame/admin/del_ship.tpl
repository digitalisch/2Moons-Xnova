...
<table width="404">
  <tbody>
    <tr>
      <td class="c" colspan="7">{adm_addship1}</td>
    </tr>
    <tr>
      <th width="20"></th>
    ...
    <tr>
      <th>5
        <th>Elite Fighter
        <th><input name="elite_fighter" type="text" value="0" /></th>
    </tr>
    <tr>
      <th>6
        <th>Cruiser
    ...
    <tr>
      <th>16
        <th>Freighter 
        <th><input name="freighter" type="text" value="0" /></th>
    </tr>
    <tr>
      <th>17
        <th>World Eater 
        <th><input name="world_eater" type="text" value="0" /></th>
    </tr>
    <tr>
