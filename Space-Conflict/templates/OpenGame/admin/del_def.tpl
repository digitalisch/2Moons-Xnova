...
<table width="404">
  <tbody>
    <tr>
      <td class="c" colspan="7">{adm_deldef1}</td>
    </tr>
    <tr>
      <th width="20"></th>
    ...
    <tr>
      <th>9
        <th>Orbital Defense Platform 
        <th><input name="orb_def_plat" type="text" value="0" /></th>
    </tr>
    <tr>
      <th>10
        <th>Anti-Balistic Missle 
        <th><input name="interceptor_misil" type="text" value="0" /></th>
    </tr>
    <tr>
      <th>11
        <th>Interplanetary Missle 
