...
<tr>
	...
	<th>{adm_opt_fleet_debris}</th>
	<th><input name="Fleet_Cdr" maxlength="8" size="10" value="{Fleet_Cdr}" type="text"></th>
</tr><tr>
	<th>{adm_opt_defs_debris}</th>
	<th><input name="Defs_Cdr" maxlength="8" size="10" value="{Defs_Cdr}" type="text"></th>
</tr><tr>
	<th>Noob Protection (0, 1)</th>
	<th><input name="noobprotection" maxlength="8" size="10" value="{noobprotection}" type="text"></th>
</tr><tr>
	<th>Noob Protection Duration</th>
	<th><input name="noobprotectiontime" maxlength="8" size="10" value="{noobprotectiontime}" type="text"></th>
</tr><tr>
...
<th><textarea name="adress_bot" cols="80" rows="1" size="80" >{bot_adress}</textarea></th>
	...
	<th><input name="initial_fields" maxlength="80" size="10" value="{initial_fields}" type="text"> Fields</th>
</tr><tr>
	<th>{adm_opt_plan_base_inc}{Metal}</th>
	<th><input name="metal_basic_income" maxlength="2" size="10" value="{metal_basic_income}" type="text"> per hour</th>
</tr><tr>
	<th>{adm_opt_plan_base_inc}{Crystal}</th>
	<th><input name="crystal_basic_income" maxlength="2" size="10" value="{crystal_basic_income}" type="text"> per hour   </th>
</tr><tr>
	<th>{adm_opt_plan_base_inc}{Deuterium}</th>
	<th><input name="deuterium_basic_income" maxlength="2" size="10" value="{deuterium_basic_income}" type="text"> per hour   </th>
</tr><tr>
	<th>{adm_opt_plan_base_inc}{Tachyon}</th>
	<th><input name="tachyon_basic_income" maxlength="2" size="10" value="{tachyon_basic_income}" type="text"> per hour   </th>
</tr><tr>
	<th>{adm_opt_plan_base_inc}{Energy}</th>
	<th><input name="energy_basic_income" maxlength="2" size="10" value="{energy_basic_income}" type="text"> per hour</th>
</tr><tr>
...
<tr>
	...
	<th>{enable_the_donate}</th>
	<th><input name="enable_donate_" size="1" value="{enable_donate}" type="text"></th>
</tr><tr>
	<th>{enable_the_source}</th>
	<th><input name="enable_source_" size="1" value="{enable_source}" type="text"></th>
</tr>
<tr>
