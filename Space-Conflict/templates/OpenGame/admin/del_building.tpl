...
<table width="404">
  <tbody>
    <tr>
      <td class="c" colspan="7">{adm_delbuilding1}</td>
    </tr>
    <tr>
      <th width="20"></th>
      <th width="130">Planet Id </th>
    ...
    <tr>
      <th>4
        <th>Tachyon Particle Accelerator 
        <th><input name="tach_accel" type="text" value="0" /></th>
    </tr>
    <tr>
      <th>5
        <th>Solar Plant
    ...
    <tr>
      <th>13
        <th>Tachyon Containmment Center
        <th><input name="tachyon_store" type="text" value="0" /></th>
    </tr>
    <tr>
      <th>14
        <th>Research Lab   
    ...
    <tr>
      <th>17
        <th>Orbital Shipyard
        <th><input name="orb_shipyard" type="text" value="0" /></th>
    </tr>
    <tr>
      <th>18
        <th>Missle Silo 
