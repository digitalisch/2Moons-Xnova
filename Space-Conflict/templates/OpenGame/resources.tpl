...
<tr>
	...
	<td class="k">{tachyon_basic_income}</td>
...
<tr>
	...
	<th>{Tachyon}</th>
	<th>{daily_tachyon}</th>
	<th>{weekly_tachyon}</th>
	<th>{monthly_tachyon}</th>
</tr>
</tbody>
</table>
<br>
...
<tr>
	...
	<th>{Tachyon}</th>
	<th>{tachyon_storage}</th>
	<th width="250">
		<div style="border: 1px solid rgb(153, 153, 255); width: 250px;">
		<div id="AlmDBar" style="background-color: {tachyon_storage_barcolor}; width: {tachyon_storage_bar}px;">
		&nbsp;
		</div>
		</div>
	</th>
