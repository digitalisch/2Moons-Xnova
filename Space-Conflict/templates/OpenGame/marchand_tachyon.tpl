...
function calcul() {
	...
	var Tachyon = Metal + Cristal + Deuterium;
	document.getElementById("tach").innerHTML=Tachyon;

	if (isNaN(document.forms['marchand'].elements['metal'].value)) {
		document.getElementById("tach").innerHTML="{mod_ma_nbre}";
	}
...
<input type="hidden" name="ress" value="tachyon">
<table width="569">
<tr>
