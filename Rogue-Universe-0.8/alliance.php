...
if ($_GET['mode'] == 'ainfo') {
	...
	include($ugamela_root_path . 'alliance_stat.' . $phpEx);
	/*eumele mod*/
	// codigo raro
	...
	*/
	...
	
	{
	 // Default *falta revisar...*
		...
		$lang['allykasse_metall'] = $ally['allykasse_metall'];
		$lang['allykasse_kristall'] = $ally['allykasse_kristall'];
		$lang['allykasse_deuterium'] = $ally['allykasse_deuterium'];
