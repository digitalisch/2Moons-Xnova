...
<table width="530">
<tr>
	<td class="c" >Current Production: <div id=bx class=z></div>
<div style="position:relative;left:365;top:-25;visibility:visible">{total_left_time} {pretty_time_b_hangar}</div>
	<div align="center"><input type="submit" value="Cancel Building Queue" /></div>
	<br>
</td>
</tr>
<tr>
