<div id="header_top" style="position:absolute;width:20px;left:55;top:0;visibility:visible">
<center>
<table class="header">
<tbody>
<tr class="header">
	...
	<td class="header">
		...
		<tr class="header">
            ...
            <td class="header" align="center" width="140"><img src="{dpath}images/dollar.gif" border="0" height="22" width="42"></td>
		</tr>
		<tr class="header">
            ...
            <td class="header" align="center" width="140"><i><b><font color="#ffffff">VIP Arraki</font></b></i></td>
		</tr>
		<tr class="header">
            ...
            <td class="header" align="center" width="140"><font>{arraki}</font></td>
		</tr>
		</tbody>
		</table>
	</td>
