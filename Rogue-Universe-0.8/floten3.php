...
include($ugamela_root_path . 'common.' . $phpEx);
	...
	//Test the existance of the galaxy
	if ($_POST['mission'] != 15) {
	...
	// determine the possiblities of the missions to the planets
	if ($fleetmission == 15) {
...
//	doquery("FLUSH TABLES", '');
	...
	$page  = "<br><div id=\"theLayer\" style=\"border:none;background-color:transparent;position:absolute;width:20px;left:150;top:60;visibility:visible\"><center>";
