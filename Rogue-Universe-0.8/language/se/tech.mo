...
$lang['te_dt_tx_pre'] = "Kriterier för";
...
$lang['type_mission'][5]  = "ACS Försvar";
$lang['type_mission'][6]  = "Spionage";
$lang['type_mission'][7]  = "Kolonisera";
$lang['type_mission'][8]  = "Skörda";
$lang['type_mission'][9]  = "Förstör";
...
// Technologies
	...
	115 => 'Förbränningsteknologi',
	117 => 'Impulsdrift',
	118 => 'Hyperrymdsdrift',
	120 => 'Laserteknologi',
	121 => 'Jonteknologi',
	122 => 'Plasmateknologi',
	123 => 'Intergalaktiskt Forskningsnätverk',
	124 => 'Expeditionsteknologi',
	125 => 'Alliansbaserat Forskningsnätverk',
...
//Defense                        
	...
	405 => 'Jonkannon',             
	406 => 'Plasmakanon',          
	407 => 'Liten Sköldkupol',      
	408 => 'Stor Sköldkupol',
	409 => 'Planet Försvar',      
	502 => 'Anti-Ballistiska Missiler',
	503 => 'Interplanetära Missiler',
...
$lang['res']['descriptions'] = array(
	1 => "Metall produceras i Metallgruvor, men det är inte den enda källan. Metall kan även stjälas i en attack eller återvinnas ur ett Vrakfält.",
	2 => "Kristaller är den huvudsakliga resursen för att utveckla bla. kretskort till datorer och annan likvärdig hårdvara.",
	3 => "Deuterium är en väteatom med en extra neutron och passar särskilt bra som bränsle till skepp p.g.a. den höga energivinsten från reaktionen vid en Deuterium-Tritium-fusion.",
	4 => "Gigantiska solpaneler används för att utvinna Energi till dina gruvor och Deuteriumplattformar.",
	12 => "I Fusionskraftverken slås två väteatomer, under extremt högt tryck och extremt hög temperatur, ihop och bildar en heliumatom.",
	14 => "Robotfabriken tillverkar robotar som används till att uppgradera byggnader. Varje uppgradering av Robotfabriken ökar antalet robotar som används till byggnadskonstruktioner.",
	15 => "Denna fabrik producerar saker som är den ultimata revolutionen inom robotteknologin. Varje level halverar konstruktionstiden för Byggnader, Skepp och Försvar.",
	21 => "Det planetära skeppsvarvet är ansvarigt för att bygga rymdskepp och försvarssystem.",
	22 => "Denna byggnad är ett gigantiskt lager för bruten Metall.",
	23 => "I denna byggnad lagras rå Kristall.",
	24 => "Denna byggnad är egentligen stora cisterner som är byggda speciellt för lagring av nyutvunnet Deuterium.",
	31 => "I försök till att forska fram nya teknologier behöver man forskningslabb.",
	33 => "Med hjälp av enorma mängder energi kan man återskapa stora landområden, till och med kontinenter, till användbart skick.",
	34 => "Alliansdepån förser allierade flottor med bränsle och hjälper till med försvar.",
	41 => "En måne har ingen atmosfär så månbasen måste byggas innan man kan utveckla vidare.",
	42 => "Högupplösningssensorer scannar hela strålningsspektrat vid Phalanxradarn. Högpresterande datorer mäter mikroskopiska energiflöden från skepp på planeter långt borta.",
	43 => "Månportaler är som stora sändare och mottagare, kapabla att skicka och ta emot t.o.m. de största flottorna helt utan tidsförluster.",
	44 => "Missilsilos används till att lagra ock avfyra missiler.",
	
	106 => "Information om andra planeter och månar kan ges med hjälp av denna teknik.",
	108 => "Efter varje utforskad nivå, uppgraderas flygdatorn med ytterligare en flottiljplats. Datorteknologi bör uppgraderas i takt med att ditt Imperium utökas.",
	109 => "Vapenteknologi är en av dom primära teknologierna. För varje nivå ökar din vapenstyrka med 10% av basvärdet.",
	...
	125 => "Forskare på olika planeter kommunicerar via detta nätverket, därmed ökas effektiviteten och forskning på planeter sköts separat.",
	...
	217 => "Detta är inget skepp, detta är en mindre planet.",
