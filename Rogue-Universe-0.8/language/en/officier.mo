...
$lang['NoPoints']     = "You don't have points for recruiting !";
...
$lang['Desc'][609] = "<br><br>The emperor has noticed the impressive work that you have provided to its empire. To thank you it gives you the chance to become Bunker. The Bunker is the highest award of the Mining sector of the imperial army.<br><br><font color=red>Unlocking Planet protection</font>";
...
$lang['Desc'][612] = "<br><br>The destroyer is a ruthless officer. He massacred entire planet just for pleasure. It is currently developing a new method of producing the deathstars.<br><br><font color=red>2 Titans built instead of one.</font>";
...
$lang['Desc'][615] = "<br><br>You have shown that you are the greatest conqueror of the universe. Now it is time for you, to take the place that is yours.<br><br><font color=red>Unlocking the PlanetDestroyer</font>";
