...
if (file_exists($ugamela_root_path . "includes/functions/raketenangriff.php")) {
	include($ugamela_root_path . "includes/functions/raketenangriff.php");
} elseif (file_exists("includes/functions/raketenangriff.php")) {
	include("./includes/functions/raketenangriff.php");
} elseif (file_exists("../includes/functions/raketenangriff.php")) {
	include("../includes/functions/raketenangriff.php");
} else
	die('Fatal error!');
