...
include($ugamela_root_path . 'common.' . $phpEx);
	...
	$page .= "<div id=\"theLayer\" style=\"z-index:3;border:none;background-color:transparent;position:absolute;width:20px;left:450;top:50;visibility:visible\">";
	$page .= "<br><center>";
	...
	$page .= "</tr></tbody></table>";
	$page .= "</td></tr></div>";
	$page .= "<div id=\"theLayer\" style=\"border:none;background-color:transparent;position:absolute;width:20px;left:150;top:50;visibility:visible\"><tr height='20'>";
...
//		$page .= "<th>-</th>";
	...
	if ($MaxFlottes == $MaxFlyingFleets) {
		$page .= "<div id=\"theLayer\" style=\"border:none;background-color:transparent;position:absolute;width:20px;left:150;top:50;visibility:visible\">";
		$page .= "<tr height=\"20\"><th colspan=\"9\"><font color=\"red\">".$lang['fl_noslotfree']."</font></th></tr>";
	}

	$page .= "</table></center></div>";
	$page .= "<div id=\"theLayer\" style=\"z-index:4;border:none;background-color:transparent;position:absolute;width:20px;left:30;top:63;visibility:visible\">";
	$page .= "<center>";

	// select a new mission
	$page .= "<form action=\"floten1.php\" method=\"post\">";
	$page .= "<table width=\"400\" border=\"0\" cellpadding=\"0\" cellspacing=\"1\">";
	$page .= "<tr height=\"20\">";
