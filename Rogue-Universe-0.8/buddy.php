...
if ( $s == 1 && isset( $_GET['bid'] ) ) {
	...
	if ( !$buddy ) {
		if ( strlen( $_POST['text'] ) > 5000 ) {
			message( "The text cant contain more than 5000 characters !", "Error" );
		}
...
if ( $a == 2 && isset( $u ) ) {
	...
	if ( isset( $u ) && $u["id"] != $user["id"] ) {
		...
		<div style=\"border:none;background-color:transparent;position:absolute;left:150;top:100;visibility:visible\">
		<center>
