...
//	$page .= "<div class=\"gal\" style=\"z-index:3;border:none;background-color:transparent;position:absolute;left:158;top:50;visibility:visible\">";
	$page .= ShowGalaxySelector ( $galaxy, $system );
//	$page .= "</div>";
//	$page .= "<div id=\"theLayer\" style=\"z-index:3;border:none;background-color:transparent;position:absolute;left:-20;top:150;visibility:visible\">";
	if ($mode == 2) {
