...
if (!defined('INSIDE'))
{
	...
	$QryInsertConfig    .= "('COOKIE_NAME'           , 'Spacegame'), ";
	$QryInsertConfig    .= "('game_name'             , 'Spacegame'), ";
	$QryInsertConfig    .= "('game_disable'          , '1'), ";
	$QryInsertConfig    .= "('close_reason'          , 'Updating !'), ";
	...
	$QryInsertConfig    .= "('forum_url'             , 'http://www.sitename.com' ), ";
	$QryInsertConfig    .= "('OverviewNewsFrame'     , '1' ), ";
	$QryInsertConfig    .= "('OverviewNewsText'      , 'Welcome at the ultimate game' ), ";
