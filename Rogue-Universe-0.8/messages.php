...
if ($IsUserChecked == false) {
	...
	$TitleColor    = array ( 0 => '#ffff36', 1 => '#52ff36', 2 => '#ffff36', 3 => '#52ff36', 4 => '#ffff36', 5 => '#52ff36', 15 => '#ffff36', 99 => '#52ff36', 100 => '#ABABAB'  );
	...
	switch ($MessPageMode) {
		case 'write':
			...
			if ($_POST) {
				...
				if ($error == 0) {
					$page .= "<div style=\"z-index:2;border:none;background-color:transparent;position:absolute;left:195;top:200;visibility:visible\">
<center><font color=#00FF00>".$lang['mess_sended']."<br></font></center></div>";
...
//					$_POST['text'] = str_replace('\r\n', '<br />', $_POST['text']);
		...
		case 'show':
			...
			$page .= "<td></td>";
			$page .= "<td>\n";
			$page .= "<table width=\"519\" style=\"border:none;background-color:transparent;position:absolute;left:150;top:65;visibility:visible\">";
            ...
            //fix de mensaje de error en log
		...
		default:
			...
			$page .= "<center>";
			$page .= "<br>";
			$page .= "<table width=\"569\" style=\"border:none;background-color:transparent;position:absolute;left:150;top:65;visibility:visible\">";
			$page .= "<tr>";
