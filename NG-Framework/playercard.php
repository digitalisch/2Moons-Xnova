...
includeLang('playercard');
	...
	if (preg_match("/[^A-z0-9_\-]/", $playerid) == 1) { message ("Caracteres No Permitidos", "Caracteres No Permitidos"); } //Seguridad
	if (preg_match("/[^A-z0-9_\-]/", $ownid) == 1) { message ("Caracteres No Permitidos", "Caracteres No Permitidos"); } //Seguridad
...
$parse['player_buddy']      = "<a href=\"buddy.php?mode=" . $ownid . "&amp;u=" . $playerid . "\" title=\"Freundesanfrage stellen\">". $lang['BUDDY'] ."</a>";
