...
'<font color="lime">0.8b es</font>' => 'revision 102 svn
...
-ADD: Agregado jquery.js como única entrada (evitar versiones posteriores con distintos nombres) (Pada)
...
-EXT: Readme en español y frances
-MOD: Server Info
...
-MOD/TRAD: Modificados varios templates y traducción casi total de la alianza     
-OPT: Optimización de galaxia (Marcos, Pada, http://project.xnova.es/viewtopic.php?f=10&t=465)
...
-MOD: Eliminación de uso de la tabla lunas (angelus_ira, http://project.xnova.es/viewtopic.php?f=30&t=702)
...
-FIX: Permitir solo caracteres alfanuméricos en planetas (Leeloo,http://project.xnova.es/viewtopic.php?f=10&t=45)
...
-FIX: Options, no cambie solo la contraseña (SainT, http://project.xnova.es/viewtopic.php?f=10&t=40)',
...
- MOD: Liste des joueurs dans la section admin liens sur les entêtes pour tri
- MOD: Page générale section admin avec liens sur les entêtes pour tri
