...
include($ugamela_root_path . 'common.' . $phpEx);
	...
	$query = doquery("SELECT estado FROM {{table}} where modulo='Flota'", 'modulos', true); //Sacamos el estado.
...
if(IsVacationMode($user)){
   $page .= '<table width="525" height="25" cellpadding="0" cellspacing="0" border="2" bordercolor="#FF0000"><tr><td><center><font size=2 color=red><b><blink>  '.$lang['VacationMode'].'  </blink></b></font></center></td></tr></table>';
}
//FIN FIX
