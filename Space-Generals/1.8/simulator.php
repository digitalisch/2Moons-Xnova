...
// Now its Sonyedorlys input form. Many thanks for allowing me to use it. (Slightly edited)
	...
	$page = "<form action='simulator.php' method='post'><center><table><tr><td>";
	...
	$page .= "<tr><th>Schilde</th><th><input type='text' name='shield_tech_us[1]' value='".$parse['shield']."'></th><th><input type='text' name='shield_tech_them[0]' value='".$parse[111]."'></th></tr>";

	$page .= "<tr><th>Panzerung</th><th><input type='text' name='defence_tech_us[1]' value='".$parse['defence']."'></th><th><input type='text' name='defence_tech_them[0]' value='".$parse[110]."'></th></tr>";
	...
	$page .= "<tr><th colspan='3'><input type='submit' name='submit' value='Simulieren'></th></tr>";
	$page .= "</table></center></form>";
	display($page, "Kampfsimulator", false);
}
