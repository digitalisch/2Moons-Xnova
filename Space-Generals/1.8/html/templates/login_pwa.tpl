...
<tbody>
    ...
    <th>		  <form name="form" id="form">
                                <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
                                  ...
                                  <option value="http://uni2.dark-galaxy.com/rc3/login.php?mode=pwa">Universum 1</option>
								  								<option value="http://www.deine-domain2.de/login.php?mode=pwa">Universum 2</option>
                                </select>
                              </form></th>
</tr>
  <tr>
