<script language="JavaScript">
    ...
    function fenster(target_url,win_name) {
      var new_win = window.open(target_url,win_name,'resizable=yes,scrollbars=yes,menubar=no,toolbar=no,width=600,height=480,top=0,left=0');
new_win.focus();
    }
  </script>
