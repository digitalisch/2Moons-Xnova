...
if (!defined('INSIDE'))
{
	...
	// Table Allydiplomatie
	$QryTableDiplo     = "CREATE TABLE `{{table}}` ( ";
	$QryTableDiplo    .= "`pakt_owner_id_1` bigint(11) NOT NULL, ";
	$QryTableDiplo    .= "`pakt_owner_id_2` bigint(11) NOT NULL, ";
	$QryTableDiplo    .= "`pakt_name_1` varchar(500) NOT NULL, ";
	$QryTableDiplo    .= "`pakt_name_2` varchar(500) NOT NULL, ";
	$QryTableDiplo    .= "`pakt` int(1) NOT NULL, ";
	$QryTableDiplo    .= "`akzeptiert` int(1) NOT NULL, ";
	$QryTableDiplo    .= "`zeitpunkt` bigint(15) default NULL, ";
	$QryTableDiplo    .= "`pakt_ally_id` int(5) NOT NULL, ";
	$QryTableDiplo    .= "PRIMARY KEY (`pakt_owner_id_1`,`pakt_owner_id_2`) ";
	$QryTableDiplo    .= ") ENGINE=MyISAM DEFAULT CHARSET=latin1;";
	...
	$QryInsertConfig    .= "('initial_fields'        , '230'), ";
	$QryInsertConfig    .= "('COOKIE_NAME'           , 'RocketNova'), ";
	$QryInsertConfig    .= "('game_name'             , 'Rocket Nova 1.0'), ";
	...
	$QryInsertConfig    .= "('forum_url'             , 'http://www.teamrocket.info/forum' ), ";
	$QryInsertConfig    .= "('OverviewNewsFrame'     , '1' ), ";
	$QryInsertConfig    .= "('OverviewNewsText'      , 'Willkommen bei Rocket Nova 1.0' ), ";
	...
	$QryInsertConfig    .= "('standart_galaxyansicht', '0'), ";
	...
	$QryTablePlanets    .= "`metal_perhour` double(132,8) NOT NULL default '0.00000000', ";
	$QryTablePlanets    .= "`metal_max` bigint(20) default '100000', ";
	$QryTablePlanets    .= "`crystal` double(132,8) NOT NULL default '0.00000000', ";
	$QryTablePlanets    .= "`crystal_perhour` double(132,8) NOT NULL default '0.00000000', ";
	$QryTablePlanets    .= "`crystal_max` bigint(20) default '100000', ";
	$QryTablePlanets    .= "`deuterium` double(132,8) NOT NULL default '0.00000000', ";
	$QryTablePlanets    .= "`deuterium_perhour` double(132,8) NOT NULL default '0.00000000', ";
	$QryTablePlanets    .= "`deuterium_max` bigint(20) default '100000', ";
	$QryTablePlanets    .= "`energy_used` double(132,8) NOT NULL default '0.00000000', ";
	$QryTablePlanets    .= "`energy_max` double(132,8) NOT NULL default '0.00000000', ";
	...
	$QryTablePlanets    .= "`deuterium_used` double(132,8) NOT NULL default '0.00000000', ";
	...
	$QryTableUsers      .= "`wing_id` INT( 11 ) NOT NULL DEFAULT '0', ";
	$QryTableUsers      .= "`wing_name` VARCHAR( 32 ) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL, ";
	$QryTableUsers      .= "`wing_request` INT( 11 ) NOT NULL DEFAULT '0', ";
	$QryTableUsers      .= "`wing_request_text` TEXT CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL, ";
	$QryTableUsers      .= "`wing_register_time` INT( 11 ) NOT NULL DEFAULT '0', ";
	$QryTableUsers      .= "`wing_rank_id` INT( 11 ) NOT NULL DEFAULT '0', ";
	...
	$QryTableUsers      .= "`angriffszone` bigint(11) NOT NULL DEFAULT '1',";
	$QryTableUsers      .= "`Gala` INT( 11 ) NULL DEFAULT  '0',";
	$QryTableUsers      .= "`galaxyansicht` varchar(15) character set latin1 NOT NULL default '' ";
