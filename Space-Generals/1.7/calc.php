...
$v = '1.0 RC5'; /* Version de la Calculadora */
...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="designs/xnova/formate.css"><style type="text/css">
<!--
.Stil1 {color: darkred}
-->
</style></head>
...
?>
                <table border="0" cellpadding="2" cellspacing="1" width="50%">
                    <tr>
                      ...
                      <td class="c" style="width: 15%"><b><span style="color: skyblue">Kristall</span></b></td>
                      <td class="c" style="width: 15%"><strong><span class="Stil1">Deutrium</span></strong></td>
...
?>
                    <tr>
                        ...
                        <th style="width: 15%"><span style="color: skyblue"><?=number_format($t_v[$i][1], 0, ',', '.');?></span></th>
