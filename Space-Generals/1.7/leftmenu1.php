...
function ShowLeftMenu ( $Level , $Template = 'left_menu1') {
	...
	if ($game_config['enable_announces'] == 1) {
		$parse['announce_link']  = "
		<tr>
			<td colspan=\"2\"><div><a href=\"annonces.php\" target=\"Hauptframe\">".$lang['LEFTMENU_ANNONCES']."</a></div></td>
		</tr>";
	} else {
		$parse['announce_link']  = "";
	}
	...
	if ($game_config['enable_marchand'] == 1) {
		$parse['marchand_link']  = "
		<tr>
			<td colspan=\"2\"><div><a href=\"marchand.php\" target=\"Hauptframe\">".$lang['LEFTMENU_TRADER']."</a></div></td>
		</tr>";
	} else {
		$parse['marchand_link']  = "";
	}
	...
	if ($game_config['enable_notes'] == 1) {
		$parse['notes_link']  = "
		<tr>
			<td colspan=\"2\"><div><a href=\"#\" onClick=\"f(\'notes.php\', \'Report\');\" accesskey=\"n\">".$lang['LEFTMENU_NOTES']."</a></div></td>
		</tr>";
	} else {
		$parse['notes_link']  = "";
	}
