...
$lang['nfo_name']        = "Name";
$lang['nfo_destroy']     = "Abbau einer Geb&auml;udestufe";
...
$lang['gate_ship_dispo'] = "Verf&uuml;gbar";
$lang['gate_jump_btn']   = "Aufladen";
$lang['gate_jump_done']  = "N&auml;ster Sprung durchs Sprungtor jetzt m&ouml;glich: ";
...
$lang['gate_wait_data']  = "Fehler, es gibt keine Daten, &uuml;eber das Sprungtor!";
...
$lang['info'][3]['name']          = "Deuteriumfabrik";
...
$lang['info'][43]['description']  = "Sprungtore sind riesige Transmitter, die in der Lage sind, selbst gro&szlig;e Flotten ohne Zeitverlust durch das Universum zu versenden. Diese Transmitter verbrauchen kein Deuterium, jedoch muss zwischen 2 Spr&uuml;ngen eine Stunde vergehen, da sich die Tore sonst &uuml;berhitzen w&uuml;rden. Auch ist ein Mitschicken von Ressourcen nicht m&ouml;glich. Der ganze Vorgang erfordert eine ungeheuer hoch entwickelte Technologie.";
...
$lang['info'][120]['description'] = "Laser (Lichtverst&auml;rkung durch induzierte Strahlungsemission) erzeugen einen intensiven, energiereichen Strahl von koh&auml;rentem Licht. Diese Ger&auml;te finden in allen m&ouml;glichen Bereichen ihre Anwendung, von optischen Computern bis hin zu schweren Laserwaffen, die m&uuml;helos durch Raumschiffpanzerungen schneiden. Die Lasertechnik bildet einen wichtigen Grundstein f&uuml;r die Erforschung weiterer Waffentechnologien. Voraussetzungen: Forschungslabor (Stufe 1) Energietechnik (Stufe 2).";
...
$lang['info'][124]['description'] = "Expeditionstechnik umfasst verschiedene Scanntechnologien und erm&ouml;glicht Raumschiffe diverser Gr&ouml;&szlig;en mit einem Forschungsmodul auszur&uuml;sten. Dieses beinhaltet eine Datenbank und ein voll ausgestattetes mobiles Labor. Um bei gef&auml;hrlichen Forschungsobjekten die Sicherheit des Schiffes zu gew&auml;hren, verf&uuml;gt das Forschungsmodul &uuml;ber eine eigene Energieversorgung und einen Energiefeldgenerator, der im Notfall das Forschungsmodul mit einem starken Kraftfeld umgeben kann.";
...
$lang['info'][217]['description'] = "Dieser Transporter ist zwar langsamer aber daf&uuml;r kann er jetzt mehr aufladen. Doch wenn man die richtige Forschung hat ist er fast so schnell wie der gro&szlig;e Transporter.";
$lang['info'][218]['name']        = "Sternenzerst&ouml;rer";
$lang['info'][218]['description'] = "Dieses Schiff ist eine verbesserung mehrerer Schiffe gleichzeitig.";

// ----------------------------------------------------------------------------------------------------------
// Verteidigung !
$lang['info'][401]['name']        = "Raketenwerfer";
$lang['info'][401]['description'] = "Der Raketenwerfer ist eine einfache aber kosteng&uuml;nstige Verteidigungsm&ouml;glichkeit. Da er nur eine Weiterentwicklung gew&ouml;hnlicher ballistischer Feuerwaffen ist, ben&ouml;tigt er keine weitere Forschung. Seine geringen Herstellungskosten rechtfertigen seinen Einsatz gegen kleinere Flotten, er verliert aber mit der Zeit an Bedeutung. Sp&auml;ter wird er nur noch als Schussfang hinter gro&szlig;en Gesch&uuml;tzen eingesetzt. Verteidigungsanlagen deaktivieren sich, sobald sie zu stark besch&auml;digt sind. Nach einer Schlacht betr&auml;gt die Chance bis zu 70%, dass sich ausgefallene Verteidigungsanlagen wieder Instand setzen lassen.";
$lang['info'][402]['name']        = "Leichtes Lasergesch&uuml;tz";
$lang['info'][402]['description'] = "Um die enormen Fortschritte im Bereich der Raumschifftechnologie kompensieren zu k&ouml;nnen, mussten die Forscher eine Verteidigungsanlage entwickeln, welche auch mit gr&ouml;&szlig;eren und besser ausger&uuml;steten Schiffen bzw. Flotten zurechtkommt. Dies war die Geburtsstunde des leichten Lasers. Durch den konzentrierten Beschuss eines Ziels mit Photonen konnte eine wesentlich gr&ouml;&szlig;ere Schadenswirkung erzielt werden als mit gew&ouml;hnlichen ballistischen Waffen. Um der gr&ouml;&szlig;eren Feuerkraft der neuen Schiffstypen widerstehen zu k&ouml;nnen wurde er au&szlig;erdem mit verbesserten Schilden ausgestattet. Damit die Produktionskosten dennoch gering gehalten werden konnten wurde die Struktur nicht weiter verst&auml;rkt. Der leichte Laser besitzt das beste Preis-/Leistungsverh&auml;ltnis &uuml;berhaupt und ist dadurch auch f&uuml;r weiter fortgeschrittene Zivilisationen interessant. Verteidigungsanlagen deaktivieren sich, sobald sie zu stark besch&auml;digt sind. Nach einer Schlacht betr&auml;gt die Chance bis zu 70%, dass sich die zerst&ouml;rten Verteidigungsanlagen wieder Instand setzen lassen.";
...
$lang['info'][409]['description'] = "Die Weiterentwicklung der Gro&szlig;en Schildkuppel. Sie basiert auf den gleichen Technologien kann aber wesentlich mehr Energie einsetzen um feindliche Angriffe abzuhalten.";
...
// ----------------------------------------------------------------------------------------------------------
// Raketen !
$lang['info'][502]['name']        = "Boden Luft Rakete";
...
$lang['info'][503]['name']        = "Interkontineltal Rakete";
$lang['info'][503]['description'] = "Interkontinental Raketen zerst&ouml;ren die gegnerische Verteidigung, k&ouml;nnen allerdings durch Abfangraketen zerst&ouml;rt werden! Von Interplanetarraketen zerst&ouml;rte Verteidigungsanlagen bauen sich nicht wieder auf.";
