...
function MissionCaseStay ( $FleetRow ) {
	...
	if ($FleetRow['fleet_mess'] == 0) {
		if ($FleetRow['fleet_start_time'] <= time()) {
			...
			$TargetMessage        = $lang['sys_stay_mess_start'] ."<a href=\"?action=internalGalaxy&amp;mode=3&amp;galaxy=". $FleetRow['fleet_end_galaxy'] ."&amp;system=". $FleetRow['fleet_end_system'] ."\">";
		...
		if ($FleetRow['fleet_end_time'] <= time()) {
			...
			$TargetMessage        = $lang['sys_stay_mess_back'] ."<a href=\"?action=internalGalaxy&amp;mode=3&amp;galaxy=". $FleetRow['fleet_start_galaxy'] ."&amp;system=". $FleetRow['fleet_start_system'] ."\">";
