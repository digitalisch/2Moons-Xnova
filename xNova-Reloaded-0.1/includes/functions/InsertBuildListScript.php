...
function InsertBuildListScript ( $CallProgram ) {
	...
	$BuildListScript .= "		blc.innerHTML = \"". $lang['completed'] ."<br>\" + \"<a href=". $CallProgram ."&planet=\" + pl + \">". $lang['continue'] ."</a>\";\n";
	$BuildListScript .= "		if ((ss + 6) >= aa) {\n";
	$BuildListScript .= "			window.setTimeout('document.location.href=\"". $CallProgram ."&planet=' + pl + '\";', 3500);\n";
	$BuildListScript .= "		}\n";
	$BuildListScript .= "	} else {\n";
	$BuildListScript .= "		if ( s < 0 ) {\n";
	$BuildListScript .= "			if (1) {\n";
	$BuildListScript .= "				blc.innerHTML = \"". $lang['completed'] ."<br>\" + \"<a href=". $CallProgram ."&planet=\" + pl + \">". $lang['continue'] ."</a>\";\n";
	$BuildListScript .= "				window.setTimeout('document.location.href=\"". $CallProgram ."&planet=' + pl + '\";', 2000);\n";
	$BuildListScript .= "			} else {\n";
	...
	$BuildListScript .= "			}\n";
	$BuildListScript .= "			if (1) {\n";
	$BuildListScript .= "				blc.innerHTML = h + \":\" + m + \":\" + s + \"<br><a href=". $CallProgram ."&listid=\" + pk + \"&cmd=\" + pm + \"&planet=\" + pl + \">". $lang['DelFirstQueue'] ."</a>\";\n";
	$BuildListScript .= "			} else {\n";
	$BuildListScript .= "				blc.innerHTML = h + \":\" + m + \":\" + s + \"<br><a href=". $CallProgram ."&listid=\" + pk + \"&cmd=\" + pm + \"&planet=\" + pl + \">". $lang['DelFirstQueue'] ."</a>\";\n";
	$BuildListScript .= "			}\n";
	$BuildListScript .= "		}\n";
