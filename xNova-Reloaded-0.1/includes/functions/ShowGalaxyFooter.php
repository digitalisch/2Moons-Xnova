...
function ShowGalaxyFooter ( $Galaxy, $System,  $CurrentMIP, $CurrentRC, $CurrentSP) {
	...
	$Result .= "<th colspan=8>";
	$Result .= "<a href=?action=internalFleet&amp;galaxy=".$Galaxy."&amp;system=".$System."&amp;planet=16;planettype=1&amp;target_mission=15>". $lang['gf_unknowsp'] ."</a>";
	$Result .= "</th>";
	$Result .= "</tr>";
	...
	$Result .= "<td class=c colspan=3>". $LegendPopup ."</td>";
	$Result .= "</tr>";
	...
	$Result .= "<span id=\"recyclers\">". $Recyclers ."</span> ". $lang['gf_rc_title'] ."</td>";
	$Result .= "</tr>";
	
	$Result .= "\n";
	$Result .= "<tr>";
	$Result .= "<td class=c colspan=6>&nbsp;</td>";
	$Result .= "<td class=c colspan=3>";
...
//	$Result .= "</tr>";
	...
	$Result .= "</tr>";
/*
<tr style=\"display: none;\" id=\"fleetstatusrow\"><th colspan="10"><!--<div id="fleetstatus"></div>-->
