...
function GalaxyRowPlanet ( $GalaxyRow, $GalaxyRowPlanet, $GalaxyRowUser, $Galaxy, $System, $Planet, $PlanetType ) {
	...
	if ($GalaxyRow && $GalaxyRowPlanet["destruyed"] == 0 && $GalaxyRow["id_planet"] != 0) {
		...
		$MissionType3Link = "<a href=?action=internalFleet&amp;galaxy=".$Galaxy."&amp;system=".$System."&amp;planet=".$Planet."&amp;planettype=".$PlanetType."&amp;target_mission=3>". $lang['type_mission'][3] ."</a>";
		...
		$Result .= "<tr>";
		$Result .= "<th width=80>";
		$Result .= "<img src=images/planeten/gross/". $GalaxyRowPlanet["image"] .".jpg height=75 width=75 />";
		$Result .= "</th>";
...
//		$Result .= ", STICKY, MOUSEOFF, DELAY, ". ($user["settings_tooltiptime"] * 1000) .", CENTER, OFFSETX, -40, OFFSETY, -40 );'";
		...
		$Result .= "<img src=images/planeten/gross/". $GalaxyRowPlanet["image"] .".jpg height=30 width=30>";
