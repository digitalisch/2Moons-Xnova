			...
			if ($b != '') {
				...
				if ($FleetRow["fleet_mess"] != "1") {
					if ($a[0] == "210") {
						...
						$AttackLink = "<center>";
						$AttackLink .= "<a href=\"?action=internalFleet&amp;galaxy=". $FleetRow['fleet_end_galaxy'] ."&amp;system=". $FleetRow['fleet_end_system'] ."";
						...
						$TargetMessage .= "<a href=\"?action=internalGalaxy&amp;mode=3&amp;galaxy=". $CurrentPlanet["galaxy"] ."&amp;system=". $CurrentPlanet["system"] ."\">";
						...
						$TargetMessage .= $lang['sys_mess_spy_seen_at2'];
