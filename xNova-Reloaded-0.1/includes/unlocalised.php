...
function GetGameSpeedFactor () {
	...
	return $game_config['fleet_speed'] * 14 ;
}
...
// Zeigt die Bauzeit + Text dazu an (Techwerte werden dabei berücksichtigt)
...
//Zeigt die Bauzeit + Text dazu an. Allerdings diesmal ohne Techwerte
function ShowBuildTimeWithoutTechs ($time) {
	global $lang;

	return pretty_time($time);
}

//Zeigt den Technoligiebonus an
function ShowTechBonus ($time) {
	global $lang;
...
function GetStartAdressLink ( $FleetRow, $FleetType ) {
	$Link  = "<a href=\"?action=internalGalaxy&amp;mode=3&amp;galaxy=".$FleetRow['fleet_start_galaxy']."&amp;system=".$FleetRow['fleet_start_system']."\" ". $FleetType ." >";
...
function GetTargetAdressLink ( $FleetRow, $FleetType ) {
	$Link  = "<a href=\"?action=internalGalaxy&amp;mode=3&amp;galaxy=".$FleetRow['fleet_end_galaxy']."&amp;system=".$FleetRow['fleet_end_system']."\" ". $FleetType ." >";
...
function BuildPlanetAdressLink ( $CurrentPlanet ) {
	$Link  = "<a href=\"?action=internalGalaxy&amp;mode=3&amp;galaxy=".$CurrentPlanet['galaxy']."&amp;system=".$CurrentPlanet['system']."\">";
...
function BuildHostileFleetPlayerLink ( $FleetRow ) {
	...
	$Link .= "<a href # OnClick=\"f( '?action=internalMessages&amp;mode=write&amp;id=".$FleetRow['fleet_owner']."', '');\" >";
