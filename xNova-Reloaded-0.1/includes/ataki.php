...
function walka ($CurrentSet, $TargetSet, $CurrentTechno, $TargetTechno) {
	...
	$zlom['metal']   += ((($atakujacy_zlom_poczatek['metal']   - $atakujacy_zlom_koniec['metal'])   + ($wrog_zlom_poczatek_obrona['metal']   - $wrog_zlom_koniec_obrona['metal']))   * ($game_config['Defs_Cdr'] / 100));
	$zlom['crystal'] += ((($atakujacy_zlom_poczatek['crystal'] - $atakujacy_zlom_koniec['crystal']) + ($wrog_zlom_poczatek_obrona['crystal'] - $wrog_zlom_koniec_obrona['crystal'])) * ($game_config['Defs_Cdr'] / 100));
