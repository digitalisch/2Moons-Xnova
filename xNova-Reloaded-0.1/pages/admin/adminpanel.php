		...
		if (isset($_GET['result'])) {
			switch ($_GET['result']){
				...
				case 'usr_data':
					...
					$parse['adm_sub_form2']  = "<table width=\"700\"><tbody>";
					$parse['adm_sub_form2'] .= "<tr><td colspan=\"4\" class=\"c\">".$lang['adm_colony']."</td></tr>";
					$parse['adm_sub_form2'] .= "<tr><td class=\"c\"><center>".$lang['adm_frm1_id']."</center></td>
													<td class=\"c\"><center>".$lang['adm_planet_type']."</center></td>
													<td class=\"c\"><center>".$lang['adm_position']."</center></td>
													<td class=\"c\"><center>".$lang['adm_frm1_name']."</center></td>
												</tr>";
					...
					$parse['adm_sub_form3']  = "<table width=\"700\"><tbody>";
					...
					$parse['adm_sub_form3'] .= "</tbody></table><br>";
					break;
