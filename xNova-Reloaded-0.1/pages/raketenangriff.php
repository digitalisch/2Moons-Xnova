...
$flugzeit = round(((30 + (60 * $tempvar1)) * 2500) / ($game_config['game_speed'] * 2500));
...
<meta http-equiv="refresh" content="3; URL=?action=internalGalaxy&amp;mode=3&amp;galaxy=<?php echo $g; ?>&amp;system=<?php echo $s; ?>&amp;target=<?php echo $i; ?>">
  ...
  <tbody><tr>
    <td>
      <table>
        ...
        <tr>
	<td class="l"><?php echo "<b>".$anz."</b> Interplanetarrakete".$n." wurde".$n." zum Ziel geschickt!"; ?>
        </tr>
       </tbody></table>
      </td>
      </tr>
