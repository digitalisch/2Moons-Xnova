 ...
 */
	...
	foreach ($reslist['fleet'] as $n => $i) {
		if ($i > 200 && $i < 300 && intval($_POST["ship$i"]) > "0") {
	...
	if (!$fleet['fleetlist']) {
		message($lang['fl_unselectall'], $lang['fl_error'], "?action=internalFleet", 1);
	} else {
	...
	$page .= "}\n";
	$page .= "</script>\n";
	$page .= "<form action=\"?action=internalFleet2\" method=\"post\">";
...
*/
	...
	$page .= "<tr height=\"20\">";
	$page .= "<td colspan=\"2\" class=\"c\">". $lang['fl_shortcut'] ." <a href=\"?action=internalFleetshortcut\">". $lang['fl_shortlnk'] ."</a></td>";
	$page .= "</tr>";
