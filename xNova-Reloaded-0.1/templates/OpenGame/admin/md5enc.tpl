...
<center>
<h2>{md5_title}</h2>
<form method="post" action="?action=administrativeMD5Encoder">
...
<tr>
	...
	<th width="171"><input type="text" name="md5q" value="{md5_md5}"></th>
</tr><tr>
	<th width="130">{md5_pswenc}</th>
	<th width="171"><input type="text" name="md5w" value="{md5_enc}"></th>
</tr><tr>
	<th width="130">&nbsp;</th>
