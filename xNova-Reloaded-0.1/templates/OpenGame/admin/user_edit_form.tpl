...
<tr>
	<th colspan="5"><input type="submit" name="submit" value="Änderungen speichern"></th>
</tr>
</table>
<table width="750">
<tr>
...
<tr>
        <th>13</td>
        <th>Plasmatechnik</td>
        <th><input name="buster_tech" type="text" value="{plasma_tech}" /></th>
</tr>
<tr>
        <th>14</td>
        <th>Intergalaktisches Forschungsnetzwerk</td>
        <th><input name="intergalaktic_tech" type="text" value="{intergalaktic_tech}" /></th>
</tr>
<tr>
        <th>15</td>
