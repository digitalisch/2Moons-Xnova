<center>
<br><br>
<form action="?action=internalOptions&amp;mode=change" method="post">
<table width="700">
<tbody>
{opt_adm_frame}
<tr>
	...
	<th>{lastpassword}</th>
	<th><input style="background-color:#FFFFFF" name="db_password" size="20" value="" type="password"></th>
</tr><tr>
	<th>{newpassword}</th>
	<th><input style="background-color:#FFFFFF" name="newpass1"    size="20" maxlength="40" type="password"></th>
</tr><tr>
	<th>{newpasswordagain}</th>
	<th><input style="background-color:#FFFFFF" name="newpass2"    size="20" maxlength="40" type="password"></th>
</tr><tr>
...
<tr>
	...
	<th>{tooltip_time}{seconds}</th>
	<th><input name="settings_tooltiptime" maxlength="2" size="2" value="{opt_toolt_data}" type="text"></th>
</tr><tr>
	<th>{shortcut}</th>
	<th>{show}</th>
</tr><tr>
