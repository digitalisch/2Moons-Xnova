...
<body id="page2" onload="MM_preloadImages('images/m1_act.jpg','images/m2_act.jpg','images/m3_act.jpg','images/m4_act.jpg','images/m5_act.jpg','images/m6_act.jpg')">	<div id="main">
		...
		<div id="header">
			...
			<div class="row_3">
<a href="index.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('r_1','','images/m1_act.jpg',1)"><img alt="" src="images/m1.jpg" id="r_1" /></a><a href="forum/index.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('r_2','','images/m2_act.jpg',1)"><img alt="" src="images/m2.jpg" id="r_2" /></a><a href="chat.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('r_3','','images/m3_act.jpg',1)"><img alt="" src="images/m3.jpg" id="r_3" /></a><a href="pranger.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('r_4','','images/m4_act.jpg',1)"><img alt="" src="images/m4.jpg" id="r_4" /></a><a href="gameinfos.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('r_5','','images/m5_act.jpg',1)"><img alt="" src="images/m5.jpg" id="r_5" /></a><a href="kontakt.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('r_6','','images/m6_act.jpg',1)"><img alt="" src="images/m6.jpg" id="r_6" /></a>    			</div>
		</div>
		<!-- content -->
		<div id="content">
			<div class="bgd">
					...
					<div class="article">
						<div class="wrapper">
							<div class="col_1">
								...
								<table width="572" border="0" cellspacing="0" cellpadding="0" id="table6">
  <tr>
    <td width="572">{TextPass1} {servername} {TextPass2}</td>

  </tr>
  </table>
								<br>
								<table width="572" border="0" cellspacing="0" cellpadding="0" id="table7">
  <tr>
    <td width="203">{email}:</td>
    <td width="369"> <input type="text" name="email" /></td>
  </tr>
    </table>
<br><table width="572" border="0" cellspacing="0" cellpadding="0" id="table8">
  <tr>
    <td width="572">
	<p align="center"><input name="submit" type="submit" value="{ButtonSendPass}"/></td>
