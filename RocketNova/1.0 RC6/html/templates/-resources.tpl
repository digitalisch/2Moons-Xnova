...
<tr>
	...
	<td class="k">{energy_total}</td><td class="k"></td>
	<td class="k"></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
   <td class="c" colspan="4">Schifffs-Produktion</td>
</tr><tr>
   <th>&nbsp;</th>
   <th>{Daily}</th>
   <th>{Weekly}</th>
...
{predu_fleet}
<tr>
   <td class="c" colspan="4">Verteidigungsanlagen-Produktion</td>
</tr><tr>
   <th>&nbsp;</th>
   <th>{Daily}</th>
   <th>{Weekly}</th>
