...
function GalaxyLegendPopup () {
	...
	$Result .= "</tr><tr>";
	$Result .= "<td width=220><font color=red>Admin</font></td><td><font color=red>A</font></td>";
	$Result .= "</tr><tr>";
	$Result .= "<td width=220><font color=green>Game Operator</font></td><td><font color=green>GO</font></td>";
	$Result .= "</tr><tr>";
	$Result .= "<td width=220><font color=orange>Supergame Operator</font></td><td><font color=orange>SGO</font></td>";
	$Result .= "</tr>";
	$Result .= "</table>";
