   ...
   if ($FleetRow['fleet_start_time'] <= time()) {
      ...
      if ($FleetRow['fleet_mess'] == 0) {
         ...
         //Nous y voila! l attaquant a gagne, nous allons voir ses chances de detruire la lune
            ...
            $destructionl2 = $destructionl1*sqrt($CurrentSet['214']['count']);
         ...
         //destruction de la lune dabord dans la liste des planete puis dans la liste des lunes et enfin dans la galaxie
