...
elseif ($ansicht == 3)
{
	...
	echo "	<div id=\"raum_3\" style=\"z-index: 0; position: absolute; left: 1px; right: 8px; top: 45px; height: 0px;\">
			<img src=\"images/galaxy/gala2.jpg\" border=\"4\" height=\"612\" width=\"910\">
			</div>
		 ";
	...
	while($row = mysql_fetch_assoc($query))
	{
		...
		while($row2 = mysql_fetch_assoc($query2))
		{
			...
			{
			 $mond     = "<font color=yellow>&nbsp;Mond: ja&nbsp;</font><br>";
			 $command .= "<br><a href=fleet.php?galaxy=$galaxy&system=$system&planet=$count&planettype=3&target_mission=9><font color=red>&nbsp;Mond Zerst&ouml;ren&nbsp;</font></a>";
			 $mond3    = "&nbsp;<img src=images/galaxy/mond1.gif>";
			}
			else
			{
			 $mond  = "<font color=yellow>&nbsp;Mond: nein&nbsp;</font><br>";
			 $mond3 = "";
			}
			...
			{
			 $trbild = "tr";
			 $tf = "<hr>&nbsp;Tr&uuml;mmerfeld&nbsp;<br>&nbsp;".$TFMET." Metall&nbsp;<br>&nbsp;".$TFCRY." Kristall&nbsp;<br><a href=fleet.php?galaxy=$galaxy&system=$system&planet=$count&planettype=2&target_mission=8><br>Abbau</a><br><br>";
			}
		}
	...
	if ($planetrow['colonizer'] >= 1){$siedeln = "<br><a href=fleet.php?galaxy=$galaxy&system=$system&planet=$count&planettype=1&target_mission=7>&nbsp;".$lang['siedeln']."&nbsp;</a><br>";}else{$siedeln = "";}
	...
	echo "<div id=\"99\" style=\" position: absolute; left: 20px; right: 824px; top: 100px; height: 10px;\"><a href=fleet.php?galaxy=$galaxy&system=$system&planet=16&planettype=1&target_mission=15><img src=images/galaxy/wurmloch.png height=\"30\" width=\"30\"><br>Wurmloch</a></th></div>";
...
//  $page .= ShowGalaxyFooter ( $galaxy, $system,  $CurrentMIP, $CurrentRC, $CurrentSP);
	...
	echo "	<div id=\"raum_3\" style=\"z-index: 0; position: absolute; left: 1px; right: 8px; top: 45px; height: 0px;\">
			<img src=\"images/galaxy/gala.jpg\" border=\"4\" height=\"612\" width=\"910\">
			</div>
		 ";
	...
	//	v-----v NEU v-----v
	// Die ausgew�hlte Galaxy und das System werden nun zu einer zahl addirt diese zahl wird in eine Deximalzahl umgewandelt
	...
	// 00, 01, 10 und 11 �ber und die werden mit 0-3 erstezt daraus ergiebt sich nun f�r jedes Sonnensystem eine ganz eigene nummer.
	...
	//$randomquote = mt_rand(0,count($position)-1);				<----- Aktiviren um immer eine neue zuf�llige anordnung der planeten in der Galaxy zu zeigen.
