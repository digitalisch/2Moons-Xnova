...
/*eumele mod*/
   ...
   $replacements[] = '</font>';
	...
	if ($user['ally_id'] == 0) {
		$lang['bewerbung'] = "<tr>
	  <th>Bewerben</th>
	  <th><a href=\"alliance.php?mode=apply&amp;allyid=" . $id . "\">Bewir dich Jetzt!</a></th>
...
elseif ($user['ally_id'] != 0 && $user['ally_request'] == 0) { 
	...
	*/
	...
	if ($mode == 'admin' && $edit == 'ally') { // Administrar la alianza *pendiente urgente*
		...
		$lang['Disolve_alliance'] = MessageForm("Allianz aufl&ouml;sen", "", "?mode=admin&edit=exit", $lang['Continue']);
	...
	*/
	...
	if ($mode == 'admin' && $edit == 'give') { // Als Admin austreten
        ...
        message("Kein anderes Mitglied der Allianz hat den Rechte Hand Status. Allianz kann nicht gel&ouml;scht werden.");    
    }
