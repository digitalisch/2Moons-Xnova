...
#########################################################################################################
# Alliance_diplo.php by  RedFighter, Dotsch_2005																		#
# in Version Alpha																						#
# 																										#
# Templets:																								#
# templates\OpenGame\alliance_diplo.tpl																	#
# templates\OpenGame\alliance_diplo_search.tpl															#
# templates\OpenGame\alliance_diplo_add.tpl																#
# templates\OpenGame\alliance_diplo_anfragen.tpl														#
# 																										#
# Datenbank SQL:																						#
# SET FOREIGN_KEY_CHECKS=0;																				#
# -- ----------------------------																		#
# -- Table structure for -->[dein Prefix]<--_diplo														#
# -- ----------------------------																		#
# CREATE TABLE `-->[dein Prefix]<--_diplo` (															#
#   `pakt_owner_id_1` bigint(11) NOT NULL,																#
#   `pakt_owner_id_2` bigint(11) NOT NULL,																#
#   `pakt_name_1` varchar(500) NOT NULL,																#
#   `pakt_name_2` varchar(500) NOT NULL,																#
#   `pakt` int(1) NOT NULL,																				#
#   `akzeptiert` int(1) NOT NULL,																		#
#   `zeitpunkt` bigint(15) default NULL,																#
#   PRIMARY KEY  (`pakt_owner_id_1`,`pakt_owner_id_2`)													#
# ) ENGINE=MyISAM DEFAULT CHARSET=latin1;																#
#																										#
# Funktion: 																							#
# Mit diesem Mod wird in die XNova_0.8__2.1_repack_by_Dr.Isaacs eine Diplomatische function eingefügt.  #
# Die Diplomati wird durch diesen Mod besser Unterstützt und trägt dazu bei das BNDs/NAPs/Kriege öfter	#
# genutzt und auch eingehalten werden.																	#
# 																										#
# Fehler und Verbesserungsvorschläge bitte im entsprechende Thread posten!								#
# Support auch nur über diesen Thread!																	#
# 																										#
# (c) Copyright by RedFighter, Dotsch_2005 AND XNova-Germany (www.xnova-germany.de) | 28. September 2008			#
#########################################################################################################
**/
