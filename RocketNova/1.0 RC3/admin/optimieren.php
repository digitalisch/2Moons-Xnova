<?php
   ...
   $parse['table'] .= "<tr>";
   $parse['table'] .= "<td class=\"c\" colspan=\"2\" style=\"color:#000000\"><strong>".$table."</strong></td>";
   $parse['table'] .= "<td class=\"b\" colspan=\"2\" style=\"color:red\"><strong>Nicht optimiert</strong></td>";
   $parse['table'] .= "</tr>";
      }else{
         $parse['table'] .= "<tr>";
   $parse['table'] .= "<td class=\"c\" style=\"color:#000000\"><strong>".$table."</strong></td>";
   $parse['table'] .= "<td class=\"b\" style=\"color:green\"><strong>Optimiert</strong></td>";
   $parse['table'] .= "</tr>";
      }
   }
}
   ...
   display($menu, 'Datenbank optimieren', '', false);
