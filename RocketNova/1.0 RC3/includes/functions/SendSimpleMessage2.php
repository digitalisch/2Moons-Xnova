...
/**
 * SendSimpleMessage2.php
 *
 * @version 1.4
 * @copyright 2008 by Chlorel for XNova (-1.3)
 * @copyright 2008 by Mwieners for Xnova-Germany (1.4)
 */
...
// $Class -> Wichtigkeits Stufe
//
function SendSimpleMessage2 ( $Owner, $Sender, $Time, $Type, $From, $Subject, $Message, $Class) {
	global $messfields;
	...
	$QryInsertMessage .= "`message_class` = '". $Class ."'; ";
...
// 1.4 - Class mit eingebaut, Wichtigkeits stufe! (Mwieners)
?>