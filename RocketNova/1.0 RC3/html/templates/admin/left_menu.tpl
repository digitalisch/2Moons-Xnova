...
<tr>
	...
	<td><div><a href="optimieren.php" accesskey="s" target="{mf}">Datenbank optimieren</a></div></td>
</tr
<tr>
	...
	<td><div><a href="XNovaResetUnivers.php" target="{mf}" class="Stil1" accesskey="e"><strong><blink>{adm_reset}</strong></a></div></td>
</tr><tr>
