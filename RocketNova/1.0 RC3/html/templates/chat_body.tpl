...
<tr><th><div id="shoutbox" style="margin: 5px; vertical-align: text-top; height: 305px; overflow:auto;"></div></th></tr>
...
<tr><th colspan="2"><img src="images/smileys/cry.png" align="absmiddle" title=":c" alt=":c" width="12" height="12" onClick="addSmiley(':c')">
		    ...
		    <img src="images/smileys/wink.png" align="absmiddle" title=";)" alt=";)" width="12" height="12" onClick="addSmiley(';)')">
                <img src="images/smileys/wow.png" align="absmiddle" title="wow" alt="wow" width="12" height="12" onClick="addSmiley('wow')">
                <img src="images/smileys/cool.png" align="absmiddle" title="cool" alt="cool" width="12" height="12" onClick="addSmiley('cool')">
                <img src="images/smileys/grrr.png" align="absmiddle" title="grrr" alt="grrr" width="12" height="12" onClick="addSmiley('grrr')">
		    <img src="images/smileys/shit.png" align="absmiddle" title=":s" alt=":s" width="12" height="12" onClick="addSmiley(':s')"></th></tr>

<tr><th width="60"><b>{chat_text}</b><br><i>{chat_text}</i><br><u>{chat_text}</u><br><a href="http://forum.xorbit.de" target="_blank">{chat_text}</a><br><font color="red">{chat_text}</font></th>

<th>[b]{chat_text}[/b]<br>[i]{chat_text}[/i]<br>[u]{chat_text}[/u]<br>[a=http://forum.xorbit.de]{chat_text}[/a]<br>[c=blue|yellow|green|pink|red|orange|lime]{chat_text}[/c]</th></tr>
