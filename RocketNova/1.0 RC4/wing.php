...
*
* @version 1.0
* @copyright 2008 by Anthony for Darkness of Evolution
*/
...
if ($_GET['mode'] == 'ainfo') {
   ...
   // Si no existe
   if (!$allyrow) {
      message("This alliance doesn't exist", "Allianz Information (1)");
   }
   extract($allyrow);
   ...
   if ($user['ally_id'] == 0) {
      $lang['bewerbung'] = "<tr>
     <th>Bewerben</th>
     <th><a href=\"alliance.php?mode=apply&amp;allyid=" . $id . "\">Write an application</a></th>
