...
function check_build_time($time){
	global $game_config;
   
if(intval($time) < $game_config['min_time_per_build']) $time = $game_config['min_time_per_build'];
   return $time;
}
