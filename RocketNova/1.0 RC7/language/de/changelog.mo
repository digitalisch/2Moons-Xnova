...
'<font color="red">Team</font>' => '<font color="yellow">Team Rocket Core Members</font>
Mori - Erweiterungen und Fixe
Inforcer - Grafik, PR und Delegation
col_burton - Codeoptimierung & Codebasing
TechnoMan - Assistenz und Fehlersuche
Pudel - Mod Entwickling
cookie - Troubleshooting
meikel - Codeoptimierung
Sycrog - Codebasing
<font color="yellow">Team Rocket Members</font>
darklord2009 - Grafik
marc - Game Scout
McRay2001 - Bug Tracker und Tester
Perilion - C++ Programmierer
-0815- - C++ Programmierer
<font color="yellow">Forum & Showcase Game Team</font>
Krixli - General Administrator SpaceGenerals.com
TechnoMan - Global Forum Moderator
...
etic_wum - Don Promillo - Metusalem - mwieners - Perry - xire',

'<font color="lime">1.0 RC7</font>' => 'Team Rocket
...
'0.9c' => 'Inforcer
- DIV: Interoperated SpaceGenerals 3.0 RC2 features',

'0.9b' => 'Inforcer
- FIX: Interoperated Gigra (Ugamela) features',

'0.9a' => 'Inforcer
- MOD: Interoperated xNova RC features',

'0.8h' => 'Dr.Isaacs neue exclusiv version f&uuml;r XNova-Germany
- MOD: Sky-Game Portal Login
- DIV: Einige anpassungen
- DIV: Neuer hintergrund',

'0.8g' => 'Infos (Kleinerzwerg)
...
- MOD: Sig Banner 1.0.1 by Steggi
- FIX: Minus Deuterium ( RedFighter)
- FIX: Ranglistendifferenz (RedFighter)
- FIX: Research Hack
- DIV: Diverse anpassungen im Spiel
- DIV: Ogame aus allen Script datein rausgenommen
- DIV: Urlaubsmodus repariert',

'0.8e' => 'Infos (Kleinerzwerg)
...
- FIX: Rohstoffanzeigen von Mwieners ( 2008 )
- FIX: Raketen Fix von Der_Tod + giogio ( 2008 )
- FIX: Schildkuppel Fix von &dagger;Vincent&dagger; ( 2008 )
- FIX: Geb&auml;udecheat
- FIX: Flotten zur&uuml;ckschicken
- FIX: Passwort &auml;ndern
- DIV: Diverse anpassungen im Spiel',

'0.8d' => 'Infos (Kleinerzwerg)
...
'0.8' => 'Correction de bugs (Dr.Isaacs)
