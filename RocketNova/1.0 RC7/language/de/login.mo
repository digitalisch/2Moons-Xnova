...
$lang['Multiverse']        = 'TeamRocket.info';
$lang['E-Mail']            = 'admin@teamrocket.info';
$lang['MainPlanet']        = 'Name des Hauptplanets (keine Sonderzeichen)';
$lang['GameName']          = 'Username';
$lang['Sex']              = 'Geschlecht';
$lang['accept']            = 'Ich akzeptiere die <a href="rules.html">Regeln</a>';
...
// User Send
$lang['mail_welcome']      = "Vielen Dank fuer ihre Anmeldung bei uns ({gameurl}) \nVotre Ihr Passwort ist : {password}\n\nViel Spass!\n{gameurl}";
$lang['mail_title']        = 'Anmeldung erfolgreich';
$lang['thanksforregistry'] = 'Danke f&uuml;r ihre Anmeldung! Sie k&ouml;nnen sich nun <a href="login.php">Einloggen</a> Ihre Daten erhalten sie an folgende eMail Adresse.';
...
$lang['error_rgt']        = 'Sie m&uuml;ssen den Regeln und den AGB zustimmen!<br />';
