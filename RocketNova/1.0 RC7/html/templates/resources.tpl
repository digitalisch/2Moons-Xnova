...
<tbody>
<tr>
	<td class="c" colspan="6"><br><p align="center"><b>Wirtschaft - Energie - </b>{Production_of_resources_in_the_planet}</p><br></td>
</tr><tr>
	<th height="22"></th>
...
<tbody>
<tr>
	<td class="c" colspan="3"><p align="center">{Storage_state}</p></td>
</tr><tr>
...
<tbody>
<tr>
	<td class="c" colspan="5"><p align="center">{Widespread_production}</p></td>
</tr><tr>
	<th>&nbsp;</th>
...
<tbody>
<tr>
   <td class="c" colspan="4"><p align="center">{ship_production}</p></td>
</tr><tr>
   <th>&nbsp;</th>
   <th>{Daily}</th>
   <th>{Weekly}</th>
...
{predu_fleet}
<tr>
   <td class="c" colspan="4"><p align="center">{deffend_production}</p></td>
</tr><tr>
   <th>&nbsp;</th>
   <th>{Daily}</th>
   <th>{Weekly}</th>
