...
/*
 ...
 ALTER TABLE uni1_config ADD achievements_badge int(11) NOT NULL DEFAULT '4';
 ...
 ALTER TABLE uni1_users ADD achievements_badge int(11) NOT NULL DEFAULT '0';
 ALTER TABLE uni1_users ADD achievements_badge1 int(11) NOT NULL DEFAULT '0';
 ALTER TABLE uni1_users ADD achievements_badge2 int(11) NOT NULL DEFAULT '0';
 ALTER TABLE uni1_users ADD achievements_badge3 int(11) NOT NULL DEFAULT '0';
 ALTER TABLE uni1_users ADD achievements_badge4 int(11) NOT NULL DEFAULT '0';
...
######### Badge Achievements Level 1
	...
	if($USER['achievements'] >= 20)
		{
	$db->query("UPDATE ".USERS." SET `achievements_badge1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_badge` = achievements_badge+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$achievement1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	
	$template->message(sprintf($LNG['achievements_badge1_success']),"?page=achievement",1);
...
######################################################################################
######### Badge Achievements Level 2

	if($USER['achievements_badge2'] == 0)
	{
	if($USER['achievements'] >= 35)
		{
	$db->query("UPDATE ".USERS." SET `achievements_badge2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_badge` = achievements_badge+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$achievement2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_badge2_success']),"?page=achievement",1);
		
}
	if($USER['achievements'] >= 35)
	$badge2_req1 = '<span style="color:lime">'.$LNG['achievements_badge2_require_1'].'</span>';
else
	$badge2_req1 = '<span style="color:red">'.$LNG['achievements_badge2_require_1'].'</span>';


$template->assign_vars(array(
	'badge2_req1'    	=> $badge2_req1,
	'badge2_title'    => ' <span style="color:red">'.$LNG['achievements_badge2'].'</span>',
	'badge2_img'    => ' <img border="1" src="styles/achievements/locked.png" align="top" width="80" height="80"></td>',
));
	}
	
if($USER['achievements_badge2'] == 1)
	{
$template->assign_vars(array(
	'badge2_title'    => ' <span style="color:lime">'.$LNG['achievements_badge2'].'</span>',
	'badge2_req1'    => ' <span style="color:lime">'.$LNG['achievements_badge2_done'].'</span>',
	'badge2_img'    => ' <img border="1" src="styles/achievements/badge2_done.png" align="top" width="80" height="80"></td>',
));
	}
	
######################################################################################
######### Badge Achievements Level 3

	if($USER['achievements_badge3'] == 0)
	{
	if($USER['achievements'] >= 45)
		{
	$db->query("UPDATE ".USERS." SET `achievements_badge3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_badge` = achievements_badge+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$achievement3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_badge3_success']),"?page=achievement",1);
		
}
	if($USER['achievements'] >= 45)
	$badge3_req1 = '<span style="color:lime">'.$LNG['achievements_badge3_require_1'].'</span>';
else
	$badge3_req1 = '<span style="color:red">'.$LNG['achievements_badge3_require_1'].'</span>';


$template->assign_vars(array(
	'badge3_req1'    	=> $badge3_req1,
	'badge3_title'    => ' <span style="color:red">'.$LNG['achievements_badge3'].'</span>',
	'badge3_img'    => ' <img border="1" src="styles/achievements/locked.png" align="top" width="80" height="80"></td>',
));
	}
	
if($USER['achievements_badge3'] == 1)
	{
$template->assign_vars(array(
	'badge3_title'    => ' <span style="color:lime">'.$LNG['achievements_badge3'].'</span>',
	'badge3_req1'    => ' <span style="color:lime">'.$LNG['achievements_badge3_done'].'</span>',
	'badge3_img'    => ' <img border="1" src="styles/achievements/badge3_done.png" align="top" width="80" height="80"></td>',
));
	}
...
######### Badge Achievements Level 3
	...
	if($USER['achievements_badge4'] == 0)
	{
	if($USER['achievements_badge'] == 3 && $USER['achievements_mines'] == 4 && $USER['achievements_tech'] == 4 && $USER['achievements_engine'] == 4 && $USER['achievements_colonization'] == 3 && $USER['achievements_moon'] == 3 && $USER['achievements_war'] == 3 && $USER['achievements_destroy'] == 4 && $USER['achievements_time'] == 3 && $USER['achievements_hof'] == 4 && $USER['achievements_community'] == 3 && $USER['achievements_fleet'] == 4 && $USER['achievements_darkmatter'] == 5 && $USER['achievements_planet'] == 4 && $USER['achievements_lab'] == 4)
		{
	$db->query("UPDATE ".USERS." SET `achievements_badge4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_badge` = achievements_badge+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$achievement4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_badge4_success']),"?page=achievement",1);
		
}
	if($USER['achievements_badge'] == 3 && $USER['achievements_mines'] == 4 && $USER['achievements_tech'] == 4 && $USER['achievements_engine'] == 4 && $USER['achievements_colonization'] == 3 && $USER['achievements_moon'] == 3 && $USER['achievements_war'] == 3 && $USER['achievements_destroy'] == 4 && $USER['achievements_time'] == 3 && $USER['achievements_hof'] == 4 && $USER['achievements_community'] == 3 && $USER['achievements_fleet'] == 4 && $USER['achievements_darkmatter'] == 5 && $USER['achievements_planet'] == 4 && $USER['achievements_lab'] == 4)
	$badge4_req1 = '<span style="color:lime">'.$LNG['achievements_badge4_require_1'].'</span>';
else
	$badge4_req1 = '<span style="color:red">'.$LNG['achievements_badge4_require_1'].'</span>';


$template->assign_vars(array(
	'badge4_req1'    	=> $badge4_req1,
	'badge4_title'    => ' <span style="color:red">'.$LNG['achievements_badge4'].'</span>',
	'badge4_img'    => ' <img border="1" src="styles/achievements/locked.png" align="top" width="80" height="80"></td>',
));
	}
	
if($USER['achievements_badge4'] == 1)
	{
$template->assign_vars(array(
	'badge4_title'    => ' <span style="color:lime">'.$LNG['achievements_badge4'].'</span>',
	'badge4_req1'    => ' <span style="color:lime">'.$LNG['achievements_badge4_done'].'</span>',
	'badge4_img'    => ' <img border="1" src="styles/achievements/badge4_done.png" align="top" width="80" height="80"></td>',
));
	}
...
{
	$db->query("UPDATE ".USERS." SET `achievements_mines1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$metal1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_mines1_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_mines2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$metal2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_mines2_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_mines3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$metal3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_mines3_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_mines4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$metal4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_mines4_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_tech1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_tech` = achievements_tech+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$tech1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_tech1_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_tech2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_tech` = achievements_tech+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$tech2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_tech2_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_tech3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_tech` = achievements_tech+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$tech3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_tech3_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_tech4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_tech` = achievements_tech+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$tech4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_tech4_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_engine1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_engine` = achievements_engine+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$engine1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_engine1_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_engine2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_engine` = achievements_engine+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$engine2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_engine2_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_engine3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_engine` = achievements_engine+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$engine3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_engine3_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_engine4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_engine` = achievements_engine+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$engine4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_engine4_success']),"?page=achievement",1);
...
######### Colonization Achievements Level 1
	...
	{
	$query = $db->uniquequery("SELECT count(*) AS planet_count FROM ".PLANETS." WHERE `planet_type` = '". 1 ."' AND `id_owner` = '". $USER['id'] ."';");
	$planet_count = $query['planet_count'];
	if($planet_count >=2)
		{
	$db->query("UPDATE ".USERS." SET `achievements_colonization1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_colonization` = achievements_colonization+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$colonization1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_colonization1_success']),"?page=achievement",1);
...
######### Colonization Achievements Level 2
	...
	if($planet_count >=9)
		{
	$db->query("UPDATE ".USERS." SET `achievements_colonization2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_colonization` = achievements_colonization+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$colonization2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_colonization2_success']),"?page=achievement",1);
...
######### Colonization Achievements Level 2
	...
	if($planet_count == $CONF['max_player_planets'])
		{
	$db->query("UPDATE ".USERS." SET `achievements_colonization3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_colonization` = achievements_colonization+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$colonization3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_colonization3_success']),"?page=achievement",1);
...
######### Moon Achievements Level 1
	...
	{
	$query = $db->uniquequery("SELECT count(*) AS moon_count FROM ".PLANETS." WHERE `planet_type` = '". 3 ."' AND `id_owner` = '". $USER['id'] ."';");
	$moon_count = $query['moon_count'];
	if($moon_count >=1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_moon1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_moon` = achievements_moon+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$moon1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_moon1_success']),"?page=achievement",1);
...
######### Moon Achievements Level 2
	...
	if($moon_count >=9)
		{
	$db->query("UPDATE ".USERS." SET `achievements_moon2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_moon` = achievements_moon+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$moon2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_moon2_success']),"?page=achievement",1);
...
######### Moon Achievements Level 3
	...
	if($moon_count == $CONF['max_player_planets'])
		{
	$db->query("UPDATE ".USERS." SET `achievements_moon3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_moon` = achievements_moon+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$moon3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_moon3_success']),"?page=achievement",1);
...
######### War Achievements Level 1
	...
	if($USER['wons'] >= 50)
		{
	$db->query("UPDATE ".USERS." SET `achievements_war1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_war` = achievements_war+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$war1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_war1_success']),"?page=achievement",1);
...
######### War Achievements Level 2
	...
	if($USER['wons'] >= 100)
		{
	$db->query("UPDATE ".USERS." SET `achievements_war2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_war` = achievements_war+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$war2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_war2_success']),"?page=achievement",1);
...
######### War Achievements Level 3
	...
	if($USER['wons'] >= 250 && $USER['loos'] >= 50)
		{
	$db->query("UPDATE ".USERS." SET `achievements_war3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_war` = achievements_war+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$war3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_war3_success']),"?page=achievement",1);
...
######### Destroy Achievements Level 1
	...
	if($USER['kbmetal'] >= 100000000 && $USER['kbcrystal'] >= 100000000)
		{
	$db->query("UPDATE ".USERS." SET `achievements_destroy1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_destroy` = achievements_destroy+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$destroy1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_destroy1_success']),"?page=achievement",1);
...
######### Destroy Achievements Level 2
	...
	if($USER['kbmetal'] >= 1000000000 && $USER['kbcrystal'] >= 1000000000)
		{
	$db->query("UPDATE ".USERS." SET `achievements_destroy2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_destroy` = achievements_destroy+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$destroy2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_destroy2_success']),"?page=achievement",1);
...
######### Destroy Achievements Level 3
	...
	if($USER['kbmetal'] >= 10000000000 && $USER['kbcrystal'] >= 10000000000)
		{
	$db->query("UPDATE ".USERS." SET `achievements_destroy3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_destroy` = achievements_destroy+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$destroy3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_destroy3_success']),"?page=achievement",1);
...
######### Destroy Achievements Level 4
	...
	if($USER['kbmetal'] >= 100000000000 && $USER['kbcrystal'] >= 100000000000)
		{
	$db->query("UPDATE ".USERS." SET `achievements_destroy4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_destroy` = achievements_destroy+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$destroy4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_destroy4_success']),"?page=achievement",1);
...
######### Time Achievements Level 1
	...
	if(($PLANET['b_hangar'] - 14400) > TIMESTAMP)
		{
	$db->query("UPDATE ".USERS." SET `achievements_time1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_time` = achievements_time+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$time1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_time1_success']),"?page=achievement",1);
...
######### Time Achievements Level 2
	...
	if(($PLANET['b_building'] - 43200) > TIMESTAMP)
		{
	$db->query("UPDATE ".USERS." SET `achievements_time2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_time` = achievements_time+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$time2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_time2_success']),"?page=achievement",1);
...
######### Time Achievements Level 3
	...
	if(($USER['b_tech'] - 86400) > TIMESTAMP)
		{
	$db->query("UPDATE ".USERS." SET `achievements_time3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_time` = achievements_time+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$time3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_time3_success']),"?page=achievement",1);
...
######### Hall of Fame Achievements Level 1
	...
	{
	$query = $db->uniquequery("SELECT * FROM uni1_users_to_topkb WHERE `rid` = '1' AND `role` = '1' AND `uid` = '". $USER['id'] ."';");
	if($query>1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_hof1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_hof` = achievements_hof+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$hof1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_hof1_success']),"?page=achievement",1);
...
######### Hall of Fame Achievements Level 2
	...
	{
	$query = $db->uniquequery("SELECT * FROM uni1_users_to_topkb WHERE `rid` = '2' AND `uid` = '". $USER['id'] ."';");
	if($query>1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_hof2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_hof` = achievements_hof+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$hof2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_hof2_success']),"?page=achievement",1);
...
######### Hall of Fame Achievements Level 3
	...
	{
	$query = $db->uniquequery("SELECT * FROM uni1_users_to_topkb WHERE `rid` = '3' AND `uid` = '". $USER['id'] ."';");
	if($query>1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_hof3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_hof` = achievements_hof+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$hof3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_hof3_success']),"?page=achievement",1);
...
######### Hall of Fame Achievements Level 4
	...
	{
	$query = $db->uniquequery("SELECT count(*) AS rid FROM uni1_users_to_topkb WHERE `uid` = '". $USER['id'] ."';");
	$rid = $query['rid'];
	if($rid >=10)
		{
	$db->query("UPDATE ".USERS." SET `achievements_hof4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_hof` = achievements_hof+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$hof4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_hof4_success']),"?page=achievement",1);
...
######### Community Achievements Level 1
	...
	{
	$query = $db->uniquequery("SELECT * FROM uni1_ticket WHERE `ownerID` = '".$USER['id']."';");
	$ticket = $query;
	if($ticket >=1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_community1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_community` = achievements_community+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$community1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_community1_success']),"?page=achievement",1);
...
######### Community Achievements Level 2
	...
	if($USER['ally_id'] >=1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_community2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_community` = achievements_community+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$community2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_community2_success']),"?page=achievement",1);
...
######### Community Achievements Level 3
	...
	{
	$query = $db->uniquequery("SELECT * FROM uni1_fleets WHERE `fleet_mission` = '5' AND `fleet_owner` = '". $USER['id'] ."';");
	$fleet = $query;
	if($fleet >=1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_community3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_community` = achievements_community+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$community3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_community3_success']),"?page=achievement",1);
...
######### Fleet Achievements Level 1
	...
	{
	$query = $db->uniquequery("SELECT count(*) AS attacks FROM `uni1_fleets` WHERE `fleet_mission` = '". 1 ."' AND `fleet_owner` = '". $USER['id'] ."';");
	$fleet1 = $query['attacks'];
	if($fleet1 >=5)
		{
	$db->query("UPDATE ".USERS." SET `achievements_fleet1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_fleet` = achievements_fleet+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$fleet1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_fleet1_success']),"?page=achievement",1);
...
######### Fleet Achievements Level 2
	...
	{
	$query = $db->uniquequery("SELECT * FROM uni1_fleets WHERE `fleet_mission` = '8' AND `fleet_resource_metal` = '10000000000' AND `fleet_resource_crystal` = '10000000000' AND `fleet_owner` = '". $USER['id'] ."';");
	$fleet2 = $query;
	if($fleet2 >=1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_fleet2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_fleet` = achievements_fleet+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$fleet2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_fleet2_success']),"?page=achievement",1);
...
######### Fleet Achievements Level 3
	...
	{
	$query = $db->uniquequery("SELECT * FROM uni1_fleets WHERE `fleet_mission` = '11' AND  `fleet_owner` = '". $USER['id'] ."';");
	$fleet3 = $query;
	if($fleet3 >=1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_fleet3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_fleet` = achievements_fleet+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$fleet3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_fleet3_success']),"?page=achievement",1);
...
######### Fleet Achievements Level 4
	...
	{
	$query = $db->uniquequery("SELECT * FROM uni1_fleets WHERE `fleet_mission` = '2' AND  `fleet_owner` = '". $USER['id'] ."';");
	$fleet4 = $query;
	if($fleet4 >=1)
		{
	$db->query("UPDATE ".USERS." SET `achievements_fleet4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_fleet` = achievements_fleet+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$fleet4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_fleet4_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_darkmatter1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$darkmatter1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_darkmatter1_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_darkmatter2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$darkmatter2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_darkmatter2_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_darkmatter3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$darkmatter3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_darkmatter3_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_darkmatter4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$darkmatter4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_darkmatter4_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_darkmatter5` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$darkmatter5_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_darkmatter5_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_planet1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$planet1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_planet1_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_planet2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$planet2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_planet2_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_planet3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$planet3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_planet3_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_planet4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_mines` = achievements_mines+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$planet4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_planet4_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_lab1` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_lab` = achievements_lab+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$lab1_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_lab1_success']),"?page=achievement",1);
...
if($USER['spy_tech'] >= 30)
{
	$db->query("UPDATE ".USERS." SET `achievements_lab2` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_lab` = achievements_lab+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$lab2_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_lab2_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_lab3` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_lab` = achievements_lab+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$lab3_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_lab3_success']),"?page=achievement",1);
...
{
	$db->query("UPDATE ".USERS." SET `achievements_lab4` = 1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements_lab` = achievements_lab+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `achievements` = achievements+1 WHERE `id` = ".$USER['id'].";");
	$db->query("UPDATE ".USERS." SET `darkmatter` = darkmatter + '".$lab4_darkmatter."' WHERE `id` = ".$USER['id'].";");
	$template->message(sprintf($LNG['achievements_lab4_success']),"?page=achievement",1);
...
if($USER['achievements_lab'] == 4)
	...
	$Max_MetalMine = $db->countquery("SELECT MAX(metal_mine) as metal_mine FROM uni1_planets WHERE id_owner = ".$USER['id'].";");
	$Max_CrystalMine = $db->countquery("SELECT MAX(crystal_mine) as crystal_mine FROM uni1_planets WHERE id_owner = ".$USER['id'].";");
	$Max_DeuteriumSint = $db->countquery("SELECT MAX(deuterium_sintetizer) as deuterium_sintetizer FROM uni1_planets WHERE id_owner = ".$USER['id'].";");

	// Colonization & Moon Achievements - Show the amount of moons and colonies of the user
	$MyPlanets = $db->countquery("SELECT count(*) AS planet_count FROM ".PLANETS." WHERE `planet_type` = '". 1 ."' AND `id_owner` = '". $USER['id'] ."';");
	$MyMoons = $db->countquery("SELECT count(*) AS moon_count FROM ".PLANETS." WHERE `planet_type` = '". 3 ."' AND `id_owner` = '". $USER['id'] ."';");
	
	// Destroy Achievements - Amount of destroy
	$RecMetal = $db->countquery("SELECT count(*) AS kbmetal FROM ".USERS." WHERE `id` = '". $USER['id'] ."';");
	$RecCrystal = $db->countquery("SELECT count(*) AS kbcrystal FROM ".USERS." WHERE `id` = '". $USER['id'] ."';");
	
	// Hall of Fame Achievemens - Attacks you joined
	$HallOfFame = $db->countquery("SELECT count(*) AS rid FROM uni1_users_to_topkb WHERE `uid` = '". $USER['id'] ."';");

	// Fleet Achievemens - How many fleets Am I doing?
	$FleetAmount = $db->countquery("SELECT count(*) AS fleet_id FROM uni1_fleets WHERE `fleet_owner` = '". $USER['id'] ."';");
	...
	$template->show('page.achievements.body.tpl');
 }
