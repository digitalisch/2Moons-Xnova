...
<table style="width:760px">
	...
	<tr>
		<td><center><form action="game.php?page=alliance&amp;mode=admin&amp;action=close" method="post"><input class="button" type="submit" value="{$LNG.al_continue}" onclick="return confirm('{$LNG.al_close_ally}');"></form></td>
	</tr>  
</table>
<table style="width:760px">
	<tr>
	...
	<tr>
		<td><center><form action="game.php?page=alliance&amp;mode=admin&amp;action=transfer" method="post"><input class="button" type="submit" value="{$LNG.al_continue}"></form></td>
	</tr>  
</table>
{/if}
</div>
