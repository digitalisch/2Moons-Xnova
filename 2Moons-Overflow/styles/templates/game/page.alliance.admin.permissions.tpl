...
<input type="hidden" value="1" name="send">
	...
	{/foreach}
	<tr>
		<td colspan="{$countRank + 2}"><p align=right><input class="button" type="submit" value="{$LNG.al_save}"></td>
	</tr>
	<tr>
...
<div id="new_alliance_rank" title="{$LNG.al_create_new_rank}" style="display:none;">
	...
	{/foreach}
	<tr>
				<td colspan="{$countRank + 2}"><p align=right><input class="button" type="submit" value="{$LNG.al_create}"></td>
	</tr>
	</table>
</form>
</div>
