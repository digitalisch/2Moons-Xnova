...
<h3 class="spec">{$LNG.lm_galaxy}</h3>
<div class="tabbable">
			...
			<td class="transparent">
				<table>
					...
					<tr>
						...
						<td><input class="button button-mini" name="galaxy" value="{$galaxy}" size="5" maxlength="3" tabindex="1"></td>
			...
			<td class="transparent">
				<table>
					...
					<tr>
						...
						<td><input class="button button-mini" name="system" value="{$system}" size="5" maxlength="3" tabindex="2"></td>
