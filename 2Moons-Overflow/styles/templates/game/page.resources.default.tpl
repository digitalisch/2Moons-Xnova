...
<h3 class="spec">{$LNG.lm_resources}</h3>
<div class="tabbable">
...
<tr style="height:22px">
	...
	<td style="width:10%">
		{html_options style="width:70px;" name="prod[{$productionID}]" options=$prodSelector selected=$productionRow.prodLevel}
	</td>
</tr>
{/foreach}
<tr style="height:22px">
	...
	<td><input class="button button-mini" value="{$LNG.rs_calculate}" type="submit"></td>
</tr>
<tr style="height:22px">
