...
$LNG['fl_expedition_fleets_limit']		    = 'No slots of Exploration avaliable!';
...
$LNG['error_3']= 'You do not have enough dark matter!';
$LNG['harvest'] = 'Empires Resources Collector';
$LNG['h_planets'] = 'Planet';
$LNG['h_moon'] = 'Moon';
$LNG['h_harvest'] = 'Harvest';
$LNG['h_ok']= 'Gathering of your resources was successful!';
$LNG['h_desc1'] = 'With this mod, you have the chance to gather the resources (metal, crystal, deuterium), ';
$LNG['h_desc2'] = 'of the planet did you choose to collect.';
$LNG['h_desc3'] = 'NOTE: ';
$LNG['h_desc4'] = 'Before you start a transfer, you should click on the empire, so that the raw materials are the "latest" Stand!';
$LNG['h_desc5'] = 'If you do not do this, it may happen that you may gather no resources, but the Dark Matter pay!';
$LNG['h_desc6'] = 'Each "Transfer cost you 500 Dark Matter';
$LNG['planet']							= "Planet Mod";
$LNG['p_ok']							= 'Exchange has been successfully made';
$LNG['p_s']								= 'Spread';
$LNG['p_p']								= 'Points left';
$LNG['p_desc1'] 						= 'Every Trade cost you ';
$LNG['p_desc2'] 						= ' Dark Matter!';
$LNG['p_desc3'] 						= 'Do not stay too long here, the resources you produce in that time will be lost!';

// Overall
$LNG['bank_transCoast']	= 'Transfer cost:';
$LNG['bank_tcShort']	= 'DM';
$LNG['bank_ressm']		= 'Metal:';
$LNG['bank_ressc']		= 'Crystal:';
$LNG['bank_ressd']		= 'Deuterium:';
$LNG['bank_ress']		= 'Ressourcen in der Bank';
$LNG['bank_in']			= 'Deposit';
$LNG['bank_out']		= 'Pay off';
$LNG['bank_storage']	= 'Free space:';

// Overview
$LNG['bank']			= 'Bank';
$LNG['bank_info']		= 'Resources can be stored in the bank, but every tansaction will cost you some amount of dark matter.';
$LNG['bank_choice']		= 'What would you like to do?';

// In
$LNG['bank_in_header']	= 'Deposit resource';
$LNG['bank_in_info']	= 'Attention, transfers cost dark matter.';

// Out
$LNG['bank_out_header']	= 'Resource pay off';

// Error
$LNG['error_1']			= 'Not this way!';
$LNG['error_2']			= 'You need to enter some!';
$LNG['error_3']			= 'You don`t have enough Dark Matter!';
$LNG['error_in_1']			= 'you don`t have enough Metal on the planet!';
$LNG['error_in_2']			= 'you don`t have enough Crystal on the planet!';
$LNG['error_in_3']			= 'you don`t have enough Deuterium on the planet!';
$LNG['error_out_1']			= 'you don`t have enough Metal in the bank!';
$LNG['error_out_1']			= 'you don`t have enough Crystal in the bank!';
$LNG['error_out_1']			= 'you don`t have enough Deuterium in the bank!';
