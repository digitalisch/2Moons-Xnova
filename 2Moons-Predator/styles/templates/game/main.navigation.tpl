<div id="leftmenu">
	<ul id="menu">
		<li><img src="{$dpath}img/menu-logo.png" alt=""></li>
		<li class="menucat1-head"></li><b>
		<li><a href="game.php?page=achievements"style="color:red"><em>Achievements</em></a></li>
		<li><a href="game.php?page=bonus">{$LNG.lm_Bonus}</a></li>
...
<li><a href="game.php?page=moonbuy"style="color:yellow"><em>Buy Moon</em></a></li>
<li><a href="game.php?page=res"style="color:yellow"><em>Buy Resources</em></a></li>
<li><a href="game.php?page=banco"style="color:yellow"><em>Bank</em></a></li>
<li><a href="game.php?page=harvest"style="color:yellow"><em>Harvest</em></a></li>
<li><a href="game.php?page=premium"style="color:lime"><em>Premium Trader</em></a></li>
