...
{block name="content"}
	<table style="border: 2px solid black;">
		...
		<tr>
		<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$LNG.p_desc1}{$transcoasts}{$LNG.p_desc2}"></td>
		<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$LNG.p_desc3}"></td>
		<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$LNG.p_desc1}{$transcoasts}{$LNG.p_desc2}"></td>
		</tr>
		</table>
	<table style="border: 2px solid black;">
				...
				<form method="post" action="">
					...
					<table style="border: 2px solid black;">
						<tbody>
							...
							<table style="border: 2px solid black;"><br>
								<tr>
