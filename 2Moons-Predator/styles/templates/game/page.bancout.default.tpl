...
<tbody><th colspan="2" style="text-align:center"><tr>
        <td colspan="2">
    ...
    <tr>
        ...
        <td>
         Here you may withdraw your banked resources and add it to your planets resources to spend.<br><br>
Each withdraw will cost u nothing.<br>
...
<tr><th>Metal</th><th>Crystal</th><th>Deuterium</th></tr>
        ...
        <tr><td colspan="3">
        <button type="submit" name="deposit" class="button" style="height:25px;">Withdraw!</button>
    </td></tr><th colspan="3" style="text-align:center"></table>
        </form>
