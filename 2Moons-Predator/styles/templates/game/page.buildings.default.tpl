...
<table style="width:650px">
	...
	<tr>
		<td>
			<table style="width:100%">
				<tr>
					<td class="transparent left" style="width:80%;padding:10px;"><p>{$LNG.shortDescription.{$ID}}</p>
  ...
  <form action="game.php?page=buildings" method="post" class="build_form">
    <input type="hidden" name="cmd" value="insert">
    <input type="hidden" name="building" value="{$ID}">
    <button type="submit" class="build_submit">Construct</button><br>
    <input type="text" id="building_anz{$ID}" name="building_anz" value="1" style="width:30px;">
  </form>
      							{else}
