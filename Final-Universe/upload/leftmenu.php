...
$parse['DILIZIUM_LINK'] = '<tr><td><div align="center"><a href="dilizium.php" target="'.$mf.'"><font color="gold">Dilizium Speicher</font></a></div></td></tr>';

$parse['ADMIN_LINK'] = ($user['authlevel'] > 0)?'<tr><td><div align="center"><a href="admin/leftmenu.php" target="_self"><font color="lime">Admin</font></a></div></td></tr>':'';
