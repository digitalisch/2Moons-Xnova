 ...
 if ($_POST['resetall']	!=	'on')
 {
	...
	if ($_POST['ships']	==	'on'){
		doquery("UPDATE {{table}} SET `small_ship_cargo` = '0', `big_ship_cargo` = '0', `light_hunter` = '0',
									...
									`dearth_star` = '0', `battleship` = '0', `supernova` = '0', `nave_de_asalto` = '0'", "planets");
		$Log	.=	$lang['log_ships']."\n";}
	...
	if ($_POST['edif_p']	==	'on'){
		doquery("UPDATE {{table}} SET `metal_mine` = '0', `crystal_mine` = '0', `deuterium_sintetizer` = '0',
									`solar_plant` = '0', `darkmatter_mine` = '0', `fusion_plant` = '0', `robot_factory` = '0',
									`nano_factory` = '0', `hangar` = '0', `metal_store` = '0',
									`crystal_store` = '0', `deuterium_store` = '0', `darkmatter_store` = '0', `laboratory` = '0',
	...
	if ($_POST['edif_l']	==	'on'){
		doquery("UPDATE {{table}} SET `mondbasis` = '0', `phalanx` = '0', `sprungtor` = '0',
									...
									`deuterium_store` = '0', `darkmatter_store` = '0', `ally_deposit` = '0' WHERE `planet_type` = '3'", "planets");
	...
	if ($_POST['resources']	==	'on'){
		doquery("UPDATE {{table}} SET `metal` = '0', `crystal` = '0', `deuterium` = '0', `darkmatter` = '0'", "planets");
