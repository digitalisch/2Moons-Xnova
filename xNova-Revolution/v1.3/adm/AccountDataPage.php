	...
	if ($_GET)
	{
		...
		else
		{
			...
			"id,username,email,email_2,authlevel,id_planet,galaxy,system,planet,user_lastip,ip_at_reg,user_agent,register_time,onlinetime,noipcheck,urlaubs_modus,
			 ...
			 rpg_commandant,rpg_stockeur,rpg_defenseur,rpg_destructeur,rpg_general,rpg_bunker,rpg_raideur,rpg_empereur,bana,banaday";
			...
			$SpecifyItemsP	=	
				...
				metal_mine,crystal_mine,deuterium_sintetizer,solar_plant,darkmatter_mine,fusion_plant,robot_factory,nano_factory,hangar,metal_store,crystal_store,deuterium_store,darkmatter_store,
				...
				spy_sonde,bomber_ship,solar_satelit,destructor,dearth_star,battleship,supernova,nave_de_asalto,misil_launcher,small_laser,big_laser,gauss_canyon,ionic_canyon,
			...
			while ($PlanetsWhile	=	mysql_fetch_array($PlanetsQuery))
			{
				...
				{	
					...
					<tr>
						...
						<th><a title=\"".pretty_number($PlanetsWhile['darkmatter'])."\">".shortly_number($PlanetsWhile['darkmatter'])."</a></th>
					...
					<tr>
						...
						<th width=\"10%\"><a title=\"".pretty_number($PlanetsWhile['darkmatter_mine'])."\">".shortly_number($PlanetsWhile['darkmatter_mine'])."</a></th>
						...
						<th width=\"10%\"><a title=\"".pretty_number($PlanetsWhile['darkmatter_store'])."\">".shortly_number($PlanetsWhile['darkmatter_store'])."</a></th>
