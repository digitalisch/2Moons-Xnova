...
'<font color="99cc00">RV 1.3<br><font size="1" face="arial">TUNING</font></font>' => '02/04/10
-[Comp] Materia Oscura (by brayan narvaez).-
---> [Add] Mina de materia oscura (by brayan narvaez).-
---> [Add] Almacen de materia oscura (by brayan narvaez).-
---> [Add] Agregar mina de materia oscura,contenedor de materia oscura y la nave corbeta desde el cpanel.-
---> [Add] Materia oscura puede ser robada en ataques (by brayan narvaez).-
---> [Add] Materia oscura puede transportarse  (by brayan narvaez).-
---> [Add] Materia oscura queda en escombros de batallas y puede reciclarse  (by brayan narvaez).-
---> [Add] Las naves, defensas, investigaciones y edificios pueden ser pagados con materia oscura  (by brayan narvaez).-
---> [Add] Se muestra en el panel de administración lo de materia oscura  (by brayan narvaez).-
---> [Add] Producción del recurso  (by brayan narvaez).-
---> [Add] Materia oscura se muestra en los reportes de espionaje  (by brayan narvaez).-
- [Add] Cuando hace falta el laboratorio y el hangar no solo aparece un texto, sale un cuadro de tipo edificio con descripcion, indicaciones para construir e imagen del edificio.-
- [Add] Pagina de creditos.-

- [Cambio] Oficiales paga por creditos.-
- [Cambio] Mejora en el redondeo de los numeros comprimidos (by Ropnom).-
- [Cambio] El reloj y el planetmenu se dividen como un unico frame por el skin al resto del cuerpo del juego.-
- [Cambio] Imagen de construccion en edficios.-
- [Cambio] Materia oscura se consigue en expediciones como un recurso normal.-
- [Cambio] Ahora la materia oscura es de la tabla de planetas, no de usuarios y pertenece a currentplanet.-
- [Cambio] La tecnologia de Expediciones se puede usar para colonizar por cada nivel se puede colonizar +1 colonia.-
- [Cambio] Oficiales solo hay 5.-
- [Cambio] Imagenes small de planetas.-
- [Cambio] Ligera optimización en la instalación.-

- [Novedad] Sistema de creditos (by brayan narváez).-
- [Novedad] Nuevo diseño de oficiales (by xsgames y brayan narváez).-
- [Novedad] Nuevo diseño de hangar (by brayan narváez).-
- [Novedad] Nuevo diseño de defensas (by brayan narváez).-
- [Novedad] Nuevo diseño de galaxia (by brayan narváez).-
- [Novedad] Nuevo diseño de pageinfo (ya esta preparado para fusionar con mensajes).-
- [Novedad] Nuevo diseño de mensajes (ya esta preparado para fusionar con alianzas).-
- [Novedad] Inesperada optimización a causa del skin, que es muy ligero el juego va mas rápido (by cosas de la vida...).-
- [Novedad] Nuevos diseños paginas mercader, oficiales, imperio, recursos y flotas.-
- [Novedad] Hora local en el topnav.-
- [Novedad] Officiales en el Topnav.-
- [Novedad] Mejoras en el Topnav.-
- [Novedad] Ahora los oficiales se activan.-
- [Novedad] Toltip en recursos.-
- [Novedad] Mensajes ahora se muestran en la vision general.-
- [Novedad] Se saco la luna del planet menu.-
- [Novedad] Left Menu reducido.-
- [Novedad] Estadisticas de usuario en el topbar.-
- [Novedad] Nueva interfaz.-
--[Add] Overscroll automatico, da otra forma de ver el juego mucho mas comoda y optimizada.-
--[Add] Menu izquierdo y tablas.-
--[Add] Resoluciones del skin soportadas hasta 1900 x 1200px.-
--[Add] Posibilidad de mas skins en opciones.-
--[Add] Cambio en el sistema de templates.-
- [Novedad] Algunas nuevas imagenes.-
- [Novedad] Sensor de espionaje y Ataque.-

- [Fix][Bug #4] Al guardar algo en opciones,se guarda correctamente Problemas del class.ShowOptionsPage .-
- [Fix][Bug #16] Sacs Al 100%.-
- [Fix][Bug #18] Imperio vision desencuadre total.-
- [Fix][Bug #19] Phalanx No mostraba correctamente el enlaze.-
- [Fix][Bug #----] El javascript se desactiva del servidor.-
- [Fix][Bug #----] Error grafico en el mensaje de servidor cerrado.-
- [Beta-Fix] Tiempos de regreso, pero no funciona bien para mision mantener posicion.
- [Fix] 3 Mysql Injection en alianza (resolved by team http://www.futuria-space.com)
- [Fix] Cola en el hangar no se actualiza al cambiar los rates (resolved by team http://www.futuria-space.com)
- [Fix][Bug #6] Ataques siempre quedan en empates.-
',


'RV 1.2<br><font size="1" face="arial">ESTABLE</font>' => '12/03/10
- [Mod_Plug] Chatarrero.-
- [Mod_Plug] Sistema de Soporte.-

- [Novedad] Mercader con manteria oscura.-
...
- [Mod] Mensaje al fundador de la alianza cuando hay solicitud de ingreso.-
- [Mod] Boton Cancelar en Hangar y Defensas.-
- [Mod] Ahora el usuario que tenga Internet Explorer le saldra un mensaje en el login para que se cambie a Firefox o Safari 4 (by brayan narvaez).-
- [Mod] Sistema de mensajer&iacute;a avanzado.-

- [Add] Nave Corbata, especial para sacs.-
- [Add] Botones en el menu izquierdo.-
- [Add] Nuevo sistema de registro, mejorado con c&oacute;digo de seguridad.-
- [Add] Nuevo Login, Registro y Recordar contrase&ntilde;a (by brayan narvaez).-
- [Add] Modificaciones ligeras en el skin, mejoras en colores de misiones.-
- [Add] Modulo de avatares en opciones.-
- [Add] Mod_Plug system (by green).-
- [Add] Nombre de usuario en barheader.-

- [Cambio] Puedes desplegar flota en el planeta del cualquier jugador deseado.-
- [Cambio] Topnav permanece en vision de imperio.-
- [Cambio] Modificaci&oacute;n ligera en la galaxia, un poco mas comoda.-
- [Cambio] Imagenes de metal, cristal, deuterio, materia oscura y energia.-
- [Cambio] Removido el sistema de plugins actual.-
- [Cambio] De nuevo numeros normales en el topnav.-
- [Cambio] Modificaci&oacute;n ligera de pageinfo de alianza.-
- [Cambio] Topnav permanece en la galaxia.-
...
- [Fix][Bug #3] Flotas desaparecen al hacer desplege en la luna(by brayan narvaez).-
- [FIX][Bug #2] Reportes de batalla(by brayan narvaez).-
- [Fix] Infinite loop en PlanetResourceUpdate (by jtsamper).-
- [Fix] Pueden aumentar las naves con valores alfanumericos en el salto cuantico (by medel).-
- [Fix] Galaxia, Vision general, Estatisticas con el overlib.-
- [Fix] Descuadre del topnav en internet explorer.-
- [Fix] Error al imprimir la fabrica de robots.-
- [Fix] Redirecci&oacute;n a install (by brayan navaez).-
-- [Pre-Fix] Common con mod_plug.-
- [Fix] Descuadre del Menu izquierdo con Internet Explorer.-
- [Fix] Espacio en blanco para dimenciones grandes, ahora esta completa solo hasta 1900 x 1200 maximo.-
- [Fix] Problema con botones max en seleccionar recursos en mision.-
- [Fix] Reparado todo el estilo del panel de administraci&oacute;n.-
- [Fix] Super Nova en mision de expedici&oacute;n.
- [Fix] Loader del login.-
- [Fix] Error visual al ingresar malos datos, ya que no existia styles.css.-
- [Fix] Imagen de Luna.-
- [Fix] Algunos oficiales no aparecen.-
- [Fix] Algunos edificios no aparecen.-
- [Fix] Requisitos de la super nova, ahora se cumplen por que existe el emperador.-
- [Fix] Descripcion de la super nova en informaciones.-
- [Fix] Puntos vision general (by TheRip).-
- [Fix] Imagenes y letras en vision general.-
- [Fix] Recursos en negativos ya no dara mas problemas (by hermanos).-
- [Fix] Cerrado un agujero en opciones que permit&iacute;a sql injection (Gracias a TheRip).-
...
- [Cambio] Utilidades para menu izquierdo y topbaar.-

- [Fix][Bug #-------] Mods compatibles.-
...
- [Fix][Bug #-------] Bug no se ven bien las letras en vision general.-
- [Fix][Bug #-------] Imagen faltante, ya no da error.-
- [Fix][Bug #-------] Oficiales con Internet Explorer.-
...
'RV 1.0' => ' 02/02/10
- [Redesign] Editado la skin y templates del juego para lograr un entorno mas amigable
- Nueva vision general
- Planetarios en la parte derecha de la pantalla
- Nuevo dise&ntilde;o de vision de estructuras
- Nuevo modelo de vision de recursos rapidos (topnav)
- Hangar, Defensas e Investagaciones entorno mas amigable
- Nuevo menu izquierdo mucho mas comodo
- Nuevo menu de topbar para accesos rapidos
- Nuevo dise&ntilde;o de Login y registro
- Nuevo logo con psd disponible

- [Fix][Menor] Correjido el texto en phalanx
- [Fix] Planetas en posicion 0 al crear un usuario desde cpanel
- [Fix] Phalanx 100% funcional (by morgado)
- [Mod] Botones MAX en hangares y defensas
- [Mod] Rangos deacuerdo a cantidad te puntos
- [Mod] Metodos abreviados de recursos en topnav
- [Mod] Sistema de donaciones, solo es cuestion de cambiar el enlace a paypal y listo
- [Mod] Progresos de Hangar, Edificios y Tecnologias en vision general
- [Novedad] Por defecto se amplia la cantidad de colonias a 12

- [RV] Partida de xNova Revolution, totalmente compatible con todos los mods de 2.9.x para XG proyect sin el redesign
',
