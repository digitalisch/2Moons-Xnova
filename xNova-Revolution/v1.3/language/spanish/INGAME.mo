...
$lang['tech_rc'] = array (
202 => "Cargueras Chicas",
203 => "Cargueras Grandes",
204 => "Cazadores ligeros",
205 => "Cazadores pesados",
206 => "Cruceros",
207 => "Naves de Batalla",
208 => "Colonizadores",
209 => "Recicicaldores",
210 => "Sondas",
211 => "Bombarderos",
...
401 => "Lanza misiles",
402 => "Las&eacute;rs peque&ntilde;o",
403 => "Las&eacute;rs grandes",
404 => "Ca&ntilde;ones Gausse",
405 => "Ca&ntilde;ones i&oacute;nico",
406 => "Ca&ntilde;ones de plasma",
407 => "C&uacute;pulas pequeñas",
408 => "C&uacute;pulas grandes",
);
...
//----------------------------------------------------------------------------//
//LEFT MENU
$lang['lm_overview']						= 'Vista General';
$lang['lm_galaxy']							= 'Universos';
$lang['lm_empire']							= 'Imperio';
$lang['lm_fleet']							= 'Flota';
$lang['lm_buildings']						= 'Instalaciones';
$lang['lm_research']						= 'Investigaciones';
$lang['lm_shipshard']						= 'Hangar';
$lang['lm_defenses']						= 'Defensa';
$lang['lm_resources']						= 'Economia';
$lang['lm_officiers']						= 'Oficiales';
$lang['lm_trader']							= 'Mercader';
$lang['lm_technology']						= 'Desarrollo';
...
$lang['lm_options']							= 'Configuracion';
$lang['lm_banned']							= 'Expulsados';
$lang['lm_contact']							= 'Contacto';
$lang['lm_forums']							= 'Foro';
$lang['lm_logout']							= 'Salir';
$lang['lm_administration']					= 'Admin';
$lang['lm_mercado']							= 'Mercado Negro';
$lang['lm_donar']							= 'Donaciones';
...
$lang['ov_free']							= 'No hay edificios en construcción.';
$lang['ov_tfree']							= 'No hay ninguna investigación en progreso.';
$lang['ov_hree']							= 'No hay ni naves ni defensas en construcción.';
$lang['ov_colo']							= 'Colonias';
...
$lang['ov_campos']		                    = 'Campos';
$lang['ov_diameter_porciento']				= 'Barra de Porcentaje';
...
$lang['ov_options']							= 'Opciones';
$lang['ov_points']							= 'Total';
...
$lang['ov_escombros']						= 'Escombros';
$lang['ov_metal']		                    = 'Metal';
$lang['ov_cristal']		                    = 'Cristal';
$lang['ov_darkmatter']		                = 'Materia Oscura';
$lang['ov_bildings']		                = 'Edificios';
$lang['ov_fleet']		              	    = 'Flota';
$lang['ov_tech']		                	= 'Tecnologia';
$lang['ov_defe']		    	            = 'Defensas';
$lang['ov_stadisc']		    	            = 'Estadisticas';
$lang['ov_player']		    	            = 'Jugador';
$lang['ov_planet_info']		    	        = 'Información Planetaria';
$lang['ov_general_info']		    	    = 'Información General';
$lang['ov_user_info']		    		    = 'Información del Usuario';
$lang['ov_planet_tipe']		    	    	= 'Tipo de Superficie';
$lang['ov_online']		    	    		= 'Online';
$lang['ov_pueblo']		    	    		= 'Civilizacion';
$lang['ov_proxi']		    	    		= 'Proximamente';
$lang['ov_total_rnk']		    	    	= 'Estadisticas';
$lang['ov_rnk']		    	    			= 'Rango';
//---------------CREDIT------------
$lang['lm_credits']						= 'Créditos';
$lang['ow_credits']						= 'Créditos';
$lang['ow_proyect_leader']				= 'Administradores';
$lang['ow_principal_contributors']		= 'Moderadores';
$lang['ow_special_thanks']				= 'Go / SGO';
...
$lang['bd_no_more_fields']					= '<img src="styles/images/1.gif"></img>';
...
$lang['bd_lab_required']				.=	"<th>";
$lang['bd_lab_required']				.=		"<img border=\"0\" src=\"styles/skins/wofplanet/gebaeude/31.gif\" align=\"top\" width=\"100\" height=\"100\"></a>";
$lang['bd_lab_required']				.=	"</th>";
$lang['bd_lab_required']				.=	"<td class=\"1\">";
$lang['bd_lab_required']				.=		"<a href=\"game.php?page=infos&gid=31\"><b>Laboratorio</b></a> - Nivel (0)<br>";
$lang['bd_lab_required']				.=		"<font color=\"red\">Debes construir un Laboratorio de investigacion en este planeta para continuar.<br>";
$lang['bd_lab_required']				.=		"Puedes construirlo en la secci&oacute;n de instalaciones.<br>";
$lang['bd_lab_required']				.=		"</font>";
$lang['bd_lab_required']				.=	"</td>";
$lang['bd_building_lab']					= 'No se puede investigar cuando se esta ampliando el laboratorio';
$lang['bd_lvl']								= 'Nivel';
$lang['bd_spy']								= ' espia';
$lang['bd_commander']						= ' comandante';
$lang['bd_research']						= '<img src="styles/images/1.gif"></img>';
//$lang['bd_shipyard_required']				= '<img src="styles/skins/wofplanet/gebaeude/21.gif">¡Debes construir un hangar en este planeta para continuar!';
$lang['bd_shipyard_required']				.=	"<th>";
$lang['bd_shipyard_required']				.=		"<img border=\"0\" src=\"styles/skins/wofplanet/gebaeude/21.gif\" align=\"top\" width=\"100\" height=\"100\"></a>";
$lang['bd_shipyard_required']				.=	"</th>";
$lang['bd_shipyard_required']				.=	"<td class=\"1\">";
$lang['bd_shipyard_required']				.=		"<a href=\"game.php?page=infos&gid=21\"><b>Hangar</b></a> - Nivel (0)<br>";
$lang['bd_shipyard_required']				.=		"<font color=\"red\">Debes construir un hangar en este planeta para continuar.<br>";
$lang['bd_shipyard_required']				.=		"Puedes construirlo en la secci&oacute;n de instalaciones.<br>";
$lang['bd_shipyard_required']				.=		"Debes tener fabrica de robots a nivel 2 como minimo para construirlo.<br></font>";
$lang['bd_shipyard_required']				.=	"</td>";
...
//OFFICIERS
$lang['of_officer']			= 'Tus oficiales';
$lang['of_available_points'] = 'Puntos disponibles:';
$lang['of_points_per_thousand_darkmatter']	= '(1 punto por cada 1000 creditos adquiridos)';
$lang['of_lvl']				= 'Nivel';
$lang['of_infor']			= 'Con los oficiales podés llevar a tu imperio a unas dimensiones de las que nunca soñaste. ¡Todo lo que necesitás es algo de materia oscura y tus trabajadores y consejeros trabajarán incluso más! ';
...
$lang['tt_lvl']								= 'nivel ';
$lang['tt_pic']								= 'Imagen';
$lang['tt_req']                                = 'Requerido';
$lang['tt_yourlvl']                            = 'Su nivel de habilidad';  
//----------------------------------------------------------------------------//
$lang['tech'] = array(
...
25 => "Contenedor de materia oscura",
...
5 => "Las minas de materia oscura estan dise&ntilde;adas para la extracci&oacute;n de dicho recurso que es utilizado como un metodo de pago o moneda, es muy escaso por ello relativamente caro.",
...
15 => "Los nanobots son droides microscopicos programados para disminuir ",
...
25 => "Contenedores enormes para almacenar materia oscura.",
31 => "Se necesita un laboratorio de investigación para conducir la investigación en nuevas tecnologías.",
33 => "El terraformer incrementa campos al ser instalado en una superficie",
...
217 => "Tras la evolucion de los motores de combustion a impulso las naves adquirieron una nueva dimension de velocidad representada en el Crucero, pero a pesar de todo habia gente que pensaba que el Crucero era mas bien una nave lenta, gracias a una mejora del motor ionico nacio la Corbeta, 2 cubiertas armadas con laseres y ionicos y una velocidad endiablada junto a una aceptable capacidad de carga comvierten a la Corbeta en la mejor nave de ataque rapido, la unica pega de esta nave es que pierde ataque y blindaje para reducir peso y ganar espacio de carga. Esta nave cambia de motor a hiperespacial cuando se desarrolla el nivel 9 del mismo.",
...
601 => '<br>El geólogo es un experto en astrominerolog&iacute;a y astrocristalograf&iacute;a. Asiste a sus equipos en la metalurgia y qu&iacute;mica y tambi&eacute;n se encarga de las comunicaciones interplanetarias para optimizar el uso y refinamiento de la materia bruta a lo largo de todo el imperio.<br><br><strong><font color="lime">+5% de producción. Nivel Máx. 20</font></strong>',
602 => '<br>El almirante es un veterano de guerra experimentado y un habilidoso estratega. En las batallas mas duras, es capaz de hacerse una idea de la situación y contactar a sus almirantes subordinados. Un emperador sabio puede apoyarse en su ayuda durante los combates.<br><br><strong><font color="lime">+5% escudo en naves. Nivel Máx. 20</font></strong>',
603 => '<br>El Ingeniero es un especialista en la gestión de energía. En tiempos de paz, aumenta la energía de todas las colonias. En caso de ataque, garantiza el abastecimiento de energía a los cañones, evitando una posible sobrecarga, lo que conduce a una reducción de defensas perdidas en batalla.<br><br><strong><font color="lime">+5% de energia. Nivel Máx. 10</font></strong>',
604 => '<br>El gremio de los tecnócratas está compuesto de auténticos genios, y siempre los encontrarás en ese peligroso borde donde todo explotaría en mil pedazos antes de poder encontrar una explicación tecnológica y racional. Ningún ser humano normal trataría jamás descifrar el código de un tecnócrata, con su presencia, inspira a los investigadores del imperio.<br><br><strong><font color="lime">+5% velocidad de construcción de naves.</font></strong>',
615 => '<br>El puesto de Comandante se ha establecido por si mismo en la guerra moderna. A causa del simplificado manejo de las estructuras, las instrucciones pueden procesarse más rápidamente. ¡Con él serás capaz de tener una visión general de tu imperio! Esto te permitirá desarrollar estructuras que te llevan a estar a la delantera de tu enemigo.<br><br><strong><font color="lime">Podes destruir las lunas.</font></strong> ',
);
...
$lang['info'][5]['name']                    = "Mina de Materia Oscura";
$lang['info'][5]['description']             = "Las minas de materia oscura estan dise&ntilde;adas para la extracci&oacute;n de dicho recurso que es utilizado como un metodo de pago o moneda, es muy escaso por ello relativamente caro.";
...
$lang['info'][25]['name']         			= "Contenedor de materia oscura";
$lang['info'][25]['description']  			= "Contenedores enormes para almacenar materia oscura.";
...
$lang['info'][124]['name']        			= "Astrofisica";
...
$lang['info'][217]['name']                  = "Corbeta";
$lang['info'][217]['name']                  = "Tras la evolucion de los motores de combustion a impulso las naves adquirieron una nueva dimension de velocidad representada en el Crucero, pero a pesar de todo habia gente que pensaba que el Crucero era mas bien una nave lenta, gracias a una mejora del motor ionico nacio la Corbeta, 2 cubiertas armadas con laseres y ionicos y una velocidad endiablada junto a una aceptable capacidad de carga comvierten a la Corbeta en la mejor nave de ataque rapido, la unica pega de esta nave es que pierde ataque y blindaje para reducir peso y ganar espacio de carga. Esta nave cambia de motor a hiperespacial cuando se desarrolla el nivel 9 del mismo.";
...
$lang['info'][216]['description']           = "La nave mas poderosa jam&aacute;s creada.";
// -------------------------- DEFENSES ----------------------------------------------------------------------------------------------------//
...
$lang['info'][615]['name']        			= "Comandante";
$lang['info'][615]['description'] 			= "El puesto de Comandante se ha establecido por si mismo en la guerra moderna. A causa del simplificado manejo de las estructuras, las instrucciones pueden procesarse más rápidamente. ¡Con él serás capaz de tener una visión general de tu imperio! Esto te permitirá desarrollar estructuras que te llevan a estar a la delantera de tu enemigo. .";
*/
...
$lang['mg_no_text_subject']                    = '<font color="red">Falta el asunto y el mensaje</font><br /><a href="javascript:history.back()">Volver</a>';
$lang['mg_no_subject']                        = '<font color="red">Falta el asunto</font><br /><a href="javascript:history.back()">Volver</a>';
$lang['mg_no_text']                            = '<font color="red">Falta el mensaje</font><br /><a href="javascript:history.back()">Volver</a>';
$lang['mg_msg_sended']                        = '<font color="#00FF00">Mensaje enviado</font>';
$lang['mg_sin_subject']                     = 'Sin Asunto';
$lang['mg_answer_prefix']                   = 'Re:';
...
$lang['mg_msg_spy']                         = 'Espionaje';
$lang['mg_msg_battle']                      = 'Batalla';
$lang['mg_msg_players']                     = 'Jugadores';
$lang['mg_msg_expedition']                  = 'Expedición';
$lang['mg_msg_alliance']                    = 'Alianza';
$lang['mg_msg_other']                       = 'Otros';
$lang['mg_type'][6]                         = 'Informes de (recolección, transporte, construcción)';
$lang['mg_msg_no_msg']                      = 'No se han encontrado mensajes';
$lang['mg_msg_from']                        = 'Remitente';
$lang['mg_msg_mark']                        = 'Marcar';
$lang['mg_msg_unmark']                      = 'Desmarcar';
$lang['mg_msg_all_msg']                     = 'todos los mensajes';
$lang['mg_msg_del_msg']                     = 'Eliminar este mensaje';
$lang['mg_msg_select_action']               = 'Seleccionar acción';
$lang['mg_marked_read']                     = 'Marcar como leidos';
$lang['mg_marked_unread']                   = 'Marcar como no leidos'; 
...
$lang['sys_moonbuilt'] 						= "Las enormes cantidad de metal, cristal y materia oscura se fucionan y forman un satélite lunar en la orbita del planeta %s [%d:%d:%d] !";
...
$lang['sys_adress_planet'] 					= "[%s:%s:%s:%s]";
...
$lang['sys_recy_gotten'] 					= "Tu flota llego a las coordenadas indicadas y recolecto %s unidades de %s, %s unidades de %s y %s unidades de %s.";
$lang['sys_notenough_money'] 				= "No tienes suficientes recursos para contruir una % s. Tienes %s de %s, %s de %s, %s de %s y %s de %s y el costo de la construcción era %s de %s, %s de %s, %s de %s y %s de %s";
...
$lang['pr_general']                           = 'Producción General'; 
