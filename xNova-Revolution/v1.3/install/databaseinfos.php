...
$QryInsertConfig    .= "('game_name'             , 'xNova Revolution'), ";
...
$QryInsertConfig    .= "('darkmatter_basic_income', '0'), ";
...
$QryInsertConfig    .= "('forum_url'             , 'http://www.xnovarevolution.com.ar/foros/' ), ";
...
$QryTableGalaxy     .= "`darkmatter` bigint(11) NOT NULL default '0', ";
...
$QryTablePlanets    .= "`darkmatter` double(132,8) NOT NULL default '0.00000000', ";
$QryTablePlanets    .= "`darkmatter_perhour` int(11) NOT NULL default '1', ";
$QryTablePlanets    .= "`darkmatter_max` bigint(20) default '100000', ";
...
$QryTablePlanets    .= "`darkmatter_mine` int(11) NOT NULL default '0', ";
...
$QryTablePlanets    .= "`darkmatter_store` int(11) NOT NULL default '0', ";
...
$QryTablePlanets    .= "`small_ship_cargo` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`big_ship_cargo` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`light_hunter` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`heavy_hunter` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`crusher` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`battle_ship` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`colonizer` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`recycler` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`spy_sonde` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`bomber_ship` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`solar_satelit` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`destructor` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`dearth_star` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`battleship` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`supernova` bigint(11) NOT NULL, ";
$QryTablePlanets    .= "`nave_de_asalto` bigint(11) NOT NULL, ";
...
$QryTablePlanets    .= "`darkmatter_mine_porcent` int(11) NOT NULL default '10', ";
...
$QryTableUsers      .= "`avatar` char(250) NOT NULL DEFAULT 'http://i48.tinypic.com/2ex7oya.jpg', ";
...
$QryTableUsers      .= "`creditos` int(11) NOT NULL default '0', ";
