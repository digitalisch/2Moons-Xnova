...
if(!defined('INSIDE')){ die(header("location:../../"));}
	...
	function formatCR (&$result_array,&$steal_array,&$moon_int,&$moon_string,&$time_float)
	{
		...
		elseif ($result_array['won'] == "a")
		{
			...
			$result1 .= $lang['sys_stealed_ressources']." ".$steal_array['metal']." ".$lang['Metal'].", ".$steal_array['crystal']." ".$lang['Crystal'].", ".$steal_array['darkmatter']." ".$lang['Darkmatter']." ".$lang['and']." ".$steal_array['deuterium']." ".$lang['Deuterium']."<br />";
		}
		else
		{
