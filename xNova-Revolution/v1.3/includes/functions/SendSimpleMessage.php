...
if(!defined('INSIDE')){ die(header("location:../../"));}
    ...
    if($Type == 1 AND ($Sender == "" OR $Sender == "0")){message("Eres un spammer de mierda.<br>Si no lo eres, envia un mp a un administrador contando lo que estabas haciendo en el momento en el que te salio esta advertencia</b></font>", "./", 5);}
