...
if(!defined('INSIDE')){ die(header("location:../../"));}
	...
	function CreateOnePlanetRecord($Galaxy, $System, $Position, $PlanetOwnerID, $PlanetName = '', $HomeWorld = false)
	{
		...
		if (!$PlanetExist)
		{
            ...
            $planet['darkmatter']        = BUILD_DARKMATTER;
			...
			$QryInsertPlanet .= "`darkmatter` = '".         $planet['darkmatter']         ."', ";
			$QryInsertPlanet .= "`darkmatter_perhour` = '". $planet['darkmatter_perhour'] ."', ";
			$QryInsertPlanet .= "`darkmatter_max` = '".     $planet['darkmatter_max']     ."';";
