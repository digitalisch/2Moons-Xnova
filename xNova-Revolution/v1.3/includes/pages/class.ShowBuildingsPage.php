...
class ShowBuildingsPage
{
	...
	private function CancelBuildingFromQueue (&$CurrentPlanet, &$CurrentUser)
	{
		...
		if ($CurrentQueue != 0)
		{
			...
			$CurrentPlanet['darkmatter']   += $Needed['darkmatter'];
			}
    ...
    private function ShowBuildingQueue ( $CurrentPlanet, $CurrentUser )
    {
        ...
        if ($ActualCount != 0)
        {
            $ListIDRow .= "<tr><td class='c' colspan='3'><center><font color='#99cc00'>Edificios en desarrollo</font><br />Espacios usados <font color='#00FF00'>".$ActualCount."</font> / <font color='#FF0000'>". MAX_BUILDING_QUEUE_SIZE ."</font> Restan ". ( MAX_BUILDING_QUEUE_SIZE - $ActualCount) ." espacios de cola.</center></td></tr>";
