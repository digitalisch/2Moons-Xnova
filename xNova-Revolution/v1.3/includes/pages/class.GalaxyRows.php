...
class GalaxyRows
{
	...
	public function GalaxyRowDebris($GalaxyRow, $GalaxyRowPlanet, $GalaxyRowUser, $Galaxy, $System, $Planet, $PlanetType, $CurrentRC)
	{
		...
		if ($GalaxyRow)
		{
			if ($GalaxyRow["metal"] != 0 || $GalaxyRow["crystal"] != 0 || $GalaxyRow["darkmatter"] != 0)
			{
				$RecNeeded = ceil(($GalaxyRow["metal"] + $GalaxyRow["crystal"] + $GalaxyRow["darkmatter"]) / $pricelist[209]['capacity']);
				...
				$Result .= "</tr><tr>";
				$Result .= "<th>".$lang['Darkmatter'].": </th><th>". number_format( $GalaxyRow['darkmatter'], 0, '', '.') ."</th>";
				$Result .= "</tr><tr>";
				...
				$Result .= ", STICKY, MOUSEOFF, DELAY, 750, CENTER, OFFSETX, -40, OFFSETY, -40 );'";
				$Result .= " onmouseout='return nd();'>";
				$Result .= "<img src=". $dpath ."planeten/debris.gif height=22 width=22></a>";
			} elseif ($GalaxyRow["metal"] == 0 || $GalaxyRow["crystal"] == 0 || $GalaxyRow["darkmatter"] == 0) {
                $Result .="<img src=". $dpath ."planeten/debris_off.gif height=22 width=22 style=\"background : fixed;\">";
            }
        }
		$Result .= "</th>";
		return $Result;
	...
	public function GalaxyRowMoon($GalaxyRow, $GalaxyRowPlanet, $GalaxyRowUser, $Galaxy, $System, $Planet, $PlanetType)
	{
		...
		if ($GalaxyRow && $GalaxyRowPlanet["destruyed"] == 0 && $GalaxyRow["id_luna"] != 0)
		{
			...
			$Result .= "</tr><tr>";
			$Result .= "<th width=80>";
			$Result .= "<img src=". $dpath ."planeten/small/s_mond.jpg height=75 width=75 />";
			$Result .= "</th>";
			$Result .= "<th>";
			$Result .= "<table>";
			$Result .= "<tr>";
			...
			$Result .= ", STICKY, MOUSEOFF, DELAY, 750, CENTER, OFFSETX, -40, OFFSETY, -40 );'";
			$Result .= " onmouseout='return nd();'>";
			$Result .= "<img src=". $dpath ."planeten/mond.gif height=22 width=22>";
			$Result .= "</a>";
		} elseif ($GalaxyRow && $GalaxyRowPlanet["destruyed"] == 0 && $GalaxyRow["id_luna"] == 0) {
            $Result .= "<img src=". $dpath ."planeten/mond_off.gif height=22 width=22>";
        } elseif ($GalaxyRow && $GalaxyRowPlanet["destruyed"] == true && $GalaxyRow["id_luna"] == 0) {
            $Result .= "<img src=". $dpath ."planeten/mond_dest.gif height=22 width=22>";
        }
        $Result .= "</th>";
		return $Result;
	}
	...
	public function GalaxyRowPlanet($GalaxyRow, $GalaxyRowPlanet, $GalaxyRowUser, $Galaxy, $System, $Planet, $PlanetType, $HavePhalanx, $CurrentGalaxy, $CurrentSystem)
	{
		...
		if ($GalaxyRow && $GalaxyRowPlanet["destruyed"] == 0 && $GalaxyRow["id_planet"] != 0)
		{
			...
			$Result .= "<tr>";
			$Result .= "<th width=80>";
			$Result .= "<img src=". $dpath ."planeten/small/s_". $GalaxyRowPlanet["image"] .".gif height=75 width=75 />";
			$Result .= "</th>";
			...
			$Result .= ", STICKY, MOUSEOFF, DELAY, 750, CENTER, OFFSETX, -40, OFFSETY, -40 );'";
			$Result .= " onmouseout='return nd();'>";
			$Result .= "<img src=".   $dpath ."planeten/small/s_". $GalaxyRowPlanet["image"] .".gif height=30 width=30>";
			$Result .= "</a>";
		}
		$Result .= "</th>";
