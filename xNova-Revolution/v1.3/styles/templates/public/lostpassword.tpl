...
<div style="position: absolute; left: 150px; top: 50px; height: 400px; width:300px;">
  <br><tr><th style="text-align: left;">
...
<tr>
  <td align="center" valign="center" width="400px">
    ...
    <table class="c" style="filter:alpha(opacity=80); opacity:.80; background-color: Black;">
      <tr><th width="400px" style="background-image:url(styles/css/img/bg1.png);"><font color="D0E0FF" size="2">Recuperar contrase&ntilde;a</font></font></th></tr>
      <tr><th style="text-align: left;">

      <li>  Escribe el email con el que te haz registrado.
<li>  Aprieta en {retrieve_pass} y revisa tu email.
<li>  Te llegar&aacute; una nueva contrase&ntilde;a a tu e-mail y accederas luego con tu nombre de usuario y tu nueva contrase&ntilde;a.<br><br><br>

<form action="" name="lstpass_form" method="post"
<center><b>{email}: <input type="text" size="20" maxlength="60" name="email" /></b></center>
      <div id="register" class="bigbutton" onclick="document.lstpass_form.submit();"><font color="#99cc00">{retrieve_pass}</font></div>
</form>
</th></tr></th></tr>
</body>
</html>
