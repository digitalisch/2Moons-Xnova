...
<div id="content">
    ...
    <table width="519">
        ...
        <tr>
          <th><img src=styles/images/r1.gif></th>
          <th>{al_legend_disolve_alliance}</th>
        </tr>
        <tr>
          <th><img src=styles/images/r2.gif></th>
          <th>{al_legend_kick_users}</th>
        </tr>
        <tr>
          <th><img src=styles/images/r3.gif></th>
          <th>{al_legend_see_requests}</th>
        </tr>
        <tr>
          <th><img src=styles/images/r4.gif></th>
          <th>{al_legend_see_users_list}</th>
        </tr>
        <tr>
          <th><img src=styles/images/r5.gif></th>
          <th>{al_legend_check_requests}</th>
        </tr>
        <tr>
          <th><img src=styles/images/r6.gif></th>
          <th>{al_legend_admin_alliance}</th>
        </tr>
        <tr>
          <th><img src=styles/images/r7.gif></th>
          <th>{al_legend_see_connected_users}</th>
        </tr>
        <tr>
          <th><img src=styles/images/r8.gif></th>
          <th>{al_legend_create_circular}</th>
        </tr>
        <tr>
          <th><img src=styles/images/r9.gif></th>
