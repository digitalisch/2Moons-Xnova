...
<div id="content">
<img src="styles/images/headers/flotas2.png">
            <div style="position: absolute; right: 160px;top: 8px; font-size: 16px" ><span class="Estilo2">Envío de flota II - Seleccionar Destino </span><font style="font-size:10px"></div><br />
