...
<div id="content">
<img src="styles/images/headers/flotas3.png">
            <div style="position: absolute; right: 160px;top: 8px; font-size: 16px" ><span class="Estilo2">Envío de flota II - Seleccionar Misión </span><font style="font-size:10px"></div><br />
...
<input type="hidden" name="thisresource4"  value="{darkmatter}" />
		...
		<tr align="left" valign="top">
        	...
        	<th>
				<table border="0" cellpadding="0" cellspacing="0" width="259">
                  ...
                  <tr height="20">
        				<th>{Darkmatter}</th>
        				<th><a href="javascript:maxResource('4');">{fl_max}</a></th>
        				<th><input name="resource4" size="10" onchange="calculateTransportCapacity();" type="text"></th>
        			</tr>
                    <tr height="20">
