...
$LNG['server_message']			= 'Regístrese ahora y experimente una nueva y emocionante aventura en el mundo de';
$LNG['login']					= 'Login';
...
$LNG['welcome_message_content']	    = 'Bienvenido a %s!<br>En primer lugar construye una Planta de energía solar, porque la energía es necesaria para la posterior producción de materias primas. Para construila, haga clic en Edificios del panel izquierdo. Cuando tengas la energía, puedes comenzar a construir las minas. Vuelve al menú Edificio y construye una mina de metal, y luego otra vez una mina de cristal. El equipo le desea mucha diversión y comienza a explorar el universo!';
$LNG['newpass_smtp_email_error']	= '<br><br>Se produjo un error. Su contraseña es: ';
$LNG['reg_completed']				= 'Gracias por tu registro! Usted recibirá un correo electrónico con un enlace de activación.';
...
$LNG['accept_terms_and_conditions'] = 'Acepto las Reglas y los T&C';
