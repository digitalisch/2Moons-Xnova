...
$LNG['intro_welcome']		= "Bienvenido a xNova Revolution";
$LNG['intro_text']			= "xNova Revolution es un clon de ogame trabajado sobre la version estable y final 1.3 de 2moons, el proyecto cuenta con un <a href=\"http://xnovarevforum.com.ar/index.php\" target=\"_blank\">foro</a> de soporte y con una <a href=\"http://www.xnovarevolution.com.ar\" target=\"_blank\">web principal</a> en la cual podran encontrar mayor informaci&oacute;n (Spanish only).<br><br>El sistema de instalaci&oacute;n le gu&iacute;a a trav&eacute;s de la instalaci&oacute;n.<br>xNova Revolution es un proyecto de c&oacute;digo abierto bajo la licencia GNU GPL v3. Para la licencia por favor haga clic en el elemento en el men&uacute;.<br><br>Antes de la instalaci&oacute;n, se comprueban las caracteristicas del servidor, si se cumplen los requisitos del sistema continuar&aacute; la instalaci&oacute;n.<br><br><br><center><font color=\"red\">Se recomienda tener conocimientos en Php para el autosoporte del servidor.</font></center>";
...
$LNG['step2_conf_op_fail']	= "config.php no esta en modo CHMOD 777!";
$LNG['step2_db_connet_ok']	= "Conexi&oacute;n establecida satisfactoriamente con la Base de datos...";
$LNG['step2_db_create_ok']	= "Tablas creadas satisfactoriamente...";
...
$LNG['step3_admin_pass']	= "Administrador Contrase&ntilde;a:";
$LNG['step3_admin_mail']	= "Administrador E-Mail:";


$LNG['step4_need_fields']	= "Usted tiene que llenar todos los campos!";
