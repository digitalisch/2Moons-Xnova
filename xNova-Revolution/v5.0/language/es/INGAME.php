...
// GAME.PHP
$LNG['see_you_soon']						= 'Hasta la próxima!';
...
$LNG['tn_delete_mode']						= 'Tu cuenta se encuentra en modo borrar. La misma será borrada el %s!';
...
$LNG['lm_queue']							= 'Colas';
$LNG['lm_topkb']							= 'Batallas Memorables';
$LNG['lm_faq']								= 'FAQ';
...
$LNG['ov_planet_abandoned']				= 'Planeta abandonado con éxito.!';
...
$LNG['ov_security_confirm']				= 'Confirmar borrado de planeta';
...
$LNG['ov_userbanner']						= 'Banner de estadísticas de los jugadores';
$LNG['ov_userrank_info']					= '%s (%s <a href="game.php?page=statistics&amp;range=%d">%d</a> %s %s)';
$LNG['ov_teamspeak_not_online']			= 'El servidor está inaccesible. Le pedimos disculpas.';
$LNG['ov_teamspeak']						= 'Teamspeak';
$LNG['ov_teamspeak_v2']					= '<a href="teamspeak://%s:%s?nickname=%s" title="Teamspeak Connect">Connectar</a> &bull; Online: %d/%d &bull; Canales: %d &bull; Trafico ges.: %s MB';
...
$LNG['gl_avaible_grecyclers']				= 'Mega-Recicladores';
...
$LNG['fl_order']							= 'Orden';
$LNG['fl_new_mission_title']				= 'Nueva mision: escoge las naves';
...
$LNG['fl_fleet_speed']						= 'Velocidad (Años Luz)';
...
$LNG['fl_max_speed']						= 'Velocidad max.';
...
$LNG['fl_all_resources']					= 'Máxima carga de recursos';
$LNG['fl_empty_target']					= 'No hay misiones disponibles (¿existe el planeta?)';
$LNG['fl_expedition_alert_message']		= 'Atención ! Las expediciones son misiones arriesgadas, puedes perder tus naves!';
$LNG['fl_dm_alert_message']				= 'Ten cuidado, si en el %s %s es encontrado, tu flota será destruida!';
$LNG['fl_vacation_mode_active']			= 'Estas en modo vacaciones';
$LNG['fl_expedition_tech_required']		= 'Investiga la tecno de expedición!';
...
$LNG['fl_admins_cannot_be_attacked']		= 'Los administradores y moderadores del juego no pueden recibir ataques.';
...
$LNG['fl_no_empty_derbis']					= 'No existe campo de escombros! ';
...
$LNG['fl_error_same_planet']				= 'Origen y destino no pueden ser el mismo planeta!';
...
$LNG['bd_add_to_list']						= '<input type="submit" value="Añadir a la cola de producción"></input>';
$LNG['bd_no_more_fields']					= 'No hay espacio en el planeta';
$LNG['bd_remaining']						= 'Restantes';
$LNG['bd_lab_required']					= '&#161;Es necesario construir primero un laboratorio de investigación en este planeta!';
$LNG['bd_building_lab']					= 'No se puede investigar cuando se esta ampliando el laboratorio';
$LNG['bd_max_lvl']							= '(Max. Nivel: %s)';
$LNG['bd_lvl']								= 'Nivel';
$LNG['bd_research']						= '<input type="submit" value="Investigar">';
...
$LNG['sys_nomore_level'] 					= 'Intentas destruir un edificio que ya no tiene má ( %s ).';
...
$LNG['rs_storage_capacity']				= 'Capacidad de los almacenes';
$LNG['rs_calculate']						= 'calcular';
$LNG['rs_sum']								= 'Total:';
$LNG['rs_daily']							= 'Por dia:';
$LNG['rs_weekly']							= 'Por Semana:';
$LNG['rs_ress_bonus']						= 'Bonos(Oficiales/DM-Bonus):';

//----------------------------------------------------------------------------//
//OFFICIERS
$LNG['of_recruit']							= 'Reclutar';
$LNG['of_max_lvl']							= 'Nivel máximo';
$LNG['of_available_points']				= 'Puntos disponibles:';
$LNG['of_points_per_thousand_darkmatter']	= '(%d %s = 1 punto)';
$LNG['of_lvl']								= 'Nivel';
$LNG['of_dm_trade']						= 'Oficiales';
$LNG['of_still']							= 'duración';
$LNG['of_active']							= 'activo';
$LNG['of_update']							= 'actualizar';

//----------------------------------------------------------------------------//
//TRADER
$LNG['tr_empty_darkmatter']				= 'No tienes suficiente %s!';
$LNG['tr_cost_dm_trader']					= 'El importe de las tasas es de %s %s!';
$LNG['tr_only_positive_numbers']			= '&#161;Solo se pueden usar números positivos!';
$LNG['tr_not_enought_metal']				= 'No tienes suficiente metal.';
$LNG['tr_not_enought_crystal']				= 'No tienes suficiente cristal.';
...
$LNG['tr_exchange_quota']					= 'El tipo de intercambio es de 2/1/0.7/0.5';
...
//----------------------------------------------------------------------------//
//INFOS
$LNG['in_jump_gate_done']					= 'El salto cuántico fue realizado, el próximo salto podrá ser realizado en: ';
...
$LNG['in_level']       					= 'Nivel';
$LNG['in_prod_p_hour'] 					= 'Producion/hora';
$LNG['in_difference']  					= 'Diferencia';
$LNG['in_used_energy'] 					= 'Consumo de energía';
$LNG['in_prod_energy'] 					= 'Produción de energía';
...
//----------------------------------------------------------------------------//
//MESSAGES
$LNG['mg_type'][0]    						= 'Informes de espionaje';
$LNG['mg_type'][1]    						= 'Mensajes de jugadores';
$LNG['mg_type'][2]    						= 'Mensajes de la alianza';
$LNG['mg_type'][3]    						= 'Informes de batalla';
$LNG['mg_type'][4]    						= 'Mensajes del Sistema';
$LNG['mg_type'][5]    						= 'Informes de tranporte';
$LNG['mg_type'][15]   						= 'Informes de expedición';
$LNG['mg_type'][50]						= 'Noticias del Juego';
$LNG['mg_type'][99]   						= 'Informes de construcción';
...
$LNG['mg_show_only_header_spy_reports']	= 'Mostrar solo encabezado de los informes de espionaje';
...
$LNG['al_newname_alphanum']				= 'El nombre de la Alianza y tag solo puede contener caracteres alfanumericos.';
$LNG['al_newname_no_space']				= 'El nombre de la Alianza y tag no debe contener espacios.';
$LNG['al_description_message']				= 'Mensaje de descripción de la alianza.';
$LNG['al_web_text']						= 'Web de la alianza';
$LNG['al_request']							= 'Solicitud';
$LNG['al_click_to_send_request']			= 'Click aqui para enviar su solicitud a la alianza';
...
$LNG['al_default_request_text']			= 'Los líderes de la alianza no han creado un ejemplo de solicitud, o no tienen pretensiones de hacerlo.';
$LNG['al_write_request']					= 'Escribir solicitud a la alianza %s';
$LNG['al_request_deleted']					= 'Tu solicitud ha sido borrada. <br/>Ahora puedes escribir una nueva solicitud o crear tu propia alianza.';
$LNG['al_request_wait_message']			= 'Ya has enviado una solicitud a la alianza %s. <br/>Por favor, espera hasta que recibas una respuesta o borra la solicitud.';
$LNG['al_delete_request']					= 'Borrar solicitud';
$LNG['al_founder_cant_leave_alliance']		= 'El fundador no puede abandonar la alianza.';
...
$LNG['al_go_out_no'] 						= 'No';
$LNG['al_close_ally'] 						= 'De verdad quiere renunciar a la alianza?';
$LNG['al_kick_player']						= 'De verdad quiere que el jugador %s quede eliminado de la alianza?';
$LNG['al_circular_sended']					= 'Mensaje circular enviado, Los siguiente(s) miembro(s) recibieron tu mensaje:';
...
$LNG['al_send_circular_message']			= 'enviar correo circular';
...
$LNG['al_request_from_user']				= 'Suscripció de jugadores';
...
$LNG['al_transfer_alliance']				= 'Resignarse/echar a todos de la alianza?';
...
$LNG['al_circular_send_ciruclar']			= 'Enviar correo circular';
...
$LNG['al_make_alliance']					= 'Fundar alianza';
...
$LNG['al_manage_change_name']				= 'Cambiar el nombre de la alianza';
$LNG['al_texts']							= 'Textos';
...
$LNG['al_configura_ranks']					= 'Configurar los rangos';
...
$LNG['al_tfmetall']     					= 'Total de escombros de metal';
$LNG['al_tfkristall']   					= 'Total de escombros de cristal';
$LNG['al_tfnorio']   					   = 'Total de escombros de norio';
...
$LNG['al_diplo_level_des']                    = 'Arca de la alianza';
...
$LNG['al_leave_ally']					= 'Realmente desea salir de la alianza?';
...
$LNG['op_vacation_mode_active_message']	= 'El modo vacaciones esta activado. Tendra que estar de vacaciones como mínimo hasta el: ';
...
$LNG['op_old_pass']						= 'Contraseña anterior';
...
$LNG['op_lang']							= 'Idioma';
$LNG['op_skin_example']					= 'Skins (p.e. /css/)';
$LNG['op_show_skin']						= 'Mostrar skin';
$LNG['op_deactivate_ipcheck']				= 'Desactivar comprobación de IP';
...
$LNG['op_email_adress_descrip']			= 'Esta dirección puede ser cambiada en cualquier momento. La dirección sera permanente si no se realizan cambios en los próximos 7 días.';
$LNG['op_deactivate_ipcheck_descrip']		= 'La comprobación de IP significa que se realizará un logout de seguridad automáticamente cuando cambie la IP o cuando 2 personas entren en la misma cuenta usando diferentes IPs.  Desactivar la comprobación de IP puede ser un agujero de seguridad!';
...
$LNG['op_activate_vacation_mode_descrip']	= 'El modo vacaciones protege tu cuenta durante tu ausencia. Sólo podra ser activada si no se esta construyemdo nada (flotas, edificios o defensas), nada esta siendo investigado y ninguna de tus flotas esta en movimiento. Una vez activada estas protegido contra ataques. Los ataques que esten en proceso finalizaran. Durante las vacaciones la producción se establece a cero y deberas devolverla al 100% cuando vuelvas a estar activo. El modo vacaciones dura como mínimo dos dias y solo se podra desactivar despues de ese tiempo.';
$LNG['op_dlte_account_descrip']			= 'Si seleccionas esta opcion, el sistema borrará tu cuenta automáticamente pasados 7 días';
$LNG['op_not_vaild_mail']                                       = 'Usted no tiene una dirección válida de correo electrónico!';
...
$LNG['css_account_banned_message']			= 'Tu cuenta ha sido suspendida! ';
$LNG['css_account_banned_expire']			= 'Por esta razón %s estas suspendido!<br><a href="./index.php?page=pranger">Pranger</a>';
$LNG['css_goto_homeside']					= '<a href="./index.php">Ir a la página principal</a>';
$LNG['css_server_maintrace']				= 'Server en mantenimiento<br><br>El juego está cerrado.<br><br>razón: %s';
...
$LNG['cdg_error_message']					= 'Error, por favor contacte al administrador. Error:';
$LNG['cdg_fatal_error']					= 'ERROR FATAL';

//----------------------------------------------------------------------------//
//class.FlyingFleetsTable.php

$LNG['cff_no_fleet_data']					= 'No hay datos de la flota';
...
$LNG['fa_no_more_slots']					= 'Error, no tienes mas slots de flotas disponibles';
...
//----------------------------------------------------------------------------//
// MissilesAjax.php
$LNG['ma_silo_level']						= 'Debes tener al menos silo al nivel 4';
...
$LNG['pl_dermetal']    					= 'Total de metal en campos de escombros';
$LNG['pl_dercrystal']   					= 'Total de cristal en campos de escombros';
...
$LNG['rec_build']  						= 'Edificios';
$LNG['rec_specb']							= 'Edificios especiales';
...
$LNG['rec_nbre']   						= 'Numero';
$LNG['rec_rien']   						= '-';
$LNG['rec_last_update_on']   				= 'última actualización : %s';
...
$LNG['bs_wait']							= "Por favor, espere 10 segundos para la simulación siguiente";

//----------------------------------------------------------------------------//
// Fleettrader
$LNG['ft_head']								= 'Mercader Flotas';
$LNG['ft_count']							= 'Número';
$LNG['ft_max']								= 'Max';
$LNG['ft_total']							= 'Total';
$LNG['ft_charge']							= 'Tasas del Mercader';
$LNG['ft_absenden']							= 'Enviar';

//----------------------------------------------------------------------------//
// Logout
$LNG['lo_title']						= 'Desconexión satisfactoria! :)';
$LNG['lo_logout']						= 'Session Terminada';
$LNG['lo_redirect']						= 'Redirección';
$LNG['lo_notify']						= 'Seras redireccionado en <span id="seconds"> 5 </ span> s';
$LNG['lo_continue']						= 'Pulsa aquí si no redirecciona.';
