...
7 => "Nório foi descoberto recentemente, é um mineral que nasceu da fusão de metal com vidro, é usado atualmente para construir navios como escudos Norio construídos tenham revelado muito mais resistentes do que os protetores de metal convencional, nori tem uma imagem semelhante a vidro, então você pode ver através dela, os engenheiros recurso valioso para encontrar uma nova mina conseguiram extrair das profundezas do planeta, é um recurso que está perto do núcleo dos planetas.",
...
25 => "Cada evolução do armazém de nório permite o aumento da capacidade de armazenamento.",
...
134 => 'A matéria escura é um recurso muito caro, e quem a possui em grande quantidade será um milionário. A tecnologia de extração de matéria escura foi investigada por cientistas de topo do império, acompanhado de um tecnocrata para chegar ao ponto final, que obter um porfin mñetodo para a remoção de matéria escura da lua.',
...
700 => 'O almirante é um veterano experiente e um estrategista hábil. Nas batalhas mais duras, é capaz de ter uma idéia da situação e manter contato com seus subordinados almirantes. Um sábio imperador pode contar com sua ajuda durante a luta para aumentar o valor de ataque das naves e defesas em %s%% ',
701 => 'Engenheiro de batalha é um especialista em gestão de energia em tempos de guerra, garante o fornecimento de energia para os canhões, evitando assim uma sobrecarga, o que leva a uma redução na defesa perdeu na batalha em %s%%.',
702 => 'O coordenador é responsável pela limpeza do local de trabalho do império, na sua presença o tempo de construção é reduzido em %s%%.',
703 => 'O geólogo é um especialista em astrominerología e astrocristalografía. equipes Auxilia na metalúrgica e química e também é responsável pela comunicação interplanetária para otimizar o uso e aperfeiçoamento das matérias-primas por todo o império, aumentando a produção de recursos em %s%%.',
704 => 'O coordenador local é um especalista em gestão de energia em todas as vezes aumenta a eficiência de energia do planeta, aumentando a produção de energia em %s%%.',
705 => 'O Sindicato é composta por gênios tecnocratas, e eu sempre acho que limite perigoso, onde tudo explodir em mil pedaços, antes de encontrar uma explicação racional e tecnológico. Nenhum ser humano normal jamais iria quebrar o código de um tecnocrata, sua presença inspira pesquisadores império reduzindo o tempo de pesquisa em %s%%.',
706 => 'A frota total é responsável por coordenar as batalhas, o universo conhecido como a palma da sua mão, na presença da ordem geral da frota é diferente, e então é hora de navegar muito mais rápido, encurtando o tempo de vôo em %s%% para expedições exepcion.',
);
...
$LNG['info'][7]['name']          = "Mina de Nório";
$LNG['info'][7]['description']   = "Nório foi descoberto recentemente, é um mineral que nasceu da fusão de metal com vidro, é usado atualmente para construir navios como escudos Norio construídos tenham revelado muito mais resistentes do que os protetores de metal convencional, nori tem uma imagem semelhante a vidro, então você pode ver através dela, os engenheiros recurso valioso para encontrar uma nova mina conseguiram extrair das profundezas do planeta, é um recurso que está perto do núcleo dos planetas.";
...
$LNG['info'][25]['name']         = "Armazém de Nório";
$LNG['info'][25]['description']  = "Cada evolução do armazém de nório permite o aumento da capacidade de armazenamento. Se a capacidade máxima do armazém é atingida, a produção de cristal é interrompida.";
...
$LNG['info'][134]['name'] = 'Remoção de Matéria Escura';
$LNG['info'][134]['descrption'] = 'A matéria escura é um recurso muito caro, e quem a possui em grande quantidade será um milionário. A tecnologia de extração de matéria escura foi investigada por cientistas de topo do império, acompanhado de um tecnocrata para chegar ao ponto final, que obter um porfin mñetodo para a remoção de matéria escura da lua.';
...
// Thanks to g4me0ver for improvements in the translation.
