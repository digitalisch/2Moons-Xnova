...
$LNG['lm_forums']							= 'Fórum';
$LNG['lm_logout']							= 'Sair';
$LNG['lm_administration']				    = 'Administrador';
...
$LNG['bd_add_to_list']				        = '<input type="submit" value="Adicionar a lista"></input>';
...
$LNG['bd_lvl']								= 'Nível';
$LNG['bd_research']					        = '<input type="submit" value="Pesquisa para"></input>';
...
$LNG['of_available_points']					= 'Pontos Disponiveis:';
$LNG['of_points_per_thousand_darkmatter']	= '(1 ponto por %d %s)';
$LNG['of_lvl']								= 'Nivel';
...
//----------------------------------------------------------------------------//
//TRADER
$LNG['tr_empty_darkmatter']                 = 'Não tens recursos suficientes %s!';
$LNG['tr_cost_dm_trader']                   = 'O valor do mercador é de %s %s!';
$LNG['tr_only_positive_numbers']			= 'Só podes usar números positivos!';
$LNG['tr_not_enought_metal']				= 'Não tens metal suficiente.';
$LNG['tr_not_enought_crystal']				= 'Não tens metal suficiente.';
$LNG['tr_not_enought_deuterium']			= 'Não tens deutério suficiente.';
$LNG['tr_not_enought_norio']			    = 'Não tens nório suficiente.';
$LNG['tr_exchange_done']					= 'Troca efectuada';
$LNG['tr_call_trader']						= 'Chama um mercador';
$LNG['tr_call_trader_who_buys']			    = 'Chama um mercador que compre ';
$LNG['tr_call_trader_submit']				= 'Chama o mercador';
$LNG['tr_exchange_quota']					= 'A taxa de troca e 2/1/0.7/0.5';
$LNG['tr_sell_metal']						= 'Vende metal';
$LNG['tr_sell_crystal']						= 'Vende cristal';
$LNG['tr_sell_deuterium']					= 'Vende deutério';
$LNG['tr_sell_norio']					    = 'Vende nório';
$LNG['tr_resource']							= 'Recursos';
$LNG['tr_amount']							= 'Quantidade';
$LNG['tr_quota_exchange']					= 'Taxa de troca';
$LNG['tr_exchange']							= 'Troca';
...
$LNG['mg_type'][2]                          = 'Mensagens de<br> Aliança';
$LNG['mg_type'][3]                          = 'Mensagens de Combate';
$LNG['mg_type'][4]                          = 'Mensagens de<br> Sistema';
$LNG['mg_type'][5]                          = 'Mensagens de Transporte';
$LNG['mg_type'][15]                         = 'Mensagens de Expedição';
$LNG['mg_type'][50]                         = 'Mensagens de<br> Jogo';
$LNG['mg_type'][99]                         = 'Mensagens de Construção';
$LNG['mg_type'][100]                        = 'Todas<br> as<br> mensagens';
...
$LNG['al_disolve_alliance']				    = 'Dissolver Aliança';
...
$LNG['al_tfnorio']   					    = 'Total de destroços de nório';
...
$LNG['sh_search_in_the_universe']		    = 'Procurar no universo vedra';
...
$LNG['bs_names']		                    = "Frota";
$LNG['bs_atter']		                    = "Simulador";
$LNG['bs_deffer']		                    = "Simulador";
$LNG['bs_steal']                            = "Recursos(Para Roubo):";
