...
$LNG['Metal']								= 'of Metal';
$LNG['Crystal']								= 'of Crystal';
$LNG['Deuterium']							= 'of Deuterium';
$LNG['Norio']						     	= 'of Norium';
$LNG['Darkmatter']							= 'of Dark matter';
$LNG['Energy']								= 'of Energy';
...
$LNG['fleet_attack_1'] 						= "Fleet shoots the attacking of with a performance";
$LNG['fleet_attack_2']						= "on the defender. The shields of the defender absorb";
$LNG['fleet_defs_1'] 						= "The defending fleet shoots of with a performance";
$LNG['fleet_defs_2']						= "on the attacker. The shields of the attacker absorb";
...
$LNG['sys_stat_mess'] 		         		= 'Your fleet reaches the planet %s and deliver %s %s, %s %s, %s %s and %s %s.';
...
$LNG['sys_expe_back_home'] 					= 'Your fleet has returned again from the expedition.<br>They have brought %s %s, %s %s, %s %s, %s %s and %s %s brought.';
...
$LNG['sys_tran_mess_owner']		 			= 'One of your fleets reaches the planet %s %s and deliver %s %s, %s %s, %s %s and %s %s.';
$LNG['sys_tran_mess_user'] 		 			= 'A peaceful fleet of %s %s reached %s %s and delivers %s %s, %s %s, %s %s and %s %s.';
$LNG['sys_mess_fleetback'] 					= 'Fleet return';
$LNG['sys_tran_mess_back'] 					= 'One of your fleets sweeps to the planet %s %s back.';
$LNG['sys_recy_gotten'] 					= 'Having your Recycler %s %s, %s %s and %s %s collected';
$LNG['sys_gain'] 				  			= 'Profit';
...
$LNG['sys_gain'] 				  			= 'Profit';
$LNG['sys_fleet_won'] 						= 'One of your fleets sweeps of the attack at the planet %s %s back. You have captured %s %s, %s %s, %s %s and %s %s ';
