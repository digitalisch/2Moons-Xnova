...
class ResourceUpdate
{
	...
	private function UpdateRessource()
	{
		...
		else
		{
			...
			{
				$NorioTheorical		= $this->PLANET['norio'] + ($this->ProductionTime * (($CONF['norio_basic_income'] * $CONF['resource_multiplier']) + $this->PLANET['norio_perhour']) / 3600);
				$this->PLANET['norio']	= min($NorioTheorical, $MaxNorioStorage);
			}
		}
