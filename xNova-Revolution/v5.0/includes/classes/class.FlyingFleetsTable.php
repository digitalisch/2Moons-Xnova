...
class FlyingFleetsTable
{
	...
	private function CreateFleetPopupedMissionLink($FleetRow, $Texte, $FleetType)
	{
		...
		$FleetTotalC  = $FleetRow['fleet_resource_metal'] + $FleetRow['fleet_resource_crystal'] + $FleetRow['fleet_resource_deuterium'] + $FleetRow['fleet_resource_darkmatter'] + $FleetRow['fleet_resource_norio'];
		if ($FleetTotalC <> 0)
		{
			...
			$FRessource  .= "<tr><td style=\'width:50%\' class=\'transparent\'><span style=\'color:white\'>".$LNG['Norio']."</span></td><td style=\'width:50%\' class=\'transparent\'><span style=\'color:white\'>". pretty_number($FleetRow['fleet_resource_norio']) ."</span></td></tr>";
