...
function ShowBattleSimPage()
{
	...
	if($action == 'send')
	{
		...
		$StrRuins         	= sprintf($LNG['sys_gcdrunits'], $result['debree']['def'][0] + $result['debree']['att'][0], $LNG['Metal'], $result['debree']['def'][1] + $result['debree']['att'][1], $LNG['Crystal'], $result['debree']['def'][2] + $result['debree']['att'][2], $LNG['Norio']);
