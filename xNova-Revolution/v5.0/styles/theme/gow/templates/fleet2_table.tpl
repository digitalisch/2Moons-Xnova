		...
		<tr class="left top">
        	...
        	<td class="top">
				<table border="0" cellpadding="0" cellspacing="0" width="259">
					...
					<tr style="height:20px;">
        				<td class="transparent">{$Norio}</td>
        				<td class="transparent"><a href="javascript:maxResource('norio');">{$fl_max}</a></th>
        				<td class="transparent"><input name="norio" size="10" onchange="calculateTransportCapacity();" type="text"></td>
        			</tr>
                    <tr style="height:20px;">
