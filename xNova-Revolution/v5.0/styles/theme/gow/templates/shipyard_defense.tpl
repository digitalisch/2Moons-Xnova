    ...
    <table align="top" width="530">	
		...
		<tr>
			...
			<td class="l">
						...
						<!--BUTTON MAX IN HANGAR BUG IN THE FUNCTION maxcount IN SCRIPTS/GLOBAL.JS --><!--<input type="button" value="Max" onclick="$('#input_{$DefenseListRow.id}').val(maxcount({$DefenseListRow.id}))">-->
