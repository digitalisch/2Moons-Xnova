...
$LNG['step1_mysql_dbname']	= "MySQL-DB-Name: <br> Ej.: Game";
$LNG['step1_mysql_dbuser']	= "MySQL-DB-User: <br> Ej.: root";
$LNG['step1_mysql_dbpass']	= "MySQL-DB-Password: <br> Ej.: ar2r3c1";
$LNG['step1_mysql_prefix']	= "MySQL-DB-Prefix: <br> Ej.: uni1_";
...
$LNG['step4_need_fields']	= "Tienes que llenar todos los campos.";
