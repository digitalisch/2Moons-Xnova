...
<div id="content" class="content">
    ...
    <tr>
        ...
        <td>{$op_toolt_data}</td>
        <td><input name="sk" maxlength="2" size="2" value="{$opt_toolt_data}" type="text"> {$op_seconds}</td>
    </tr><tr>
	   ...
	   <th>{$op_shortcut}</th>
        ...
        <td>{$op_spy}</td>
        <td><img src="{$dpath}img/e.gif" alt=""><input name="settings_esp" type="checkbox" {if $user_settings_esp == 1}checked="checked"{/if}></td>
    </tr><tr>
        <td>{$op_write_message}</td>
        <td><img src="{$dpath}img/m.gif" alt=""><input name="settings_wri" type="checkbox" {if $user_settings_wri == 1}checked="checked"{/if}></td>
    </tr><tr>
        <td>{$op_add_to_buddy_list}</td>
        <td><img src="{$dpath}img/b.gif" alt=""><input name="settings_bud" type="checkbox" {if $user_settings_bud == 1}checked="checked"{/if}></td>
    </tr><tr>
        <td>{$op_missile_attack}</td>
        <td><img src="{$dpath}img/r.gif" alt=""><input name="settings_mis" type="checkbox" {if $user_settings_mis == 1}checked="checked"{/if}></td>
    </tr><tr>
        <td>{$op_send_report}</td>
        <td><img src="{$dpath}img/s.gif" alt=""><input name="settings_rep" type="checkbox" {if $user_settings_rep == 1}checked="checked"{/if}></td>
    </tr><tr>
