...
<tr>
   	<td width="50%"><a href="?page=accounteditor&amp;edit=buildings"><img src="./styles/images/Adm/arrowright.png" width="16" height="10"> {$ad_editor_buildings}</a></td>
   	<td width="50%"><a href="?page=accounteditor&amp;edit=ships"><img src="./styles/images/Adm/arrowright.png" width="16" height="10"> {$ad_editor_ships}</a></td>
</tr><tr>
   	<td width="50%"><a href="?page=accounteditor&amp;edit=defenses"><img src="./styles/images/Adm/arrowright.png" width="16" height="10"> {$ad_editor_defenses}</a></td>
