...
{if $GateFleetList}<form action="" method="post">{/if}
    ...
    <tr>
        ...
        <td colspan="2" style="background-image:url({$dpath}img/invisible.png);border:none;">
        <table>
			<tr>
				<td style="background-image:url({$dpath}img/invisible.png);border:none;"><img src="{$dpath}gebaeude/{$id}.png" alt="{$name}"></td>
				<td>{$description}
				{if $RapidFire}
				<br><br>
