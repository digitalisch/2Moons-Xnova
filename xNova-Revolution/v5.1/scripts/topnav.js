...
function initRessource() {
	...
	document.getElementById('current_norio').innerHTML = NumberGetHumanReadable(resourceTickerNorio.available);
	...
	if(resourceTickerNorio.limit[1] <= resourceTickerNorio.available)
		document.getElementById('current_norio').className = 'header res_current res_current_max';		
