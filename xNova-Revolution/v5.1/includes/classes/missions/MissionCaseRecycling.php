...
class MissionCaseRecycling extends MissionFunctions
{
   ...
   {   
      ...
      if ($Target['der_total'] <= $RecyclerCapacity) {
         ...
         $RecycledGoods['crystal'] = $Target['der_crystal'];
         $RecycledGoods['norio'] = $Target['der_norio'];
         if ($Target['der_metal'] > ($RecyclerCapacity - $RecycledGoods['crystal']) or $Target['der_metal'] > ($RecyclerCapacity - $RecycledGoods['norio'])) {
         ...
         $RecycledGoods['metal'] = $Target['der_metal'];
         $RecycledGoods['crystal'] = $Target['der_crystal'];
         if ($Target['der_norio'] > ($RecyclerCapacity - $RecycledGoods['metal']) or $Target['der_norio'] > ($RecyclerCapacity - $RecycledGoods['crystal'])) {
