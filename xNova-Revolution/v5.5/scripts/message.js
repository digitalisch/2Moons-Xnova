Message = {
        ...
        GenerateMessages: function () {
                ...
                HTML += '<form action="" id="del" onsubmit="Message.DelMessages();return false"><table width="90%" id="messages"><tr><th colspan="4">'+Message.LNG.mg_message_title+'</td></tr><tr style="height: 20px;"><th>'+Message.LNG.mg_action+'</th><th>'+Message.LNG.mg_date+'</th><th>';
                HTML += (Message.MessID != 999) ? Message.LNG.mg_from : Message.LNG.mg_to;
                HTML += '</th><th>'+Message.LNG.mg_subject+'</th></tr>';
                ...
                if(Message.MessID != 999 && Message.MessID != 50) {
                        ...
                        HTML += '</select>';
                        HTML += '<input class="submit" value="'+Message.LNG.mg_confirm_delete+'" type="button" onclick="Message.DelMessages()">';
                        HTML += '</td></tr>';
                }
                HTML += '</table></form>';
                $('#messages').remove();
