...
class ShowInfosPage
{
	...
	public function __construct()
	{
		...
		if($BuildID == 202 or $BuildID == 203 or $BuildID == 209 or $BuildID == 217 or $BuildID == 219) {
			$tipo = "<div class=\"imagen_tipo\"><center><img src=\"styles/theme/gow/imagenes/otros/fragata.png\" width=\"70\" height=\"69\"/><br /><b>" .$LNG['fragatas'] ."</b></center></div>";
		}
		
		if($BuildID == 204 or $BuildID == 205) {
			$tipo = "<div class=\"imagen_tipo\"><center><img src=\"styles/theme/gow/imagenes/otros/cazador.png\" width=\"70\" height=\"64\"/><br /><b>" .$LNG['cazador'] ."</b></center></div>";
		}
		
		if($BuildID == 206 or $BuildID == 207) {
			$tipo = "<div class=\"imagen_tipo\"><center><img src=\"styles/theme/gow/imagenes/otros/crucero.png\" width=\"70\" height=\"66\"/><br /><b>" .$LNG['cruceros'] ."</b></center></div>";
		}
		
		if($BuildID == 208 or $BuildID == 212 or $BuildID == 210 or $BuildID == 220) {
			$tipo = "<div class=\"imagen_tipo\"><center><img src=\"styles/theme/gow/imagenes/otros/civil.png\" width=\"70\" height=\"69\"/><br /><b>" .$LNG['civil'] ."</b></center></div>";
		}
		
		if($BuildID == 211 or $BuildID == 213 or $BuildID == 215) {
			$tipo = "<div class=\"imagen_tipo\"><center><img src=\"styles/theme/gow/imagenes/otros/insignia.png\" width=\"70\" height=\"77\"/><br /><b>" .$LNG['insignia'] ."</b></center></div>";
		}
		
		if($BuildID == 214 or $BuildID == 216 or $BuildID == 218) {
			$tipo = "<div class=\"imagen_tipo\"><center><img src=\"styles/theme/gow/imagenes/otros/capital.png\" width=\"70\" height=\"77\"/><br /><b>" .$LNG['capital'] ."</b></center></div>";
		}
