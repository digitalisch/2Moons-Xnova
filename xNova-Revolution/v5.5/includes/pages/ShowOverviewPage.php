...
function ShowOverviewPage()
{
	...
	{		
		...
		$BuildPlanet		= "<img src=\"styles/theme/gow/gebaeude/" .$Queue[0][0] ."png\" width=\"140\" height=\"140\" /><br />" .$LNG['tech'][$Queue[0][0]]." (".$Queue[0][1].")<br /><span style=\"color:#7F7F7F;\"><b>(".pretty_time($Queue[0][3] - TIMESTAMP).")</b></span>";
		} else {
	...
	if (!empty($PLANET['b_building'])) {
		...
		$Build		= "<a href=\"?page=buildings\" class=\"tooltip\" name=\"" .$LNG['tech'][$Queue[0][0]]  ."\"><img src=\"styles/theme/gow/gebaeude/" .$Queue[0][0] .".png\"  width=\"140\" height=\"140\" /></a><br /><b>" .$LNG['ov_subiendo'] ." " .$Queue[0][1] ."</b>";
	}
	else
	{
	...
	if (!empty($PLANET['b_hangar'])) {
		...
		$Build_h	= "<a href=\"?page=buildings&mode=fleet\" class=\"tooltip\" name=\"" .$LNG['tech'][$Queue2[0][0]] ."\"><img src=\"styles/theme/gow/gebaeude/" .$Queue2[0][0] .".png\"  width=\"140\" height=\"140\"  /></a><br /><b>" .$LNG['ov_cantidad'] ." " .$Queue2[0][1]."</b>" ;
	}
	else
	{
	...
	if($PLANET['der_metal']  > 0 or $PLANET['der_crystal'] > 0) {
		$escombros = "<img class=\"tooltip\" name=\"" .$LNG['Metal'] .": " .$PLANET['der_metal'] ."<br />" .$LNG['Crystal'] .": " .$PLANET['der_crystal']  ."\" src=\"styles/theme/gow/imagenes/escombro.png\" />";
	} else {
		$escombros = "<img src=\"styles/theme/gow/imagenes/escombro_o.png\" />";
	}
