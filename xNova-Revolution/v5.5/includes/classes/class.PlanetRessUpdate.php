...
class ResourceUpdate
{
	...
	{
		global $ProdGrid, $resource, $reslist, $CONF;
		
		$this->PLANET['metal_max']			= floor(2.5 * pow(1.8331954764, $this->PLANET[$resource[22]])) * 5000  * $CONF['resource_multiplier'] * STORAGE_FACTOR;
		$this->PLANET['crystal_max']		= floor(2.5 * pow(1.8331954764, $this->PLANET[$resource[23]])) * 5000  * $CONF['resource_multiplier'] * STORAGE_FACTOR;
		$this->PLANET['deuterium_max']		= floor(2.5 * pow(1.8331954764, $this->PLANET[$resource[24]])) * 5000  * $CONF['resource_multiplier'] * STORAGE_FACTOR;
		$this->PLANET['norio_max']		    = floor(2.5 * pow(1.8331954764, $this->PLANET[$resource[25]])) * 5000  * $CONF['resource_multiplier'] * STORAGE_FACTOR;
