...
class MissionCaseSpy extends MissionFunctions
{
	...
	private function SpyTarget($TargetPlanet, $Mode, $TitleString, $LNG)
	{
		...
		if ($Mode == 0)
		{
                ...
                <td style="width:25%;" class="left transparent"><img src="styles/theme/gow/images/metal.jpg" class="tooltip" name="'. $LNG['Metal'] .'" /></td><td style="width:25%;" class="left transparent">'. pretty_number($TargetPlanet['metal']) .'</td><td class="transparent">&nbsp;</td>
                <td style="width:25%;" class="left transparent"><img src="styles/theme/gow/images/cristal.jpg" class="tooltip" name="'. $LNG['Crystal']   .'" /></td><td style="width:25%;" class="left transparent">'. pretty_number($TargetPlanet['crystal'])    .'</td>
                </tr><tr>
                <td style="width:25%;" class="left transparent"><img src="styles/theme/gow/images/deuterio.jpg" class="tooltip" name="'. $LNG['Deuterium'] .'" /></td><td style="width:25%;" class="left transparent">'. pretty_number($TargetPlanet['deuterium'])  .'</td><td class="transparent">&nbsp;</td>
                <td style="width:25%;" class="left transparent"><img src="styles/theme/gow/images/energia.jpg" class="tooltip" name="'. $LNG['Energy']    .'" /></td><td style="width:25%;" class="left transparent">'. pretty_number($TargetPlanet['energy_max']) .'</td>
                </tr><tr>
				  <td style="width:25%;" class="left transparent"><img src="styles/theme/gow/images/norio.jpg" class="tooltip" name="'. $LNG['Norio'] .'" /></td><td style="width:25%;" class="left transparent">'. pretty_number($TargetPlanet['norio']) .'</td>
				</tr><tr>
				';
		...
		if ($LookAtLoop == true)
		{
			...
			while ($CurrentLook < $Loops)
			{
				...
				for ($Item = $ResFrom[$CurrentLook]; $Item <= $ResTo[$CurrentLook]; $Item++)
				{
					...
					$String  .= '<td style="width:25%;" class="left transparent"><img src="styles/theme/gow/gebaeude/' .$Item .'.png" width="50" height="50" class="tooltip" name="'.$LNG['tech'][$Item].'" /></td><td style="width:25%;" class="left transparent">'.pretty_number($TargetPlanet[$resource[$Item]]).'</td>';
