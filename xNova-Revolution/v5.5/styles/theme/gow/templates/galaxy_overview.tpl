...
<div id="elCosoxD">
<div id="cabezza" style="background-image: url(styles/theme/gow/imagenes/navegacion/head2.png);"></div>
<div id="eins_small">
        <div>	
	...
	<tr>
	<td style='width:80'>
	<img src='{$dpath}planeten/small/s_{$GalaxyRow.planet.image}.jpg' height='75' width=75 />
	</td>
	<td>
	...
	</tr></table>"><img src="{$dpath}imagenes/planeta.png" height="30" width="40" alt="" /></a></td>
	{/if}
	...
	<tr>
	<td style='width:80'>
	<img src='{$dpath}planeten/small/s_mond.jpg' height='75' style='width:75' />
	</td>
	<td>
	...
	</table>"><img src="{$dpath}imagenes/luna.png" height="22" width="22" alt="{$GalaxyRow.moon.name}" /></a>
	{else}
	<img src="{$dpath}imagenes/luna_o.png" height="22" width="22" alt="{$GalaxyRow.moon.name}" />
	{/if}
	</td>
	...
	<tr>
	<td style='width:80'><img src='{$dpath}planeten/debris.jpg' height='75' style='width:75' />
	</td>
	...
	</table>"><img src="{$dpath}imagenes/escombro.png" height="22" width="22" alt="" /></a>
	{else}
	<img src="{$dpath}imagenes/escombro_o.png" height="22" width="22" alt="" />
	{/if}
	</td>
	...
	<td><img class="tooltip" name="{$inavitado}" src="{$dpath}imagenes/planeta_o.png" height="30" width="40" /></td><td style="white-space: nowrap;">-</td><td style="white-space: nowrap;"><img src="{$dpath}imagenes/luna_o.png" height="22" width="22" /></td><td style="white-space: nowrap;"><img src="{$dpath}imagenes/escombro_o.png" height="22" width="22" /></td><td>-</td><td>-</td><td style="white-space: nowrap;">-</td>
	{else}
	<td><img class="tooltip" name="{$inavitado}" src="{$dpath}imagenes/planeta_o.png" height="30" width="40" /></td><td style="white-space: nowrap;">-</td><td style="white-space: nowrap;"><img src="{$dpath}imagenes/luna_o.png" height="22" width="22" /></td><td style="white-space: nowrap;"><img src="{$dpath}imagenes/escombro_o.png" height="22" width="22" /></td><td>-</td><td>-</td><td style="white-space: nowrap;">-</td>
	{/if}
	</tr>
	...
	<tr>
		...
		</table>"><img src="{$dpath}imagenes/otros/s.gif" /></a> 
		</td></td>
	</tr>
...
<div>
<br />							
   <form action="?page=missiles&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$gl_cp}" method="POST"> 
	<tr>
		<table>
			<tr>
...
<div id="menu_flotas">
	...
	<table class="galaxia_mini">
		<tr>
			<td><img class="tooltip" name="{$gl_avaible_spyprobes}" src="styles/theme/gow/gebaeude/210.png" width="50" height="50" /></td><td> <span id="probes">{$spyprobes}</span> </td>
		</tr><tr>
			<td><img class="tooltip" name="{$gl_avaible_recyclers}" src="styles/theme/gow/gebaeude/209.png" width="50" height="50" /></td><td> <span id="recyclers">{$recyclers}</span></td> 
		</tr><tr>
			<td><img class="tooltip" name="{$gl_avaible_grecyclers}" src="styles/theme/gow/gebaeude/219.png" width="50" height="50" /></td><td> <span id="grecyclers">{$grecyclers}</span></td> 
		</tr>
	</table>
