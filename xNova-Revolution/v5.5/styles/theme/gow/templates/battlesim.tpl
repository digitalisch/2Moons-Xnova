...
<tr>
<td>
<center><img src="styles/theme/gow/images/metal.jpg" class="tooltip" name="{$Metal}" /> <br /><input class="campo_comun" type="text" size="10" value="{if $battleinput.0.1.1}{$battleinput.0.1.1}{else}0{/if}" name="battleinput[0][1][1]"></center>
</td>

<td>
 <center><img src="styles/theme/gow/images/cristal.jpg" class="tooltip" name="{$Crystal}" /> <br /> <input class="campo_comun" type="text" size="10" value="{if $battleinput.0.1.2}{$battleinput.0.1.2}{else}0{/if}" name="battleinput[0][1][2]"></center>
 </td>
 
 <td>
 <center><img src="styles/theme/gow/images/deuterio.jpg" class="tooltip" name="{$Deuterium}" /> <br />  <input class="campo_comun" type="text" size="10" value="{if $battleinput.0.1.3}{$battleinput.0.1.3}{else}0{/if}" name="battleinput[0][1][3]"></center>
 </td>
 
 <td>
 <center><img src="styles/theme/gow/images/norio.jpg" class="tooltip" name="{$Norio}" /> <br />  <input class="campo_comun" type="text" size="10" value="{if $battleinput.0.1.4}{$battleinput.0.1.4}{else}0{/if}" name="battleinput[0][1][4]"></center>
</td>
</tr>
