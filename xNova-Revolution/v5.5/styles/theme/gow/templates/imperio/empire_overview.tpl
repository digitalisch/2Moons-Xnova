...
<br />
 	<table id="imperio_tabla">        
			<tr>
				...
				<td><a href="game.php?page=overview&amp;cp={$PlanetsInfoRow.InfoList.id}&amp;re=0"><img class="redondeada" width="80" height="80" border="0" src="{$dpath}planeten/small/s_{$PlanetsInfoRow.InfoList.image}.jpg" alt="{$PlanetsInfoRow.InfoList.name}" /></a></td>
				{/foreach}
            </tr>
            <tr>
				<td></td>
			...
			<tr>
				<td><img class="tooltip" name="<font color='#a0b3cd'><b><h3>{$Metal}</h3></b></font>" src="styles/theme/gow/images/metal.jpg" /></td>
				{foreach item=PlanetsInfoRow from=$PlanetsList}
					<td class="tech_nombre"><font color="#a0b3cd"><b><h3>{$PlanetsInfoRow.InfoList.metal}</h3></b></font></td>
				{/foreach}
			</tr>
            <tr>
				<td><img class="tooltip" name="<font color='#6eb6ff'><b><h3>{$Crystal}</h3></b></font>" src="styles/theme/gow/images/cristal.jpg" /></td>
				{foreach item=PlanetsInfoRow from=$PlanetsList}
					<td class="tech_nombre"><font color="#6eb6ff"><b><h3>{$PlanetsInfoRow.InfoList.crystal}</h3></b></font></td>
				{/foreach}
			</tr>
			<tr>
				<td><img class="tooltip" name="<font color='#dbfff8'><b><h3>{$Norio}</h3></b></font>" src="styles/theme/gow/images/norio.jpg" /></td>
				{foreach item=PlanetsInfoRow from=$PlanetsList}
					<td class="tech_nombre"><font color="#dbfff8"><b><h3>{$PlanetsInfoRow.InfoList.norio}</h3></b></font></td>
				{/foreach}
			</tr>
            <tr>
				<td><img class="tooltip" name="<font color='#1a8494'><b><h3>{$Deuterium}</h3></b></font>" src="styles/theme/gow/images/deuterio.jpg" /></td>
				{foreach item=PlanetsInfoRow from=$PlanetsList}
					<td class="tech_nombre"><font color="#1a8494"><b><h3>{$PlanetsInfoRow.InfoList.deuterium}</h3></b></font></td>
				{/foreach}
			</tr>
            <tr>
				<td><img class="tooltip" name="<font color='#e36b6a'><b><h3>{$Energy}</h3></b></font>" src="styles/theme/gow/images/energia.jpg" /></td>
				{foreach item=PlanetsInfoRow from=$PlanetsList}
			...
			<tr>
              <th class="repetido" colspan="{$colspan}">{$iv_buildings}</th>
				...
				{foreach item=Builds from=$build}
					<tr>
					<td><img class="tooltip" name="<b><h3>{$tech.$Builds}</h3></b>" src="styles/theme/gow/gebaeude/{$Builds}.png" width="50" height="50" /></td>
					{foreach item=PlanetsInfoRow from=$PlanetsList}
			...
			<tr>
				...
				{foreach item=Researchs from=$research}
					<tr>
					<td><img class="tooltip" name="<b><h3>{$tech.$Researchs}</h3></b>" src="styles/theme/gow/gebaeude/{$Researchs}.png" width="50" height="50" /></td>
					{foreach item=PlanetsInfoRow from=$PlanetsList}
            ...
            <tr>
               <th class="repetido" colspan="{$colspan}">{$iv_ships}</th>
				...
				{foreach item=Fleets from=$fleet}
					<tr>
					<td><img class="tooltip" name="<b><h3>{$tech.$Fleets}</h3></b>" src="styles/theme/gow/gebaeude/{$Fleets}.png" width="50" height="50" /></td>
					{foreach item=PlanetsInfoRow from=$PlanetsList}
            ...
            <tr>
				...
				{foreach item=Defenses from=$defense}
					<tr>
					<td><img class="tooltip" name="<b><h3>{$tech.$Defenses}</h3></b>" src="styles/theme/gow/gebaeude/{$Defenses}.png" width="50" height="50" /></td>
					{foreach item=PlanetsInfoRow from=$PlanetsList}
