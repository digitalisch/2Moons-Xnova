...
<div id="planeta_small" style="background-image: url(styles/theme/gow/adds/redes.jpg);"></div>	
<div id="titulo_alternativo_corto">
    <ul class="tabsbelow">
        <li>
              <span><b>{$al_configura_ranks}</b></span>
        </li>                                    
    </ul>
</div>	
<div id="eins">
<div>		
	...
	<tr>
		<th>{$al_dlte}</th>
		<th>{$al_rank_name}</th>
		<td><img class="tooltip" name="{$al_legend_disolve_alliance}" src="styles/theme/gow/imagenes/otros/r1.png" alt=""></td>
		<td><img class="tooltip" name="{$al_legend_kick_users}" src="styles/theme/gow/imagenes/otros/r2.png" alt=""></td>
		<td><img class="tooltip" name="{$al_legend_see_requests}" src="styles/theme/gow/imagenes/otros/r3.png" alt=""></td>
		<td><img class="tooltip" name="{$al_legend_see_users_list}" src="styles/theme/gow/imagenes/otros/r4.png" alt=""></td>
		<td><img class="tooltip" name="{$al_legend_check_requests}" src="styles/theme/gow/imagenes/otros/r5.png" alt=""></td>
		<td><img class="tooltip" name="{$al_legend_admin_alliance}" src="styles/theme/gow/imagenes/otros/r6.png" alt=""></td>
		<td><img class="tooltip" name="{$al_legend_see_connected_users}" src="styles/theme/gow/imagenes/otros/r7.png" alt=""></td>
		<td><img class="tooltip" name="{$al_legend_create_circular}" src="styles/theme/gow/imagenes/otros/r8.png" alt=""></td>
		<td><img class="tooltip" name="{$al_legend_right_hand}" src="styles/theme/gow/imagenes/otros/r9.png" alt=""></td>
	</tr>
