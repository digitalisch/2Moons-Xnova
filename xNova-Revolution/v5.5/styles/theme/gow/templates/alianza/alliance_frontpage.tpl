...
<div>
 <table width="95%">		
		...
		<th>{$alianzas}</th>
			...
			<tr class="alt">
			<td width="30"><img class="tooltip" name="{$al_diplo_level.1}" src="styles/theme/gow/imagenes/otros/pacto_alianza.png" width="60" height="58" /></td>
			...
			<tr class="alt_2">
			<td width="30"><img class="tooltip" name="{$al_diplo_level.2}" src="styles/theme/gow/imagenes/otros/pacto_comercio.png" width="60" height="58" /></td>
			...
			<tr class="alt">
			<td width="30"><img class="tooltip" name="{$al_diplo_level.3}" src="styles/theme/gow/imagenes/otros/no_agrecion.png" width="60" height="58" /></td>
			...
			<tr class="alt_2">
			<td width="30"><img class="tooltip" name="{$al_diplo_level.4}" src="styles/theme/gow/imagenes/otros/en_guerra.png" width="60" height="58" /></td>
...
<div id="menu_flotas">
		<div id="lista_misiones">    
			...
			<div class="misiones">
			<img class="tooltip" name="{$logo}" src="{$ally_image}" width="151" height="151" />
			</div> 
