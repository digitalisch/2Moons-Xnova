...
<div id="eins">
	...
	<tr>
        <td>&nbsp;</td>
		<td><img class="tooltip" name="{$Metal}" src="styles/theme/gow/images/metal.jpg" /></td>
        <td><img class="tooltip" name="{$Crystal}" src="styles/theme/gow/images/cristal.jpg" /></td>
        <td><img class="tooltip" name="{$Deuterium}" src="styles/theme/gow/images/deuterio.jpg" /></td>
        <td><img class="tooltip" name="{$Norio}" src="styles/theme/gow/images/norio.jpg" /></td>		
        <td><img class="tooltip" name="{$Energy}" src="styles/theme/gow/images/energia.jpg" /></td>
	...
	<tr>
		<td><img class="tooltip" name="{$CurrPlanetInfo.type}" src="styles/theme/gow/gebaeude/{$CurrPlanetInfo.id}.png" width="50" height="50" /><br /><font color="lime">({$CurrPlanetInfo.level} {$CurrPlanetInfo.level_type})</font></td>
		<td class="semi_remarcado"><h3>{$CurrPlanetInfo.metal_type}</h3></td>
		<td class="remarcado"><h3>{$CurrPlanetInfo.crystal_type}</h3></td>
		<td class="semi_remarcado"><h3>{$CurrPlanetInfo.deuterium_type}</h3></td>
		<td class="remarcado"><h3>{$CurrPlanetInfo.norio_type}</h3></td>		
