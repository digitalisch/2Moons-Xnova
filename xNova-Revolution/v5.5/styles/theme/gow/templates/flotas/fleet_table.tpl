...
<div id="planeta_small" style="background-image: url(styles/theme/gow/adds/flotas1.jpg);"></div>
...
<div id="eins">
	...
	<br />
		...
		{foreach name=Fleets item=FleetRow from=$FleetsOnPlanet}   
			{if $FleetRow.speed != 0}
			<li>
			<img class="tooltip" name="<font color='orange'><b>{$FleetRow.name}:</b></font> <td id='ship{$FleetRow.id}_value'>{$FleetRow.count}</td><br /><b>{$fl_speed_title}</b> {pretty_number($FleetRow.speed)}" src="styles/theme/gow/gebaeude/{$FleetRow.id}.png" width="70" height="70" /><br />{else}&nbsp;{/if}
			{if $FleetRow.id == 212} {else}<font color="orange"><b><ul id="ship{$FleetRow.id}_value">{$FleetRow.count}</ul></b></font>{/if}
			{if $FleetRow.speed != 0}
			<input name="ship{$FleetRow.id}" id="ship{$FleetRow.id}_input" class="campo_comun" size="10" value="" /><a href="javascript:maxShip('ship{$FleetRow.id}');"><img class="max_img" src="styles/theme/gow/imagenes/navegacion/none.png" /></a>
			</li>
			{else}
			&nbsp;
			{/if}
...
<div id="info_centro">	
	<span id="info_izquierda">
		<img class="tooltip" name="<font color='orange'><b>{$fl_bonus_attack}:</b></font> +{$bonus_attack}%" src="styles/theme/gow/imagenes/infos/Atacar.png" />
		<img class="tooltip" name="<font color='orange'><b>{$fl_bonus_defensive}:</b></font> +{$bonus_defensive}%" src="styles/theme/gow/imagenes/infos/defensa.png" />
		<img class="tooltip" name="<font color='orange'><b>{$fl_bonus_shield}:</b></font> +{$bonus_shield}%" src="styles/theme/gow/imagenes/infos/shield.png" />	
	</span>	
	<span>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</span>
	<span id="info_derecha">
		<img class="tooltip" name="<font color='orange'><b>{$bonus_comp}:</b></font> +{$bonus_combustion}%" src="styles/theme/gow/imagenes/infos/combustion.png" />
		<img class="tooltip" name="<font color='orange'><b>{$bonus_impul}:</b></font> +{$bonus_impulse}%" src="styles/theme/gow/imagenes/infos/impulso.png" />
		<img class="tooltip" name="<font color='orange'><b>{$bonus_hyper}:</b></font> +{$bonus_hyperspace}%" src="styles/theme/gow/imagenes/infos/hiperespacio.png" />	
	</span>
</div>	
</div>
</div>	
