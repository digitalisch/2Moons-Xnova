...
<div id="planeta_small" style="background-image: url(styles/theme/gow/adds/investigaciones.jpg);"></div>
	...
	<ul class="estructuras_c">
		{foreach item=ResearchInfoRow from=$ResearchList}
			<li>
				...
				{if $ResearchInfoRow.lvl > 0}<div class="nivel_c"> <b style="cursor:help;" class="tooltip" name="{$bd_lvl} {$ResearchInfoRow.lvl}">{$bd_lvl} {$ResearchInfoRow.lvl} {if $ResearchInfoRow.elvl > 0} <span style="color:lime;">+{$ResearchInfoRow.elvl}</span>{/if}</b></div>{/if}		
				<br />
