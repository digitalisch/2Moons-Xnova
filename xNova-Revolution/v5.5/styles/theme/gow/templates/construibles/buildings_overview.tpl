...
<div id="topnav" class="header_normal"> 	
		{include file="overall_topnav.tpl"}	
			...
			<div id="estructura_titular" style="position:relative;">
				<div id="titular_texto" style="display: block;">{$lm_buildings}</div>
			</div>
        </div>
	</div> 
   ...
   <table width="95%">	
		...
		{foreach item=BuildInfoRow from=$BuildInfoList}
			<li>
				...
				{if $BuildInfoRow.level > 0} <div class="tooltip destruir_c" name="<table style=\'width:100%;margin:0;padding:0\'><tr><th colspan=\'2\'>&nbsp;{$bd_price_for_destroy} {$BuildInfoRow.name} {$BuildInfoRow.level}&nbsp;</th></tr><tr><td class=\'transparent\'><img src=styles/theme/gow/images/metal.jpg width=30 height=20 /></td><td class=\'transparent\'>{$BuildInfoRow.destroyress.metal}</td></tr><tr><td class=\'transparent\'><img src=styles/theme/gow/images/cristal.jpg width=30 height=20 /></td><td class=\'transparent\'>{$BuildInfoRow.destroyress.crystal}</td></tr><tr><td class=\'transparent\'><img src=styles/theme/gow/images/deuterio.jpg width=30 height=20 /></td><td class=\'transparent\'>{$BuildInfoRow.destroyress.deuterium}</td></tr><tr><td class=\'transparent\'><img src=styles/theme/gow/images/norio.jpg width=30 height=20 /></td><td class=\'transparent\'>{$BuildInfoRow.destroyress.norio}</td></tr><tr><td class=\'transparent\'>{$bd_destroy_time}</td><td class=\'transparent\'>{$BuildInfoRow.destroytime}</td></tr></table>"><a href="game.php?page=buildings&amp;cmd=destroy&amp;building={$BuildInfoRow.id}"><img src="styles/theme/gow/imagenes/navegacion/destruir.gif" /></a></div>{/if}
				<div class="demas_c">
