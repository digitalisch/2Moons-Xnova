...
<div id="topnav" class="header_normal"> 	
		{include file="overall_topnav.tpl"}	
			...
			<div id="estructura_titular" style="position:relative;">
				<div id="titular_texto" style="display: block;">{$chat_disc}</div>
			</div>
        </div>
	</div> 
...
<table width="98%">
	...
	<tr>
		<td> 
		{$chat_message}: <input class="campo_comun" name="msg" type="text" id="msg" style="width:75%" maxlength="255"> 
		<input class="campo_comun" type="submit" name="send" value="{$chat_send}" id="send">
		</td>
	</tr>
	<tr>
		...
		&nbsp;&nbsp;
		<input class="campo_comun" type="button" style="font-weight:bold" name="Bold" value="B" onClick="addBBcode('[b] [/b]')" />
		<input class="campo_comun" type="button" style="font-style:italic;" name="Italic" value="I" onClick="addBBcode('[i] [/i]')" />
		<input class="campo_comun" type="button" style="text-decoration:underline;" name="underlined" value="U" onClick="addBBcode('[u] [/u]')" />
		<input class="campo_comun" type="button" name="url" value="URL" onClick="addBBcode('*URL*')" />
		</td>
	</tr>
	<tr>
		<td> 
