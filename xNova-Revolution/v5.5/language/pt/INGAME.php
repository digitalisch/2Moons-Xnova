 ...
 * @version 5.3 Redesigned (17-09-2011)
 ...
 - Tradução original por QwataKayean <qwatakayean@gmail.com>
...
$LNG['see_you_soon']						= 'Até logo. Aguardamos por si!';
$LNG['page_doesnt_exist']					= 'A página que seleccionou não existe';
...
$LNG['lm_notes']							= 'Notas';
$LNG['lm_statistics']				        = 'Estatísticas';
...
$LNG['lm_game_speed']					    = 'Jogo';
$LNG['lm_fleet_speed']					    = 'Frota';
$LNG['lm_resources_speed']				    = 'Recursos';
$LNG['lm_queue']							= 'Fila de Construção';
$LNG['lm_topkb']                            = 'Salão da Fama';
$LNG['lm_faq']                              = 'Ajudas';
...
# General
$LNG['rang_1']  = 'Civilização Primitiva';
$LNG['rang_2']  = 'Civilização Planetária';
$LNG['rang_3']  = 'Civilização Espacial';
$LNG['rang_4']  = 'Civilização Colonial';
$LNG['rang_5']  = 'Civilização Avançada';
$LNG['rang_6']  = 'Império Estrelar';
$LNG['rang_7']  = 'Império Galáctico';
$LNG['rang_8']  = 'Império Avançado';
$LNG['rang_9']  = 'Império Dominante';
$LNG['ov_fragatas'] = "Fragatas: ";
$LNG['ov_cazador'] = "Caçadores: ";
$LNG['ov_civil'] = "Naves Civis: ";
$LNG['ov_cruceros'] = "Cruzadores: ";
$LNG['ov_insignia'] = "Naves de Batalha: ";
$LNG['ov_capital'] = "Naves de Destruição: ";
$LNG['ov_subiendo']						= 'A evoluir - Nível';
...
$LNG['ov_estructuras_construccion']     = 'Construções';
$LNG['ov_principal_planet_cant_abanone']	= 'Não e possível apagar o planeta principal!';
$LNG['ov_abandon_planet_not_possible']      = 'A colónia não pode ser abandonada, com movimentos de frotas a partir ou para!';
$LNG['ov_wrong_pass']			            = 'A password que introduziste está inválida! Tenta de novo.';
$LNG['ov_have_new_message']		            = 'Tens 1 mensagem nova';
$LNG['ov_cantidad']						= 'Construindo %d unidades';
$LNG['ov_have_new_messages']		        = 'Tens %d mensagens novas';
$LNG['ov_planetmenu']                       = 'Abandonar | Renomear Planeta';
$LNG['ov_free']                             = 'Livre';
$LNG['ov_news']                             = 'Notícias';
$LNG['ov_place']                            = 'Posição';
$LNG['ov_of']                               = 'de';
$LNG['ov_planet']                           = 'Planeta';
$LNG['ov_free_estructuras']					= 'De momento não existe nenhum edifício em construção/demolição.';
$LNG['ov_free_hangar']						= 'De momento não existem naves/defesas em construção. ';
$LNG['ov_server_time']			            = 'Hora do servidor ';
...
$LNG['ov_no_admins_online']                 = 'Não se encotra nenhum Admin online!';
$LNG['ov_userbanner']                       = 'Estatísticas-Banner';
$LNG['ov_userrank_info']                    = '%s (%s <a href="game.php?page=statistics&amp;range=%d">%d</a> %s %s)';
$LNG['ov_teamspeak_not_online']             = 'Servidor está inacessível. Pedimos a sua compreensão.';
...
# Bonus
$LNG['packs_darkmatter'] = "de Materia Negra";
$LNG['packs_en_venta'] = "Packs em venda";
$LNG['packs_comprar'] = "Comprar";
$LNG['packs_coste'] = "Preço: ";
$LNG['recursos_pack'] = "Pack de Recursos";
$LNG['recursos_pack_descr'] = "Metal: +10.000.000 <br />Cristal: +5.000.000 <br />Nório: +4.000.000 <br />Deuterio: +2.500.000";
$LNG['minas_pack'] = "Pack de Minas";
$LNG['minas_pack_descr'] = "Mina de Metal +2 <br />Mina de Cristal +2 <br />Mina de Nório +2 <br />Planta de Energía Solar +5 <br />Fábrica de Robots +2";
$LNG['Armazémes_pack'] = "Pack de Armazens";
$LNG['Armazémes_pack_descr'] = "Armazém de Metal +1 <br />Armazém de Cristal +1 <br />Armazém de Deuterio +1 <br />Armazém de Nório +1 ";
$LNG['flotas_pack'] = "Pack de Frotas";
$LNG['flotas_pack_descr']  = "Cargueiros Pequenos: +300.000 <br />Cargueiros Grandes: +150.000 <br />Grande Reciclador: +500 <br />Deuterio: +3.000.000 ";
$LNG['bunkers_pack'] = "Pack de Bunker";
$LNG['bunkers_pack_descr'] = "Pequeno Escudo Planetário +1 <br />Grande Escudo Planetário +1 <br />Gigantic signpost dome +1 <br />Canhão de Iões: +20.000 ";
$LNG['tecnos_pack'] = "Pack de Tecnología";
$LNG['tecnos_pack_descr'] = "Espionagem +1 <br />Computadores +1 <br />Energía +1 <br />Motores de Combustão +1 <br />Motores de Impulsão +1 <br />Motores de  Hiperespaço +1 ";
$LNG['bn_pack_ok'] = "Compraste esse pack.";
$LNG['bn_pack_no'] = "Não tens matéria negra suficiente para comprar esse pack.";

#Galaxia (Universo)
$LNG['gl_no_deuterium_to_view_galaxy']	    = 'não tem deutério suficiente';
$LNG['gl_legend']							= 'Legendas';
$LNG['gl_strong_player']				    = 'Jogador Forte';
$LNG['gl_week_player']		                = 'Jogador fraco (novato)';
...
$LNG['gl_missil_to_launch']			        = 'Numero de mísseis (<b>%d</b> disponíveis):';
$LNG['gl_all_defenses']					    = 'Todas as Defesas!';
$LNG['gl_objective']						= 'Objectivo';
$LNG['gl_missil_launch_action']			    = 'OK';
$LNG['gl_galaxy']							= 'Galáxia';
$LNG['gl_solar_system']					    = 'Sistema';
$LNG['gl_show']						        = 'Mostrar';
$LNG['gl_pos']								= 'posições';
$LNG['gl_planet']							= 'Planeta';
$LNG['gl_name_activity']			        = 'Nomes Dos P. (actividade)';
$LNG['gl_moon']						        = 'Luas';
$LNG['gl_debris']							= 'Destroços';
$LNG['gl_player_estate']				    = 'Jogadores (estado)';
$LNG['gl_alliance']							= 'Alianças';
$LNG['gl_actions']							= 'Acções';
$LNG['gl_spy']								= 'Espionagem';
$LNG['gl_buddy_request']			        = 'Pedido de amizade';
$LNG['gl_missile_attack']			        = 'Ataque de mísseis';
$LNG['gl_with']					            = ' consiste em ';
$LNG['gl_member']					        = ' Numero';
$LNG['gl_member_add']					    = '(s)';
$LNG['gl_alliance_page']			        = 'Página de Aliança';
$LNG['gl_see_on_stats']				        = 'Estatísticas';
$LNG['gl_alliance_web_page']		        = 'Link da página da alianca';
$LNG['gl_debris_field']			            = 'Campo de destroços';
$LNG['gl_collect']							= 'Reciclar';
$LNG['gl_resources']						= 'Recursos';
$LNG['gl_features']							= 'Features';
$LNG['gl_diameter']							= 'Diâmetro';
$LNG['gl_temperature']					    = 'Temperatura';
$LNG['gl_phalanx']							= 'Phalanx';
$LNG['gl_planet_destroyed']		            = 'Planeta destruído';
...
$LNG['gl_to']								= 'depois';
 ...
 # Phalanx
$LNG['px_no_deuterium']					    = 'Não tens deutério sufeciente!';
$LNG['px_scan_position']					= 'Phalanxiar Planeta';
$LNG['px_fleet_movement']					= 'Movimentos de Frota em';
$LNG['px_no_fleet']                         = 'Nenhum movimento actual de frota.';
$LNG['px_out_of_range']						= 'Não tens alcançe sufeciente!';

//----------------------------------------------------------------------------//
//IMPERIUM
$LNG['iv_imperium_title']                   = 'Vista de Império';
$LNG['iv_planet']                           = 'Planeta';
$LNG['iv_name']                             = 'Nome';
$LNG['iv_coords']                           = 'Coordenadas';
$LNG['iv_fields']                           = 'Campos';
$LNG['iv_resources']                        = 'Recursos';
$LNG['iv_buildings']                        = 'Edifícios';
$LNG['iv_technology']                       = 'Tecnologias';
$LNG['iv_ships']                            = 'Frota';
...
$LNG['fl_titulo_misiones']					= 'Missões Actuais';
$LNG['fl_no_misiones']						= 'Não há qualquer tipo de missão.';
$LNG['fl_returning']						= 'Regressar';
$LNG['fl_onway']							= 'A caminho';
$LNG['fl_r']								= '(R)';
$LNG['fl_a']								= '(A)';
$LNG['fl_send_back']						= 'Regressar';
$LNG['fl_acs']								= 'ACS';
$LNG['fl_no_more_slots']	                = 'Todos os slots de frota ocupados';
$LNG['fl_speed_title']					    = 'Velocidade: ';
$LNG['fl_continue']							= 'continuar';
$LNG['fl_no_ships']			                = 'Sem frota disponível';
$LNG['fl_remove_all_ships']				    = 'sem frota';
$LNG['fl_select_all_ships']			        = 'toda a frota';
$LNG['fl_fleets']							= 'Frota';
$LNG['fl_expeditions']					    = 'Exploração Espacial';
$LNG['fl_number']							= 'ID';
$LNG['fl_mission']							= 'Missão';
$LNG['fl_ammount']					        = 'Naves (total)';
$LNG['fl_beginning']						= 'Origem';
$LNG['fl_departure']						= 'Partida';
...
$LNG['fl_ship_available']				    = 'Disponível';
$LNG['fl_planet']							= 'Planeta';
$LNG['fl_debris']							= 'Destroços';
$LNG['fl_moon']						        = 'Lua';
...
$LNG['fl_shortcut_add_title']				= 'Nome [Galáxia / Sistema / Planeta]';
$LNG['fl_shortcut_name']					= 'Nome';
$LNG['fl_shortcut_galaxy']				    = 'Galáxia';
$LNG['fl_shortcut_solar_system']			= 'Sistema solar';
$LNG['fl_clean']							= 'Apagar';
$LNG['fl_register_shorcut']				    = 'Registar';
$LNG['fl_shortcuts']						= 'Atalhos';
$LNG['fl_reset_shortcut']					= 'Apagar atalhos';
$LNG['fl_dlte_shortcut']				    = 'Apagar atalhos';
$LNG['fl_back']					         	= 'Regressa';
$LNG['fl_shortcut_add']					    = 'Adicionar';
$LNG['fl_shortcut_edition']				    = 'Editar Atalhos: ';
$LNG['fl_no_colony']					    = 'Sem colónias';
$LNG['fl_send_fleet']				        = 'Enviar frota';
$LNG['fl_fleet_speed']					    = 'Velocidade';
$LNG['fl_distance']							= 'Distância';
$LNG['fl_flying_time']					    = 'Tempo de vôo';
$LNG['fl_flying_arrival']					= 'Chegada';
$LNG['fl_flying_return']					= 'Retorno';
$LNG['fl_fuel_consumption']			        = 'Consumo de deutério';
...
$LNG['fl_my_planets']					    = 'Os meus planetas';
$LNG['fl_acs_title']						= 'Ataque de Aliança';
$LNG['fl_hold_time']						= 'Em órbita';
$LNG['fl_resources']						= 'Recursos';
$LNG['fl_cantidad']							= 'Quantidade';
$LNG['fl_accion']							= 'Acção';
$LNG['fl_max']								= 'max';
$LNG['fl_hours']                            = 'Horas';
...
$LNG['fl_vacation_mode_active']			    = 'Modo de férias activo';
$LNG['fl_expedition_tech_required']		    = 'Precisas de tecnologia de exploração espacial!';
$LNG['fl_expedition_fleets_limit']		    = 'Sem slots de exploração espacial desponiveis!';
$LNG['fl_week_player']						= 'O jogador está sob a protecção de jogador fraco';
...
$LNG['fl_empty_transport']				    = 'Não podes transportar os recursos';
...
$LNG['fl_fleet']					        = 'Frota';
$LNG['fl_player']					        = 'O jogador ';
$LNG['fl_add_to_attack']		            = ' foi adicionado ao ataque.';
$LNG['fl_dont_exist']	                    = ' não foi adicionado ao ataque.';
$LNG['fl_acs_invitation_message']	        = '  enviou-te um convite de ataque em ACS.';
$LNG['fl_acs_invitation_title']	            = 'Convite de ACS';
$LNG['fl_sac_of_fleet']			            = 'Frota em ACS';
...
$LNG['bd_max_lvl']                          = '(Max. Nível: %s)';
$LNG['bd_lvl']								= 'Nível';
$LNG['bd_research']					        = 'Pesquisa para';
$LNG['bd_shipyard_required']				= 'Terás de construir um hangar primeiro!';
$LNG['bd_building_shipyard']				= 'Não podes construir naves enquanto estiveres a subir o hangar de nível, a fábrica de robots ou a fábrica de nanites.';
...
$LNG['bd_actual_production']				= 'Produção actual:';
...
//----------------------------------------------------------------------------//
//RESOURCES
$LNG['rs_amount']							= 'Quantidade';
$LNG['rs_lvl']								= 'Nível';
$LNG['rs_production_on_planet']			    = 'Recursos produzidos no planeta "%s"';
$LNG['rs_basic_income']					    = 'Produção básica';
$LNG['rs_storage_capacity']				    = 'Capacidade de armazenamento';
$LNG['rs_calculate']						= 'Cálculo';
$LNG['rs_sum']								= 'Total';
...
$LNG['tr_empty_darkmatter']				= 'Não tens %s suficiente.';
$LNG['tr_cost_dm_trader']					= 'O valor das taxas é <font color=\'orange\'><b>%s</b></font> de %s';
$LNG['tr_almacenes']					= 'A capacidade dos teus armazens podem ser vista nos Edificios.';
$LNG['tr_only_positive_numbers']			= 'Só se pode comprar quantidades acima de 0.';
$LNG['tr_elemento'] 						= 'Trocar unidades de ';
$LNG['tr_not_enought_metal']				= 'Não tens metal suficiente.';
$LNG['tr_not_enought_crystal']				= 'Não tens cristal suficiente.';
$LNG['tr_not_enought_deuterium']			= 'Não tens deutério suficiente.';
$LNG['tr_not_enought_norio']				= 'Não tens nório suficiente.';
$LNG['tr_exchange_done']					= 'Troca realizada com sucesso.';
$LNG['tr_call_trader']						= 'Mercado de Recursos Intergaláctico';
$LNG['tr_call_trader_who_buys']				= 'Chama um mercador que troque:';
$LNG['tr_descr']							= 'O mercador só proporciona recursos que sejam compativeis com o teu armazém';
$LNG['tr_call_trader_submit']				= 'Negociar';
$LNG['tr_exchange_quota']					= 'O tipo de taxa é de 2/1/0.25/0.5';
$LNG['tr_sell_metal']						= 'Vender metal';
$LNG['tr_sell_crystal']					= 'Vender cristal';
$LNG['tr_sell_deuterium']					= 'Vender deutério';
$LNG['tr_sell_norio']					= 'Vender nório';
$LNG['tr_resource']						= 'Recurso';
$LNG['tr_amount']							= 'Quantidade';
$LNG['tr_quota_exchange']					= 'Percentagem';
...
$LNG['in_jump_gate_error_data']			    = 'Erro, coordenadas para salto não estão correctas!';
$LNG['in_jump_gate_not_ready_target']		= 'O portal não está pronto na lua de destino, Estará pronto em ';
$LNG['in_jump_gate_doesnt_have_one']		= 'Não tens outro portal para efectuar o salto!';
$LNG['in_jump_gate_already_used']			= 'O portal de salto foi usado, tempo para carregar energia: ';
$LNG['in_jump_gate_available']				= 'Disponível';
$LNG['in_rf_again']    			            = 'Rapidfire contra';
$LNG['in_rf_from']     			            = 'Rapidfire de';
$LNG['in_level']       				        = 'Nível';
$LNG['in_prod_p_hour'] 			            = 'Produção/hora';
$LNG['in_difference']  						= 'Diferente';
$LNG['in_used_energy'] 			            = 'Consumo de energia';
$LNG['in_prod_energy'] 			            = 'Produção de energia';
$LNG['in_used_deuter']		                = 'Consumo de deutério';
$LNG['in_range']       				        = 'Distância do phalanx';
$LNG['in_title_head']  			            = 'Informação de';
$LNG['in_name']        						= 'Nome';
$LNG['in_struct_pt']   			            = 'Integridade estrutural';
$LNG['in_shield_pt']   			            = 'Força de escudo';
$LNG['in_attack_pt']   			            = 'Força de ataque';
$LNG['in_capacity']    				        = 'Capacidade de carga';
$LNG['in_units']       			            = 'Unidade';
$LNG['in_base_speed'] 				        = 'Velocidade base';
$LNG['in_consumption'] 	                    = 'Combustível usado(Deuterio)';
$LNG['in_jump_gate_start_moon']			    = 'Saltar de lua';
$LNG['in_jump_gate_finish_moon']			= 'Lua de destino do salto';
$LNG['in_jump_gate_select_ships']	        = 'Usar portal de salto: numero de naves';
$LNG['in_jump_gate_wait_time']              = 'Próximo salto possível em:';
...
//----------------------------------------------------------------------------//
//MESSAGES
$LNG['mg_type'][0]                          = 'Mensagens de Espionagem';
$LNG['mg_type'][1]                          = 'Mensagens de Jogadores';
$LNG['mg_type'][2]                          = 'Mensagens de Aliança';
$LNG['mg_type'][3]                          = 'Mensagens de Combate';
$LNG['mg_type'][4]                          = 'Mensagens de Sistema';
$LNG['mg_type'][5]                          = 'Mensagens de Transporte';
$LNG['mg_type'][15]                         = 'Mensagens de Expedição';
$LNG['mg_type'][50]                         = 'Mensagens de Jogo';
$LNG['mg_type'][99]                         = 'Mensagens de Construção';
$LNG['mg_type'][100]                        = 'Todas as mensagens';
$LNG['mg_type'][999]                        = 'Caixa de saída';
$LNG['mg_no_subject']			            = 'Sem assunto';
$LNG['mg_no_text']				            = 'Sem texto';
...
$LNG['al_click_to_send_request']		    = 'Carrega aqui para enviares uma mensagem para a aliança';
$LNG['al_nivel_error']								= '<center><img width="120" height="120" src="styles/theme/gow/imagenes/otros/rangos/3.png" /></center><br /><b>Necessita de ter mais de nível 3 para criar uma aliança,<br /> para chegar ao nível 3 necessita de ter mais de 10.000 pontos</b>.';
$LNG['al_tag_required']					    = 'Falta a tag da aliança';
$LNG['al_name_required']					= 'Falta o nome da aliança';
$LNG['al_already_exists']					= 'A aliança %s já existe.';
...
$LNG['al_go_out_no']                        = 'Não';
$LNG['al_close_ally']                       = 'Queres mesmo fechar a aliança ?';
$LNG['al_kick_player']                      = 'Queres mesmo remover o usuário %s da aliança?';
$LNG['al_circular_sended']					= 'Mensagem circular enviada. Estes jogadores irão receber a tua mensagem circular:';
$LNG['al_all_players']						= 'Todos os jogadores';
$LNG['al_no_ranks_defined']				    = 'Sem posições definidas';
$LNG['al_request_text']						= 'Texto da aplicação';
$LNG['al_inside_text']						= 'Texto interno';
$LNG['al_outside_text']						= 'Texto externo';
$LNG['al_transfer_alliance']				= 'Transfere aliança';
$LNG['al_disolve_alliance']				    = 'Eliminar Aliança';
$LNG['al_founder_rank_text']				= 'Fundador';
$LNG['al_new_member_rank_text']			    = 'Novo membro';
...
$LNG['al_num']								= 'ID';
$LNG['al_member']							= 'Nome';
$LNG['al_request_from_user']                = 'Os pedidos dos jogadores';
$LNG['al_message']							= 'Mensagem';
$LNG['al_position']							= 'Posição';
$LNG['al_points']							= 'Pontos';
$LNG['al_coords']							= 'Coordenadas';
$LNG['al_member_since']						= 'Entrou';
$LNG['al_estate']							= 'Online';
$LNG['al_back']								= 'Voltar';
$LNG['al_actions']							= 'Acções';
$LNG['al_change_title']						= 'Mudar título';
$LNG['al_the_alliance']						= 'da aliança';
$LNG['al_change_submit']					= 'Alterar';
$LNG['al_reply_to_request']				    = 'Responde ao pedido';
$LNG['al_reason']							= 'Razão';
...
$LNG['al_transfer_alliance']				= 'Transferir Aliança';
...
$LNG['al_ally_info_members']				= 'Membros';
$LNG['al_your_request_title']				= ' a tua aplicação';
$LNG['al_applyform_send']					= 'Enviar';
$LNG['al_applyform_reload']				    = 'Recarregar';
$LNG['al_circular_send_ciruclar']			= 'Envia mensagem circular';
$LNG['al_circular_alliance']               	= 'Aliança ';
$LNG['al_receiver']							= 'Receptor';
$LNG['al_circular_send_submit']			    = 'Enviar';
$LNG['al_circular_reset']					= 'Limpar';
$LNG['al_alliance']							= 'Alianças';
$LNG['al_alliance_make']					= 'Cria a tua própria aliança';
$LNG['al_alliance_search']					= 'Procura alianças';
$LNG['al_your_ally']						= 'A tua aliança';
$LNG['al_rank']								= 'O teu Rank';
$LNG['al_web_site']							= 'Página principal';
$LNG['al_inside_section']					= 'Área interna';
$LNG['al_make_alliance']					= 'Cria aliança';
$LNG['al_make_ally_tag_required']			= 'Tag da aliança (3-8 caracteres)';
$LNG['al_make_ally_name_required']			= 'Nome da aliança (3-30 caracteres)';
$LNG['al_make_submit']						= 'procura';
$LNG['al_find_alliances']					= 'procura aliança';
$LNG['al_find_text']						= 'Procura por';
$LNG['al_find_no_alliances']                = 'Nenhuma aliança encontrado!';
$LNG['al_find_submit']						= 'Procura';
$LNG['al_manage_ranks']						= 'Configurar direitos';
$LNG['al_manage_members']					= 'Gerir membros';
$LNG['al_manage_change_tag']				= 'Alterar Tag da Aliança';
$LNG['al_manage_change_name']				= 'Alterar Nome da Aliança';
$LNG['al_texts']							= 'Opções de texto';
$LNG['al_manage_options']					= 'Opções';
$LNG['al_manage_image']						= 'Imagem de aliança';
$LNG['al_manage_requests']					= 'Aplicações';
$LNG['al_manage_diplo']                    	= 'Diplomacia da Aliança';
$LNG['al_requests_not_allowed']			    = 'Impossível (aliança fechada)';
$LNG['al_requests_allowed']				    = 'Possível (aliança aberta)';
$LNG['al_manage_founder_rank']				= 'Posição do fundador';
$LNG['al_configura_ranks']					= 'Configurar direitos';
$LNG['al_create_new_rank']					= 'Criar nova posição';
$LNG['al_rank_name']						= 'Nome da posição';
$LNG['al_create']							= 'Criar';
$LNG['al_legend']							= 'Descrição dos direitos';
$LNG['al_legend_disolve_alliance']			= 'Dissolver aliança';
$LNG['al_legend_kick_users']				= 'Expulsar membros';
$LNG['al_legend_see_requests']				= 'Mostrar aplicações';
$LNG['al_legend_see_users_list']		    = 'Mostrar lista de membros';
$LNG['al_legend_check_requests']		    = 'Processar aplicação';
...
$LNG['al_Gesamtk']     						= 'Lutas';
$LNG['al_Erfolg']       					= 'Odds de Luta';
$LNG['al_Siege']        					= 'Ganhas';
$LNG['al_Drawp']        					= 'Empate';
$LNG['al_Loosi']        					= 'Perdidas';
$LNG['al_KGesamt']      					= 'Total de Lutas';
$LNG['al_Allyquote']    					= 'Recorde de Lutas do Membro da Aliança';
$LNG['al_Quote']        					= 'Cota de Vitória';
$LNG['al_unitsshut']    					= 'Unidades Mortas';
$LNG['al_unitsloos']    					= 'Unidades Perdidas';
$LNG['al_tfmetall']     					= 'Total de destroços de metal';
$LNG['al_tfkristall']   					= 'Total de destroços de cristal';
$LNG['al_view_stats']						= 'Recorde de Batalha Publica?';
...
$LNG['al_diplo_level'][3]                   = 'Pacto de não agressão';
...
$LNG['al_diplo_accept_send']                = 'Pedidos de saída';
$LNG['al_diplo_create']                     = 'Criar novo pacto.';
$LNG['al_diplo_create_done']                = 'Pacto criado com sucesso.';
$LNG['al_diplo_ally']                       = 'Alianças';
$LNG['al_diplo_level_des']                  = 'Tipo de Pactos';
$LNG['al_diplo_text']                       = 'Texto/Pedido';
$LNG['al_diplo_accept_yes']                 = 'Pacto assinado.';
$LNG['al_diplo_accept_yes_mes']             = 'O (%s) entre as alianças %s e %s foi assinado!';
$LNG['al_diplo_accept_yes_confirm']		    = 'Queres realmente aceitar o pacto?';
$LNG['al_diplo_accept_no']                  = 'Pacto Rejeitado.';
$LNG['al_diplo_accept_no_mes']				= 'O (%s) entre as alianças %s e %s foi rejeitado!'; 
$LNG['al_diplo_accept_no_confirm']			= 'Queres realmente rejeitar o pacto?';                                                             
$LNG['al_diplo_delete']                     = 'Pacto apagado.';
$LNG['al_diplo_delete_mes']                 = 'O (%s) entre as alianças %s e %s foi apagado!';
...
//----------------------------------------------------------------------------//
//BUDDY
$LNG['bu_request_exists']					= 'Já existe uma aplicação para este jogador!';
$LNG['bu_cannot_request_yourself']			= 'Tu não poderás enviar um pedido de amigo a ti próprio';
$LNG['bu_request_message']					= 'Pedido de mensagem';
$LNG['bu_player']							= 'Jogador';
$LNG['bu_request_text']						= 'Texto de aplicação';
$LNG['bu_characters']						= 'Caracteres';
$LNG['bu_back']								= 'Voltar';
$LNG['bu_send']								= 'Enviar';
$LNG['bu_cancel_request']					= 'Cancelar pedido';
$LNG['bu_accept']							= 'Aceite';
$LNG['bu_decline']							= 'Negado';
$LNG['bu_connected']						= 'Ligado';
$LNG['bu_minutes']                          = ' min';
$LNG['bu_online']                           = 'Online';
$LNG['bu_disconnected']						= 'Desligado';
$LNG['bu_buddy_list']						= 'Lista de amigos';
$LNG['bu_requests']							= 'Aplicações';
$LNG['bu_alliance']							= 'Aliança';
$LNG['bu_coords']							= 'Coordenadas';
$LNG['bu_text']								= 'Texto';
$LNG['bu_action']							= 'Acção';
$LNG['bu_my_requests']						= 'Meus pedidos';
$LNG['bu_partners']							= 'Companheiros';
$LNG['bu_delete']                           = 'Excluir';
$LNG['bu_no_request']                       = 'Nenhum pedido disponível!';
$LNG['bu_no_buddys']                        = 'Sem amigos disponíveis!';
$LNG['bu_request_send']                     = 'Pedido enviado!';

//----------------------------------------------------------------------------//
//NOTES
$LNG['nt_important']						= 'Importante';
$LNG['nt_normal']							= 'Normal';
$LNG['nt_unimportant']						= 'Não importante';
$LNG['nt_create_note']						= 'Criar nota';
$LNG['nt_you_dont_have_notes']				= 'Sem notas guardadas';
$LNG['nt_notes']							= 'Notas';
$LNG['nt_create_new_note']					= 'Criar nova nota';
$LNG['nt_edit_note']                        = 'Editar Nota';
$LNG['nt_date_note']						= 'Data';
$LNG['nt_subject_note']						= 'Assunto';
$LNG['nt_size_note']						= 'Tamanho';
$LNG['nt_dlte_note']						= 'Apagar';
$LNG['nt_priority']							= 'Prioridade';
$LNG['nt_note']								= 'Noticia';
...
//----------------------------------------------------------------------------//
//STATISTICS
$LNG['st_player']					        = 'Jogador';
$LNG['st_alliance']					        = 'Aliança';
$LNG['st_points']					        = 'Pontos';
$LNG['st_fleets']					        = 'Frotas';
$LNG['st_researh']					        = 'Pesquisas';
$LNG['st_buildings']					    = 'Edifícios';
$LNG['st_defenses']					        = 'Defesa';
$LNG['st_position']					        = 'Posição';
$LNG['st_members']					        = 'Membros';
$LNG['st_per_member']				        = 'Por membro';
$LNG['st_statistics']				        = 'Estatísticas';
$LNG['st_updated']					        = 'Actualizadas';
$LNG['st_show']								= 'Mostrar';
$LNG['st_per']								= 'Por';
$LNG['st_in_the_positions']				    = 'Em posições';
$LNG['st_write_message']                    = 'Escrever Mensagem Privada';

//----------------------------------------------------------------------------//
//SEARCH
$LNG['sh_tag']						        = 'Tag';
$LNG['sh_name']					        	= 'Nome';
$LNG['sh_members']					        = 'Membro';
$LNG['sh_points']					        = 'Pontos';
$LNG['sh_search_in_the_universe']		    = 'Procurar no universo';
$LNG['sh_player_name']				        = 'Nome de jogador';
$LNG['sh_planet_name']				        = 'Nome do planeta';
$LNG['sh_alliance_tag']				        = 'Tag de aliança';
$LNG['sh_alliance_name']				    = 'Nome da aliança';
$LNG['sh_search']					        = 'Procurar';
$LNG['sh_buddy_request']				    = 'Pedido de amigo';
$LNG['sh_alliance']					        = 'Aliança';
...
$LNG['op_save_changes']					    = 'Gravar';
$LNG['op_admin_title_options']				= 'Opções disponíveis para administrador';
$LNG['op_admin_planets_protection']		    = 'Protecção dos planetas';
$LNG['op_user_data']						= 'Dados de Jogador';
$LNG['op_username']							= 'Username';
$LNG['op_old_pass']							= 'Password antiga';
$LNG['op_new_pass']							= 'Nova password (min. 8 caractéres)';
$LNG['op_repeat_new_pass']	                = 'Nova password (repetir)';
$LNG['op_email_adress']					    = 'Email ';
$LNG['op_permanent_email_adress']			= 'Email permanente';
$LNG['op_general_settings']				    = 'Opções Gerais';
$LNG['op_sort_planets_by']					= 'Ver planetas por:';
$LNG['op_sort_kind']						= 'Organizar por ordem:';
$LNG['op_lang']								= 'Idioma';
$LNG['op_skin_example']					    = 'Escolhe a skin que queres usar:';
$LNG['op_show_skin']						= 'Mostrar skin';
$LNG['op_deactivate_ipcheck']				= 'Activar verificador de IP';
$LNG['op_galaxy_settings']					= 'Opções de vista da galáxia';
$LNG['op_spy_probes_number']				= 'Numero de sondas a enviar';
$LNG['op_toolt_data']						= 'Ferramentas de informação';
$LNG['op_seconds']							= 'segundos';
$LNG['op_max_fleets_messages']				= 'Numero máximo de mensagens de frota';
$LNG['op_show_planetmenu']                  = 'Exibir Menu dos Planetas';
$LNG['op_shortcut']							= 'atalho';
$LNG['op_show']						        = 'Mostrar';
$LNG['op_spy']								= 'Espiar';
$LNG['op_write_message']					= 'Escrever mensagem';
$LNG['op_add_to_buddy_list']				= 'Adicionar a lista de amigos';
$LNG['op_missile_attack']					= 'Ataque de mísseis';
$LNG['op_send_report']						= 'Enviar relatório';
$LNG['op_vacation_delete_mode']			    = 'Modo de férias / Apagar conta';
$LNG['op_activate_vacation_mode']			= 'Ligar modo de férias';
...
$LNG['op_deactivate_ipcheck_descrip']		= 'Check IP significa que o logout de segurança ocorre automaticamente quando o IP muda ou duas pessoas são registrados em uma conta de IPs diferentes. Desativando a verificação de IP pode representar um risco à segurança!';
...
$LNG['op_user_name_no_alphanumeric']        = 'Por favor, digite o nome do usuário apenas caracteres alfanuméricos!';
...
//----------------------------------------------------------------------------//
//BANNED
$LNG['bn_no_players_banned']				= 'Sem jogadores banidos';
$LNG['bn_exists']							= 'Existe ';
$LNG['bn_players_banned']					= ' Jogadores banidos';
$LNG['bn_players_banned_list']				= 'Lista de jogadores banidos';
$LNG['bn_player']					        = 'Jogador';
$LNG['bn_reason']					        = 'Motivo';
$LNG['bn_from']					            = 'A partir';
$LNG['bn_until']					        = 'Até';
$LNG['bn_by']						        = 'Por';
...
$LNG['cff_mission_own_expo_0']				= 'Uma de suas %s do %s %s %s alcançará a posição %s. Missão: %s';
...
$LNG['cff_mission_own_recy_0']				= 'Uma de suas %s do %s %s %s atingirá os destroços %s. Missão: %s';
...
$LNG['cr_shields']							= 'Escudo';
$LNG['cr_armor']							= 'Blindagem';
...
$LNG['fa_planet_not_exist']				    = 'Erro, Esse planeta não existe';
$LNG['fa_not_enough_fuel']					= 'Erro, Não tens combustível que chegue';
$LNG['fa_no_more_slots']					= 'Erro, Tu não tens mais slots de frota disponíveis';
$LNG['fa_no_recyclers']						= 'Erro, Não tens recicladores disponíveis';
$LNG['fa_no_fleetroom']                     = 'Erro, O consumo de deutério é maior do que a capacidade de carga';
$LNG['fa_mission_not_available']            = 'Erro, Essa missão não está disponível';
$LNG['fa_no_spios']                         = 'Erro, Sem sondas desponíveis';
$LNG['fa_vacation_mode']					= 'Erro, O jogador está em modo de ferias';
$LNG['fa_week_player']						= 'Erro, O jogador é muito fraco';
$LNG['fa_strong_player']					= 'Erro, O jogador é muito forte';
$LNG['fa_not_spy_yourself']				    = 'Erro, Não é possível espiar os teus próprios planetas';
$LNG['fa_not_attack_yourself']				= 'Erro, Não é possível atacares os teus próprios planetas';
$LNG['fa_action_not_allowed']				= 'Erro, Essa acção não é permitida';
...
$LNG['ma_misil_launcher']					= 'Lançador de mísseis';
$LNG['ma_small_laser']						= 'Laser pequeno';
$LNG['ma_big_laser']						= 'Laser pesado';
$LNG['ma_gauss_canyon']						= 'Canhão de gauss';
$LNG['ma_ionic_canyon']						= 'Canhão de iões';
$LNG['ma_buster_canyon']					= 'Canhão plasma';
$LNG['ma_small_protection_shield']			= 'Pequeno escudo planetário';
$LNG['ma_big_protection_shield']			= 'Grande escudo planetário';
$LNG['ma_planet_protector']			= 'Gigant singpost dome';
...
$LNG['tkb_platz']                           = 'Top';
$LNG['tkb_owners']                          = 'Combates';
$LNG['tkb_datum']                           = 'Data';
$LNG['tkb_units']                           = 'Destroços';
$LNG['tkb_legende']                         = '<b>Legenda: </b>';
$LNG['tkb_gewinner']                        = '<b>-Vencedores-</b>';
$LNG['tkb_verlierer']                       = '<b>-Derrotados-</b>';
...
$LNG['pl_ally']                             = 'Aliança';
$LNG['pl_message']                          = 'Escrever Mensagem Privada';
$LNG['pl_buddy']                            = 'Escrever Pedido de Amizade';
$LNG['pl_points']                           = 'Pontos';
$LNG['pl_range']                            = 'Posição';
$LNG['pl_builds']                           = 'Edifícios';
$LNG['pl_tech']                             = 'Tecnologias';
$LNG['pl_fleet']                            = 'Frotas';
$LNG['pl_def']                              = 'Defesas';
$LNG['pl_total']                            = 'Total';
$LNG['pl_fightstats']                       = 'Estatisticas de Combate';
$LNG['pl_fights']                           = 'Combates';
$LNG['pl_fprocent']                         = 'Percentagem de combates';
$LNG['pl_fightwon']                         = 'Combates Vencidos';
$LNG['pl_fightdraw']                        = 'Combates Empatados';
$LNG['pl_fightlose']                        = 'Combates Perdidos';
$LNG['pl_totalfight']                       = 'Combates Totais';
$LNG['pl_destroy']                          = '%s esteve envolvido na sequência da destruição total de';
$LNG['pl_unitsshot']                        = 'Unidades Disparadas';
...
$LNG['pl_dernorio']   						= 'Total de Destroços de Nório';
...
$LNG['chat_title']                         = 'Chat';
$LNG['chat_ally_title']                    = 'Chat de Alianza';
$LNG['chat_bbcode']                    		= 'BB-Codes';
$LNG['chat_fontcolor']                    	= 'Cor da Fonte';
...
$LNG['chat_notext']							= 'Escreve algo!';
$LNG['chat_request_url']					= 'Por favor, poem o link:';
$LNG['chat_request_url_desc']				= 'Introduz a descrição do link (opcional):';
...
$LNG['subject']                             = 'Assunto';
$LNG['status']                              = 'Estado';
$LNG['ticket_posted']                       = 'Data Envio';
$LNG['ticket_new']                          = 'Abrir Novo Ticket';
$LNG['input_text']                          = 'Texto';
$LNG['answer_new']                          = 'Responder:';
$LNG['text']                                = 'Mensagem';
$LNG['message_a']                           = 'Estado do Ticket:';
$LNG['sendit_a']                            = 'A sua mensagem foi enviada. Aguarde pela resposta.';
$LNG['message_t']                           = 'Estado dos Tickets';
$LNG['supp_send'] 							= 'Enviar';
$LNG['sendit_t']                            = 'O teu Ticket foi enviado. Aguarda pela resposta.';
$LNG['close_t']                             = 'O Ticket foi fechado.';
$LNG['sendit_error']                        = 'Erro:';
$LNG['sendit_error_msg']                    = 'Não completaste o ticket!';
$LNG['supp_admin_system']                   = 'Support-Admin-panel';
$LNG['close_ticket']                        = 'Fechar Ticket';
...
$LNG['bs_derbis_raport']					= "Para recolher os destroços necessita cerca de %s %s ou %s %s";
$LNG['bs_steal_raport']					= "Necessita de %s %s de %s %s e %s %s .";
$LNG['bs_names']							= "Nave";
$LNG['bs_atter']							= "Agressor";
$LNG['bs_deffer']							= "Defensor";
$LNG['bs_steal']							= "Recursos(por roubar):";
$LNG['bs_techno']							= "Tecnologia";
$LNG['bs_send']							= "Enviar";
$LNG['bs_cancel']							= "Reset";
$LNG['bs_wait']							= "Por favor, aguarde 10 segundos para poder fazer a próxima simulação";

//----------------------------------------------------------------------------//
// Fleettrader
$LNG['ft_head']								= 'Comerciante de Frotas';
$LNG['ft_max']								= 'Max';
$LNG['ft_total']							= 'Total';
$LNG['ft_charge']							= 'Taxas do Comerciante';
$LNG['ft_absenden']							= 'Enviar';
$LNG['ft_empty']							= 'Vazio';	
$LNG['ft_cau']								= 'A quantidade de ';
$LNG['ft_cau_2']							= ' que receberás por cada nave.';
$LNG['ft_naves']							= 'Naves comerciaveis';
$LNG['ft_selecciona']						= 'Selecciona a nave a comerciar';
$LNG['ft_cantidad']							= 'Quantidade ';
$LNG['ft_coste']							= 'Custo';
