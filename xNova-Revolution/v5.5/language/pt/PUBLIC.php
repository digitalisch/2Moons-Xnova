...
$LNG['server_infos']                   	= array(
        ...
        "Não necessita de fazer qualquer tipo de download, 
		apenas necessita de um navegador.",   
        "Registo Gratuito",
...
$LNG['server_description']             = 'É um jogo de estratégia emocionante com milhares de jogadores.Entre e torne-se o imperador da galáxia.Só precisa de um browser para jogar.';
...
$LNG['accept_terms_and_conditions']    = 'Por favor aceite as Régras e o T&C';
...
$LNG['rules']                          = array(
   ...
   * É considerado pushing:
    ...
    * A Equipa xNova Galaxy não irá responsabilizar-se por perdas de contas com a Verificação de IP desactivada. ",
    ...
    * A língua oficial dos uníversos xNova Galaxy é o português. No entanto, qualquer pessoa, de qualquer nacionalidade, pode jogar no xNova Galaxy, desde que não use outra língua a não ser a oficial no jogo, quer através de mensagens internas com outros jogadores ou informação nas páginas de alianças. 
    * Da mesma maneira, spam, nomes ou mensagens no jogo de conteúdo obsceno, insultuoso, racista, xenófobo ou terrorista conduzem à exclusão do jogo. ",
     ...
     * Desrespeito, insultos, racismo, xenofobia, ameaças à vida real, difamação ou qualquer tipo de perseguição feita a elementos da equipa do xNova Galaxy, leva à exclusão do jogador infractor da comunidade do xNova Galaxy, ou seja, ao bloqueamento permanente em todos os universos que joga.",
...
$LNG['agb']                            = array(
        ...
        "Condições especiais para (nomeadamente fórum de discussão, chat)"                         => array(
	         ...
	         h) Possuem um carácter comercial e nomeadamente publicitário.",
                ...
                "Sem prejuízo dos outros direitos de acordo com estas condições de utilização, ao xNova Galaxy tem o direito de alterar e apagar total ou parcialmente os conteúdos e os artigos que violam estas regras. Além disso, ao xNova Galaxy tem o direito de excluir, total ou provisoriamente, os utilizadores que infringem estas regras, da utilização dos jogos online, páginas de Internet do jogo e outras ofertas de serviços.",
        ),
        ...
        "Consequência da violação de deveres" => array(
                ...
                "Sem prejuízo de todos os outros direitos legais ou contratuais, ao xNova Galaxy pode tomar as seguintes medidas, conforme pretendido, se existirem pontos de referência de que um utilizador está a infringir as normas legais, os direitos de terceiros, as presentes condições de utilização ou as condições e regras do jogo complementares aplicáveis:
	         ...
	         g) Rescisão imediata do contrato de utilização.",
                ...
                "Se um utilizador tiver sido bloqueado ou excluído, não pode registar-se novamente sem a autorização prévia do xNova Galaxy. Não existe direito ao levantamento de um bloqueio, de uma exclusão, de uma proibição virtual de utilização do site ou de outras medidas.",                
        ),
        ...
        "Recompensa relativamente à utilização"                               => array(
                ...
                "As possibilidades de pagamento variam de acordo com o jogo online, o país do participante e as possibilidades de pagamento disponíveis no mercado e tecnicamente realizáveis. Ao xNova Galaxy reserva-se o direito de alterar, a qualquer momento, as possibilidades de pagamento.",
                
                "O xNova Galaxy reserva-se o direito de alterar recompensas para funções internas do jogo (incluindo moedas virtuais). Isto inclui o direito do xNova Galaxy de baixar ou aumentar recompensas para funções individuais internas ao jogo.",
                
                "Em caso de atraso, aplicam-se os juros legais. Para além disso, o xNova Galaxy está autorizada a bloquear o user account, a exigir a substituição de um dano e a anular os serviços.",
                
                "Se o xNova Galaxy tiver de pagar taxas de agravo ou de anulação devido à culpa do utilizador (também se a conta não tiver saldo suficiente), o utilizador suporta os custos relacionados com isso. O xNova Galaxy pode exigir estes custos e a recompensa, através de novo débito. Se o pagamento se efectuar através de cobrança de cartão de crédito, surgem débitos de até 50 Euros por cada cobrança de cartão de crédito, adicionando-se as taxas bancárias que surgiram à Gameforge. O xNova Galaxy está autorizada a exigir que um dano seja reparado através de substituição.",
        ),

        
        "Limitação de responsabilidade"      => array(
                "O utilizador responsabiliza-se, quanto à infracção que realizou, pelos direitos de terceiros em relação a eles próprios e directamente. O utilizador tem o dever de substituir todos os danos ao xNova Galaxy que surgem devido à não observância dos deveres resultantes destas condições de utilização. O utilizador liberta o xNova Galaxy de todas as reivindicações que outros utilizadores ou outros terceiros fazem em relação ao xNova Galaxy devido à violação dos seus direitos devido aos conteúdos ajustados pelo utilizador ou devido à violação de outros deveres. O utilizador também assume aqui os custos da defesa legal necessária do xNova Galaxy, incluindo todos os custos de tribunal e advogado. Isto não é válido se a violação dos direitos não for da responsabilidade do utilizador.",
                
                "A responsabilidade do xNova Galaxy, qualquer que seja a razão legal, quer seja devido à violação de deveres contratual ou actuação não permitida determina-se de acordo com os seguintes regulamentos:",
                
                "Caso o xNova Galaxy preste o respectivo serviço que activa a responsabilidade a título oneroso, o xNova Galaxy responsabiliza-se apenas pela intenção dolosa e pela negligência grave.",
                
                "Nos serviços a título oneroso, o xNova Galaxy responsabiliza-se ilimitadamente pela intenção dolosa e pela negligência grave, assim como no caso de danos em pessoas, no entanto quanto à negligência leve apenas se forem violados deveres essenciais ao contrato, em caso de atraso por parte do xNova Galaxy e impossibilidade. A responsabilidade em caso de violação de um destes deveres essenciais ao contrato está limitada ao dano típico contratual com cujo surgimento o xNova Galaxy teve de contar na celebração do contrato devido às circunstâncias conhecidas nessa altura.",
                
                "O xNova Galaxy não assume responsabilidade por falhas não cometidas pelo xNova Galaxy dentro das redes.",
                
                "O xNova Galaxy só se responsabiliza pela perda de dados de acordo com os parágrafos mencionados previamente se não fosse possível evitar esta perda através de medidas adequadas de protecção de dados por parte do utilizador.",
                
                "As limitações de responsabilidade existentes não são válidas no caso de aceitação de garantias expressas pelo xNova Galaxy, no caso de malícia e no caso de danos resultantes da colocação em perigo de vida, do corpo ou saúde, assim como no caso de regulamentos legais obrigatórios.",
         ),
...
$LNG['fb_perm']						   = 'Acesso proibido. %s Precisas de todos os direitos para fazeres o login com a conta do Facebook.\n Alternadamente poderás fazer o login sem a conta do Facebook!';         
