...
//Traduzione originale eseguita da Malware del sito http://2moons.freedost.com, la community italiana di 2moons.
//Traduzione aggiuntiva per xnova 5.3 esaguita da killer99 http://www.games-universe.net
...
$LNG['type_mission'][11]  					= 'Ricerca Materia Oscura';
...
$LNG['ov_delete_planet']					= 'Cancella Pianeta';
$LNG['ov_your_planet']						= 'Il tuo pianete';
$LNG['ov_coords']							= 'Posizione';
$LNG['ov_abandon_planet']					= 'Abbandona pianeta';
$LNG['ov_planet_name']						= 'Nome';
$LNG['ov_actions']							= 'Azione';
...
$LNG['rang_1']  = 'Civiltà Primitiva';
$LNG['rang_2']  = 'Civiltà Planetaria';
$LNG['rang_3']  = 'Civiltà Spaziale';
$LNG['rang_4']  = 'Civiltà Coloniale';
$LNG['rang_5']  = 'Civiltà Avanzata';
$LNG['rang_6']  = 'Impero Stellare';
$LNG['rang_7']  = 'Impero Galattico';
$LNG['rang_8']  = 'Impero Avanzato';
$LNG['rang_9']  = 'Impero Dominante';
$LNG['ov_fragatas'] = "Fregate: ";
$LNG['ov_cazador'] = "Caccia: ";
$LNG['ov_civil'] = "Navi Civili: ";
$LNG['ov_cruceros'] = "Incrociatori: ";
$LNG['ov_insignia'] = "Navi Bombardiere: ";
$LNG['ov_capital'] = "Navi Ammiraglie: ";
$LNG['ov_subiendo']						= 'Salendo di livello';
$LNG['ov_cantidad']						= 'Costruendo';
$LNG['ov_estructuras_construccion']     = 'Costruzioni';
$LNG['ov_free_estructuras']					= 'Non ci sono strutture planetarie in costruzione.';
$LNG['ov_free_hangar']						= 'Non ci sono costruzioni in corso nell\'hangar';
$LNG['ov_with_pass']						= 'con password.';
$LNG['ov_planet_rename_action']			= 'Rinomina';

//----------------------------------------------------------------------------//
//BONUS

$LNG['packs_darkmatter'] = "di Materia Oscura";
$LNG['packs_en_venta'] = "Contenitori in vendita";
$LNG['packs_comprar'] = "Compra";
$LNG['packs_coste'] = "Costo: ";
$LNG['recursos_pack'] = "Contenitori di risorse";
$LNG['recursos_pack_descr'] = "Niobio: +10.000.000 <br />Germanio: +5.000.000 <br />Norio: +4.000.000 <br />Deuterio: +2.500.000";
$LNG['minas_pack'] = "Contenitore di minerali";
$LNG['minas_pack_descr'] = "Miniera di Niobio +2 <br />Miniera di Germanio +2 <br />Miniera di Norio +2 <br />Impianto di energia solare +5 <br />Fabbrica di robot +2";
$LNG['almacenes_pack'] = "Gruppo di magazzini";
$LNG['almacenes_pack_descr'] = "Magazzino di Niobio +1 <br />Magazzino di Germanio +1 <br />Magazzino di Deuterio +1 <br />Magazzino di Norio +1 ";
$LNG['flotas_pack'] = "Gruppo di flotte";
$LNG['flotas_pack_descr']  = "Fregate piccole: +300.000 <br />Fregate medie: +150.000 <br />Riciclatori grandi: +500 <br />Deuterio: +3.000.000 ";
$LNG['bunkers_pack'] = "Gruppo di bunker";
$LNG['bunkers_pack_descr'] = "Piccola cupola di protezione +1 <br />Grande cupola di protezione +1 <br />Cupola esterna di protezione +1 <br />Cannoni ionici: +20.000 ";
$LNG['tecnos_pack'] = "Insieme tecnologico";
$LNG['tecnos_pack_descr'] = "Spionaggio +1 <br />Computazione +1 <br />Energia +1 <br />Motori a combustione +1 <br />Motori ad impulso +1 <br />Propulsori iperspaziali +1 ";
$LNG['bn_pack_ok'] = "Hai comprato questo contenitore.";
$LNG['bn_pack_no'] = "Non hai materia oscura a sufficienza per comprare questo contenitore.";
...
$LNG['fl_titulo_misiones']					= 'MISSIONI IN CORSO';
$LNG['fl_no_misiones']						= 'Non hai missioni';
$LNG['fl_cantidad']							= 'Quantità';
$LNG['fl_accion']							= 'Azione';
$LNG['fl_capitals']				= 'Le navi ammiraglie devono essere accompagnate da almeno 10 incrociatori e 5 bombardiere.';
...
$LNG['no_recursos']							= 'Non hai risorse sufficienti';
$LNG['bd_add_to_list']						= 'Aggiungi alla coda di produzione';
...
$LNG['tr_almacenes']					= 'Puoi visualizzare le informazioni sulla capacità del magazzino nel visualizzatore risorse o nella gestione delle risorse.';
$LNG['tr_elemento'] 						= 'Acquista unità di ';
...
//----------------------------------------------------------------------------//
//INFOS
$LNG['in_jump_gate_done']					= 'Lo StarGate è stato usato, il prossimo salto potrà essere fatto tra:';
...
$LNG['pactos']        						= 'Patti';
$LNG['alianzas']        					= 'Alleanze';
$LNG['logo']								= 'Logo dell\'alleanza';
$LNG['al_nivel_error']								= '<center><img width="120" height="120" src="styles/theme/gow/imagenes/otros/rangos/3.png" /></center><br /><b>Devi essere almeno di livello 3 per creare un\'alleanza.<br /> Per arrivare al livello 3 devi avere pi&ugrave di 10.000 punti.</b>.';
...
$LNG['ma_planet_protector']			= 'Protezione Planetaria';
$LNG['ma_graviton_canyon']			= 'Cannone Gravitazionale';
...
$LNG['pl_etc']   							= 'Ecc ';
$LNG['pl_dernorio']   					= 'Totale Norio nei campi di risorse';

//----------------------------------------------------------------------------//
// Chat

$LNG['chat_title']                         = 'Chat';
$LNG['chat_ally_title']                    = 'Chat dell\'alleanza';
$LNG['chat_bbcode']                    		= 'BB-Codes';
$LNG['chat_fontcolor']                    	= 'Colore del carattere';

$LNG['chat_disc']                          = 'Chat';
$LNG['chat_message']                       = 'Messaggio';
$LNG['chat_send']                          = 'Invia';
$LNG['chat_admin']                       	= '<font color="red">Amministratore %s</font>';
$LNG['chat_color_white']					= 'Bianco';
$LNG['chat_color_blue']						= 'Blu';
$LNG['chat_color_yellow']					= 'Giallo';
$LNG['chat_color_green']					= 'Verde';
$LNG['chat_color_pink']						= 'Rosa';
$LNG['chat_color_red']						= 'Rosso';
$LNG['chat_color_orange']					= 'Arancione';

$LNG['chat_notext']							= 'Scrivi qualcosa!';
$LNG['chat_request_url']					= 'Inserisci un link:';
$LNG['chat_request_url_desc']				= 'Inserisci una descrizione del link (facoltativo):';
...
$LNG['ft_cau']								= 'Riceverà la seguente quantità di ';
$LNG['ft_cau_2']							= ' per ogni nave.';
$LNG['ft_naves']							= 'Navi negoziabili';
$LNG['ft_selecciona']						= 'Seleziona la nave per il commercio';
$LNG['ft_cantidad']							= 'Quantità ';
$LNG['ft_coste']							= 'Costo';
