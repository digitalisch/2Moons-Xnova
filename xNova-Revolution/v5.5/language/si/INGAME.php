...
$LNG['lm_chat']								= 'Pogovor';
$LNG['lm_support']							= 'Podpora';
$LNG['lm_rules']							= 'Pravila';
$LNG['lm_battlesim']						= "Bojni simulator";
$LNG['lm_credits']                          = "Zahvale";

# General
$LNG['rang_1']  = 'Primitivna civilizacija';
$LNG['rang_2']  = 'Planetarna civilizacija';
$LNG['rang_3']  = 'Vesoljska civilizacija';
$LNG['rang_4']  = 'Kolonizacijska civilizacija';
$LNG['rang_5']  = 'Napredna civilizacija';
$LNG['rang_6']  = 'Zvezdni imperij';
$LNG['rang_7']  = 'Galaktični imperij';
$LNG['rang_8']  = 'Napreden imperij';
$LNG['rang_9']  = 'Prevladujoč imperij';
$LNG['fragatas'] = "Fregata";
$LNG['cazador'] = "Lovec";
$LNG['civil'] = "Civilna";
$LNG['cruceros'] = "Križarka";
$LNG['insignia'] = "Vodilna ladja";
$LNG['capital'] = "Matična ladja";
$LNG['ov_newname_alphanum']				= 'Vnesli ste nepravilne znake. Dovoljeni so samo številke in črke.';
$LNG['ov_newname_no_space']				= 'Imena planetov ne smejo vsebovati presledkov.';
$LNG['ov_subiendo']						= 'Nadgradnja stopnje';
$LNG['ov_cantidad']						= 'V gradnji';
$LNG['ov_estructuras_construccion']     = 'Lista gradnje';
$LNG['ov_planet_abandoned']				= 'Planet ste zapustili uspešno.';
$LNG['ov_principal_planet_cant_abanone']	= 'Ni mogoče zapustiti glavnega planeta.';
$LNG['ov_abandon_planet_not_possible']		= 'Ni mogoče zapustiti planeta, če se na planetu izvajajo operacije z flotami.';
$LNG['ov_wrong_pass']						= 'Napačno geslo. Poskusite znova!.';
$LNG['ov_have_new_message']				= 'Prejeli ste 1 novo sporočilo';
$LNG['ov_have_new_messages']				= 'Prejeli ste %d novih sporočil';
$LNG['ov_planetmenu']						= 'Planeti';
$LNG['ov_free_estructuras']					= 'V tem trenutku se nobena zgradba ne gradi.';
$LNG['ov_free_hangar']						= 'V tem trenutku se nobena ladja/obramba ne gradi.';
$LNG['ov_news']							= 'Novice';
$LNG['ov_place']							= 'Mesto';
$LNG['ov_of']								= 'od';
...
$LNG['ov_temp_unit']						= '&#176;C';
$LNG['ov_to']								= 'do';
$LNG['ov_position']						= 'Koordinati';
$LNG['ov_points']							= 'Točk';
$LNG['ov_security_request']				= 'Ali ste prepričani, da želite zapustiti ta planet?';
$LNG['ov_security_confirm']				= 'Z vnosom gesla potrdite vašo izbiro.';
$LNG['ov_with_pass']						= 'z geslom.';
$LNG['ov_password']						= 'Geslo';
$LNG['ov_delete_planet']					= 'Izbriši planet';
$LNG['ov_your_planet']						= 'Vaš planet';
$LNG['ov_coords']							= 'Koordinati';
$LNG['ov_abandon_planet']					= 'Opusti kolonijo';
$LNG['ov_planet_name']						= 'Ime';
$LNG['ov_actions']							= 'Dejanja';
$LNG['ov_planet_rename']					= 'Preimenuj';
$LNG['ov_planet_rename_action']			= 'Preimenuj';
$LNG['ov_fields']							= 'Polja';
$LNG['ov_developed_fields']                = 'Polj razvitih';
$LNG['ov_max_developed_fields']			= 'maks. polj za gradnjo';
$LNG['ov_fleet']							= 'Flota';
$LNG['ov_admins_online']					= 'Prijavljeni administratorji:';
$LNG['ov_no_admins_online']				= 'Trenutno ni prijavljen noben administrator.';
$LNG['ov_userbanner']						= 'Banner z vašo statistiko';
$LNG['ov_userrank_info']					= '%s (%s <a href="game.php?page=statistics&amp;range=%d">%d</a> %s %s)';
$LNG['ov_teamspeak_not_online']			= 'Strežnik žal ni na voljo. Se opravičujemo.';
$LNG['ov_teamspeak']						= 'Teamspeak';
$LNG['ov_teamspeak_v2']					= '<a href="teamspeak://%s:%s?nickname=%s" title="Teamspeak povezava">Poveži</a> &bull; Online: %d/%d &bull; Kanali: %d &bull; Prenos: %s MB';
$LNG['ov_teamspeak_v3']					= '<a href="ts3server://%s?port=%d&amp;nickname=%s&amp;password=%s" title="Teamspeak povezava">Poveži</a>&nbsp;&bull;&nbsp;Online: %d/%d &bull; Kanali: %d &bull; Prenos: %s MB';
$LNG['ov_closed']						= 'Igra je trenutno onemogočena.';

# Bonus
$LNG['packs_darkmatter'] = "črne materije";
$LNG['packs_en_venta'] = "Dodatni paketi";
$LNG['packs_comprar'] = "Kupi";
$LNG['packs_coste'] = "Znesek: ";
$LNG['recursos_pack'] = "Paket surovin";
$LNG['recursos_pack_descr'] = "Metal: +10.000.000 <br />Kristal: +5.000.000 <br />Deuterium: +2.500.000 <br />Norium: +4.000.000";
$LNG['minas_pack'] = "Paket rudnikov";
$LNG['minas_pack_descr'] = "Rudnik metala +2 <br />Rudnik kristala +2 <br />Rudnik noriuma +2 <br />Sončna elektrarna +5 <br />Tovarna robotov +2";
$LNG['almacenes_pack'] = "Paket skladišč";
$LNG['almacenes_pack_descr'] = "Skladišče metala +1 <br />Skladišče kristala +1 <br />Rezervoarji deuteriuma +1 <br />Skladišče noriuma +1 ";
$LNG['flotas_pack'] = "Paket flot";
$LNG['flotas_pack_descr']  = "Majhna tovorna ladja: +300.000 <br />Velika tovorna ladja: +150.000 <br />Giga-Recikler: +500 <br />Deuterium: +3.000.000 ";
$LNG['bunkers_pack'] = "Paket obrambe";
$LNG['bunkers_pack_descr'] = "Majhen ščit +1 <br />Velik ščit +1 <br />Atmosferski ščit +1 <br />Ionski top: +20.000 ";
$LNG['tecnos_pack'] = "Paket raziskav";
$LNG['tecnos_pack_descr'] = "Vohunska tehnologija +1 <br />Računalniška tehnologija +1 <br />Energijska tehnologija +1 <br />Pogon izgorevanja +1 <br />Impulzni pogon +1 <br />Hiperprostorski pogon +1 ";
$LNG['bn_pack_ok'] = "Paket je kupljen uspešno.";
$LNG['bn_pack_no'] = "Nimate dovolj črne materije za ta paket.";
...
$LNG['gl_name_activity']					= 'Ime (Aktivnosti)';
$LNG['gl_moon']								= 'Luna';
$LNG['gl_inavitado']					= 'Nenaseljen';
...
$LNG['fl_titulo_misiones']					= 'Trenutne misije';
$LNG['fl_no_misiones']						= 'Ni trenutnih misij';
$LNG['fl_returning']						= 'Nazaj';
...
$LNG['fl_cantidad']							= 'Znesek';
$LNG['fl_accion']							= 'Dejanje';
$LNG['fl_max']								= 'max';
$LNG['fl_hours']							= 'Ur(s)';
...
$LNG['fl_capitals']				= 'Matične ladje morajo biti opremljene z vsaj 10 križarkami in 5 vodilnimi ladjami.';
...
$LNG['bd_build']							= 'Zgradi';
$LNG['no_recursos']							= 'Ni dovolj surovin';
...
$LNG['rs_weekly']							= 'Surovin na teden:';

//----------------------------------------------------------------------------//
//TRADER
$LNG['tr_empty_darkmatter']					= 'Nimate dovolj %s!';
$LNG['tr_cost_dm_trader']					= 'Provizija prodaje znaša <font color=\'orange\'><b>%s</b></font> %s';
$LNG['tr_almacenes']					= 'Informacije o sposobnostih vašega trgovanja najdete v iskalniku ali na strani surovine.';
...
$LNG['tr_not_enought_norio']				= 'Nezadostna količina Noriuma.';
...
$LNG['tr_descr']							= 'Trgovec vam samo ponuja toliko surovin, kolikšne imate zmogljivosti skladišč.';
...
$LNG['tr_sell_norio']					= 'Prodaj Norium';
...
$LNG['al_nivel_error']								= '<center><img width="120" height="120" src="styles/theme/gow/imagenes/otros/rangos/3.png" /></center><br /><b>Za ustvarjanje alianse potrebujete najmanj 3. raven..<br /> Za pridobitev ravena 3 potrebujete najmanj 10.000 točk</b>.';
...
$LNG['ma_planet_protector']			= 'Atmosferski ščit';
$LNG['ma_graviton_canyon']			= 'Gravitonski top';
$LNG['ma_all']								= 'Vse';
...
$LNG['tkb_gratz']                  			= 'Celotna ekipa čestita top stotim igracem';
$LNG['tkb_platz']                  			= 'Mesto';
...
$LNG['pl_dernorio']   					= 'Recikliran Norium';
$LNG['pl_etc']   							= 'Sporočilo';

//----------------------------------------------------------------------------//
// Chat

$LNG['chat_title']                         = 'Klepet';
$LNG['chat_ally_title']                    = 'Klepet alianse';
$LNG['chat_bbcode']                    		= 'BB-kode';
$LNG['chat_fontcolor']                    	= 'Barva pisave';

$LNG['chat_disc']                          = 'Klepet';
$LNG['chat_message']                       = 'Sporočilo';
$LNG['chat_send']                          = 'Pošlji';
$LNG['chat_admin']                       	= '<font color="red">Administrador %s</font>';
$LNG['chat_color_white']					= 'Bela';
$LNG['chat_color_blue']						= 'Modra';
$LNG['chat_color_yellow']					= 'Rumena';
$LNG['chat_color_green']					= 'Zelena';
$LNG['chat_color_pink']						= 'Roza';
$LNG['chat_color_red']						= 'Rdeča';
$LNG['chat_color_orange']					= 'Oranžna';
...
$LNG['ft_cau']								= 'Prejeli boste naslednji znesek ';
$LNG['ft_cau_2']							= ' na vsako ladjo.';
$LNG['ft_naves']							= 'Trgujte z ladjami';
$LNG['ft_selecciona']						= 'Izberite ladje za trgovanje';
$LNG['ft_cantidad']							= 'Število';
$LNG['ft_coste']							= 'Cena';
