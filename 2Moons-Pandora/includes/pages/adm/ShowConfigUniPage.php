...
function ShowConfigUniPage()
{
	...
	if (!empty($_POST))
	{
		$config_before = array(
			...
			//Lotterie Start//
			'lottery_prize'			=> $CONF['lottery_prize'],
			'lottery_met'			=> $CONF['lottery_met'],
			'lottery_cry'			=> $CONF['lottery_cry'],
			'lottery_deu'			=> $CONF['lottery_deu'],
			'lottery_min'			=> $CONF['lottery_min'],
			//Lotterie End//
		);
		...
		//Lotterie Start//
		$lottery_prize			= HTTP::_GP('lottery_prize', '');
		$lottery_met			= HTTP::_GP('lottery_met', '');
		$lottery_cry			= HTTP::_GP('lottery_cry', '');
		$lottery_deu			= HTTP::_GP('lottery_deu', '');
		$lottery_min			= HTTP::_GP('lottery_min', '');
		//Lotterie End//
		...
		$config_after = array(
			...
			'lottery_met'			=> $lottery_met,
			'lottery_cry'			=> $lottery_cry,
			'lottery_deu'			=> $lottery_deu,
	...
	$template->assign_vars(array(
		...
		//Lotterie Start//
		'se_lottery_prize'				=> $LNG['se_lottery_prize'],
		'se_lottery_met'				=> $LNG['se_lottery_met'],
		'se_lottery_cry'				=> $LNG['se_lottery_cry'],
		'se_lottery_deu'				=> $LNG['se_lottery_deu'],
		'se_lottery_min'				=> $LNG['se_lottery_min'],
		//Lotterie End//
		'game_name'						=> $CONF['game_name'],
		'uni_name'						=> $CONF['uni_name'],
