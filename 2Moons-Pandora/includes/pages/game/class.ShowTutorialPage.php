...
function m1(){
    ...
    $USER['darkmatter']	+= 200;
	$this->printMessage(sprintf($LNG['tut_m1_ready']),  true, array('game.php?page=tutorial&mode=m2', 3));
	exit;
...
function m2(){
	...
	$USER['darkmatter']	+= 200;
	$this->printMessage(sprintf($LNG['tut_m2_ready']), true, array('game.php?page=tutorial&mode=m3', 3));
	exit;
	}
	}
...
function m3(){
	...
	$USER['darkmatter']	+= 200;
	$this->printMessage(sprintf($LNG['tut_m3_ready']), true, array('game.php?page=tutorial&mode=m4', 3));
	exit;
	}
	}
...
$USER['darkmatter']	+= 200;
$this->printMessage(sprintf($LNG['tut_m4_ready']),  true, array('game.php?page=tutorial&mode=m5', 3));
exit;
}
}
...
$USER['darkmatter']	+= 400;
$this->printMessage(sprintf($LNG['tut_m5_ready']),  true, array('game.php?page=tutorial&mode=m6', 3));
exit;
}
}
	$this->display('mission_5.tpl');
...
$USER['darkmatter']	+= 400;
$this->printMessage(sprintf($LNG['tut_m6_ready']),  true, array('game.php?page=tutorial&mode=m7', 3));
exit;
}
}
$this->display('mission_6.tpl');
...
$USER['darkmatter']	+= 400;
$this->printMessage(sprintf($LNG['tut_m7_ready']),  true, array('game.php?page=tutorial&mode=m8', 3));
exit;
...
if($USER['tut_m8']==0){
if($PLANET['colonizer'] >=20 && $planet_count >=2 && $PLANET['big_ship_cargo'] >=10){
$GLOBALS['DATABASE']->query("UPDATE ".USERS." SET `tut_m8`=tut_m8+1 WHERE id=".$USER['id']."");
$USER['darkmatter']	+= 1000;
$this->printMessage(sprintf($LNG['tut_m8_ready']),  true, array('game.php?page=tutorial&mode=m9', 3));
exit;
		}
	}
	$this->display('mission_8.tpl');
...
$this->printMessage(sprintf($LNG['tut_m9_ready']),  true, array('game.php?page=tutorial&mode=m9', 3));
exit;
