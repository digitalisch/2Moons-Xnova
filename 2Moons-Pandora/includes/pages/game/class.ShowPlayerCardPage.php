...
class ShowPlayerCardPage extends AbstractPage
{
	...
	function show()
	{
		...
		$query 		= $GLOBALS['DATABASE']->getFirstRow("SELECT 
						u.username, u.galaxy, u.signature, u.user_image, u.system, u.planet, u.wons, u.loos, u.draws, u.kbmetal, u.kbcrystal, u.lostunits, u.desunits, u.ally_id, 
						p.name, 
		...
		$this->tplObj->assign_vars(array(	
			...
			'signature'     => bbcode ($query['signature']),
			'pl_signature'  => $LNG['op_signature'],
		));
