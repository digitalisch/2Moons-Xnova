...
<center>
	<form action="" method="post">
		...
		<table width="70%" cellpadding="2" cellspacing="2">
			...
			//Lotterie Start//
				<tr>
					<th colspan="2">Lotterie-Einstellungen</th><th>&nbsp;</th>
				</tr>
				<tr>
					<td>{$se_lottery_prize}</td>
					<td><input name="lottery_prize" maxlength="20" size="25" value="{$lottery_prize}" type="text"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>{$se_lottery_min}</td>
					<td><input name="lottery_min" maxlength="20" size="25" value="{$lottery_min}" type="text"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>{$se_lottery_met}</td>
					<td><input name="lottery_met" maxlength="20" size="25" value="{$lottery_met}" type="text"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>{$se_lottery_cry}</td>
					<td><input name="lottery_cry" maxlength="20" size="25" value="{$lottery_cry}" type="text"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>{$se_lottery_deu}</td>
					<td><input name="lottery_deu" maxlength="20" size="25" value="{$lottery_deu}" type="text"></td>
					<td>&nbsp;</td>
				</tr>
			//Lotterie End//
			<tr>
