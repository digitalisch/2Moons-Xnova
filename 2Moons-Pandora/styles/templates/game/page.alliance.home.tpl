...
<table style="90%>
	...
	{if $ally_image}
	<tr>
		<td colspan="2"><img src="{$ally_image}" style="width:100%;"></td>
	</tr>
	{/if}
	...
	<tr>
		<td><a href="#" onclick="return Dialog.AllianceChat();">{$LNG.al_goto_chat}</td>
		<td></a><a href="game.php?page=alliance&mode=circular" onclick="return Dialog.open(this.href, 650, 300);">{$LNG.al_send_circular_message}</a></td>
	</tr> 
