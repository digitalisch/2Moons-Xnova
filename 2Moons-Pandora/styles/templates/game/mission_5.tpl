...
<table class="table517">
	...
	<tr>
		<td class="k" colspan="10"><h3 class="textBeefy">{$LNG.tut_m5_name} - {$livello5} {$Si5}{$No5}</h3></td>
    </tr>
	<tr>
		<td class="k" colspan="3">
			<p id="aufgabentext"><img src="{$dpath}gebaeude/124.png" class="pic"></p>
		</td>
	...
	{if $Si5}
	<tr>
		<td colspan=9><a href ="game.php?page=tutorial&mode=m6"><input type="submit" style="cursor: pointer;" value="{$LNG.tut_go_to} {$LNG.tut_m6}" onclick="window.location = 'game.php?page=tutorial&mode=mercante'"/></a></td>
	</tr>
	{/if}
	<tr>
	</tr>
