...
<table style="width:100%;">
	...
	<tr>
		<td>
			<table>
				<tr>
					<td class="transparent" style="width:120px"><img width="120" height="120" src="{$dpath}gebaeude/{$elementID}.{if $elementID >=600 && $elementID <= 699}jpg{else}png{/if}" alt=""></td>
...
{if !empty($costTable)}
{include file="shared.information.cost.tpl"}
{/if}
