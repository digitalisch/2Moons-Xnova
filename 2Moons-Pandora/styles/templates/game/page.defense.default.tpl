...
{if !$NotBuilding}<table width="70%" id="infobox" style="border: 2px solid red; text-align:center;background:transparent"><tr><td>{$LNG.bd_building_defense}</td></tr></table><br><br>{/if}
{if !empty($BuildList)}
<table style="width:760px">
	<tr>
		<td class="transparent">
			<a style="color:gold"><div id="bx" class="z"></div></a>
			<br>
			...
			<tr>
				<td><select name="auftr[]" id="auftr" size="10" multiple><option>&nbsp;</option></select>
				<br><br><a style="color:red"><span id="timeleft"></span></a>
				<br>{$LNG.bd_cancel_warning}
				<br><input type="submit" value="{$LNG.bd_cancel_send}"></td>
			</tr>
			<tr>
				<th>&nbsp;</th>
			</tr>
			...
			<a style="color:red"><br><span id="timeleft"></span><br><br></a>
		</td>
	</tr>
</table>
<br>
