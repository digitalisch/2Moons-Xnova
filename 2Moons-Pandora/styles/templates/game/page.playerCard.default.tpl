...
<table style="width:95%">
	...
	{if $user_image}
	<tr>
		<td colspan="3"><img src="{$user_image}"style="max-width:500px;max-heigth:500px;"></td>
	</tr>
	{/if}
	<tr>
	...
	<tr>
		...
		<td>{$homeplanet}</td><td> <a href="#" onclick="parent.location = 'game.php?page=galaxy&amp;galaxy={$galaxy}&amp;system={$system}';return false;">[{$galaxy}:{$system}:{$planet}]</a></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
		<th>{$LNG.pl_points}</th>
