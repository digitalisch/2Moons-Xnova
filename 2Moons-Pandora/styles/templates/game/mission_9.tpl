...
<table class="table517">
	...
	<tr>
		<td class="k" colspan="10"><h3 class="textBeefy">{$LNG.tut_m9_name} - {$livello9} {$Si9}{$No9}</h3></td>
    </tr>
	<tr>
		<td class="k" colspan="3">
			<p id="aufgabentext"><img src="{$dpath}gebaeude/209.png" class="pic">
		</td>
		...
		<td class="k" colspan="10">
			<h3 style="text-align:left;">{$LNG.tut_objects}:</h3>
				<ul id="aufgabe_liste" style="text-align: left;">
					...
					<li class="aufzaehlungszeichen">{$LNG.tut_m9_quest2} {$Si_m9_2}{$No_m9_2}{$Si9}</li>
	...
	{if $Si9}
	<tr>
		<td colspan=9><input type="submit" style="cursor: pointer;" value="{$LNG.tut_compleat}" onclick=""/></td>
	</tr>
	{/if}
	<tr>
	</tr>	
