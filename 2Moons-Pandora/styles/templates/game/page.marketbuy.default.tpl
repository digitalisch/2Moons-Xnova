...
{if ($sr.user != $sr.users)}
<a href="game.php?page=market&amp;action=buy&amp;id={$sr.id}"><font color="#00FF00">{$LNG.an_buy}</font></a>
{else}
<a href="game.php?page=market&amp;action=del&amp;id={$sr.id}">{$LNG.an_del}</a>
...
<tr>
<th colspan="9"><a href="game.php?page=market&mode=in"><center><font color="#00FF00">{$LNG.an_upsale}</font></center></a></th>
</tr>
