 ...
 * @info $Id: FAQ.php 2632 2013-03-18 19:05:14Z slaver7 $
 * @link http://2moons.cc/
 */
...
<h3>Der Naquada Generator:</h3>
<p>Um Ressourcen zu produzieren, die du zum Aufbau deines Imperiums brauchst ist es notwendig dieses Gebäude gleich als erstes mit aufzubauen. Es liefert die Energie mit denen deine Minen die Ressourcen Trinium, Naquada und Naquadria produzieren. Sobald der Bau abgeschlossen ist kannst du in der Ressourcen-Leiste so wie unter dem Punkt "Produktion" einsehen wieviel Energie zur Verfügung steht.</p>
<h3>Das Trinium Modul:</h3>
<p>Trinium ist eine der drei Ressourcen, die dir im Spiel zur Verfügung stehen. Trinium wird für fast alles gebraucht was man bauen oder forschen kann. Daher ist ein guter Ausbau dieser Mine ratsam. Grade am Anfang ist es wichtig, dass diese Mine um einige Stufen höher betrieben wird, als die anderen.</p>
<h3>Die Naquada Mine und der Naquadria Sammler:</h3>
<p>Naquada ist ein wichtiger Rohstoff für Gebäude, Schiffe und Forschungen. Es wird in geringerem Umfang produziert als Trinium, was es dadurch aber nicht weniger wert macht. Im Verlaufe des Spiels wirst du sehen wie heiß umkämpft Naquada sein kann. Naquadria ist Energielieferant (Naquadria Sammler), Flottentreibstoff und Grundressource einiger wichtiger Forschungen und Bauten (Forschungslabor).</p>
BODY;
...
$LNG['questions'][3]['category']	= 'Fortgeschrittene';
$LNG['questions'][3][1]['title']	= 'Offiziere';
$LNG['questions'][3][1]['body']		= <<<BODY
<h3>Was bringen Offiziere?</h3>
<p>Die Offiziere bringen viele kleine Bonis, wie z.b.: </p>
<p>- erhöhung der Rohstoffproduktion, </p>
<p>- mehr Flottenslots, </p>
<p>- schnellere Forschung, </p>
<p>- schnellere Bauen, </p>
<p>- mehr Energie 
<p>- erhöhung der Lagerkapazität (bis dies neu berechnet wird, kann es immer ein bisschen dauern, deswegen bitte kein Ticket schreiben)
BODY;

$LNG['questions'][3][2]['title']	= 'Reflink-Bonus';
$LNG['questions'][3][2]['body']		= <<<BODY
<h3>Wie funktioniert das mit dem Reflink-Bonus?</h3>
<p>Ihr habt auf der Übersichtsseite, über dem Banner, einen Reflink. Den kopiert ihr und schickt ihn z.B. einem Freund.
<p>Wenn er den Reflink benutzt und sich registriert, steht sein Name auf eurer Übersichtsseite, wo ihr seht wieviel Punkte er schon hat.
<h3>Wann kriege ich den Bonus?</h3>
<p>Den Bonus erhaltet ihr, sobald die Person über 50000 Punkte verfügt.
<p>Du wirst auch per Nachricht darüber informiert, wenn der geworbene seine Punkte erreicht hat, und du bekommst die Dunkle Materie gutgeschrieben.
BODY;

$LNG['questions'][4]['category']	= 'Experte';
$LNG['questions'][4][1]['title']	= 'Kämpfe';
$LNG['questions'][4][1]['body']		= <<<BODY
<h3>Wie funkioniert das neue Belohnungs-System?</h3>
<p>Es besteht eine Chance, das ihr zu: 
<p>-		10% bei einem gewonnenen Kampf 100 DM gewinnt,
<p>-		15% bei einem gewonnenen Kampf  75 DM gewinnt,
<p>-		20% bei einem gewonnenen Kampf  50 DM gewinnt, 
<p>-		25% bei einem gewonnenen Kampf  25 DM gewinnt,
<p>-		30% bei einem gewonnenen Kampf   0 DM gewinnt.
<p>- 		Diesen Bonus erlangt aber auch erst dann, wenn über 1.000.000 Units zerstört wurden.
BODY;
