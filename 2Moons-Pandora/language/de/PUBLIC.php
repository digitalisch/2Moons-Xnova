...
// Button
$LNG['buttonRegister']				= 'Registrieren';
...
$LNG['loginInfo']					= 'Mit dem Login akzeptiere ihr die %s.';
$LNG['loginWelcome']				= '%s';
$LNG['loginServerDesc']				= 'ist ein Onlinine Strategie Browsergame. Spiele gegen andere um das Universum zu erobern und versuche der oder die beste zu werden im Game.';
$LNG['loginServerDesc2']				= 'der/die Beste zu werden. Alles was ihr zum spielen braucht ist ein Standartwebbrowser.';

// Register
$LNG['registerRace']                = 'Wähle deine Rasse:';
...
$LNG['registerWelcomePMText']		= 'Willkommen bei %s! Baue zuerst ein Solarkraftwerk, denn Energie wird für die spätere Rohstoffproduktion benötigt. Um diese zu bauen, klicke links im Menu auf "Bauzentrum". Danach baue das 4. Gebäude von oben. Da du nun Energie hast, kannst du anfangen Minen zu bauen. Gehe dazu wieder im Menü auf Bauzentrum und baue eine Holziumfabrik, danach wieder eine Goldmine. Um Schiffe bauen zu können musst du zuerst eine Raumschiffswerft gebaut haben. Was dafür benötigt wird findest du links im Menüpunkt Technologiebaum. Das Team wünscht dir viel Spaß beim Erkunden des Universums!';
...
//eigenes
$LNG['index_welc']					= 'Es ist Zeit für dein Imperium';
$LNG['index_new']					= 'Neues Design';
$LNG['index_new_desc']				= 'Es gibt ein komplett neues Design, registrier dich und überzeuge dich selbst.';
$LNG['index_info']					= 'Game Info';
$LNG['index_info_desc']				= 'Teste dein Wissen in dieser einzigartigen Game-Welt, du hast die Macht über dein Imperium.';
$LNG['index_stats']					= 'Detaillierte Statistiken';
$LNG['index_stats_desc']			= 'Neue und verbesserte Möglichkeiten, dein Imperium zu Verwalten und deine Statistiken mit dem Rest zu vergleichen.';
$LNG['index_news_desc']				= '"Herzlich Willkommen auf Pandora V1.0. Nach mehreren Monaten ist es endlich soweit, der Pandora ist fertig. Ich habe mir sehr viel Mühe gegeben, und hoffe das ich jedes kleine Detail beachtet habe. Hiermit wünsche ich allen Spieler viel Spaß und Erfolg beim spielen."';
$LNG['races_m']						= 'Mensch';
$LNG['races_m_desc1']				= 'Menschen sind große Bauherren. Die Geschwindigkeit und Gründlichkeit der Gebäude ist einzigartig.';
$LNG['races_m_1']					= 'Gebäudebauzeit reduziert -10%';
$LNG['races_m_2']					= 'Erhöhte Bauliste';
$LNG['races_m_3']					= 'Under Consturction';
$LNG['races_g']						= 'Goauld';
$LNG['races_g_desc1']				= 'Goaulds sind aggressiv und schnell bei ihren Angriffen. Sie erholen sich schnell und sind ausgezeichnete Jäger.';
$LNG['races_g_1']					= 'Schiffs/Deff-bauzeit reduziert -10%';
$LNG['races_g_2']					= 'Mehr Flottenslots';
$LNG['races_g_3']					= 'Under Consturction';
$LNG['races_r']						= 'Replikator';
$LNG['races_r_desc1']				= 'Replikatoren glauben nur an den Fortschritt. Sie sind sehr Intelligent und versuchen immer die fortgeschrittensten zu sein.';
$LNG['races_r_1']					= 'Forschungszeit reduziert -10%';
$LNG['races_r_2']					= 'Erhöhte Forschungsliste';
$LNG['races_r_3']					= 'Under Consturction';
