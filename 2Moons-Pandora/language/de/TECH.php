...
$LNG['tech'] = array(
	...
	31 => 'Forschungslabor',
	33 => 'Terraformer',
	34 => 'Intergalaktischer Raumhafen',
	44 => 'Raketensilo',
	40 => 'Mondgebäude',
	41 => 'Basisstützpunkt',
	42 => 'Sensorenphalax',
	...
	115 => 'Oxidationsantrieb',
	117 => 'Hoverantrieb',
	118 => 'Hyperraumantrieb',
	120 => 'Lasertechnik',
	121 => 'Ionentechnik',
	122 => 'Plasmatechnik',
	123 => 'Internationales Forschungsnetzwerk',
	124 => 'Weltraumphysik',
	131 => 'Produktionsmaximierung Holzium',
	132 => 'Produktionsmaximierung Iridium',
	133 => 'Produktionsmaximierung Öl',
...
$LNG['shortDescription'] = array(
	...
	3 => 'Entziehen den natürlichen Ölvorkommen eines Planeten das Öl.',
	4 => 'Solarkraftwerke gewinnen Energie aus Sonneneinstrahlung. Einige Gebäude benötigen Energie für ihren Betrieb.',
	5 => 'Die Multimine produziert alle Ressourcen indem sie wasser vom Meeresgrund zieht',
	6 => 'Sie verkürzt pro Stufe die Forschungszeit um 8%.',
	7 => 'Baue dieses Gebäude und du kannst deine Rohstoffe sichern',
	12 => 'Das Atomkraftwerk gewinnt Energie aus Brennstäben die aus Öl gefertigt werden.',
	...
	20 => 'Im Verteidigungszentrum werden alle Arten von Verteidigungsanlagen gebaut.',
	21 => 'In der planetaren Werft werden alle Arten von Schiffen gebaut.',
	22 => 'Lagerstätte für Holzium bevor sie weiter verarbeitet werden.',
	23 => 'Lagerstätte für Iridium bevor es weiter verarbeitet wird.',
	24 => 'Riesige Tanks zur Lagerung der neu gewonnenen Öle.',
	...
	34 => 'Der Intergalaktische Raumhafen bietet die Möglichkeit, befreundete Flotten, die bei der Verteidigung helfen und im Orbit stehen, mit Treibstoff zu versorgen.',
	...
	117 => 'Der Hoverantrieb basiert auf dem Rückstoßprinzip. Die Weiterentwicklung dieser Triebwerke macht einige Schiffe schneller, allerdings steigert jede Stufe die Geschwindigkeit nur um 20% des Grundwertes.',
	...
	131 => 'Erhöht die Produktion der Holziumfabrik um 2%',
	132 => 'Erhöht die Produktion der Iridiummine um 2%',
	133 => 'Erhöht die Produktion der Ölraffinerie um 2%',
	...
	204 => 'Der Sparrow ist ein wendiges Schiff, das auf fast jedem Planeten vorgefunden wird. Die Kosten sind nicht besonders hoch, Schildstärke und Ladekapazität sind allerdings sehr gering.',
	205 => 'Die Weiterentwicklung des Sparrows ist besser gepanzert und hat eine höhere Angriffsstärke.',
	206 => 'Raven sind fast dreimal so stark gepanzert wie Blackbird und verfügen über mehr als die doppelte Schusskraft. Zudem sind sie sehr schnell.',
	207 => 'Eagle bilden meist das Rückgrat einer Flotte. Ihre schweren Geschütze, die hohe Geschwindigkeit und der große Frachtraum machen sie zu ernst zu nehmenden Gegnern.',
	...
	213 => 'Der Nightingale ist der König unter den Kriegsschiffen.',
	214 => 'Die Zerstörungskraft des Todessterns ist unübertroffen und er kann als einziges Schiff Monde zerstören.',
	215 => 'Der ravager ist auf das Abfangen feindlicher Flotten spezialisiert.',
	...
	221	=> 'Die Schlange ist das langsamste Flugzeug überhaupt',
	...
	406 => 'Plasmageschütze setzen die Kraft einer Sonneneruption frei und übertreffen in ihrer zerstörerischen Wirkung sogar den Nightingale.',
	...
	601 => 'Der Geologe ist ein Experte bekannt in der Gesteinsphysiologie und der Iridiumographie. Mit seinem Expertenteam bestehend aus Holzium-Ingenieuren und Chemikern, assistiert er den interplanetaren Regierungen in der Recherche nach neuen Quellen und diese sicher gewinnen zu können.',
...
$LNG['longDescription'] = array(
	1 => 'Hauptrohstofflieferanten für den Bau tragender Strukturen von Bauwerken und Schiffen. Holzium ist der billigste Rohstoff, dafür wird er mehr benötigt als die anderen. Holzium braucht zur Herstellung am wenigsten Energie. Gleichzeitig muss für die größere Holziumfabrik mehr Energie zur Verfügung gestellt werden.',
	...
	3 => 'Der Ausbau der Raffinerie sorgt ebenfalls für die Erschließung dieser Öl-Tiefenlagerstätten. Öl wird als Treibstoff für die Schiffe, für fast alle Forschungen, für einen Blick in die Galaxie sowie für den Sensorphalanx-Scan benötigt.',
	...
	5 => 'Die Multimine produziert alle Ressourcen indem sie wasser vom Meeresgrund zieht und aus der Luft weitere Partikel sammelt. Da diese Prozedur technologisch weit fortgeschritten ist, braucht sie große mengen an Energie.',
	...
	7 => 'Hiermit kannst du deine Rohstoffe sichern',
	6 => 'Aufgrund der immer zeitaufwendigeren Forschungen, haben sich die klügsten Köpfe der intergalaktischen Forschungsnetzwerke zusammengetan und den TechnoDome entwickelt. Es verkürzt die Forschungszeiten um 8%',
	...
	20 => 'Im Verteidigungszentrum werden alle Arten von Verteidigungsanlagen gebaut. Je größer sie ist, desto schneller können aufwändigere und größere Verteidigungsanlagen gebaut werden. Durch Anbau einer Nanitenfabrik werden winzige Roboter erstellt, die den Arbeitern helfen, schneller zu arbeiten.',
	21 => 'In der planetaren Werft werden alle Arten von Schiffen gebaut. Je größer sie ist, desto schneller können aufwändigere und größere Schiffe gebaut werden. Durch Anbau einer Nanitenfabrik werden winzige Roboter erstellt, die den Arbeitern helfen, schneller zu arbeiten.',
	22 => 'Riesige Lagerstätte für abgebautes Holzium. Je größer der Speicher, desto mehr Holzium kann in ihm gelagert werden. Ist das Lager voll, wird kein Holzium mehr abgebaut.',
	23 => 'Das Iridium wird in diesen riesigen Lagerhallen zwischengespeichert. Je größer das Lager, desto mehr Iridium kann in ihm eingelagert werden. Sind die Iridiumlager voll, wird kein weiteres Iridium abgebaut.',
	24 => 'Riesige Tanks zur Lagerung des neu gewonnenen Öl. Diese Lager findet man meistens in der Nähe von Raumhäfen. Je größer sie sind, desto mehr Öl kann in ihnen gelagert werden. Sind sie gefüllt, wird kein Öl mehr abgebaut.',
	...
	34 => 'Der Intergalaktische Raumhafen bietet die Möglichkeit, befreundete Flotten, die bei der Verteidigung helfen und im Orbit stehen, mit Treibstoff zu versorgen. Für jeden Ausbaulevel des Intergalaktischen Raumhafens können 10.000 Einheiten Öl pro Stunde an die zu versorgenden Flotten im Orbit geschickt werden.',
	...
	42 => 'Hochauflösende Sensoren scannen das vollständige Frequenzspektrum aller auf die Phalanx auftreffenden Strahlungen. Hochleistungscomputer kombinieren winzige Energieschwankungen und gewinnen so Informationen über Schiffsbewegungen auf entfernten Planeten. Für den Scan muss Energie in Form von Öl (5.000) auf dem Mond bereitgestellt werden. Man scannt, indem man vom Mond aus ins Galaxiemenü wechselt und auf einen feindlichen Planeten in Sensorenreichweite (Phalanxstufe)^2 - 1 klickt.',
	43 => 'Sprungtore sind riesige Transmitter, die in der Lage sind, selbst große Flotten ohne Zeitverlust durch das Universum zu versenden. Diese Transmitter verbrauchen kein Öl, jedoch muss zwischen 2 Sprüngen eine Stunde vergehen, da sich die Tore sonst überhitzen würden. Auch ist ein Mitschicken von Ressourcen nicht möglich. Der ganze Vorgang erfordert eine ungeheuer hoch entwickelte Technologie.',
	...
	114 => 'Durch die Einbindung der 4. und 5. Dimension ist es nun möglich einen neuartigen Antrieb zu erforschen, welcher sparsamer und leistungsfähiger ist.',
	115 => 'Oxidationsantriebe basieren auf dem uralten Prinzip des Rückstoßes. Hocherhitzte Materie wird weggeschleudert und treibt das Schiff in die entgegengesetzte Richtung. Der Wirkungsgrad dieser Triebwerke ist eher gering, aber sie sind billig und zuverlässig und benötigen kaum Wartung. Außerdem verbrauchen sie weniger Raum und sind deshalb gerade auf kleineren Schiffen immer wieder zu finden. Da Oxidationsantriebe die Grundlage jeder Raumfahrt sind, sollten sie so früh wie möglich erforscht werden. Die Weiterentwicklung dieser Triebwerke macht folgende Schiffe um 10% des Grundwertes pro Stufe schneller: Kleine und große Transporter, Sparrow, Recycler und Spionagesonden.',
	117 => 'Der Hoverantrieb basiert auf dem Rückstoßprinzip, wobei die Strahlmasse zum Großteil als Abfallprodukt der zur Energiegewinnung verwendeten Kernfusion entsteht. Zusätzlich kann weitere Masse eingespritzt werden. Die Weiterentwicklung dieser Triebwerke macht folgende Schiffe um 20% des Grundwertes pro Stufe schneller: Bomber, Raven, Blackbird und Kolonieschiffe. Interplanetarraketen können pro Stufe weiter fliegen.',
	118 => 'Durch eine Raumzeitverkrümmung wird in unmittelbarer Umgebung eines Schiffes der Raum komprimiert, womit sich weite Strecken sehr schnell zurücklegen lassen. Je höher der Hyperraumantrieb entwickelt ist, desto höher wird die Kompression des Raumes, wodurch sich pro Stufe die Geschwindigkeit der Schiffe die damit ausgestattet sind (Ravager, Eagle, Nightingale und Todessterne) um 30% erhöht. Voraussetzungen: Hyperraumtechnik (Stufe 3) Forschungslabor (Stufe 7).',
	...
	213 => 'Der Nightingale ist der König unter den Kriegsschiffen. Seine Multiphalanx Ionen-, Plasma- und Gaußgeschütztürme können durch ihre verbesserten Anpeilungssensoren fast 99% der verteidigenden leichten Laser treffen. Da der Nightingale sehr groß ist, ist seine Manövrierfähigkeit stark eingeschränkt, wodurch er im Kampf eher einer Kampfstation gleicht, als einem Kampfschiff. So hoch wie seine Kampfkraft ist auch sein Verbrauch an Öl.',
	214 => 'Der Todesstern ist mit einer riesigen Gravitonkanone bewaffnet, die Schiffe so groß wie Nightingale oder sogar Monde zerstören kann. Da dafür eine hohe Menge an Energie benötigt wird, besteht er fast nur aus Generatoren. Lediglich riesige Sternenreiche können überhaupt die Ressourcen und Arbeiter aufbringen, um dieses mondgroße Schiff zu Bauen.',
	...
	220 => 'Mit diesem Schiff ist es nach jahrelangem Forschen möglich, Dunkle Materie an seinem Mond zu sammeln.',
	221 => 'Die Schlange ist das langsamste Flugzeug, dass es momentan gibt. Deswegen wird es gerne benutzt um seine Flotte zu sichern.',
