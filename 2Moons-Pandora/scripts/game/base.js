...
var Dialog	= {	
	...
	imperium: function(ID) {
		return Dialog.open('game.php?page=imperium&id='+ID, 960, 900);
	},
	
	infos: function(ID) {
		return Dialog.open('game.php?page=infos&id='+ID, 770, 550);
	},
	
	rules: function() {
		return Dialog.open('index.php?page=rules', 960, 900);
	},
	...
	Chat: function() {
	    return OpenPopup('game.php?page=chat&action=alliance', "chat", 960, 900);
	},
